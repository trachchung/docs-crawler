<!-- Source: https://danielmiessler.com/blog/ai-predictable-path-7-components-2024 -->

# AI's Predictable Path
Technological progress isn't predictable, but the human desires that drive it are
December 31, 2023
[ #ai](https://danielmiessler.com/archives/?tag=ai)[ #business](https://danielmiessler.com/archives/?tag=business)[ #creativity](https://danielmiessler.com/archives/?tag=creativity)[ #cybersecurity](https://danielmiessler.com/archives/?tag=cybersecurity)[ #ethics](https://danielmiessler.com/archives/?tag=ethics)[ #future](https://danielmiessler.com/archives/?tag=future)[ #innovation](https://danielmiessler.com/archives/?tag=innovation)[ #society](https://danielmiessler.com/archives/?tag=society)[ #technology](https://danielmiessler.com/archives/?tag=technology)[ #recommended](https://danielmiessler.com/archives/?tag=recommended)[ #top](https://danielmiessler.com/archives/?tag=top)[ #must](https://danielmiessler.com/archives/?tag=must)
 All-systems-redding…
1 reading now 
The seven components of AI's predictable future (click for full size)  
...
The trick, however, is that I'm going to do this _stochastically_ , and my promise to you is that once you hear them and let them sit for a bit, they'll be as obvious to you as they are to me.
It's almost impossible to predict exactly what a given tech will look like, who will make it, or when it'll happen.
That $37 word I used— _stochastic_ —is one of my favorites. It basically means random at any given point, but with a predictable destination.
Like a drunk person stumbling home—unpredictable steps, predictable destination (click for full size)  
...
But _humans_ are.
## Unpredictable tech; predictable humans [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#unpredictable-tech-predictable-humans)
...
The same human desires across millennia (click for full size)  
...
## Stochastic predictions [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#stochastic-predictions)
So, with all that throat clearing out of the way, here's what I see coming in the world of AI. Sidenote: I captured a number of these in my essay-turned-book [_The Real Internet of Things_](https://www.amazon.com/Real-Internet-Things-Daniel-Miessler-ebook/dp/B01NCLUA5T/ref=asap_bc?ie=UTF8&utm_source=danielmiessler.com&utm_medium=newsletter&utm_campaign=ai-s-predictable-path), in 2016. I wish I could recommend it strongly, but the only thing it's really good for is showing that I've been thinking about this for a long time. Worth a read if you're into a 2016 view of these same concepts.
...
## 1. Digital Assistants: _Our Personal AIs Will Know and Be Everything to Us_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_1-digital-assistants-our-personal-ais-will-know-and-be-everything-to-us)
Digital Assistants will be our constant companions (click for full size)  
Nobody knows exactly how personal AI's will end up on our mobile devices, but I'm guessing it'll be some combination of:
  1. Via our mobile OS AI's, e.g., Siri, Gemini/Assistant, and whatever Satya calls Microsoft's new one
  2. The mobile platforms will be required to put third-party Digital Assistants on their devices with equal access
...
### So, much, access… [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#so-much-access)
  ...
  * They'll know our likes and dislikes for foods, conversation topics, sexual preferences/kinks, reading and movies, and everything else because—once again—they'll make the DA a better assistant and, um, _friend_
...
DAs will fulfill multiple roles in our lives (click for full size)  
...
## 2. Everything and Everyone Gets an API (Daemon/Aura): _AIs Will Understand Things By What They Broadcast_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_2-everything-and-everyone-gets-an-api-daemon-aura-ais-will-understand-things-by-what-they-broadcast)
Everything will broadcast its capabilities via APIs (click for full size)  
The way DAs will interact with the world to help their owners is through APIs.
**Everyone and everything is about to have an API, which I call a** _Daemon_ ([Greek for spirit](https://en.wikipedia.org/wiki/Daimon?utm_source=danielmiessler.com&utm_medium=newsletter&utm_campaign=ai-s-predictable-path)). This is one of the changes that will start slow with lots of different players and protocols, and then a winning format will emerge that everyone standardizes on.
...
For a restaurant, it'll be things like:
  * `/menu` // So your DA can give you options
  * `/hours` // So your DA will know availability
  * `/staff` // Get sat in your favorite section
  * `/media` // Change the monitor to their preferred media
  * `/order` // Your DA can order for you
For a globally available business, it'll be things like:
  * `/catalog` // So your DA will know availability
  * `/about` // Additional info
  * `/contact` // Interact with the company
  * `/support` // Get help
  * `/order` // Your DA can buy for you
...
The next section on Mediation shows how powerful this will be.
  * **People** : People will have Daemons, or Auras, or APIs as well. Again, it's like a business but tuned for an individual. Who knows what it'll actually be called. I think _Daemon_ or _Aura_ would be cool names, but predicting those names is like predicting drunken footsteps.


Personal APIs will share what we want others to know (click for full size)  
...
Human Daemons will host things like:
  * `/about` // General info
  * `/preferences` // Visibility depends on access
  * `/restricted` // Requires additional auth/access
  * `/work` // The ability to hire them
  * `/cv` // See their work history
...
## 3. Our DAs Will Mediate Everything: _We'll Say What We Want, And Our DAs Will Manipulate External Daemons/APIs to Make It Happen_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_3-our-das-will-mediate-everything-we-ll-say-what-we-want-and-our-das-will-manipulate-external-daemons-apis-to-make-it-happen)
DAs will handle thousands of API interactions for us (click for full size)  
Too many APIs
...
DAs will create custom interfaces for complex interactions (click for full size)  
...
Here are some of the steps it can take from there.
  ...
  * Create a summary for their owner that goes into their `/checklater` file, and/or ask them when they have a minute
...
**And our DAs won't do this once in a while. They'll do it** **_constantly_**. **Continuously. Perpetually. All day every day.**
...
## 4. Our DAs Will Become Our Active Advocates and Defenders: _They'll Actively Monitor, Filter, and Manipulate The World To Protect Us_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_4-our-das-will-become-our-active-advocates-and-defenders-they-ll-actively-monitor-filter-and-manipulate-the-world-to-protect-us)
A Veritas propaganda shield protecting a young principal (click for full size)  
The major advantage of [Component 1](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#1-digital-assistants) in this list is that our DA's will know more about us than anyone, often including ourselves.
_This includes our vulnerabilities._
Some of us are young and angry, and we can be swayed by being offered a scapegoat. Others among us are lonely, and we can get [Pig Butchered](https://www.propublica.org/article/whats-a-pig-butchering-scam-heres-how-to-avoid-falling-victim-to-one?utm_source=danielmiessler.com&utm_medium=newsletter&utm_campaign=ai-s-predictable-path) and have all our money stolen. Or maybe we've been traumatized in the past, and people know how to push our buttons. Others are simply gullible, and can fall for all manner of scams and trickery.
...
### Physical lookouts [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#physical-lookouts)
DAs will monitor physical threats in real-time (click for full size)  
...
The peace of mind this will give the owner will be immeasurable, and it hits right at the center of our first aspect of human predictability— _Security_.
...
Live analysis of a person they're on a call with (click for full size)  
...
## 5. We'll Have a Thriving Ecosystem of DA Modules: _Companies Will Put All Their Effort into Being the Go-to Module for DAs_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_5-we-ll-have-a-thriving-ecosystem-of-da-modules-companies-will-put-all-their-effort-into-being-the-go-to-module-for-das)
A marketplace of specialized modules for every need (click for full size)  
...
Going back to [Component 2](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#2-everything-gets-an-api), DA modules will basically include every company in existence because every company will effectively be an API.
...
DAs constantly discovering and evaluating new modules (click for full size)  
...
A world of APIs (click for full size)  
Examples of Modules
...
## 6. AR Interfaces Will Show Us The Daemons Around Us: _We'll See Visual Representations of Character, Personality, and Functionality_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_6-ar-interfaces-will-show-us-the-daemons-around-us-we-ll-see-visual-representations-of-character-personality-and-functionality)
Your filter for authors in the fantasy genre (click for full size)  
Going back to [our opening comments about what humans want](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#introduction), people will want to see the world in dramatically different ways because they will value different things.
...
Some examples:
  * Show me everyone with a _criminal_ record and/or who might be dangerous
  * Show me famous people with a brighter glow for the most famous
  * Show me **everyone single** and looking for a friend
  * `RoseColored Lens:` Reality is depressing; highlight everything good happening around me
  ...
  * Make people sparkly if they like a lot of the same reading that I do
  * Show me the **NICEST** people around me, and outline them in purple, and put a smiley face over their heads
  * Light up the street in front of me with the directions to the Burrito place we're walking to


What will be so cool about these AR modules is that they'll leverage all the previous components we've talked about. [Everything will be broadcasting a daemon](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#2-everything-gets-an-api), and at least some of that data will be readable by your DA. And that data can then be part of your view of the world.
More visual examples/ideas for personal Aura display:
RPGlow — Shows anyone into Role-playing Games (click for full size)  
CompassionAI — Shows people going through hard times who could use a friend (click for full size)  
ZenWatch — Shows anyone broadcasting that they're interested in meditation (click for full size)  
PIXELTECH — Shows anyone working in tech (click for full size)  
CreaView — Shows people being creative across 3 or more fields (click for full size)  
...
## 7. We'll Have Additional Role-Based DAs Performing Specific Tasks: _It'll Be a Collective of AIs Managed by Your Primary DA_ [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_7-we-ll-have-additional-role-based-das-performing-specific-tasks-it-ll-be-a-collective-of-ais-managed-by-your-primary-da)
Multiple DAs working together to help Christopher (click for full size)  
...
Sometimes distinct perspectives on a problem can help as much as distinct capabilities.
So let's say you're a super shy person named Kendrick. You might have picked a DA that isn't just like you, but that is a great _compliment_ to you. So your DA's name is Tan, and he's actually outgoing, and funny, and adventurous. And even a little mischievous. He balances you out. And for the killjoys out there—yes—you put in your DA creation questionnaire that you're looking to come out of your shell, and you need someone to help you do that.
...
###  **CODEX:** Your _Developer_ DA [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#codex-your-developer-da)
CODEX - specialized developer DA (click for full size)  
...
…etc.
So now you have your regular DA, _Kai_ , and now you decide to subscribe to this new CODEX DA, which you customize and name _Loop_.
###  **GLiTCH:** Your _Hacker_ DA [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#glitch-your-hacker-da)
GLiTCH - specialized hacker DA (click for full size)  
...
Diverse hacker DAs for different perspectives (click for full size)  
  * **StackProf** : For any given target, build a full report on the tech they use, the social media handles they operate under, a full archive of their public content, and builds a psychological profile on them that can be used to (defensively, _cough_) respond during a conflict
...
So now Kai has a friend named _Chaos_. Chaos is very blue-focused, unless you tell him not to be. And if you get too much hate online he starts asking if he can pre-emptively hack back.
### More Standalone DA Examples [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#more-standalone-da-examples)
A team of specialized DAs for different needs (click for full size)  
...
Some additional supplemental DA ideas:
  * **Executive Assistant:** Runs your email, runs your calendar, fiercely defends your time. Knows your life strategy and goals, and learns to decline and accept inbound opportunities based on that. Keeps you on time and on task.
  ...
  * 🔥 **Sage** : Think about having a virtual Socrates, or Richard Feynman, or MLK that you can ask any question. The DA creator company has the whole corpus of their work and excels at capturing how they might have responded to new types of challenges. **Now imagine having like 10 of those for your favorite thinkers**. Think of the deep analysis and introspection you could do by seeing problems from multiple perspectives. Jung, Confucius, Plato, etc.
...
Your personal team of AI advocates (click for full size)  
...
Again, your primary DA will have access to modules/APIs that will make it good enough to do most of these. But there are three main issues there:
  1. The **personality** aspect will give each dedicated DA a distinct feel because so much time and effort gets put into how they interact with their owner. So it'll be more like having a crew/posse of regular friends as opposed to one friend who changes clothes to be different people.
  2. The behavior required for a given **role** might be weird coming from your primary DA who you already have a relationship with. E.g., you might want to separate out your gaming buddy from your therapist from your flirting pal. But hey—maybe not.
  3. The **experience and capabilities** of your module-enabled DA are not likely to rival a dedicated DA on domain-specific tasks. Dedicated DAs will be holistic systems that combine the personality with the absolute latest models and data sets for a particular area.


## Holy crap, that's cool! But what about security and privacy? [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#holy-crap-that-s-cool-but-what-about-security-and-privacy)
Security will be a major concern in this ecosystem (click for full size)  
...
On the **security** side, I have good news and bad news. Mostly bad news.
  1. If you're hoping AI will help us secure all this ecosystem before it gets hacked, because AI is really cool and smart, etc., **that's not going to happen**. I've talked about AI's [security](https://danielmiessler.com/blog/the-ai-attack-surface-map-v1-0/?utm_source=danielmiessler.com&utm_medium=newsletter&utm_campaign=ai-s-predictable-path&last_resource_guid=Post%3A6b27f6d4-e7b9-4148-ab0b-ee891a61e62b) challenges [at length](https://danielmiessler.com/blog/ai-agents-api-calling-prompt-injection?utm_source=danielmiessler.com&utm_medium=newsletter&utm_campaign=ai-s-predictable-path&last_resource_guid=Post%3A6b27f6d4-e7b9-4148-ab0b-ee891a61e62b) elsewhere, but the short version is that it's going to be extremely treacherous.
  2. The good news is that If you're in cybersecurity, and are capable of doing anything with/around AI Security, **the world is going to need your services for a good long while**.


The number of things that can—and will—go wrong with this ecosystem I'm describing are _legion_. Here are the two worst in my opinion:
## 1. Digital Assistant Hacks [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_1-digital-assistant-hacks)
DA hacks will be catastrophic personal events (click for full size)  
...
#### The ransomware case [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#the-ransomware-case)
...
Hacking someone's Digital Assistant will be like compromising their soul. Not their accounts. Not their tech. Their soul.
  ...
  * Your likes and dislikes, including _private_ ones
...
## 2. Agents and APIs [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_2-agents-and-apis)
API vulnerabilities will affect global infrastructure (click for full size)  
Hacking the Digital Assistants will have the most personal impact, but society-wise the biggest risk, in my opinion, has to do with AI Agents like DAs having access to all the APIs we talked about in [the second section](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#2-everything-gets-an-api).
...
## 3. The Influence Industrial Complex [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_3-the-influence-industrial-complex)
DAs will be prime targets for influence operations (click for full size)  
...
Except the system is designed specifically to manipulate, bias, and otherwise influence the principal. Examples include making people:
  ...
  * _Start believing something untrue_
...
## Holy crap, that's horrific. Why are we even saying this is a good thing? [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#holy-crap-that-s-horrific-why-are-we-even-saying-this-is-a-good-thing)
Great question. In my model, however, it doesn't matter if it's a good or bad thing. Going back to the core idea of predictability, **this is what we humans want.**
  * We _want_ the functionality we'll get from DA's having full access to our lives
  * We _want_ the functionality we'll get when those DAs can navigate the entire world using standardized interfaces
  * We _want_ our human capabilities to Survive, Thrive, and Connect to be enhanced using all these tools


And so it will happen.
What if I told you in the 80's that in the 2020's everyone would have their money online even though identities and accounts were hacked on a regular basis? Risk becomes invisible when the benefits are deemed worth it.
...
## Vignettes [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#vignettes)
Here are some random and illustrative use cases that cross all 7 components.
## 1. Your DA hooks you up in the Starbucks line [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_1-your-da-hooks-you-up-in-the-starbucks-line)
DAs facilitating real-world connections (click for full size)  
...
## 2. Your DA guides you through difficult areas [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_2-your-da-guides-you-through-difficult-areas)
Real-time threat assessment and navigation (click for full size)  
Security is the first layer of our [human predictability model](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#unpredictable-tech-predictable-huma) for good reason. Basically, if you don't have your safety in order, it's hard to think about climbing a ladder or finding a partner.
And because it's such a deep priority for us, I think it'll be one of the first use cases to combine [API-ification](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#2-everything-gets-an-api), [DA mediation](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#3-d-as-mediate-everything), and [AR interfaces](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#6-ar-interfaces).
AR overlay showing potential threats (click for full size)  
...
## 3. You get a customized dining experience, every time [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_3-you-get-a-customized-dining-experience-every-time)
Personalized dining experiences through API integration (click for full size)  
**YOU** : Kai, I'm hungry. Maybe Thai. Anything good around here?
Your DA hears that, and starts firing off API requests.
  1. Use our favorite restaurant discovery API
  2. What Thai restaurants are close
  3. What's highly rated
  4. He doesn't like that place on 4th and Mason
  5. Papaya Thai on Mowry looks good
  6. Checks `/staff` on Papaya's daemon/API and sees that the owner is there
  7. Checks `/media` and sees that he can change two of the screens in the restaurant to Table Tennis, his owner's favorite sport
  8. Hits `/menu` and orders Panang Curry with Chicken, Spicy, and a Diet Coke
  9. Pings the owner's DA, Kim, and lets him know his principal is on the way
...
## Closing Questions and Analysis [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#closing-questions-and-analysis)
Even everyday objects will have their own auras (click for full size)  
Here are some random additional thoughts these ideas raise for me.
## 1. What happens to search engines and other human-focused interfaces? [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_1-what-happens-to-search-engines-and-other-human-focused-interfaces)
...
## 2. What does it do to society to have DAs become so compelling as companions? [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#_2-what-does-it-do-to-society-to-have-das-become-so-compelling-as-companions)
...
Cool, but what about **human** friends? What about human connection? Isn't the point of tech to enhance humanity? Or shouldn't it be? What if this all gets so good that people start thinking it means it can _replace_ humanity?
...
## Summary and Recommendations [​](https://danielmiessler.com/blog/ai-predictable-path-7-components-2024#summary-and-recommendations)
...
Here is a **crisp capture of the major claims and points**.
  1. **Digital Assistants (DAs)** will become our primary interface to the world, knowing everything about us and advocating for us 24/7
  2. **Everything Gets an API** - Every person, business, and object will broadcast their capabilities and preferences through standardized interfaces
  3. **DA Mediation** - We'll rarely interact directly with services; our DAs will handle thousands of API calls to accomplish what we need
  4. **Active Protection** - DAs will continuously monitor, filter, and shape our reality to protect us from physical and psychological threats
  5. **Module Ecosystem** - A thriving marketplace of specialized DA modules will emerge, with companies competing to be the go-to solution
  6. **AR Interfaces** - We'll see the world through customized AR filters that highlight what matters to us based on daemon/aura data
  7. **Multiple Specialized DAs** - We'll have teams of role-specific DAs with distinct personalities working together under our primary DA


The security implications are severe:
  * DA hacks will be catastrophic personal events
  * API vulnerabilities will affect global infrastructure
  * Influence operations will have unprecedented power
...
#### Notes
  1. This essay was originally published in December 2023 and represents my vision of how AI will reshape human interaction over the next decade.
  2. The concept of "stochastic" progress - unpredictable in specifics but predictable in direction - is central to understanding technological evolution.
  3. All visualizations were created specifically for this essay to help illustrate these abstract concepts.
  4. The security concerns outlined here are not hypothetical - they represent real challenges we'll need to address as these systems emerge.


Share
[HN Hacker News ](https://ul.live/share-hn?url=https%3A%2F%2Fdanielmiessler.com%2Fblog%2Fai-predictable-path-7-components-2024&title=AI's%20Predictable%20Path "Share on Hacker News")
Follow
## supporting = loving
...
aibusinesscreativitycybersecurityethicsfutureinnovationsocietytechnologyrecommendedtopmust

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#__docusaurus_skipToContent_fallback)
On this page
...
If you don't have a public URL or just want to get started quickly, check out [Build a GitHub PR Review Agent](https://hermes-agent.nousresearch.com/docs/guides/github-pr-review-agent) — uses cron jobs to poll for PRs on a schedule, works behind NAT and firewalls.
For the full webhook platform reference (all config options, delivery types, dynamic subscriptions, security model) see [Webhooks](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks).
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#prerequisites "Direct link to Prerequisites")
  ...
  * A publicly reachable URL for your Hermes instance (see [Local testing with ngrok](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#local-testing-with-ngrok) if running locally)
  * Admin access to the GitHub repository (required to manage webhooks)


## Step 1 — Enable the webhook platform[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-1--enable-the-webhook-platform "Direct link to Step 1 — Enable the webhook platform")
...
## Step 2 — Start the gateway[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-2--start-the-gateway "Direct link to Step 2 — Start the gateway")
...
## Step 3 — Register the webhook on GitHub[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-3--register-the-webhook-on-github "Direct link to Step 3 — Register the webhook on GitHub")
...
## Step 4 — Open a test PR[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-4--open-a-test-pr "Direct link to Step 4 — Open a test PR")
...
## Local testing with ngrok[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#local-testing-with-ngrok "Direct link to Local testing with ngrok")
...
## Filtering to specific actions[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#filtering-to-specific-actions "Direct link to Filtering to specific actions")
...
## Using a skill for consistent review style[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#using-a-skill-for-consistent-review-style "Direct link to Using a skill for consistent review style")
Load a [Hermes skill](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills) to give the agent a consistent review persona. Add `skills` to your route inside `platforms.webhook.extra.routes` in `config.yaml`:
...
## Sending responses to Slack or Discord instead[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#sending-responses-to-slack-or-discord-instead "Direct link to Sending responses to Slack or Discord instead")
...
## GitLab support[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#gitlab-support "Direct link to GitLab support")
...
## Security notes[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#security-notes "Direct link to Security notes")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#troubleshooting "Direct link to Troubleshooting")  
| Symptom  | Check  |  
| --- | --- |  
...
## Full config reference[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#full-config-reference "Direct link to Full config reference")
...
## What's Next?[​](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#whats-next "Direct link to What's Next?")
  * **[Cron-Based PR Reviews](https://hermes-agent.nousresearch.com/docs/guides/github-pr-review-agent)** — poll for PRs on a schedule, no public endpoint needed
  * **[Webhook Reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks)** — full config reference for the webhook platform
  * **[Build a Plugin](https://hermes-agent.nousresearch.com/docs/guides/build-a-hermes-plugin)** — package review logic into a shareable plugin
  * — run a dedicated reviewer profile with its own memory and config


  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#prerequisites)
  * [Step 1 — Enable the webhook platform](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-1--enable-the-webhook-platform)
  * [Step 2 — Start the gateway](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-2--start-the-gateway)
  * [Step 3 — Register the webhook on GitHub](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-3--register-the-webhook-on-github)
  * [Step 4 — Open a test PR](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#step-4--open-a-test-pr)
  * [Local testing with ngrok](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#local-testing-with-ngrok)
  * [Filtering to specific actions](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#filtering-to-specific-actions)
  * [Using a skill for consistent review style](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#using-a-skill-for-consistent-review-style)
  * [Sending responses to Slack or Discord instead](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#sending-responses-to-slack-or-discord-instead)
  * [GitLab support](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#gitlab-support)
  * [Security notes](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#security-notes)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#troubleshooting)
  * [Full config reference](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#full-config-reference)
  * [What's Next?](https://hermes-agent.nousresearch.com/docs/guides/webhook-github-pr-review#whats-next)

...
## Development Workflow[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#development-workflow "Direct link to Development Workflow")
### Nightly Backlog Triage[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#nightly-backlog-triage "Direct link to Nightly Backlog Triage")
...
### Automatic PR Code Review[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#automatic-pr-code-review "Direct link to Automatic PR Code Review")
...
### Docs Drift Detection[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#docs-drift-detection "Direct link to Docs Drift Detection")
...
### Dependency Security Audit[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#dependency-security-audit "Direct link to Dependency Security Audit")
...
## DevOps & Monitoring[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#devops--monitoring "Direct link to DevOps & Monitoring")
### Deploy Verification[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#deploy-verification "Direct link to Deploy Verification")
...
### Alert Triage[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#alert-triage "Direct link to Alert Triage")
...
### Uptime Monitor[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#uptime-monitor "Direct link to Uptime Monitor")
...
## Research & Intelligence[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#research--intelligence "Direct link to Research & Intelligence")
### Competitive Repository Scout[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#competitive-repository-scout "Direct link to Competitive Repository Scout")
...
### AI News Digest[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#ai-news-digest "Direct link to AI News Digest")
...
### Paper Digest with Notes[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#paper-digest-with-notes "Direct link to Paper Digest with Notes")
...
## GitHub Event Automations[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#github-event-automations "Direct link to GitHub Event Automations")
### Issue Auto-Labeling[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#issue-auto-labeling "Direct link to Issue Auto-Labeling")
...
### CI Failure Analysis[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#ci-failure-analysis "Direct link to CI Failure Analysis")
...
### Auto-Port Changes Across Repos[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#auto-port-changes-across-repos "Direct link to Auto-Port Changes Across Repos")
...
## Business Operations[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#business-operations "Direct link to Business Operations")
### Stripe Payment Monitoring[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#stripe-payment-monitoring "Direct link to Stripe Payment Monitoring")
...
### Daily Revenue Summary[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#daily-revenue-summary "Direct link to Daily Revenue Summary")
...
## Multi-Skill Workflows[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#multi-skill-workflows "Direct link to Multi-Skill Workflows")
### Security Audit Pipeline[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#security-audit-pipeline "Direct link to Security Audit Pipeline")
...
### Content Pipeline[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#content-pipeline "Direct link to Content Pipeline")
...
## Quick Reference[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#quick-reference "Direct link to Quick Reference")
### Cron Schedule Syntax[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#cron-schedule-syntax "Direct link to Cron Schedule Syntax")  
| Expression  | Meaning  |  
| --- | --- |  
...
| `0 */6 * * *`  | Every 6 hours  |  
### Delivery Targets[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#delivery-targets "Direct link to Delivery Targets")  
| Target  | Flag  | Notes  |  
| --- | --- | --- |  
...
### Webhook Template Variables[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#webhook-template-variables "Direct link to Webhook Template Variables")  
...
### The [SILENT] Pattern[​](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#the-silent-pattern "Direct link to The \[SILENT\] Pattern")
...
This means you only get notified when the agent has something to report.
  * [Development Workflow](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#development-workflow)
    * [Nightly Backlog Triage](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#nightly-backlog-triage)
    * [Automatic PR Code Review](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#automatic-pr-code-review)
    * [Docs Drift Detection](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#docs-drift-detection)
    * [Dependency Security Audit](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#dependency-security-audit)
  * [DevOps & Monitoring](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#devops--monitoring)
    * [Deploy Verification](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#deploy-verification)
    * [Alert Triage](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#alert-triage)
    * [Uptime Monitor](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#uptime-monitor)
  * [Research & Intelligence](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#research--intelligence)
    * [Competitive Repository Scout](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#competitive-repository-scout)
    * [AI News Digest](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#ai-news-digest)
    * [Paper Digest with Notes](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#paper-digest-with-notes)
  * [GitHub Event Automations](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#github-event-automations)
    * [Issue Auto-Labeling](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#issue-auto-labeling)
    * [CI Failure Analysis](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#ci-failure-analysis)
    * [Auto-Port Changes Across Repos](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#auto-port-changes-across-repos)
  * [Business Operations](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#business-operations)
    * [Stripe Payment Monitoring](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#stripe-payment-monitoring)
    * [Daily Revenue Summary](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#daily-revenue-summary)
  * [Multi-Skill Workflows](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#multi-skill-workflows)
    * [Security Audit Pipeline](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#security-audit-pipeline)
    * [Content Pipeline](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#content-pipeline)
  * [Quick Reference](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#quick-reference)
    * [Cron Schedule Syntax](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#cron-schedule-syntax)
    * [Delivery Targets](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#delivery-targets)
    * [Webhook Template Variables](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#webhook-template-variables)
    * [The [SILENT] Pattern](https://hermes-agent.nousresearch.com/docs/guides/automation-templates#the-silent-pattern)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#__docusaurus_skipToContent_fallback)
On this page
...
The stream read timeout is the one most likely to cause issues — it's the socket-level deadline for receiving the next chunk of data. During prefill on large contexts, local models may produce no output for minutes while processing the prompt. The auto-detection handles this transparently.
  * [Choosing a model](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#choosing-a-model)
  * [Option A: llama.cpp](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#option-a-llamacpp)
    * [Download the model](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#download-the-model)
    * [Start the server](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#start-the-server)
    * [Memory optimization for constrained systems](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#memory-optimization-for-constrained-systems)
    * [Get the model name](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#get-the-model-name)
  * [Option B: MLX via omlx](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#option-b-mlx-via-omlx)
    * [Download the model](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#download-the-model-1)
    * [Start the server](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#start-the-server-1)
    * [List available models](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#list-available-models)
  * [Benchmarks: llama.cpp vs MLX](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#benchmarks-llamacpp-vs-mlx)
    * [What this means](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#what-this-means)
    * [Which one should you pick?](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#which-one-should-you-pick)
  * [Connect to Hermes](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#connect-to-hermes)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#__docusaurus_skipToContent_fallback)
On this page
...
_For the complete delegation reference — all parameters, ACP integration, and advanced configuration — see[Subagent Delegation](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation)._
  * [When to Delegate](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#when-to-delegate)
  * [Pattern: Parallel Research](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-parallel-research)
  * [Pattern: Code Review](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-code-review)
  * [Pattern: Compare Alternatives](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-compare-alternatives)
  * [Pattern: Multi-File Refactoring](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-multi-file-refactoring)
  * [Pattern: Gather Then Analyze](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-gather-then-analyze)
  * [Toolset Selection](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#toolset-selection)
  * [Constraints](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#constraints)
    * [Tuning Concurrency and Depth](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#tuning-concurrency-and-depth)

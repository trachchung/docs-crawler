<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching -->
...
## Pluggable Context Engine[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#pluggable-context-engine "Pluggable Context Engine的直接链接")
...
```
context:engine:"compressor"# default — built-in lossy summarizationengine:"lcm"# example — plugin providing lossless context
```
...
For building a context engine plugin, see [Context Engine Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/context-engine-plugin).
## Dual Compression System[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#dual-compression-system "Dual Compression System的直接链接")
...
### 1. Gateway Session Hygiene (85% threshold)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#1-gateway-session-hygiene-85-threshold "1. Gateway Session Hygiene \(85% threshold\)的直接链接")
...
### 2. Agent ContextCompressor (50% threshold, configurable)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#2-agent-contextcompressor-50-threshold-configurable "2. Agent ContextCompressor \(50% threshold, configurable\)的直接链接")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#configuration "Configuration的直接链接")
...
### Parameter Details[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#parameter-details "Parameter Details的直接链接")  
| Parameter  | Default  | Range  | Description  |  
| --- | --- | --- | --- |  
| `threshold`  | `0.50`  | 0.0-1.0  | Compression triggers when prompt tokens ≥ `threshold × context_length`  |  
| `target_ratio`  | `0.20`  | 0.10-0.80  | Controls tail protection token budget: `threshold_tokens × target_ratio`  |  
| `protect_last_n`  | `20`  | ≥1  | Minimum number of recent messages always preserved  |  
| `protect_first_n`  | (hardcoded)  | System prompt + first exchange always preserved  |  
### Computed Values (for a 200K context model at defaults)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#computed-values-for-a-200k-context-model-at-defaults "Computed Values \(for a 200K context model at defaults\)的直接链接")
...
## Compression Algorithm[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#compression-algorithm "Compression Algorithm的直接链接")
The `ContextCompressor.compress()` method follows a 4-phase algorithm:
### Phase 1: Prune Old Tool Results (cheap, no LLM call)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-1-prune-old-tool-results-cheap-no-llm-call "Phase 1: Prune Old Tool Results \(cheap, no LLM call\)的直接链接")
...
### Phase 2: Determine Boundaries[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-2-determine-boundaries "Phase 2: Determine Boundaries的直接链接")
...
### Phase 3: Generate Structured Summary[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-3-generate-structured-summary "Phase 3: Generate Structured Summary的直接链接")
...
### Phase 4: Assemble Compressed Messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-4-assemble-compressed-messages "Phase 4: Assemble Compressed Messages的直接链接")
...
### Iterative Re-compression[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#iterative-re-compression "Iterative Re-compression的直接链接")
...
## Before/After Example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#beforeafter-example "Before/After Example的直接链接")
### Before Compression (45 messages, ~95K tokens)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#before-compression-45-messages-95k-tokens "Before Compression \(45 messages, ~95K tokens\)的直接链接")
...
### After Compression (25 messages, ~45K tokens)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#after-compression-25-messages-45k-tokens "After Compression \(25 messages, ~45K tokens\)的直接链接")
...
## Prompt Caching (Anthropic)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#prompt-caching-anthropic "Prompt Caching \(Anthropic\)的直接链接")
...
### Strategy: system_and_3[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#strategy-system_and_3 "Strategy: system_and_3的直接链接")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#how-it-works "How It Works的直接链接")
...
### Cache-Aware Design Patterns[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#cache-aware-design-patterns "Cache-Aware Design Patterns的直接链接")
...
### Enabling Prompt Caching[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#enabling-prompt-caching "Enabling Prompt Caching的直接链接")
...
## Context Pressure Warnings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#context-pressure-warnings "Context Pressure Warnings的直接链接")
Intermediate context-pressure warnings have been removed (see the iteration-budget block in `run_agent.py`, which notes: "No intermediate pressure warnings — they caused models to 'give up' prematurely on complex tasks"). Compression fires when prompt tokens reach the configured `compression.threshold` (default 50%) with no prior warning step; gateway session hygiene fires as the secondary safety net at 85% of the model's context window.
  * [Pluggable Context Engine](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#pluggable-context-engine)
  * [Dual Compression System](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#dual-compression-system)
    * [1. Gateway Session Hygiene (85% threshold)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#1-gateway-session-hygiene-85-threshold)
    * [2. Agent ContextCompressor (50% threshold, configurable)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#2-agent-contextcompressor-50-threshold-configurable)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#configuration)
    * [Parameter Details](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#parameter-details)
    * [Computed Values (for a 200K context model at defaults)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#computed-values-for-a-200k-context-model-at-defaults)
  * [Compression Algorithm](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#compression-algorithm)
    * [Phase 1: Prune Old Tool Results (cheap, no LLM call)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-1-prune-old-tool-results-cheap-no-llm-call)
    * [Phase 2: Determine Boundaries](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-2-determine-boundaries)
    * [Phase 3: Generate Structured Summary](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-3-generate-structured-summary)
    * [Phase 4: Assemble Compressed Messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#phase-4-assemble-compressed-messages)
    * [Iterative Re-compression](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#iterative-re-compression)
  * [Before/After Example](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#beforeafter-example)
    * [Before Compression (45 messages, ~95K tokens)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#before-compression-45-messages-95k-tokens)
    * [After Compression (25 messages, ~45K tokens)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#after-compression-25-messages-45k-tokens)
  * [Prompt Caching (Anthropic)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#prompt-caching-anthropic)
    * [Strategy: system_and_3](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#strategy-system_and_3)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#how-it-works)
    * [Cache-Aware Design Patterns](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#cache-aware-design-patterns)
    * [Enabling Prompt Caching](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#enabling-prompt-caching)
  * [Context Pressure Warnings](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching#context-pressure-warnings)

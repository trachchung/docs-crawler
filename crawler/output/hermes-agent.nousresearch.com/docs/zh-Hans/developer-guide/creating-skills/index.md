<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills -->
...
## Should it be a Skill or a Tool?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#should-it-be-a-skill-or-a-tool "Should it be a Skill or a Tool?的直接链接")
...
## Skill Directory Structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#skill-directory-structure "Skill Directory Structure的直接链接")
...
## SKILL.md Format[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#skillmd-format "SKILL.md Format的直接链接")
...
### Platform-Specific Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#platform-specific-skills "Platform-Specific Skills的直接链接")
...
### Conditional Skill Activation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#conditional-skill-activation "Conditional Skill Activation的直接链接")
...
### Environment Variable Requirements[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#environment-variable-requirements "Environment Variable Requirements的直接链接")
...
## Secure Setup on Load[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#secure-setup-on-load "Secure Setup on Load的直接链接")
...
### Config Settings (config.yaml)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#config-settings-configyaml "Config Settings \(config.yaml\)的直接链接")
...
### Credential File Requirements (OAuth tokens, etc.)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#credential-file-requirements-oauth-tokens-etc "Credential File Requirements \(OAuth tokens, etc.\)的直接链接")
...
## Skill Guidelines[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#skill-guidelines "Skill Guidelines的直接链接")
### No External Dependencies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#no-external-dependencies "No External Dependencies的直接链接")
...
### Progressive Disclosure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#progressive-disclosure "Progressive Disclosure的直接链接")
...
### Include Helper Scripts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#include-helper-scripts "Include Helper Scripts的直接链接")
...
#### Referencing bundled scripts from SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#referencing-bundled-scripts-from-skillmd "Referencing bundled scripts from SKILL.md的直接链接")
...
#### Inline shell snippets (opt-in)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#inline-shell-snippets-opt-in "Inline shell snippets \(opt-in\)的直接链接")
...
### Test It[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#test-it "Test It的直接链接")
...
## Where Should the Skill Live?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#where-should-the-skill-live "Where Should the Skill Live?的直接链接")
...
## Publishing Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#publishing-skills "Publishing Skills的直接链接")
### To the Skills Hub[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#to-the-skills-hub "To the Skills Hub的直接链接")

```
hermes skills publish skills/my-skill --to github --repo owner/repo
```

### To a Custom Repository[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#to-a-custom-repository "To a Custom Repository的直接链接")
...
## Security Scanning[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#security-scanning "Security Scanning的直接链接")
...
If you want your skills to be discoverable without a GitHub-specific installer, consider serving them from a well-known endpoint in addition to publishing them in a repo or marketplace.
  * [Should it be a Skill or a Tool?](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#should-it-be-a-skill-or-a-tool)
  * [Skill Directory Structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#skill-directory-structure)
  * [SKILL.md Format](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#skillmd-format)
    * [Platform-Specific Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#platform-specific-skills)
    * [Conditional Skill Activation](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#conditional-skill-activation)
    * [Environment Variable Requirements](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#environment-variable-requirements)
  * [Secure Setup on Load](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#secure-setup-on-load)
    * [Config Settings (config.yaml)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#config-settings-configyaml)
    * [Credential File Requirements (OAuth tokens, etc.)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#credential-file-requirements-oauth-tokens-etc)
  * [Skill Guidelines](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#skill-guidelines)
    * [No External Dependencies](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#no-external-dependencies)
    * [Progressive Disclosure](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#progressive-disclosure)
    * [Include Helper Scripts](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#include-helper-scripts)
  * [Where Should the Skill Live?](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#where-should-the-skill-live)
  * [Publishing Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#publishing-skills)
    * [To the Skills Hub](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#to-the-skills-hub)
    * [To a Custom Repository](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#to-a-custom-repository)
  * [Security Scanning](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/creating-skills#security-scanning)

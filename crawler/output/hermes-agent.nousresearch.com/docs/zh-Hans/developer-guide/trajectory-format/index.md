<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format -->
...
## File Naming Convention[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#file-naming-convention "File Naming Convention的直接链接")
...
## JSONL Entry Format[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#jsonl-entry-format "JSONL Entry Format的直接链接")
Each line in the file is a self-contained JSON object. There are two variants:
### CLI/Interactive Format (from `_save_trajectory`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#cliinteractive-format-from-_save_trajectory "cliinteractive-format-from-_save_trajectory的直接链接")

```
"conversations":[ ... ],"timestamp":"2026-03-30T14:22:31.456789","model":"anthropic/claude-sonnet-4.6","completed":true
```

### Batch Runner Format (from `batch_runner.py`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#batch-runner-format-from-batch_runnerpy "batch-runner-format-from-batch_runnerpy的直接链接")
...
## Conversations Array (ShareGPT Format)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#conversations-array-sharegpt-format "Conversations Array \(ShareGPT Format\)的直接链接")
...
| assistant  | `"gpt"`  |  
| tool  | `"tool"`  |  
### Complete Example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#complete-example "Complete Example的直接链接")
...
## Normalization Rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#normalization-rules "Normalization Rules的直接链接")
### Reasoning Content Markup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#reasoning-content-markup "Reasoning Content Markup的直接链接")
...
### Tool Call Normalization[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#tool-call-normalization "Tool Call Normalization的直接链接")
...
### Tool Response Normalization[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#tool-response-normalization "Tool Response Normalization的直接链接")
...
### System Message[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#system-message "System Message的直接链接")
...
## Loading Trajectories[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#loading-trajectories "Loading Trajectories的直接链接")
Trajectories are standard JSONL — load with any JSON-lines reader:

```
import jsondefload_trajectories(path:str):"""Load trajectory entries from a JSONL file."""    entries =[]withopen(path,"r", encoding="utf-8")as f:for line in f:            line = line.strip()if line:                entries.append(json.loads(line))return entries# Filter to successful completions onlysuccessful =[e for e in load_trajectories("trajectory_samples.jsonl")if e.get("completed")]# Extract just the conversations for trainingtraining_data =[e["conversations"]for e in successful]
```

### Loading for HuggingFace Datasets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#loading-for-huggingface-datasets "Loading for HuggingFace Datasets的直接链接")
...
## Controlling Trajectory Saving[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#controlling-trajectory-saving "Controlling Trajectory Saving的直接链接")
...
Samples with zero reasoning across all turns are automatically discarded by the batch runner to avoid polluting training data with non-reasoning examples.
  * [File Naming Convention](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#file-naming-convention)
  * [JSONL Entry Format](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#jsonl-entry-format)
    * [CLI/Interactive Format (from `_save_trajectory`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#cliinteractive-format-from-_save_trajectory)
    * [Batch Runner Format (from `batch_runner.py`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#batch-runner-format-from-batch_runnerpy)
  * [Conversations Array (ShareGPT Format)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#conversations-array-sharegpt-format)
    * [Complete Example](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#complete-example)
  * [Normalization Rules](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#normalization-rules)
    * [Reasoning Content Markup](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#reasoning-content-markup)
    * [Tool Call Normalization](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#tool-call-normalization)
    * [Tool Response Normalization](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#tool-response-normalization)
    * [System Message](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#system-message)
  * [Loading Trajectories](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#loading-trajectories)
    * [Loading for HuggingFace Datasets](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#loading-for-huggingface-datasets)
  * [Controlling Trajectory Saving](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/trajectory-format#controlling-trajectory-saving)

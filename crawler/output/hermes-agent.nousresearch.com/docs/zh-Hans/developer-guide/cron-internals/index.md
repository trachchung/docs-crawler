<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals -->
...
## Key Files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#key-files "Key Files的直接链接")  
| File  | Purpose  |  
| --- | --- |  
...
## Scheduling Model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#scheduling-model "Scheduling Model的直接链接")
...
## Job Storage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#job-storage "Job Storage的直接链接")
...
### Job Lifecycle States[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#job-lifecycle-states "Job Lifecycle States的直接链接")  
| State  | Meaning  |  
| --- | --- |  
...
### Backward Compatibility[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#backward-compatibility "Backward Compatibility的直接链接")
...
## Scheduler Runtime[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#scheduler-runtime "Scheduler Runtime的直接链接")
### Tick Cycle[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#tick-cycle "Tick Cycle的直接链接")
...
### Gateway Integration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#gateway-integration "Gateway Integration的直接链接")
...
### Fresh Session Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#fresh-session-isolation "Fresh Session Isolation的直接链接")
...
## Skill-Backed Jobs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#skill-backed-jobs "Skill-Backed Jobs的直接链接")
...
### Script-Backed Jobs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#script-backed-jobs "Script-Backed Jobs的直接链接")
...
### Provider Recovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#provider-recovery "Provider Recovery的直接链接")
...
## Delivery Model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#delivery-model "Delivery Model的直接链接")
...
### Response Wrapping[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#response-wrapping "Response Wrapping的直接链接")
...
### Session Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#session-isolation "Session Isolation的直接链接")
...
## Recursion Guard[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#recursion-guard "Recursion Guard的直接链接")
...
## Locking[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#locking "Locking的直接链接")
...
## CLI Interface[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#cli-interface "CLI Interface的直接链接")
...
## Related Docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#related-docs "Related Docs的直接链接")
  * [Cron Feature Guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/cron)
  ...
  * [Scheduling Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#scheduling-model)
  * [Job Storage](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#job-storage)
    * [Job Lifecycle States](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#job-lifecycle-states)
    * [Backward Compatibility](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#backward-compatibility)
  * [Scheduler Runtime](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#scheduler-runtime)
    * [Gateway Integration](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#gateway-integration)
    * [Fresh Session Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#fresh-session-isolation)
  * [Skill-Backed Jobs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#skill-backed-jobs)
    * [Script-Backed Jobs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#script-backed-jobs)
    * [Provider Recovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#provider-recovery)
  * [Delivery Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#delivery-model)
    * [Response Wrapping](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#response-wrapping)
    * [Session Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#session-isolation)
  * [Recursion Guard](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#recursion-guard)
  * [CLI Interface](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#cli-interface)
  * [Related Docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals#related-docs)

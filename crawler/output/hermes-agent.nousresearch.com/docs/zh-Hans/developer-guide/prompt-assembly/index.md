<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly -->
...
## Cached system prompt layers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#cached-system-prompt-layers "Cached system prompt layers的直接链接")
...
### Concrete example: assembled system prompt[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#concrete-example-assembled-system-prompt "Concrete example: assembled system prompt的直接链接")
...
## How SOUL.md appears in the prompt[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#how-soulmd-appears-in-the-prompt "How SOUL.md appears in the prompt的直接链接")
...
```
# From agent/prompt_builder.py (simplified)defload_soul_md()-> Optional[str]:    soul_path = get_hermes_home()/"SOUL.md"ifnot soul_path.exists():returnNone    content = soul_path.read_text(encoding="utf-8").strip()    content = _scan_context_content(content,"SOUL.md")# Security scan    content = _truncate_content(content,"SOUL.md")# Cap at 20k charsreturn content
```
...
## How context files are injected[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#how-context-files-are-injected "How context files are injected的直接链接")
`build_context_files_prompt()` uses a **priority system** — only one project context type is loaded (first match wins):

```
# From agent/prompt_builder.py (simplified)defbuild_context_files_prompt(cwd=None, skip_soul=False):    cwd_path = Path(cwd).resolve()# Priority: first match wins — only ONE project context loaded    project_context =(        _load_hermes_md(cwd_path)# 1. .hermes.md / HERMES.md (walks to git root)or _load_agents_md(cwd_path)# 2. AGENTS.md (cwd only)or _load_claude_md(cwd_path)# 3. CLAUDE.md (cwd only)or _load_cursorrules(cwd_path)# 4. .cursorrules / .cursor/rules/*.mdc    sections =[]if project_context:        sections.append(project_context)# SOUL.md from HERMES_HOME (independent of project context)ifnot skip_soul:        soul_content = load_soul_md()if soul_content:            sections.append(soul_content)ifnot sections:return""return("# Project Context\n\n""The following project context files have been loaded ""and should be followed:\n\n"+"\n".join(sections)
```

### Context file discovery details[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#context-file-discovery-details "Context file discovery details的直接链接")  
...
## API-call-time-only layers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#api-call-time-only-layers "API-call-time-only layers的直接链接")
...
## Memory snapshots[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#memory-snapshots "Memory snapshots的直接链接")
...
## Context files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#context-files "Context files的直接链接")
...
## Skills index[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#skills-index "Skills index的直接链接")
The skills system contributes a compact skills index to the prompt when skills tooling is available.
## Supported prompt customization surfaces[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#supported-prompt-customization-surfaces "Supported prompt customization surfaces的直接链接")
...
### Use these surfaces first[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#use-these-surfaces-first "Use these surfaces first的直接链接")
...
### When to edit code instead[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#when-to-edit-code-instead "When to edit code instead的直接链接")
...
## Why prompt assembly is split this way[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#why-prompt-assembly-is-split-this-way "Why prompt assembly is split this way的直接链接")
...
## Related docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#related-docs "Related docs的直接链接")
  ...
  * [Cached system prompt layers](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#cached-system-prompt-layers)
    * [Concrete example: assembled system prompt](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#concrete-example-assembled-system-prompt)
  * [How SOUL.md appears in the prompt](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#how-soulmd-appears-in-the-prompt)
  * [How context files are injected](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#how-context-files-are-injected)
    * [Context file discovery details](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#context-file-discovery-details)
  * [API-call-time-only layers](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#api-call-time-only-layers)
  * [Memory snapshots](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#memory-snapshots)
  * [Context files](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#context-files)
  * [Skills index](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#skills-index)
  * [Supported prompt customization surfaces](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#supported-prompt-customization-surfaces)
    * [Use these surfaces first](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#use-these-surfaces-first)
    * [When to edit code instead](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#when-to-edit-code-instead)
  * [Why prompt assembly is split this way](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#why-prompt-assembly-is-split-this-way)
  * [Related docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly#related-docs)

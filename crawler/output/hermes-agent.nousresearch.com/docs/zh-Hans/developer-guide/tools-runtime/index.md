<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime -->
...
## Tool registration model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#tool-registration-model "Tool registration model的直接链接")
...
### How `registry.register()` works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#how-registryregister-works "how-registryregister-works的直接链接")
...
### Discovery: `discover_builtin_tools()`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#discovery-discover_builtin_tools "discovery-discover_builtin_tools的直接链接")
...
## Tool availability checking (`check_fn`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#tool-availability-checking-check_fn "tool-availability-checking-check_fn的直接链接")
...
## Toolset resolution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#toolset-resolution "Toolset resolution的直接链接")
...
### How `get_tool_definitions()` filters tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#how-get_tool_definitions-filters-tools "how-get_tool_definitions-filters-tools的直接链接")
...
### Legacy toolset names[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#legacy-toolset-names "Legacy toolset names的直接链接")
...
## Dispatch[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#dispatch "Dispatch的直接链接")
...
### Dispatch flow: model tool_call → handler execution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#dispatch-flow-model-tool_call--handler-execution "Dispatch flow: model tool_call → handler execution的直接链接")
...
### Error wrapping[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#error-wrapping "Error wrapping的直接链接")
...
### Agent-loop tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#agent-loop-tools "Agent-loop tools的直接链接")
...
### Async bridging[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#async-bridging "Async bridging的直接链接")
...
## The DANGEROUS_PATTERNS approval flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#the-dangerous_patterns-approval-flow "The DANGEROUS_PATTERNS approval flow的直接链接")
...
## Terminal/runtime environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#terminalruntime-environments "Terminal/runtime environments的直接链接")
...
## Concurrency[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#concurrency "Concurrency的直接链接")
Tool calls may execute sequentially or concurrently depending on the tool mix and interaction requirements.
## Related docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#related-docs "Related docs的直接链接")
  * [Toolsets Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference)
  * [Built-in Tools Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference)
  ...
  * [Tool registration model](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#tool-registration-model)
    * [How `registry.register()` works](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#how-registryregister-works)
    * [Discovery: `discover_builtin_tools()`](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#discovery-discover_builtin_tools)
  * [Tool availability checking (`check_fn`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#tool-availability-checking-check_fn)
  * [Toolset resolution](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#toolset-resolution)
    * [How `get_tool_definitions()` filters tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#how-get_tool_definitions-filters-tools)
    * [Legacy toolset names](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#legacy-toolset-names)
  * [Dispatch](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#dispatch)
    * [Dispatch flow: model tool_call → handler execution](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#dispatch-flow-model-tool_call--handler-execution)
    * [Error wrapping](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#error-wrapping)
    * [Agent-loop tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#agent-loop-tools)
    * [Async bridging](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#async-bridging)
  * [The DANGEROUS_PATTERNS approval flow](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#the-dangerous_patterns-approval-flow)
  * [Terminal/runtime environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#terminalruntime-environments)
  * [Concurrency](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#concurrency)
  * [Related docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime#related-docs)

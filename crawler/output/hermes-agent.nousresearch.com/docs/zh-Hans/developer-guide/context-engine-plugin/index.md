<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin -->
...
## How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#how-it-works "How it works的直接链接")
...
## Directory structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#directory-structure "Directory structure的直接链接")
...
## The ContextEngine ABC[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#the-contextengine-abc "The ContextEngine ABC的直接链接")
...
### Class attributes your engine must maintain[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#class-attributes-your-engine-must-maintain "Class attributes your engine must maintain的直接链接")
...
### Optional methods[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#optional-methods "Optional methods的直接链接")
...
## Engine tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#engine-tools "Engine tools的直接链接")
...
## Registration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#registration "Registration的直接链接")
### Via directory (recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#via-directory-recommended "Via directory \(recommended\)的直接链接")
...
### Via general plugin system[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#via-general-plugin-system "Via general plugin system的直接链接")
...
## Lifecycle[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#lifecycle "Lifecycle的直接链接")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#configuration "Configuration的直接链接")
...
## Testing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#testing "Testing的直接链接")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#see-also "See also的直接链接")
  * [Context Compression and Caching](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/context-compression-and-caching) — how the built-in compressor works
  * [Memory Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/memory-provider-plugin) — analogous single-select plugin system for memory
  * [Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/plugins) — general plugin system overview


  * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#how-it-works)
  * [Directory structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#directory-structure)
  * [The ContextEngine ABC](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#the-contextengine-abc)
    * [Class attributes your engine must maintain](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#class-attributes-your-engine-must-maintain)
    * [Optional methods](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#optional-methods)
  * [Engine tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#engine-tools)
  * [Registration](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#registration)
    * [Via directory (recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#via-directory-recommended)
    * [Via general plugin system](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#via-general-plugin-system)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-engine-plugin#configuration)

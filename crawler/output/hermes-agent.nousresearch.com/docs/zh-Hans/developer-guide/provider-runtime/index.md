<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime -->
...
If you are trying to add a new first-class inference provider, read [Adding Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/adding-providers) and the [Model Provider Plugin guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin) alongside this page.
## Resolution precedence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#resolution-precedence "Resolution precedence的直接链接")
...
## Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#providers "Providers的直接链接")
...
## Output of runtime resolution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#output-of-runtime-resolution "Output of runtime resolution的直接链接")
...
## Why this matters[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#why-this-matters "Why this matters的直接链接")
...
## AI Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#ai-gateway "AI Gateway的直接链接")
...
## OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#openrouter-ai-gateway-and-custom-openai-compatible-base-urls "OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs的直接链接")
...
## Native Anthropic path[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#native-anthropic-path "Native Anthropic path的直接链接")
...
## OpenAI Codex path[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#openai-codex-path "OpenAI Codex path的直接链接")
Codex uses a separate Responses API path:
  * `api_mode = codex_responses`
  * dedicated credential resolution and auth store support


## Auxiliary model routing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#auxiliary-model-routing "Auxiliary model routing的直接链接")
...
## Fallback models[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#fallback-models "Fallback models的直接链接")
...
### How it works internally[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#how-it-works-internally "How it works internally的直接链接")
...
### What does NOT support fallback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#what-does-not-support-fallback "What does NOT support fallback的直接链接")
...
Cron jobs **do** support fallback: `run_job()` reads `fallback_providers` (or legacy `fallback_model`) from `config.yaml` and passes it to `AIAgent(fallback_model=...)`, matching the gateway's `_load_fallback_model()` pattern. See [Cron Internals](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/cron-internals).
### Test coverage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#test-coverage "Test coverage的直接链接")
...
## Related docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#related-docs "Related docs的直接链接")
  ...
  * [Resolution precedence](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#resolution-precedence)
  * [Output of runtime resolution](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#output-of-runtime-resolution)
  * [Why this matters](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#why-this-matters)
  * [OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#openrouter-ai-gateway-and-custom-openai-compatible-base-urls)
  * [Native Anthropic path](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#native-anthropic-path)
  * [OpenAI Codex path](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#openai-codex-path)
  * [Auxiliary model routing](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#auxiliary-model-routing)
  * [Fallback models](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#fallback-models)
    * [How it works internally](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#how-it-works-internally)
    * [What does NOT support fallback](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#what-does-not-support-fallback)
    * [Test coverage](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#test-coverage)
  * [Related docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime#related-docs)

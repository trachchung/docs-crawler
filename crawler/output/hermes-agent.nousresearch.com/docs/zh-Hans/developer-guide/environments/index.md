<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments -->
...
The Python environment framework documented here lives under the repo's `environments/` directory and is the implementation-level API for Hermes/Atropos integration. This is separate from the user-facing `rl_*` tools, which operate as an orchestration surface for remote RL training workflows.
  * **Want to run benchmarks?** Jump to [Available Benchmarks](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#available-benchmarks)
  * **Want to train with RL?** See [RL Training Tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training) for the agent-driven interface, or [Running Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#running-environments) for manual execution
  * **Want to create a new environment?** See [Creating Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#creating-environments)


## Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#architecture "Architecture的直接链接")
...
### BaseEnv (Atropos)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#baseenv-atropos "BaseEnv \(Atropos\)的直接链接")
...
### HermesAgentBaseEnv[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#hermesagentbaseenv "HermesAgentBaseEnv的直接链接")
...
### Concrete Environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#concrete-environments "Concrete Environments的直接链接")
...
## Core Components[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#core-components "Core Components的直接链接")
### Agent Loop[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#agent-loop "Agent Loop的直接链接")
...
### Tool Context[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tool-context "Tool Context的直接链接")
...
### Tool Call Parsers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tool-call-parsers "Tool Call Parsers的直接链接")
...
## Available Benchmarks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#available-benchmarks "Available Benchmarks的直接链接")
### TerminalBench2[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#terminalbench2 "TerminalBench2的直接链接")
...
### TBLite (OpenThoughts Terminal Bench Lite)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tblite-openthoughts-terminal-bench-lite "TBLite \(OpenThoughts Terminal Bench Lite\)的直接链接")
...
### YC-Bench[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#yc-bench "YC-Bench的直接链接")
...
## Training Environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#training-environments "Training Environments的直接链接")
### TerminalTestEnv[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#terminaltestenv "TerminalTestEnv的直接链接")
...
### HermesSweEnv[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#hermessweenv "HermesSweEnv的直接链接")
...
## Running Environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#running-environments "Running Environments的直接链接")
Every environment is a standalone Python script with three CLI subcommands:
###  `evaluate` — Run a benchmark[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#evaluate--run-a-benchmark "evaluate--run-a-benchmark的直接链接")
...
###  `process` — Generate SFT data[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#process--generate-sft-data "process--generate-sft-data的直接链接")
...
###  `serve` — Connect to Atropos for RL training[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#serve--connect-to-atropos-for-rl-training "serve--connect-to-atropos-for-rl-training的直接链接")
...
## Two-Phase Operation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#two-phase-operation "Two-Phase Operation的直接链接")
### Phase 1: OpenAI Server (Eval / SFT)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#phase-1-openai-server-eval--sft "Phase 1: OpenAI Server \(Eval / SFT\)的直接链接")
...
### Phase 2: VLLM ManagedServer (Full RL)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#phase-2-vllm-managedserver-full-rl "Phase 2: VLLM ManagedServer \(Full RL\)的直接链接")
Uses ManagedServer for exact token IDs + logprobs via `/generate`. A client-side [tool call parser](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tool-call-parsers) reconstructs structured `tool_calls` from raw output.
...
## Creating Environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#creating-environments "Creating Environments的直接链接")
### Training Environment[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#training-environment "Training Environment的直接链接")
...
### Eval-Only Benchmark[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#eval-only-benchmark "Eval-Only Benchmark的直接链接")
...
## Configuration Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#configuration-reference "Configuration Reference的直接链接")
### HermesAgentEnvConfig Fields[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#hermesagentenvconfig-fields "HermesAgentEnvConfig Fields的直接链接")  
...
### YAML Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#yaml-configuration "YAML Configuration的直接链接")
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#prerequisites "Prerequisites的直接链接")
### For all environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-all-environments "For all environments的直接链接")
  * Python >= 3.11
...
### For Modal-sandboxed benchmarks (TB2, TBLite)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-modal-sandboxed-benchmarks-tb2-tblite "For Modal-sandboxed benchmarks \(TB2, TBLite\)的直接链接")
...
### For YC-Bench[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-yc-bench "For YC-Bench的直接链接")
  * `pip install "hermes-agent[yc-bench]"` (installs the yc-bench CLI + SQLAlchemy)
  * No Modal needed — runs with local terminal backend


### For RL training[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-rl-training "For RL training的直接链接")
...
See [RL Training](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training) for the agent-driven RL workflow.
## Directory Structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#directory-structure "Directory Structure的直接链接")
...
```
  ...
  * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#architecture)
    * [BaseEnv (Atropos)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#baseenv-atropos)
    * [HermesAgentBaseEnv](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#hermesagentbaseenv)
    * [Concrete Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#concrete-environments)
  * [Core Components](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#core-components)
    * [Tool Context](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tool-context)
    * [Tool Call Parsers](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tool-call-parsers)
  * [Available Benchmarks](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#available-benchmarks)
    * [TerminalBench2](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#terminalbench2)
    * [TBLite (OpenThoughts Terminal Bench Lite)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#tblite-openthoughts-terminal-bench-lite)
  * [Training Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#training-environments)
    * [TerminalTestEnv](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#terminaltestenv)
    * [HermesSweEnv](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#hermessweenv)
  * [Running Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#running-environments)
    * [`evaluate` — Run a benchmark](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#evaluate--run-a-benchmark)
    * [`process` — Generate SFT data](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#process--generate-sft-data)
    * [`serve` — Connect to Atropos for RL training](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#serve--connect-to-atropos-for-rl-training)
  * [Two-Phase Operation](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#two-phase-operation)
    * [Phase 1: OpenAI Server (Eval / SFT)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#phase-1-openai-server-eval--sft)
    * [Phase 2: VLLM ManagedServer (Full RL)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#phase-2-vllm-managedserver-full-rl)
  * [Creating Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#creating-environments)
    * [Training Environment](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#training-environment)
    * [Eval-Only Benchmark](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#eval-only-benchmark)
  * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#configuration-reference)
    * [HermesAgentEnvConfig Fields](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#hermesagentenvconfig-fields)
    * [YAML Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#yaml-configuration)
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#prerequisites)
    * [For all environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-all-environments)
    * [For Modal-sandboxed benchmarks (TB2, TBLite)](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-modal-sandboxed-benchmarks-tb2-tblite)
    * [For YC-Bench](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-yc-bench)
    * [For RL training](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#for-rl-training)
  * [Directory Structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/environments#directory-structure)

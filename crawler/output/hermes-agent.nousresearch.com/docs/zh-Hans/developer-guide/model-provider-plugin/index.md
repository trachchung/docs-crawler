<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin -->
...
Model provider plugins are the third kind of **provider plugin**. The others are [Memory Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/memory-provider-plugin) (cross-session knowledge) and [Context Engine Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/context-engine-plugin) (context compression strategies). All three follow the same "drop a directory, declare a profile, no repo edits" pattern.
## How discovery works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#how-discovery-works "How discovery works的直接链接")
...
## Directory structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#directory-structure "Directory structure的直接链接")
...
## Minimal example — a simple API-key provider[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#minimal-example--a-simple-api-key-provider "Minimal example — a simple API-key provider的直接链接")
...
## ProviderProfile fields[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#providerprofile-fields "ProviderProfile fields的直接链接")
...
## Overridable hooks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#overridable-hooks "Overridable hooks的直接链接")
...
## Hook reference examples[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#hook-reference-examples "Hook reference examples的直接链接")
...
## User overrides — replace a built-in without editing the repo[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#user-overrides--replace-a-built-in-without-editing-the-repo "User overrides — replace a built-in without editing the repo的直接链接")
...
## api_mode selection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#api_mode-selection "api_mode selection的直接链接")
...
## Auth types[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#auth-types "Auth types的直接链接")  
...
## Discovery timing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#discovery-timing "Discovery timing的直接链接")
...
## Testing your plugin[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#testing-your-plugin "Testing your plugin的直接链接")
...
## General PluginManager integration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#general-pluginmanager-integration "General PluginManager integration的直接链接")
...
## Distribute via pip[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#distribute-via-pip "Distribute via pip的直接链接")
...
See [Building a Hermes Plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/build-a-hermes-plugin#distribute-via-pip) for the full entry-points setup.
## Related pages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#related-pages "Related pages的直接链接")
  * [Provider Runtime](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/provider-runtime) — resolution precedence + where each layer reads the profile
  * [Adding Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/adding-providers) — end-to-end checklist for new inference backends (covers both the fast plugin path and the full CLI/auth integration)
  * [Memory Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/memory-provider-plugin)
  * [Context Engine Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/context-engine-plugin)
  * [Building a Hermes Plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/build-a-hermes-plugin) — general plugin authoring


  * [How discovery works](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#how-discovery-works)
  * [Directory structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#directory-structure)
  * [Minimal example — a simple API-key provider](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#minimal-example--a-simple-api-key-provider)
  * [ProviderProfile fields](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#providerprofile-fields)
  * [Overridable hooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#overridable-hooks)
  * [Hook reference examples](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#hook-reference-examples)
  * [User overrides — replace a built-in without editing the repo](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#user-overrides--replace-a-built-in-without-editing-the-repo)
  * [api_mode selection](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#api_mode-selection)
  * [Discovery timing](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#discovery-timing)
  * [Testing your plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#testing-your-plugin)
  * [General PluginManager integration](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#general-pluginmanager-integration)
  * [Distribute via pip](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#distribute-via-pip)
  * [Related pages](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/model-provider-plugin#related-pages)

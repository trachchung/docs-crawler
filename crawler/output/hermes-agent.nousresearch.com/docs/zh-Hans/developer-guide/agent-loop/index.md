<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop -->
...
## Core Responsibilities[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#core-responsibilities "Core Responsibilities的直接链接")
...
## Two Entry Points[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#two-entry-points "Two Entry Points的直接链接")
...
## API Modes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#api-modes "API Modes的直接链接")
...
## Turn Lifecycle[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#turn-lifecycle "Turn Lifecycle的直接链接")
...
### Message Format[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#message-format "Message Format的直接链接")
...
### Message Alternation Rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#message-alternation-rules "Message Alternation Rules的直接链接")
...
## Interruptible API Calls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#interruptible-api-calls "Interruptible API Calls的直接链接")
...
## Tool Execution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#tool-execution "Tool Execution的直接链接")
### Sequential vs Concurrent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#sequential-vs-concurrent "Sequential vs Concurrent的直接链接")
...
### Execution Flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#execution-flow "Execution Flow的直接链接")
...
### Agent-Level Tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#agent-level-tools "Agent-Level Tools的直接链接")
...
## Callback Surfaces[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#callback-surfaces "Callback Surfaces的直接链接")
...
## Budget and Fallback Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#budget-and-fallback-behavior "Budget and Fallback Behavior的直接链接")
### Iteration Budget[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#iteration-budget "Iteration Budget的直接链接")
...
### Fallback Model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#fallback-model "Fallback Model的直接链接")
...
## Compression and Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#compression-and-persistence "Compression and Persistence的直接链接")
### When Compression Triggers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#when-compression-triggers "When Compression Triggers的直接链接")
...
### What Happens During Compression[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#what-happens-during-compression "What Happens During Compression的直接链接")
...
### Session Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#session-persistence "Session Persistence的直接链接")
After each turn:
...
## Key Source Files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#key-source-files "Key Source Files的直接链接")  
| File  | Purpose  |  
| --- | --- |  
...
## Related Docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#related-docs "Related Docs的直接链接")
  * [Provider Runtime Resolution](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/provider-runtime)
  * [Prompt Assembly](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/prompt-assembly)
  * [Context Compression & Prompt Caching](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/context-compression-and-caching)
  * [Tools Runtime](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/tools-runtime)
  * [Architecture Overview](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/architecture)


  * [Core Responsibilities](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#core-responsibilities)
  * [Two Entry Points](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#two-entry-points)
  * [Turn Lifecycle](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#turn-lifecycle)
    * [Message Format](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#message-format)
    * [Message Alternation Rules](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#message-alternation-rules)
  * [Interruptible API Calls](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#interruptible-api-calls)
  * [Tool Execution](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#tool-execution)
    * [Sequential vs Concurrent](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#sequential-vs-concurrent)
    * [Execution Flow](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#execution-flow)
    * [Agent-Level Tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#agent-level-tools)
  * [Callback Surfaces](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#callback-surfaces)
  * [Budget and Fallback Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#budget-and-fallback-behavior)
    * [Iteration Budget](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#iteration-budget)
    * [Fallback Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#fallback-model)
  * [Compression and Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#compression-and-persistence)
    * [When Compression Triggers](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#when-compression-triggers)
    * [What Happens During Compression](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#what-happens-during-compression)
    * [Session Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#session-persistence)
  * [Key Source Files](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#key-source-files)
  * [Related Docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/agent-loop#related-docs)

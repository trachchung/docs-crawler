...
## Quick Install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#quick-install "Quick Install的直接链接")
### Linux / macOS / WSL2[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#linux--macos--wsl2 "Linux / macOS / WSL2的直接链接")

```
curl-fsSL https://raw.githubusercontent.com/NousResearch/hermes-agent/main/scripts/install.sh |bash
```

### Windows (native, PowerShell) — Early Beta[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#windows-native-powershell--early-beta "Windows \(native, PowerShell\) — Early Beta的直接链接")
...
### Android / Termux[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#android--termux "Android / Termux的直接链接")
...
If you want the fully explicit path, follow the dedicated [Termux guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/termux).
...
### What the Installer Does[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#what-the-installer-does "What the Installer Does的直接链接")
The installer handles everything automatically — all dependencies (Python, Node.js, ripgrep, ffmpeg), the repo clone, virtual environment, global `hermes` command setup, and LLM provider configuration. By the end, you're ready to chat.
#### Install Layout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#install-layout "Install Layout的直接链接")
...
### After Installation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#after-installation "After Installation的直接链接")
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#prerequisites "Prerequisites的直接链接")
...
If you use Nix (on NixOS, macOS, or Linux), there's a dedicated setup path with a Nix flake, declarative NixOS module, and optional container mode. See the **[Nix& NixOS Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/nix-setup)** guide.
## Manual / Developer Installation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#manual--developer-installation "Manual / Developer Installation的直接链接")
If you want to clone the repo and install from source — for contributing, running from a specific branch, or having full control over the virtual environment — see the [Development Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/developer-guide/contributing#development-setup) section in the Contributing guide.
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
For more diagnostics, run `hermes doctor` — it will tell you exactly what's missing and how to fix it.
  * [Quick Install](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#quick-install)
    * [Linux / macOS / WSL2](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#linux--macos--wsl2)
    * [Windows (native, PowerShell) — Early Beta](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#windows-native-powershell--early-beta)
    * [Android / Termux](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#android--termux)
    * [What the Installer Does](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#what-the-installer-does)
    * [After Installation](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#after-installation)
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#prerequisites)
  * [Manual / Developer Installation](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#manual--developer-installation)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#troubleshooting)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin -->
...
| An **LLM / inference backend** (new provider)  | [Model Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/model-provider-plugin)  |  
| A **gateway channel** (Discord/Telegram/IRC/Teams/etc.)  | [Adding Platform Adapters](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/adding-platform-adapters)  |  
| A **memory backend** (Honcho/Mem0/Supermemory/etc.)  | [Memory Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/memory-provider-plugin)  |  
| A **context-compression engine**  | [Context Engine Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/context-engine-plugin)  |  
| An **image-generation backend**  | [Image Generation Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/image-gen-provider-plugin)  |  
| A **video-generation backend**  | [Video Generation Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/video-gen-provider-plugin)  |  
| A **TTS backend** (any CLI — Piper, VoxCPM, Kokoro, voice cloning, …)  |  [TTS custom command providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/tts#custom-command-providers) — config-driven, no Python needed  |  
| An **STT backend** (custom whisper / ASR CLI)  |  [Voice Message Transcription](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/tts#voice-message-transcription-stt) — set `HERMES_LOCAL_STT_COMMAND` to a shell template  |  
|  **External tools via MCP** (filesystem, GitHub, Linear, any MCP server)  |  [MCP](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/mcp) — declare `mcp_servers.<name>` in `config.yaml`  |  
|  **Gateway event hooks** (fire on startup, session events, commands)  |  [Event Hooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#gateway-event-hooks) — drop `HOOK.yaml` + `handler.py` into `~/.hermes/hooks/<name>/`  |  
|  **Shell hooks** (run a shell command on events)  |  [Shell Hooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#shell-hooks) — declare under `hooks:` in `config.yaml`  |  
|  **Additional skill sources** (custom GitHub repos, private skill indexes)  |  [Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/skills) — `hermes skills tap add <repo>` · [Publishing a tap](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/skills#publishing-a-custom-skill-tap)  |  
| A first-class **core** inference provider (not a plugin)  | [Adding Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/adding-providers)  |  
See the full [Pluggable interfaces table](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/plugins#pluggable-interfaces--where-to-go-for-each) for a consolidated view of every extension surface including config-driven (TTS, STT, MCP, shell hooks) and drop-in directory (gateway hooks) styles.
## What you're building[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#what-youre-building "What you're building的直接链接")
...
## Step 1: Create the plugin directory[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-1-create-the-plugin-directory "Step 1: Create the plugin directory的直接链接")

```
mkdir-p ~/.hermes/plugins/calculatorcd ~/.hermes/plugins/calculator
```

## Step 2: Write the manifest[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-2-write-the-manifest "Step 2: Write the manifest的直接链接")
Create `plugin.yaml`:
...
## Step 3: Write the tool schemas[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-3-write-the-tool-schemas "Step 3: Write the tool schemas的直接链接")
...
## Step 4: Write the tool handlers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-4-write-the-tool-handlers "Step 4: Write the tool handlers的直接链接")
...
## Step 5: Write the registration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-5-write-the-registration "Step 5: Write the registration的直接链接")
...
**What`register()` does:**
  ...
  * `ctx.register_command()` registers an in-session slash command (e.g. `/myplugin <args>` inside CLI / gateway chat) — see [Register slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-slash-commands) below
...
## Step 6: Test it[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-6-test-it "Step 6: Test it的直接链接")
Start Hermes:
...
### Debugging plugin discovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#debugging-plugin-discovery "Debugging plugin discovery的直接链接")
...
## Your plugin's final structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#your-plugins-final-structure "Your plugin's final structure的直接链接")
...
## What else can plugins do?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#what-else-can-plugins-do "What else can plugins do?的直接链接")
### Ship data files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#ship-data-files "Ship data files的直接链接")
...
### Bundle skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#bundle-skills "Bundle skills的直接链接")
...
### Gate on environment variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#gate-on-environment-variables "Gate on environment variables的直接链接")
...
### Conditional tool availability[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#conditional-tool-availability "Conditional tool availability的直接链接")
...
### Register multiple hooks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-multiple-hooks "Register multiple hooks的直接链接")
...
### Hook reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#hook-reference "Hook reference的直接链接")
Each hook is documented in full on the **[Event Hooks reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#plugin-hooks)** — callback signatures, parameter tables, exactly when each fires, and examples. Here's the summary:  
| Hook  | Fires when  | Callback signature  | Returns  |  
| --- | --- | --- | --- |  
| [`pre_tool_call`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#pre_tool_call)  | Before any tool executes  | `tool_name: str, args: dict, task_id: str`  | ignored  |  
| [`post_tool_call`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#post_tool_call)  | After any tool returns  | `tool_name: str, args: dict, result: str, task_id: str, duration_ms: int`  | ignored  |  
| [`pre_llm_call`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#pre_llm_call)  | Once per turn, before the tool-calling loop  | `session_id: str, user_message: str, conversation_history: list, is_first_turn: bool, model: str, platform: str`  | [context injection](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#pre_llm_call-context-injection)  |  
| [`post_llm_call`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#post_llm_call)  | Once per turn, after the tool-calling loop (successful turns only)  | `session_id: str, user_message: str, assistant_response: str, conversation_history: list, model: str, platform: str`  | ignored  |  
| [`on_session_start`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#on_session_start)  | New session created (first turn only)  | `session_id: str, model: str, platform: str`  | ignored  |  
| [`on_session_end`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#on_session_end)  | End of every `run_conversation` call + CLI exit  | `session_id: str, completed: bool, interrupted: bool, model: str, platform: str`  | ignored  |  
| [`on_session_finalize`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#on_session_finalize)  | CLI/gateway tears down an active session  | `session_id: str | None, platform: str`  | ignored  |  
| [`on_session_reset`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#on_session_reset)  | Gateway swaps in a new session key (`/new`, `/reset`)  | `session_id: str, platform: str`  | ignored  |  
Most hooks are fire-and-forget observers — their return values are ignored. The exception is `pre_llm_call`, which can inject context into the conversation.
All callbacks should accept `**kwargs` for forward compatibility. If a hook callback crashes, it's logged and skipped. Other hooks and the agent continue normally.
###  `pre_llm_call` context injection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#pre_llm_call-context-injection "pre_llm_call-context-injection的直接链接")
This is the only hook whose return value matters. When a `pre_llm_call` callback returns a dict with a `"context"` key (or a plain string), Hermes injects that text into the **current turn's user message**. This is the mechanism for memory plugins, RAG integrations, guardrails, and any plugin that needs to provide the model with additional context.
#### Return format[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#return-format "Return format的直接链接")
...
#### How injection works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#how-injection-works "How injection works的直接链接")
...
#### Example: Memory recall plugin[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#example-memory-recall-plugin "Example: Memory recall plugin的直接链接")
...
#### Example: Guardrails plugin[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#example-guardrails-plugin "Example: Guardrails plugin的直接链接")
...
#### Example: Observer-only hook (no injection)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#example-observer-only-hook-no-injection "Example: Observer-only hook \(no injection\)的直接链接")
...
#### Multiple plugins returning context[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#multiple-plugins-returning-context "Multiple plugins returning context的直接链接")
...
### Register CLI commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-cli-commands "Register CLI commands的直接链接")
...
### Register slash commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-slash-commands "Register slash commands的直接链接")
...
### Dispatch tools from slash commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#dispatch-tools-from-slash-commands "Dispatch tools from slash commands的直接链接")
...
## Specialized plugin types[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#specialized-plugin-types "Specialized plugin types的直接链接")
...
### Model provider plugins — add an LLM backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#model-provider-plugins--add-an-llm-backend "Model provider plugins — add an LLM backend的直接链接")
...
**Full guide:** [Model Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/model-provider-plugin) — field reference, overridable hooks (`prepare_messages`, `build_extra_body`, `build_api_kwargs_extras`, `fetch_models`), api_mode selection, auth types, testing.
### Platform plugins — add a gateway channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#platform-plugins--add-a-gateway-channel "Platform plugins — add a gateway channel的直接链接")
...
**Full guide:** [Adding Platform Adapters](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/adding-platform-adapters) — complete `BasePlatformAdapter` contract, message routing, auth gating, setup wizard integration. Look at `plugins/platforms/irc/` for a stdlib-only working example.
### Memory provider plugins — add a cross-session knowledge backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#memory-provider-plugins--add-a-cross-session-knowledge-backend "Memory provider plugins — add a cross-session knowledge backend的直接链接")
...
**Full guide:** [Memory Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/memory-provider-plugin) — full `MemoryProvider` ABC, threading contract, profile isolation, CLI command registration via `cli.py`.
### Context engine plugins — replace the context compressor[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#context-engine-plugins--replace-the-context-compressor "Context engine plugins — replace the context compressor的直接链接")
...
**Full guide:** [Context Engine Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/context-engine-plugin).
### Image-generation backends[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#image-generation-backends "Image-generation backends的直接链接")
...
**Full guide:** [Image Generation Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/image-gen-provider-plugin) — full `ImageGenProvider` ABC, `list_models()` / `get_setup_schema()` metadata, `success_response()`/`error_response()` helpers, base64 vs URL output, user overrides, pip distribution.
...
## Non-Python extension surfaces[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#non-python-extension-surfaces "Non-Python extension surfaces的直接链接")
Hermes also accepts extensions that aren't Python plugins at all. These are shown in the [Pluggable interfaces table](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/plugins#pluggable-interfaces--where-to-go-for-each); the sections below sketch each authoring style briefly.
### MCP servers — register external tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#mcp-servers--register-external-tools "MCP servers — register external tools的直接链接")
...
Hermes connects to each server at startup, lists its tools, and registers them alongside built-ins. The LLM sees them exactly like any other tool. **Full guide:** [MCP](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/mcp).
### Gateway event hooks — fire on lifecycle events[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#gateway-event-hooks--fire-on-lifecycle-events "Gateway event hooks — fire on lifecycle events的直接链接")
...
**Full guide:** [Gateway Event Hooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#gateway-event-hooks).
### Shell hooks — run a shell command on tool calls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#shell-hooks--run-a-shell-command-on-tool-calls "Shell hooks — run a shell command on tool calls的直接链接")
...
**Full guide:** [Shell Hooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/hooks#shell-hooks).
### Skill sources — add a custom skill registry[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#skill-sources--add-a-custom-skill-registry "Skill sources — add a custom skill registry的直接链接")
...
**Full guides:** [Skills Hub](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/skills#skills-hub) · [Publishing a custom tap](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/skills#publishing-a-custom-skill-tap) (repo layout, minimal example, non-default paths, trust levels).
### TTS / STT via command templates[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#tts--stt-via-command-templates "TTS / STT via command templates的直接链接")
...
**Full guides:** [TTS custom command providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/tts#custom-command-providers) · [STT](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/tts#voice-message-transcription-stt).
## Distribute via pip[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#distribute-via-pip "Distribute via pip的直接链接")
...
## Distribute for NixOS[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#distribute-for-nixos "Distribute for NixOS的直接链接")
...
See the [Nix Setup guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/getting-started/nix-setup#plugins) for complete documentation including overlay usage and collision checking.
## Common mistakes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#common-mistakes "Common mistakes的直接链接")
...
```
  ...
  * [What you're building](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#what-youre-building)
  * [Step 1: Create the plugin directory](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-1-create-the-plugin-directory)
  * [Step 2: Write the manifest](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-2-write-the-manifest)
  * [Step 3: Write the tool schemas](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-3-write-the-tool-schemas)
  * [Step 4: Write the tool handlers](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-4-write-the-tool-handlers)
  * [Step 5: Write the registration](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-5-write-the-registration)
  * [Step 6: Test it](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#step-6-test-it)
    * [Debugging plugin discovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#debugging-plugin-discovery)
  * [Your plugin's final structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#your-plugins-final-structure)
  * [What else can plugins do?](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#what-else-can-plugins-do)
    * [Ship data files](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#ship-data-files)
    * [Bundle skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#bundle-skills)
    * [Gate on environment variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#gate-on-environment-variables)
    * [Conditional tool availability](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#conditional-tool-availability)
    * [Register multiple hooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-multiple-hooks)
    * [Hook reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#hook-reference)
    * [`pre_llm_call` context injection](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#pre_llm_call-context-injection)
    * [Register CLI commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-cli-commands)
    * [Register slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#register-slash-commands)
    * [Dispatch tools from slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#dispatch-tools-from-slash-commands)
  * [Specialized plugin types](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#specialized-plugin-types)
    * [Model provider plugins — add an LLM backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#model-provider-plugins--add-an-llm-backend)
    * [Platform plugins — add a gateway channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#platform-plugins--add-a-gateway-channel)
    * [Memory provider plugins — add a cross-session knowledge backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#memory-provider-plugins--add-a-cross-session-knowledge-backend)
    * [Context engine plugins — replace the context compressor](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#context-engine-plugins--replace-the-context-compressor)
    * [Image-generation backends](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#image-generation-backends)
  * [Non-Python extension surfaces](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#non-python-extension-surfaces)
    * [MCP servers — register external tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#mcp-servers--register-external-tools)
    * [Gateway event hooks — fire on lifecycle events](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#gateway-event-hooks--fire-on-lifecycle-events)
    * [Shell hooks — run a shell command on tool calls](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#shell-hooks--run-a-shell-command-on-tool-calls)
    * [Skill sources — add a custom skill registry](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#skill-sources--add-a-custom-skill-registry)
    * [TTS / STT via command templates](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#tts--stt-via-command-templates)
  * [Distribute via pip](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#distribute-via-pip)
  * [Distribute for NixOS](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#distribute-for-nixos)
  * [Common mistakes](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/build-a-hermes-plugin#common-mistakes)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry -->
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#prerequisites "Prerequisites的直接链接")
...
## Quick Start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#quick-start "Quick Start的直接链接")
...
## Configuration (written to `config.yaml`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#configuration-written-to-configyaml "configuration-written-to-configyaml的直接链接")
...
## OpenAI-style endpoints (GPT, Llama, etc.)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#openai-style-endpoints-gpt-llama-etc "OpenAI-style endpoints \(GPT, Llama, etc.\)的直接链接")
...
## Anthropic-style endpoints (Claude via Azure Foundry)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#anthropic-style-endpoints-claude-via-azure-foundry "Anthropic-style endpoints \(Claude via Azure Foundry\)的直接链接")
...
## Alternative: `provider: anthropic` + Azure base URL[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#alternative-provider-anthropic--azure-base-url "alternative-provider-anthropic--azure-base-url的直接链接")
...
## Model discovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#model-discovery "Model discovery的直接链接")
...
## Environment variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#environment-variables "Environment variables的直接链接")  
| Variable  | Purpose  |  
| --- | --- |  
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#troubleshooting "Troubleshooting的直接链接")
...
## Related[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#related "Related的直接链接")
  * [Environment variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/reference/environment-variables)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/configuration)
  * [AWS Bedrock](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/aws-bedrock) — the other major cloud provider integration


  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#prerequisites)
  * [Quick Start](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#quick-start)
  * [Configuration (written to `config.yaml`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#configuration-written-to-configyaml)
  * [OpenAI-style endpoints (GPT, Llama, etc.)](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#openai-style-endpoints-gpt-llama-etc)
  * [Anthropic-style endpoints (Claude via Azure Foundry)](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#anthropic-style-endpoints-claude-via-azure-foundry)
  * [Alternative: `provider: anthropic` + Azure base URL](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#alternative-provider-anthropic--azure-base-url)
  * [Model discovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#model-discovery)
  * [Environment variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#environment-variables)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/azure-foundry#troubleshooting)

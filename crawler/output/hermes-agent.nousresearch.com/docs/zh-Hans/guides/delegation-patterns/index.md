<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns -->
...
For the full feature reference, see [Subagent Delegation](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/delegation).
## When to Delegate[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#when-to-delegate "When to Delegate的直接链接")
...
## Pattern: Parallel Research[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-parallel-research "Pattern: Parallel Research的直接链接")
...
## Pattern: Code Review[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-code-review "Pattern: Code Review的直接链接")
...
## Pattern: Compare Alternatives[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-compare-alternatives "Pattern: Compare Alternatives的直接链接")
...
## Pattern: Multi-File Refactoring[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-multi-file-refactoring "Pattern: Multi-File Refactoring的直接链接")
...
## Pattern: Gather Then Analyze[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-gather-then-analyze "Pattern: Gather Then Analyze的直接链接")
...
## Toolset Selection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#toolset-selection "Toolset Selection的直接链接")
...
## Constraints[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#constraints "Constraints的直接链接")
...
### Tuning Concurrency and Depth[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#tuning-concurrency-and-depth "Tuning Concurrency and Depth的直接链接")  
...
```
delegation:max_concurrent_children:30max_spawn_depth:2
```
...
## Tips[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#tips "Tips的直接链接")
...
_For the complete delegation reference — all parameters, ACP integration, and advanced configuration — see[Subagent Delegation](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/delegation)._
  * [When to Delegate](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#when-to-delegate)
  * [Pattern: Parallel Research](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-parallel-research)
  * [Pattern: Code Review](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-code-review)
  * [Pattern: Compare Alternatives](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-compare-alternatives)
  * [Pattern: Multi-File Refactoring](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-multi-file-refactoring)
  * [Pattern: Gather Then Analyze](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#pattern-gather-then-analyze)
  * [Toolset Selection](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#toolset-selection)
  * [Constraints](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#constraints)
    * [Tuning Concurrency and Depth](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/delegation-patterns#tuning-concurrency-and-depth)

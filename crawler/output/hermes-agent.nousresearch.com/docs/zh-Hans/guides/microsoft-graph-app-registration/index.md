<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration -->
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#prerequisites "Prerequisites的直接链接")
...
## Step 1: Create the App Registration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-1-create-the-app-registration "Step 1: Create the App Registration的直接链接")
...
## Step 2: Create a Client Secret[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-2-create-a-client-secret "Step 2: Create a Client Secret的直接链接")
...
## Step 3: Grant Graph API Permissions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-3-grant-graph-api-permissions "Step 3: Grant Graph API Permissions的直接链接")
...
### Required for transcript-first summaries[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#required-for-transcript-first-summaries "Required for transcript-first summaries的直接链接")  
...
### Required for recording fallback (when a transcript is unavailable)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#required-for-recording-fallback-when-a-transcript-is-unavailable "Required for recording fallback \(when a transcript is unavailable\)的直接链接")  
| Permission  | What it lets the app do  |  
| --- | --- |  
...
### Required for outbound summary delivery (Graph mode only)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#required-for-outbound-summary-delivery-graph-mode-only "Required for outbound summary delivery \(Graph mode only\)的直接链接")
...
### Not recommended[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#not-recommended "Not recommended的直接链接")
...
## Step 4: (Recommended) Scope the App with an Application Access Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-4-recommended-scope-the-app-with-an-application-access-policy "Step 4: \(Recommended\) Scope the App with an Application Access Policy的直接链接")
...
## Step 5: Write the Credentials to Your Env File[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-5-write-the-credentials-to-your-env-file "Step 5: Write the Credentials to Your Env File的直接链接")
...
## Step 6: Verify the Token Flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-6-verify-the-token-flow "Step 6: Verify the Token Flow的直接链接")
...
## Rotating the Client Secret[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#rotating-the-client-secret "Rotating the Client Secret的直接链接")
...
## Next Steps[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#next-steps "Next Steps的直接链接")
...
Those pages land alongside the PRs that add the corresponding runtime. This credentials setup is a standalone prerequisite and is safe to complete in advance.
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#prerequisites)
  * [Step 1: Create the App Registration](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-1-create-the-app-registration)
  * [Step 2: Create a Client Secret](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-2-create-a-client-secret)
  * [Step 3: Grant Graph API Permissions](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-3-grant-graph-api-permissions)
    * [Required for transcript-first summaries](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#required-for-transcript-first-summaries)
    * [Required for recording fallback (when a transcript is unavailable)](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#required-for-recording-fallback-when-a-transcript-is-unavailable)
    * [Required for outbound summary delivery (Graph mode only)](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#required-for-outbound-summary-delivery-graph-mode-only)
    * [Not recommended](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#not-recommended)
  * [Step 4: (Recommended) Scope the App with an Application Access Policy](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-4-recommended-scope-the-app-with-an-application-access-policy)
  * [Step 5: Write the Credentials to Your Env File](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-5-write-the-credentials-to-your-env-file)
  * [Step 6: Verify the Token Flow](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#step-6-verify-the-token-flow)
  * [Rotating the Client Secret](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/microsoft-graph-app-registration#rotating-the-client-secret)

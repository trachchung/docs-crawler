<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review -->
...
If you don't have a public URL or just want to get started quickly, check out [Build a GitHub PR Review Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/github-pr-review-agent) — uses cron jobs to poll for PRs on a schedule, works behind NAT and firewalls.
For the full webhook platform reference (all config options, delivery types, dynamic subscriptions, security model) see [Webhooks](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/webhooks).
Webhook payloads contain attacker-controlled data — PR titles, commit messages, and descriptions can contain malicious instructions. When your webhook endpoint is exposed to the internet, run the gateway in a sandboxed environment (Docker, SSH backend). See the [security section](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#security-notes) below.
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#prerequisites "Prerequisites的直接链接")
  ...
  * A publicly reachable URL for your Hermes instance (see [Local testing with ngrok](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#local-testing-with-ngrok) if running locally)
  * Admin access to the GitHub repository (required to manage webhooks)


## Step 1 — Enable the webhook platform[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-1--enable-the-webhook-platform "Step 1 — Enable the webhook platform的直接链接")
...
## Step 2 — Start the gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-2--start-the-gateway "Step 2 — Start the gateway的直接链接")
...
## Step 3 — Register the webhook on GitHub[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-3--register-the-webhook-on-github "Step 3 — Register the webhook on GitHub的直接链接")
...
## Step 4 — Open a test PR[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-4--open-a-test-pr "Step 4 — Open a test PR的直接链接")
...
## Local testing with ngrok[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#local-testing-with-ngrok "Local testing with ngrok的直接链接")
...
`deliver: log` when testing locally
...
## Filtering to specific actions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#filtering-to-specific-actions "Filtering to specific actions的直接链接")
...
## Using a skill for consistent review style[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#using-a-skill-for-consistent-review-style "Using a skill for consistent review style的直接链接")
Load a [Hermes skill](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/skills) to give the agent a consistent review persona. Add `skills` to your route inside `platforms.webhook.extra.routes` in `config.yaml`:
...
## Sending responses to Slack or Discord instead[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#sending-responses-to-slack-or-discord-instead "Sending responses to Slack or Discord instead的直接链接")
...
## GitLab support[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#gitlab-support "GitLab support的直接链接")
...
## Security notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#security-notes "Security notes的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#troubleshooting "Troubleshooting的直接链接")  
| Symptom  | Check  |  
| --- | --- |  
...
## Full config reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#full-config-reference "Full config reference的直接链接")
...
## What's Next?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#whats-next "What's Next?的直接链接")
  * **[Cron-Based PR Reviews](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/github-pr-review-agent)** — poll for PRs on a schedule, no public endpoint needed
  * **[Webhook Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/webhooks)** — full config reference for the webhook platform
  * **[Build a Plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/build-a-hermes-plugin)** — package review logic into a shareable plugin
  * — run a dedicated reviewer profile with its own memory and config


  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#prerequisites)
  * [Step 1 — Enable the webhook platform](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-1--enable-the-webhook-platform)
  * [Step 2 — Start the gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-2--start-the-gateway)
  * [Step 3 — Register the webhook on GitHub](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-3--register-the-webhook-on-github)
  * [Step 4 — Open a test PR](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#step-4--open-a-test-pr)
  * [Local testing with ngrok](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#local-testing-with-ngrok)
  * [Filtering to specific actions](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#filtering-to-specific-actions)
  * [Using a skill for consistent review style](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#using-a-skill-for-consistent-review-style)
  * [Sending responses to Slack or Discord instead](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#sending-responses-to-slack-or-discord-instead)
  * [GitLab support](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#gitlab-support)
  * [Security notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#security-notes)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#troubleshooting)
  * [Full config reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#full-config-reference)
  * [What's Next?](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/webhook-github-pr-review#whats-next)

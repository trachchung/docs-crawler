<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac -->
...
## Choosing a model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#choosing-a-model "Choosing a model的直接链接")
...
## Option A: llama.cpp[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#option-a-llamacpp "Option A: llama.cpp的直接链接")
llama.cpp is the most portable local LLM runtime. On macOS it uses Metal for GPU acceleration out of the box.
### Install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#install "Install的直接链接")
...
### Download the model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#download-the-model "Download the model的直接链接")
...
### Start the server[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#start-the-server "Start the server的直接链接")

```
llama-server -m ~/models/Qwen3.5-9B-Q4_K_M.gguf \-ngl99\-c131072\-np1\-fa on \  --cache-type-k q4_0 \  --cache-type-v q4_0 \--host0.0.0.0
```
...
### Memory optimization for constrained systems[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#memory-optimization-for-constrained-systems "Memory optimization for constrained systems的直接链接")
...
### Test it[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#test-it "Test it的直接链接")
...
### Get the model name[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#get-the-model-name "Get the model name的直接链接")
...
## Option B: MLX via omlx[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#option-b-mlx-via-omlx "Option B: MLX via omlx的直接链接")
...
### Install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#install-1 "Install的直接链接")
Download and install from [omlx.ai](https://omlx.ai). It provides a GUI for model management and a built-in server.
### Download the model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#download-the-model-1 "Download the model的直接链接")
...
### Start the server[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#start-the-server-1 "Start the server的直接链接")
omlx serves models on `http://127.0.0.1:8000` by default. Start serving from the app UI, or use the CLI if available.
### Test it[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#test-it-1 "Test it的直接链接")
...
### List available models[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#list-available-models "List available models的直接链接")
...
## Benchmarks: llama.cpp vs MLX[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#benchmarks-llamacpp-vs-mlx "Benchmarks: llama.cpp vs MLX的直接链接")
...
### Results[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#results "Results的直接链接")  
...
### What this means[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#what-this-means "What this means的直接链接")
...
### Which one should you pick?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#which-one-should-you-pick "Which one should you pick?的直接链接")  
...
## Connect to Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#connect-to-hermes "Connect to Hermes的直接链接")
...
## Timeouts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#timeouts "Timeouts的直接链接")
...
The stream read timeout is the one most likely to cause issues — it's the socket-level deadline for receiving the next chunk of data. During prefill on large contexts, local models may produce no output for minutes while processing the prompt. The auto-detection handles this transparently.
  * [Choosing a model](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#choosing-a-model)
  * [Option A: llama.cpp](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#option-a-llamacpp)
    * [Download the model](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#download-the-model)
    * [Start the server](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#start-the-server)
    * [Memory optimization for constrained systems](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#memory-optimization-for-constrained-systems)
    * [Get the model name](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#get-the-model-name)
  * [Option B: MLX via omlx](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#option-b-mlx-via-omlx)
    * [Download the model](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#download-the-model-1)
    * [Start the server](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#start-the-server-1)
    * [List available models](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#list-available-models)
  * [Benchmarks: llama.cpp vs MLX](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#benchmarks-llamacpp-vs-mlx)
    * [What this means](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#what-this-means)
    * [Which one should you pick?](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#which-one-should-you-pick)
  * [Connect to Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/local-llm-on-mac#connect-to-hermes)

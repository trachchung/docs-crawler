<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security -->
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#overview "Overview的直接链接")
...
## Dangerous Command Approval[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#dangerous-command-approval "Dangerous Command Approval的直接链接")
...
### Approval Modes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-modes "Approval Modes的直接链接")
...
### YOLO Mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#yolo-mode "YOLO Mode的直接链接")
...
### Hardline Blocklist (Always-On Floor)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#hardline-blocklist-always-on-floor "Hardline Blocklist \(Always-On Floor\)的直接链接")
...
### Approval Timeout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-timeout "Approval Timeout的直接链接")
...
### What Triggers Approval[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#what-triggers-approval "What Triggers Approval的直接链接")
...
### Approval Flow (CLI)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-flow-cli "Approval Flow \(CLI\)的直接链接")
...
### Approval Flow (Gateway/Messaging)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-flow-gatewaymessaging "Approval Flow \(Gateway/Messaging\)的直接链接")
...
### Permanent Allowlist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#permanent-allowlist "Permanent Allowlist的直接链接")
...
## User Authorization (Gateway)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#user-authorization-gateway "User Authorization \(Gateway\)的直接链接")
When running the messaging gateway, Hermes controls who can interact with the bot through a layered authorization system.
### Authorization Check Order[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#authorization-check-order "Authorization Check Order的直接链接")
...
### Platform Allowlists[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#platform-allowlists "Platform Allowlists的直接链接")
...
### DM Pairing System[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#dm-pairing-system "DM Pairing System的直接链接")
...
## Container Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#container-isolation "Container Isolation的直接链接")
When using the `docker` terminal backend, Hermes applies strict security hardening to every container.
### Docker Security Flags[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#docker-security-flags "Docker Security Flags的直接链接")
...
### Resource Limits[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#resource-limits "Resource Limits的直接链接")
...
### Filesystem Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#filesystem-persistence "Filesystem Persistence的直接链接")
...
## Terminal Backend Security Comparison[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#terminal-backend-security-comparison "Terminal Backend Security Comparison的直接链接")  
...
## Environment Variable Passthrough[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#environment-variable-passthrough "Environment Variable Passthrough的直接链接")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#how-it-works "How It Works的直接链接")
...
### Credential File Passthrough (OAuth tokens, etc.)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#credential-file-passthrough "Credential File Passthrough \(OAuth tokens, etc.\)的直接链接")
...
### What Each Sandbox Filters[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#what-each-sandbox-filters "What Each Sandbox Filters的直接链接")  
...
### Security Considerations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#security-considerations "Security Considerations的直接链接")
...
## MCP Credential Handling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#mcp-credential-handling "MCP Credential Handling的直接链接")
MCP (Model Context Protocol) server subprocesses receive a **filtered environment** to prevent accidental credential leakage.
### Safe Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#safe-environment-variables "Safe Environment Variables的直接链接")
...
### Credential Redaction[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#credential-redaction "Credential Redaction的直接链接")
...
### Website Access Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#website-access-policy "Website Access Policy的直接链接")
...
See [Website Blocklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/configuration#website-blocklist) in the configuration guide for full details.
### SSRF Protection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#ssrf-protection "SSRF Protection的直接链接")
...
#### Intentionally allowing private URLs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#intentionally-allowing-private-urls "Intentionally allowing private URLs的直接链接")
...
### Tirith Pre-Exec Security Scanning[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#tirith-pre-exec-security-scanning "Tirith Pre-Exec Security Scanning的直接链接")
...
### Context File Injection Protection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#context-file-injection-protection "Context File Injection Protection的直接链接")
...
## Best Practices for Production Deployment[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#best-practices-for-production-deployment "Best Practices for Production Deployment的直接链接")
### Gateway Deployment Checklist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#gateway-deployment-checklist "Gateway Deployment Checklist的直接链接")
...
### Securing API Keys[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#securing-api-keys "Securing API Keys的直接链接")

```
# Set proper permissions on the .env filechmod600 ~/.hermes/.env# Keep separate keys for different services# Never commit .env files to version control
```

### Network Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#network-isolation "Network Isolation的直接链接")
...
The SSH connection details live in `.env` (not `config.yaml`) so they aren't checked in or shared along with profile exports. This keeps the gateway's messaging connections separate from the agent's command execution.
  * [Dangerous Command Approval](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#dangerous-command-approval)
    * [Approval Modes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-modes)
    * [Hardline Blocklist (Always-On Floor)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#hardline-blocklist-always-on-floor)
    * [Approval Timeout](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-timeout)
    * [What Triggers Approval](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#what-triggers-approval)
    * [Approval Flow (CLI)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-flow-cli)
    * [Approval Flow (Gateway/Messaging)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#approval-flow-gatewaymessaging)
    * [Permanent Allowlist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#permanent-allowlist)
  * [User Authorization (Gateway)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#user-authorization-gateway)
    * [Authorization Check Order](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#authorization-check-order)
    * [Platform Allowlists](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#platform-allowlists)
    * [DM Pairing System](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#dm-pairing-system)
  * [Container Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#container-isolation)
    * [Docker Security Flags](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#docker-security-flags)
    * [Resource Limits](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#resource-limits)
    * [Filesystem Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#filesystem-persistence)
  * [Terminal Backend Security Comparison](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#terminal-backend-security-comparison)
  * [Environment Variable Passthrough](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#environment-variable-passthrough)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#how-it-works)
    * [Credential File Passthrough (OAuth tokens, etc.)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#credential-file-passthrough)
    * [What Each Sandbox Filters](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#what-each-sandbox-filters)
    * [Security Considerations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#security-considerations)
  * [MCP Credential Handling](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#mcp-credential-handling)
    * [Safe Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#safe-environment-variables)
    * [Credential Redaction](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#credential-redaction)
    * [Website Access Policy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#website-access-policy)
    * [SSRF Protection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#ssrf-protection)
    * [Tirith Pre-Exec Security Scanning](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#tirith-pre-exec-security-scanning)
    * [Context File Injection Protection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#context-file-injection-protection)
  * [Best Practices for Production Deployment](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#best-practices-for-production-deployment)
    * [Gateway Deployment Checklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#gateway-deployment-checklist)
    * [Securing API Keys](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#securing-api-keys)
    * [Network Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security#network-isolation)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees -->
...
## Why Use Worktrees with Hermes?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#why-use-worktrees-with-hermes "Why Use Worktrees with Hermes?的直接链接")
...
See also: [Checkpoints and /rollback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/checkpoints-and-rollback).
## Quick Start: Creating a Worktree[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#quick-start-creating-a-worktree "Quick Start: Creating a Worktree的直接链接")
...
## Running Multiple Agents in Parallel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#running-multiple-agents-in-parallel "Running Multiple Agents in Parallel的直接链接")
...
## Cleaning Up Worktrees Safely[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#cleaning-up-worktrees-safely "Cleaning Up Worktrees Safely的直接链接")
...
## Best Practices[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#best-practices "Best Practices的直接链接")
  ...
  * **Commit frequently**
    ...
    * Use [checkpoints and /rollback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/checkpoints-and-rollback) as a safety net for tool‑driven edits in between.
...
## Using `hermes -w` (Automatic Worktree Mode)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#using-hermes--w-automatic-worktree-mode "using-hermes--w-automatic-worktree-mode的直接链接")
...
## Putting It All Together[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#putting-it-all-together "Putting It All Together的直接链接")
...
This combination gives you:
  ...
  * [Why Use Worktrees with Hermes?](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#why-use-worktrees-with-hermes)
  * [Quick Start: Creating a Worktree](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#quick-start-creating-a-worktree)
  * [Running Multiple Agents in Parallel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#running-multiple-agents-in-parallel)
  * [Cleaning Up Worktrees Safely](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#cleaning-up-worktrees-safely)
  * [Best Practices](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#best-practices)
  * [Using `hermes -w` (Automatic Worktree Mode)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#using-hermes--w-automatic-worktree-mode)
  * [Putting It All Together](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/git-worktrees#putting-it-all-together)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins -->
...
## Change skins[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#change-skins "Change skins的直接链接")
...
## Built-in skins[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#built-in-skins "Built-in skins的直接链接")  
...
## Complete list of configurable keys[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#complete-list-of-configurable-keys "Complete list of configurable keys的直接链接")
### Colors (`colors:`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#colors-colors "colors-colors的直接链接")
...
### Spinner (`spinner:`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#spinner-spinner "spinner-spinner的直接链接")
...
### Branding (`branding:`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#branding-branding "branding-branding的直接链接")
...
### Other top-level keys[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#other-top-level-keys "Other top-level keys的直接链接")  
...
## Custom skins[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#custom-skins "Custom skins的直接链接")
...
### Full custom skin YAML template[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#full-custom-skin-yaml-template "Full custom skin YAML template的直接链接")
...
### Minimal custom skin example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#minimal-custom-skin-example "Minimal custom skin example的直接链接")
...
## Hermes Mod — Visual Skin Editor[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#hermes-mod--visual-skin-editor "Hermes Mod — Visual Skin Editor的直接链接")
...
### Install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#install "Install的直接链接")
...
```
git clone https://github.com/cocktailpeanut/hermes-mod.gitcd hermes-mod/appnpminstallnpm start
```

### Usage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#usage "Usage的直接链接")
...
Hermes Mod respects the `HERMES_HOME` environment variable, so it works with [profiles](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/profiles) too.
## Operational notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#operational-notes "Operational notes的直接链接")
  ...
  * [Change skins](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#change-skins)
  * [Built-in skins](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#built-in-skins)
  * [Complete list of configurable keys](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#complete-list-of-configurable-keys)
    * [Colors (`colors:`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#colors-colors)
    * [Spinner (`spinner:`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#spinner-spinner)
    * [Branding (`branding:`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#branding-branding)
    * [Other top-level keys](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#other-top-level-keys)
  * [Custom skins](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#custom-skins)
    * [Full custom skin YAML template](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#full-custom-skin-yaml-template)
    * [Minimal custom skin example](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#minimal-custom-skin-example)
  * [Hermes Mod — Visual Skin Editor](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#hermes-mod--visual-skin-editor)
  * [Operational notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins#operational-notes)

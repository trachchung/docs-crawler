<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools -->
...
This is different from [fallback providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers), which switch to a _different_ provider entirely. Credential pools are same-provider rotation; fallback providers are cross-provider failover. Pools are tried first — if all pool keys are exhausted, _then_ the fallback provider activates.
## How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#how-it-works "How It Works的直接链接")
...
## Quick Start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#quick-start "Quick Start的直接链接")
...
## Interactive Management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#interactive-management "Interactive Management的直接链接")
...
## CLI Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#cli-commands "CLI Commands的直接链接")  
| Command  | Description  |  
| --- | --- |  
...
## Rotation Strategies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#rotation-strategies "Rotation Strategies的直接链接")
Configure via `hermes auth` → "Set rotation strategy" or in `config.yaml`:

```
credential_pool_strategies:openrouter: round_robinanthropic: least_used
```
...
## Error Recovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#error-recovery "Error Recovery的直接链接")
...
## Custom Endpoint Pools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#custom-endpoint-pools "Custom Endpoint Pools的直接链接")
...
## Auto-Discovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#auto-discovery "Auto-Discovery的直接链接")
...
## Delegation & Subagent Sharing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#delegation--subagent-sharing "Delegation & Subagent Sharing的直接链接")
...
## Thread Safety[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#thread-safety "Thread Safety的直接链接")
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#architecture "Architecture的直接链接")
...
## Storage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#storage "Storage的直接链接")
...
```
  ...
  * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#how-it-works)
  * [Quick Start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#quick-start)
  * [Interactive Management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#interactive-management)
  * [CLI Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#cli-commands)
  * [Rotation Strategies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#rotation-strategies)
  * [Error Recovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#error-recovery)
  * [Custom Endpoint Pools](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#custom-endpoint-pools)
  * [Auto-Discovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#auto-discovery)
  * [Delegation & Subagent Sharing](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#delegation--subagent-sharing)
  * [Thread Safety](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#thread-safety)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools#architecture)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser -->
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#overview "Overview的直接链接")
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#setup "Setup的直接链接")
If you have a paid [Nous Portal](https://portal.nousresearch.com) subscription, you can use browser automation through the **[Tool Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/tool-gateway.md)** without any separate API keys. Run `hermes model` or `hermes tools` to enable it.
### Browserbase cloud mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browserbase-cloud-mode "Browserbase cloud mode的直接链接")
...
### Browser Use cloud mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser-use-cloud-mode "Browser Use cloud mode的直接链接")
...
### Firecrawl cloud mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#firecrawl-cloud-mode "Firecrawl cloud mode的直接链接")
...
### Hybrid routing: cloud for public URLs, local for LAN/localhost[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#hybrid-routing-cloud-for-public-urls-local-for-lanlocalhost "Hybrid routing: cloud for public URLs, local for LAN/localhost的直接链接")
...
### Camofox local mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#camofox-local-mode "Camofox local mode的直接链接")
...
#### Persistent browser sessions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#persistent-browser-sessions "Persistent browser sessions的直接链接")
...
##### What Hermes does[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#what-hermes-does "What Hermes does的直接链接")
...
##### What Hermes does not do[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#what-hermes-does-not-do "What Hermes does not do的直接链接")
...
##### Verify it's working[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#verify-its-working "Verify it's working的直接链接")
...
##### Where state lives[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#where-state-lives "Where state lives的直接链接")
...
#### Externally managed Camofox sessions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#externally-managed-camofox-sessions "Externally managed Camofox sessions的直接链接")
...
#### VNC live view[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#vnc-live-view "VNC live view的直接链接")
...
### Local Chrome via CDP (`/browser connect`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#local-chrome-via-cdp-browser-connect "local-chrome-via-cdp-browser-connect的直接链接")
...
### WSL2 + Windows Chrome: prefer MCP over `/browser connect`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#wsl2--windows-chrome-prefer-mcp-over-browser-connect "wsl2--windows-chrome-prefer-mcp-over-browser-connect的直接链接")
...
### Local browser mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#local-browser-mode "Local browser mode的直接链接")
...
### Optional Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#optional-environment-variables "Optional Environment Variables的直接链接")
...
### Install agent-browser CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#install-agent-browser-cli "Install agent-browser CLI的直接链接")
...
## Available Tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#available-tools "Available Tools的直接链接")
###  `browser_navigate`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_navigate "browser_navigate的直接链接")
...
###  `browser_snapshot`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_snapshot "browser_snapshot的直接链接")
...
###  `browser_click`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_click "browser_click的直接链接")
...
###  `browser_type`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_type "browser_type的直接链接")
...
###  `browser_scroll`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_scroll "browser_scroll的直接链接")
...
###  `browser_press`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_press "browser_press的直接链接")
...
###  `browser_back`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_back "browser_back的直接链接")
Navigate back to the previous page in browser history.
###  `browser_get_images`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_get_images "browser_get_images的直接链接")
List all images on the current page with their URLs and alt text. Useful for finding images to analyze.
###  `browser_vision`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_vision "browser_vision的直接链接")
...
###  `browser_console`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_console "browser_console的直接链接")
...
###  `browser_cdp`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_cdp "browser_cdp的直接链接")
...
###  `browser_dialog`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_dialog "browser_dialog的直接链接")
...
## Practical Examples[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#practical-examples "Practical Examples的直接链接")
### Filling Out a Web Form[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#filling-out-a-web-form "Filling Out a Web Form的直接链接")
...
### Researching Dynamic Content[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#researching-dynamic-content "Researching Dynamic Content的直接链接")
...
## Session Recording[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#session-recording "Session Recording的直接链接")
...
## Stealth Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#stealth-features "Stealth Features的直接链接")
...
## Session Management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#session-management "Session Management的直接链接")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#limitations "Limitations的直接链接")
  ...
  * [Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#setup)
    * [Browserbase cloud mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browserbase-cloud-mode)
    * [Browser Use cloud mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser-use-cloud-mode)
    * [Firecrawl cloud mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#firecrawl-cloud-mode)
    * [Hybrid routing: cloud for public URLs, local for LAN/localhost](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#hybrid-routing-cloud-for-public-urls-local-for-lanlocalhost)
    * [Camofox local mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#camofox-local-mode)
    * [Local Chrome via CDP (`/browser connect`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#local-chrome-via-cdp-browser-connect)
    * [WSL2 + Windows Chrome: prefer MCP over `/browser connect`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#wsl2--windows-chrome-prefer-mcp-over-browser-connect)
    * [Local browser mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#local-browser-mode)
    * [Optional Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#optional-environment-variables)
    * [Install agent-browser CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#install-agent-browser-cli)
  * [Available Tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#available-tools)
    * [`browser_navigate`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_navigate)
    * [`browser_snapshot`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_snapshot)
    * [`browser_click`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_click)
    * [`browser_type`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_type)
    * [`browser_scroll`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_scroll)
    * [`browser_press`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_press)
    * [`browser_back`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_back)
    * [`browser_get_images`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_get_images)
    * [`browser_vision`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_vision)
    * [`browser_console`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_console)
    * [`browser_dialog`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_dialog)
  * [Practical Examples](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#practical-examples)
    * [Filling Out a Web Form](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#filling-out-a-web-form)
    * [Researching Dynamic Content](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#researching-dynamic-content)
  * [Session Recording](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#session-recording)
  * [Stealth Features](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#stealth-features)
  * [Session Management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#session-management)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#limitations)

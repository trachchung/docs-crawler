<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers -->

本页总览
Hermes Agent has three layers of resilience that keep your sessions running when providers hit issues:
  1. **[Credential pools](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/credential-pools)** — rotate across multiple API keys for the _same_ provider (tried first)
...
## Primary Model Fallback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#primary-model-fallback "Primary Model Fallback的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#configuration "Configuration的直接链接")
...
### Supported Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#supported-providers "Supported Providers的直接链接")  
...
### Custom Endpoint Fallback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#custom-endpoint-fallback "Custom Endpoint Fallback的直接链接")
...
### When Fallback Triggers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#when-fallback-triggers "When Fallback Triggers的直接链接")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#examples "Examples的直接链接")
...
### Where Fallback Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#where-fallback-works "Where Fallback Works的直接链接")  
...
## Auxiliary Task Fallback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#auxiliary-task-fallback "Auxiliary Task Fallback的直接链接")
...
### Tasks with Independent Provider Resolution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#tasks-with-independent-provider-resolution "Tasks with Independent Provider Resolution的直接链接")  
...
### Auto-Detection Chain[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#auto-detection-chain "Auto-Detection Chain的直接链接")
...
### Configuring Auxiliary Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#configuring-auxiliary-providers "Configuring Auxiliary Providers的直接链接")
...
### Provider Options for Auxiliary Tasks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#provider-options-for-auxiliary-tasks "Provider Options for Auxiliary Tasks的直接链接")
These options apply to `auxiliary:`, `compression:`, and `fallback_model:` configs only — `"main"` is **not** a valid value for your top-level `model.provider`. For custom endpoints, use `provider: custom` in your `model:` section (see [AI Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/integrations/providers)).  
...
### Direct Endpoint Override[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#direct-endpoint-override "Direct Endpoint Override的直接链接")
...
## Context Compression Fallback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#context-compression-fallback "Context Compression Fallback的直接链接")
...
## Delegation Provider Override[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#delegation-provider-override "Delegation Provider Override的直接链接")
...
See [Subagent Delegation](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/delegation) for full configuration details.
## Cron Job Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#cron-job-providers "Cron Job Providers的直接链接")
...
See [Scheduled Tasks (Cron)](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/cron) for full configuration details.
## Summary[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#summary "Summary的直接链接")  
...
| Cron jobs  | Per-job provider override only (no automatic fallback)  | Per-job `provider` / `model`  |  
  * [Primary Model Fallback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#primary-model-fallback)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#configuration)
    * [Supported Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#supported-providers)
    * [Custom Endpoint Fallback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#custom-endpoint-fallback)
    * [When Fallback Triggers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#when-fallback-triggers)
    * [Where Fallback Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#where-fallback-works)
  * [Auxiliary Task Fallback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#auxiliary-task-fallback)
    * [Tasks with Independent Provider Resolution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#tasks-with-independent-provider-resolution)
    * [Auto-Detection Chain](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#auto-detection-chain)
    * [Configuring Auxiliary Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#configuring-auxiliary-providers)
    * [Provider Options for Auxiliary Tasks](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#provider-options-for-auxiliary-tasks)
    * [Direct Endpoint Override](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#direct-endpoint-override)
  * [Context Compression Fallback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#context-compression-fallback)
  * [Delegation Provider Override](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#delegation-provider-override)
  * [Cron Job Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/fallback-providers#cron-job-providers)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation -->

本页总览
The `delegate_task` tool spawns child AIAgent instances with isolated context, restricted toolsets, and their own terminal sessions. Each child gets a fresh conversation and works independently — only its final summary enters the parent's context.
## Single Task[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#single-task "Single Task的直接链接")

```
delegate_task(    goal="Debug why tests fail",    context="Error: assertion in test_foo.py line 42",    toolsets=["terminal","file"]
```

## Parallel Batch[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#parallel-batch "Parallel Batch的直接链接")
...
## How Subagent Context Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#how-subagent-context-works "How Subagent Context Works的直接链接")
...
## Practical Examples[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#practical-examples "Practical Examples的直接链接")
### Parallel Research[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#parallel-research "Parallel Research的直接链接")
...
### Code Review + Fix[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#code-review--fix "Code Review + Fix的直接链接")
...
### Multi-File Refactoring[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#multi-file-refactoring "Multi-File Refactoring的直接链接")
...
## Batch Mode Details[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#batch-mode-details "Batch Mode Details的直接链接")
...
## Model Override[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#model-override "Model Override的直接链接")
...
## Toolset Selection Tips[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#toolset-selection-tips "Toolset Selection Tips的直接链接")
...
Certain toolsets are blocked for subagents regardless of what you specify:
  * `delegation` — blocked for leaf subagents (the default). Retained for `role="orchestrator"` children, bounded by `max_spawn_depth` — see [Depth Limit and Nested Orchestration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#depth-limit-and-nested-orchestration) below.
...
## Max Iterations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#max-iterations "Max Iterations的直接链接")
...
## Child Timeout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#child-timeout "Child Timeout的直接链接")
...
## Monitoring Running Subagents (`/agents`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#monitoring-running-subagents-agents "monitoring-running-subagents-agents的直接链接")
...
The classic CLI just prints `/agents` as a text summary; the TUI is where the overlay shines. See [TUI — Slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/tui#slash-commands).
## Depth Limit and Nested Orchestration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#depth-limit-and-nested-orchestration "Depth Limit and Nested Orchestration的直接链接")
...
## Lifetime and Durability[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#lifetime-and-durability "Lifetime and Durability的直接链接")
...
## Key Properties[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#key-properties "Key Properties的直接链接")
...
## Delegation vs execute_code[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#delegation-vs-execute_code "Delegation vs execute_code的直接链接")  
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#configuration "Configuration的直接链接")
...
The agent handles delegation automatically based on the task complexity. You don't need to explicitly ask it to delegate — it will do so when it makes sense.
  * [Single Task](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#single-task)
  * [Parallel Batch](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#parallel-batch)
  * [How Subagent Context Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#how-subagent-context-works)
  * [Practical Examples](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#practical-examples)
    * [Parallel Research](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#parallel-research)
    * [Code Review + Fix](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#code-review--fix)
    * [Multi-File Refactoring](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#multi-file-refactoring)
  * [Batch Mode Details](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#batch-mode-details)
  * [Model Override](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#model-override)
  * [Toolset Selection Tips](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#toolset-selection-tips)
  * [Max Iterations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#max-iterations)
  * [Child Timeout](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#child-timeout)
  * [Monitoring Running Subagents (`/agents`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#monitoring-running-subagents-agents)
  * [Depth Limit and Nested Orchestration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#depth-limit-and-nested-orchestration)
  * [Lifetime and Durability](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#lifetime-and-durability)
  * [Key Properties](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#key-properties)
  * [Delegation vs execute_code](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#delegation-vs-execute_code)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation#configuration)

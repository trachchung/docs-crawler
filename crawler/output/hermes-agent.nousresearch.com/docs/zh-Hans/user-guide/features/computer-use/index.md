<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use -->
...
## How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#how-it-works "How it works的直接链接")
...
## Enabling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#enabling "Enabling的直接链接")
...
## Keeping cua-driver up to date[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#keeping-cua-driver-up-to-date "Keeping cua-driver up to date的直接链接")
...
## Quick example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#quick-example "Quick example的直接链接")
...
## Provider compatibility[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#provider-compatibility "Provider compatibility的直接链接")  
...
## Safety[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#safety "Safety的直接链接")
...
## Token efficiency[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#token-efficiency "Token efficiency的直接链接")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#limitations "Limitations的直接链接")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#configuration "Configuration的直接链接")
Override the driver binary path (tests / CI):

```
HERMES_CUA_DRIVER_CMD=/opt/homebrew/bin/cua-driverHERMES_CUA_DRIVER_VERSION=0.5.0    # optional pin
```
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#troubleshooting "Troubleshooting的直接链接")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#see-also "See also的直接链接")
  ...
  * [Browser automation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser) for cross-platform web tasks.


  * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#how-it-works)
  * [Keeping cua-driver up to date](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#keeping-cua-driver-up-to-date)
  * [Quick example](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#quick-example)
  * [Provider compatibility](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#provider-compatibility)
  * [Token efficiency](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#token-efficiency)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#limitations)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#configuration)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/computer-use#troubleshooting)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers -->

本页总览
Hermes Agent ships with 8 external memory provider plugins that give the agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. Only **one** external provider can be active at a time — the built-in memory is always active alongside it.
## Quick Start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#quick-start "Quick Start的直接链接")
...
## How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#how-it-works "How It Works的直接链接")
...
## Available Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#available-providers "Available Providers的直接链接")
### Honcho[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#honcho "Honcho的直接链接")
...
### New profile, fresh Honcho peer[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#new-profile-fresh-honcho-peer "New profile, fresh Honcho peer的直接链接")
...
### Existing profiles, backfill Honcho peers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#existing-profiles-backfill-honcho-peers "Existing profiles, backfill Honcho peers的直接链接")
...
### Per-profile observation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#per-profile-observation "Per-profile observation的直接链接")
...
See the [Honcho page](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#observation-directional-vs-unified) for the full observation reference.
...
### OpenViking[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#openviking "OpenViking的直接链接")
...
### Mem0[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#mem0 "Mem0的直接链接")
...
### Hindsight[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#hindsight "Hindsight的直接链接")
...
### Holographic[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#holographic "Holographic的直接链接")
...
### RetainDB[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#retaindb "RetainDB的直接链接")
...
### ByteRover[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#byterover "ByteRover的直接链接")
...
### Supermemory[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#supermemory "Supermemory的直接链接")
...
## Provider Comparison[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#provider-comparison "Provider Comparison的直接链接")  
...
## Profile Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#profile-isolation "Profile Isolation的直接链接")
Each provider's data is isolated per [profile](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/profiles):
...
## Building a Memory Provider[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#building-a-memory-provider "Building a Memory Provider的直接链接")
See the [Developer Guide: Memory Provider Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/memory-provider-plugin) for how to create your own.
  * [Quick Start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#quick-start)
  * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#how-it-works)
  * [Available Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#available-providers)
    * [New profile, fresh Honcho peer](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#new-profile-fresh-honcho-peer)
    * [Existing profiles, backfill Honcho peers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#existing-profiles-backfill-honcho-peers)
    * [Per-profile observation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#per-profile-observation)
    * [Holographic](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#holographic)
    * [Supermemory](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#supermemory)
  * [Provider Comparison](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#provider-comparison)
  * [Profile Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#profile-isolation)
  * [Building a Memory Provider](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#building-a-memory-provider)

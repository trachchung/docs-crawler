<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator -->
...
## How it runs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#how-it-runs "How it runs的直接链接")
...
Pinned skills are off-limits to both the curator's auto-transitions and the agent's own `skill_manage` tool. See [Pinning a skill](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#pinning-a-skill) below.
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#configuration "Configuration的直接链接")
...
### Running the review on a cheaper aux model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#running-the-review-on-a-cheaper-aux-model "Running the review on a cheaper aux model的直接链接")
...
## CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#cli "CLI的直接链接")
...
## Backups and rollback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#backups-and-rollback "Backups and rollback的直接链接")
...
## What "agent-created" means[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#what-agent-created-means "What "agent-created" means的直接链接")
...
## Pinning a skill[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#pinning-a-skill "Pinning a skill的直接链接")
...
## Usage telemetry[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#usage-telemetry "Usage telemetry的直接链接")
...
## Per-run reports[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#per-run-reports "Per-run reports的直接链接")
...
## Restoring an archived skill[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#restoring-an-archived-skill "Restoring an archived skill的直接链接")
...
## Disabling per environment[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#disabling-per-environment "Disabling per environment的直接链接")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#see-also "See also的直接链接")
  * [Skills System](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/skills) — how skills work in general and the self-improvement loop that creates them
  * [Memory](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/memory) — a parallel background review that maintains long-term memory
  ...
  * [How it runs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#how-it-runs)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#configuration)
    * [Running the review on a cheaper aux model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#running-the-review-on-a-cheaper-aux-model)
  * [Backups and rollback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#backups-and-rollback)
  * [What "agent-created" means](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#what-agent-created-means)
  * [Pinning a skill](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#pinning-a-skill)
  * [Usage telemetry](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#usage-telemetry)
  * [Per-run reports](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#per-run-reports)
  * [Restoring an archived skill](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#restoring-an-archived-skill)
  * [Disabling per environment](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/curator#disabling-per-environment)

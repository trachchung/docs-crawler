<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals -->
...
## When to use it[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#when-to-use-it "When to use it的直接链接")
...
## Quick start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#quick-start "Quick start的直接链接")
...
## Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#commands "Commands的直接链接")  
...
## Behavior details[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#behavior-details "Behavior details的直接链接")
### The judge[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#the-judge "The judge的直接链接")
...
### Fail-open semantics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#fail-open-semantics "Fail-open semantics的直接链接")
...
### Turn budget[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#turn-budget "Turn budget的直接链接")
...
### User messages always preempt[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#user-messages-always-preempt "User messages always preempt的直接链接")
...
### Mid-run safety (gateway)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#mid-run-safety-gateway "Mid-run safety \(gateway\)的直接链接")
...
### Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#persistence "Persistence的直接链接")
...
### Prompt cache[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#prompt-cache "Prompt cache的直接链接")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#configuration "Configuration的直接链接")
...
### Choosing the judge model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#choosing-the-judge-model "Choosing the judge model的直接链接")
The judge uses the `goal_judge` auxiliary task. By default it resolves to your main model (see [Auxiliary Models](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/configuration#auxiliary-models)). If you want to route the judge to a cheap fast model to keep costs down, add an override:

```
auxiliary:goal_judge:provider: openroutermodel: google/gemini-3-flash-preview
```

The judge call is small (~200 output tokens) and runs once per turn, so a cheap fast model is usually the right call.
## Example walkthrough[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#example-walkthrough "Example walkthrough的直接链接")
...
## When the judge gets it wrong[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#when-the-judge-gets-it-wrong "When the judge gets it wrong的直接链接")
...
## Attribution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#attribution "Attribution的直接链接")
`/goal` is Hermes' take on the **Ralph loop** pattern. The user-facing design — keep a goal alive across turns, don't stop until it's achieved, with create/pause/resume/clear controls — was popularised and shipped in [Codex CLI 0.128.0](https://github.com/openai/codex) by Eric Traut on OpenAI's Codex team. Our implementation is independent (central `CommandDef` registry, `SessionDB.state_meta` persistence, auxiliary-client judge, adapter-FIFO continuation on the gateway side) but the idea is theirs. Credit where credit's due.
  * [When to use it](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#when-to-use-it)
  * [Quick start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#quick-start)
  * [Behavior details](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#behavior-details)
    * [Fail-open semantics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#fail-open-semantics)
    * [Turn budget](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#turn-budget)
    * [User messages always preempt](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#user-messages-always-preempt)
    * [Mid-run safety (gateway)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#mid-run-safety-gateway)
    * [Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#persistence)
    * [Prompt cache](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#prompt-cache)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#configuration)
    * [Choosing the judge model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#choosing-the-judge-model)
  * [Example walkthrough](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#example-walkthrough)
  * [When the judge gets it wrong](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#when-the-judge-gets-it-wrong)
  * [Attribution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/goals#attribution)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills -->
...
You can also point Hermes at **external skill directories** — additional folders scanned alongside the local one. See [External Skill Directories](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#external-skill-directories) below.
See also:
  * [Bundled Skills Catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/reference/skills-catalog)
  * [Official Optional Skills Catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/reference/optional-skills-catalog)


## Using Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#using-skills "Using Skills的直接链接")
...
## Progressive Disclosure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#progressive-disclosure "Progressive Disclosure的直接链接")
...
## SKILL.md Format[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skillmd-format "SKILL.md Format的直接链接")

```
---name: my-skilldescription: Brief description of what this skill doesversion: 1.0.0platforms:[macos, linux]# Optional — restrict to specific OS platformsmetadata:hermes:tags:[python, automation]category: devopsfallback_for_toolsets:[web]# Optional — conditional activation (see below)requires_toolsets:[terminal]# Optional — conditional activation (see below)config:# Optional — config.yaml settings-key: my.settingdescription:"What this controls"default:"value"prompt:"Prompt for setup"---# Skill Title## When to UseTrigger conditions for this skill.## Procedure1. Step one2. Step two## Pitfalls- Known failure modes and fixes## VerificationHow to confirm it worked.
```

### Platform-Specific Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#platform-specific-skills "Platform-Specific Skills的直接链接")
...
### Conditional Activation (Fallback Skills)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#conditional-activation-fallback-skills "Conditional Activation \(Fallback Skills\)的直接链接")
...
```
metadata:hermes:fallback_for_toolsets:[web]# Show ONLY when these toolsets are unavailablerequires_toolsets:[terminal]# Show ONLY when these toolsets are availablefallback_for_tools:[web_search]# Show ONLY when these specific tools are unavailablerequires_tools:[terminal]# Show ONLY when these specific tools are available
```
...
## Secure Setup on Load[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#secure-setup-on-load "Secure Setup on Load的直接链接")
...
Once set, declared env vars are **automatically passed through** to `execute_code` and `terminal` sandboxes — the skill's scripts can use `$TENOR_API_KEY` directly. For non-skill env vars, use the `terminal.env_passthrough` config option. See [Environment Variable Passthrough](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/security#environment-variable-passthrough) for details.
### Skill Config Settings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skill-config-settings "Skill Config Settings的直接链接")
Skills can also declare non-secret config settings (paths, preferences) stored in `config.yaml`:

```
metadata:hermes:config:-key: myplugin.pathdescription: Path to the plugin data directorydefault:"~/myplugin-data"prompt: Plugin data directory path
```
...
See [Skill Settings](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/configuration#skill-settings) and [Creating Skills — Config Settings](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/creating-skills#config-settings-configyaml) for details.
## Skill Directory Structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skill-directory-structure "Skill Directory Structure的直接链接")
...
## External Skill Directories[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#external-skill-directories "External Skill Directories的直接链接")
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#how-it-works "How it works的直接链接")
...
### Example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#example "Example的直接链接")

```
~/.hermes/skills/               # Local (primary, read-write)├── devops/deploy-k8s/│   └── SKILL.md└── mlops/axolotl/    └── SKILL.md~/.agents/skills/               # External (read-only, shared)├── my-custom-workflow/│   └── SKILL.md└── team-conventions/    └── SKILL.md
```
...
## Agent-Managed Skills (skill_manage tool)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#agent-managed-skills-skill_manage-tool "Agent-Managed Skills \(skill_manage tool\)的直接链接")
The agent can create, update, and delete its own skills via the `skill_manage` tool. This is the agent's **procedural memory** — when it figures out a non-trivial workflow, it saves the approach as a skill for future reuse.
### When the Agent Creates Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#when-the-agent-creates-skills "When the Agent Creates Skills的直接链接")
...
### Actions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#actions "Actions的直接链接")  
...
## Skills Hub[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skills-hub "Skills Hub的直接链接")
Browse, search, install, and manage skills from online registries, `skills.sh`, direct well-known skill endpoints, and official optional skills.
### Common commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#common-commands "Common commands的直接链接")
...
### Supported hub sources[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#supported-hub-sources "Supported hub sources的直接链接")  
...
### Integrated hubs and registries[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#integrated-hubs-and-registries "Integrated hubs and registries的直接链接")
Hermes currently integrates with these skills ecosystems and discovery sources:
#### 1. Official optional skills (`official`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#1-official-optional-skills-official "1-official-optional-skills-official的直接链接")
These are maintained in the Hermes repository itself and install with builtin trust.
  * Catalog: [Official Optional Skills Catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/optional-skills-catalog)
...
#### 2. skills.sh (`skills-sh`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#2-skillssh-skills-sh "2-skillssh-skills-sh的直接链接")
...
#### 3. Well-known skill endpoints (`well-known`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#3-well-known-skill-endpoints-well-known "3-well-known-skill-endpoints-well-known的直接链接")
...
#### 4. Direct GitHub skills (`github`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#4-direct-github-skills-github "4-direct-github-skills-github的直接链接")
...
#### 5. ClawHub (`clawhub`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#5-clawhub-clawhub "5-clawhub-clawhub的直接链接")
A third-party skills marketplace integrated as a community source.
  * Site: [clawhub.ai](https://clawhub.ai/)
  * Hermes source id: `clawhub`


#### 6. Claude marketplace-style repos (`claude-marketplace`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#6-claude-marketplace-style-repos-claude-marketplace "6-claude-marketplace-style-repos-claude-marketplace的直接链接")
...
#### 7. LobeHub (`lobehub`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#7-lobehub-lobehub "7-lobehub-lobehub的直接链接")
...
#### 8. Direct URL (`url`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#8-direct-url-url "8-direct-url-url的直接链接")
...
### Security scanning and `--force`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#security-scanning-and---force "security-scanning-and---force的直接链接")
...
### Trust levels[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#trust-levels "Trust levels的直接链接")  
| Level  | Source  | Policy  |  
| --- | --- | --- |  
...
### Update lifecycle[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#update-lifecycle "Update lifecycle的直接链接")
...
### Publishing a custom skill tap[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#publishing-a-custom-skill-tap "Publishing a custom skill tap的直接链接")
...
#### Repo layout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#repo-layout "Repo layout的直接链接")
...
Rules:
  ...
  * Each skill directory must contain a `SKILL.md` with standard [SKILL.md frontmatter](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skillmd-format) (`name`, `description`, plus optional `metadata.hermes.tags`, `version`, `author`, `platforms`, `metadata.hermes.config`).
...
#### Minimal tap example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#minimal-tap-example "Minimal tap example的直接链接")
...
#### Non-default paths[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#non-default-paths "Non-default paths的直接链接")
...
#### Installing individual skills directly (without adding a tap)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#installing-individual-skills-directly-without-adding-a-tap "Installing individual skills directly \(without adding a tap\)的直接链接")
...
#### Trust levels for taps[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#trust-levels-for-taps "Trust levels for taps的直接链接")
...
#### Tap management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#tap-management "Tap management的直接链接")
...
## Bundled skill updates (`hermes skills reset`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#bundled-skill-updates-hermes-skills-reset "bundled-skill-updates-hermes-skills-reset的直接链接")
...
### Slash commands (inside chat)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#slash-commands-inside-chat "Slash commands \(inside chat\)的直接链接")
...
Official optional skills still use identifiers like `official/security/1password` and `official/migration/openclaw-migration`.
  * [Using Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#using-skills)
  * [Progressive Disclosure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#progressive-disclosure)
  * [SKILL.md Format](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skillmd-format)
    * [Platform-Specific Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#platform-specific-skills)
    * [Conditional Activation (Fallback Skills)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#conditional-activation-fallback-skills)
  * [Secure Setup on Load](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#secure-setup-on-load)
    * [Skill Config Settings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skill-config-settings)
  * [Skill Directory Structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skill-directory-structure)
  * [External Skill Directories](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#external-skill-directories)
    * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#how-it-works)
  * [Agent-Managed Skills (skill_manage tool)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#agent-managed-skills-skill_manage-tool)
    * [When the Agent Creates Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#when-the-agent-creates-skills)
  * [Skills Hub](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#skills-hub)
    * [Common commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#common-commands)
    * [Supported hub sources](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#supported-hub-sources)
    * [Integrated hubs and registries](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#integrated-hubs-and-registries)
    * [Security scanning and `--force`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#security-scanning-and---force)
    * [Trust levels](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#trust-levels)
    * [Update lifecycle](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#update-lifecycle)
    * [Publishing a custom skill tap](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#publishing-a-custom-skill-tap)
  * [Bundled skill updates (`hermes skills reset`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#bundled-skill-updates-hermes-skills-reset)
    * [Slash commands (inside chat)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills#slash-commands-inside-chat)

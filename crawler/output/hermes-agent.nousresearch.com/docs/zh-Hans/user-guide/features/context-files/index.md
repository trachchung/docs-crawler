<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files -->
...
## Supported Context Files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#supported-context-files "Supported Context Files的直接链接")  
...
## AGENTS.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#agentsmd "AGENTS.md的直接链接")
...
### Progressive Subdirectory Discovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#progressive-subdirectory-discovery "Progressive Subdirectory Discovery的直接链接")
...
Subdirectory context files go through the same [security scan](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#security-prompt-injection-protection) as startup context files. Malicious files are blocked.
### Example AGENTS.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#example-agentsmd "Example AGENTS.md的直接链接")
...
## SOUL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#soulmd "SOUL.md的直接链接")
`SOUL.md` controls the agent's personality, tone, and communication style. See the [Personality](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/personality) page for full details.
**Location:**
  * `~/.hermes/SOUL.md`
...
## .cursorrules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#cursorrules ".cursorrules的直接链接")
...
## How Context Files Are Loaded[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#how-context-files-are-loaded "How Context Files Are Loaded的直接链接")
### At startup (system prompt)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#at-startup-system-prompt "At startup \(system prompt\)的直接链接")
...
### During the session (progressive discovery)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#during-the-session-progressive-discovery "During the session \(progressive discovery\)的直接链接")
...
## Security: Prompt Injection Protection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#security-prompt-injection-protection "Security: Prompt Injection Protection的直接链接")
...
## Size Limits[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#size-limits "Size Limits的直接链接")  
| Limit  | Value  |  
| --- | --- |  
...
## Tips for Effective Context Files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#tips-for-effective-context-files "Tips for Effective Context Files的直接链接")
...
### Per-Subdirectory Context[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#per-subdirectory-context "Per-Subdirectory Context的直接链接")
...
```
  ...
  * [Supported Context Files](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#supported-context-files)
  * [AGENTS.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#agentsmd)
    * [Progressive Subdirectory Discovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#progressive-subdirectory-discovery)
    * [Example AGENTS.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#example-agentsmd)
  * [.cursorrules](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#cursorrules)
  * [How Context Files Are Loaded](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#how-context-files-are-loaded)
    * [At startup (system prompt)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#at-startup-system-prompt)
    * [During the session (progressive discovery)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#during-the-session-progressive-discovery)
  * [Security: Prompt Injection Protection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#security-prompt-injection-protection)
  * [Size Limits](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#size-limits)
  * [Tips for Effective Context Files](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#tips-for-effective-context-files)
    * [Per-Subdirectory Context](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/context-files#per-subdirectory-context)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp -->
...
## When LSP runs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#when-lsp-runs "When LSP runs的直接链接")
...
## Supported languages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#supported-languages "Supported languages的直接链接")  
...
## CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#cli "CLI的直接链接")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#configuration "Configuration的直接链接")
...
### Per-server keys[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#per-server-keys "Per-server keys的直接链接")
...
## Installation locations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#installation-locations "Installation locations的直接链接")
...
## Performance characteristics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#performance-characteristics "Performance characteristics的直接链接")
...
## Disabling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#disabling "Disabling的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#troubleshooting "Troubleshooting的直接链接")
...
By design, LSP only runs inside a git repository. If the project isn't yet initialized, run `git init` to enable LSP diagnostics. Otherwise the in-process syntax-only fallback applies.
  * [When LSP runs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#when-lsp-runs)
  * [Supported languages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#supported-languages)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#configuration)
    * [Per-server keys](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#per-server-keys)
  * [Installation locations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#installation-locations)
  * [Performance characteristics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#performance-characteristics)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/lsp#troubleshooting)

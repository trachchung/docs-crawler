<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins -->
...
See the [Plugins](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/plugins) page for the general plugin system, and [Build a Hermes Plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/build-a-hermes-plugin) to write your own.
## How discovery works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#how-discovery-works "How discovery works的直接链接")
...
## Bundled plugins are opt-in[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#bundled-plugins-are-opt-in "Bundled plugins are opt-in的直接链接")
...
## Currently shipped[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#currently-shipped "Currently shipped的直接链接")
...
| `kanban/dashboard`  | dashboard tab  | Kanban board UI for the multi-agent dispatcher — tasks, comments, fan-out, board switching. See [Kanban Multi-Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban).  |  
Memory providers (`plugins/memory/*`) and context engines (`plugins/context_engine/*`) are listed separately on [Memory Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers) — they're managed through `hermes memory` and `hermes plugins` respectively. The full per-plugin detail for the two long-running hooks-based plugins follows.
### disk-cleanup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#disk-cleanup "disk-cleanup的直接链接")
...
### observability/langfuse[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#observabilitylangfuse "observability/langfuse的直接链接")
...
### google_meet[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#google_meet "google_meet的直接链接")
...
### hermes-achievements[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#hermes-achievements "hermes-achievements的直接链接")
...
## Adding a bundled plugin[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#adding-a-bundled-plugin "Adding a bundled plugin的直接链接")
Bundled plugins are written exactly like any other Hermes plugin — see [Build a Hermes Plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/build-a-hermes-plugin). The only differences are:
...
Counter-examples — things that should stay as user-installable plugins, not bundled: third-party integrations with API keys, niche workflows, large dependency trees, anything that would meaningfully change agent behaviour by default.
  * [How discovery works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#how-discovery-works)
  * [Bundled plugins are opt-in](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#bundled-plugins-are-opt-in)
  * [Currently shipped](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#currently-shipped)
    * [disk-cleanup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#disk-cleanup)
    * [observability/langfuse](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#observabilitylangfuse)
    * [google_meet](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#google_meet)
    * [hermes-achievements](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#hermes-achievements)
  * [Adding a bundled plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/built-in-plugins#adding-a-bundled-plugin)

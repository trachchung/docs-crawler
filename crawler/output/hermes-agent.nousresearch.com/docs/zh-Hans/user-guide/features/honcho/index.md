<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho -->
...
Honcho is integrated into the [Memory Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers) system. All features below are available through the unified memory provider interface.
## What Honcho Adds[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#what-honcho-adds "What Honcho Adds的直接链接")  
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#setup "Setup的直接链接")
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#architecture "Architecture的直接链接")
### Two-Layer Context Injection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#two-layer-context-injection "Two-Layer Context Injection的直接链接")
...
### Cold/Warm Prompt Selection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#coldwarm-prompt-selection "Cold/Warm Prompt Selection的直接链接")
...
### Three Orthogonal Config Knobs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#three-orthogonal-config-knobs "Three Orthogonal Config Knobs的直接链接")
...
### Dialectic Depth (Multi-Pass)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#dialectic-depth-multi-pass "Dialectic Depth \(Multi-Pass\)的直接链接")
...
### Session-Start Prewarm[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#session-start-prewarm "Session-Start Prewarm的直接链接")
...
### Query-Adaptive Reasoning Level[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#query-adaptive-reasoning-level "Query-Adaptive Reasoning Level的直接链接")
...
## Configuration Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#configuration-options "Configuration Options的直接链接")
...
### Full Config Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#full-config-reference "Full Config Reference的直接链接")  
...
## Observation (Directional vs. Unified)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#observation-directional-vs-unified "Observation \(Directional vs. Unified\)的直接链接")
...
## Tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#tools "Tools的直接链接")
...
## CLI Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#cli-commands "CLI Commands的直接链接")
...
## Migrating from `hermes honcho`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#migrating-from-hermes-honcho "migrating-from-hermes-honcho的直接链接")
...
## Full Documentation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#full-documentation "Full Documentation的直接链接")
See [Memory Providers — Honcho](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers#honcho) for the complete reference.
  * [What Honcho Adds](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#what-honcho-adds)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#architecture)
    * [Two-Layer Context Injection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#two-layer-context-injection)
    * [Cold/Warm Prompt Selection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#coldwarm-prompt-selection)
    * [Three Orthogonal Config Knobs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#three-orthogonal-config-knobs)
    * [Dialectic Depth (Multi-Pass)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#dialectic-depth-multi-pass)
    * [Session-Start Prewarm](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#session-start-prewarm)
    * [Query-Adaptive Reasoning Level](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#query-adaptive-reasoning-level)
  * [Configuration Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#configuration-options)
    * [Full Config Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#full-config-reference)
  * [Observation (Directional vs. Unified)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#observation-directional-vs-unified)
  * [CLI Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#cli-commands)
  * [Migrating from `hermes honcho`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#migrating-from-hermes-honcho)
  * [Full Documentation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/honcho#full-documentation)

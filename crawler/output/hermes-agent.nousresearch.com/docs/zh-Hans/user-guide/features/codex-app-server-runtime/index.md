<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime -->
...
## Why[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#why "Why的直接链接")
...
## What tools the model actually has[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#what-tools-the-model-actually-has "What tools the model actually has的直接链接")
...
### 1. Codex's built-in toolset (always on)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#1-codexs-built-in-toolset-always-on "1. Codex's built-in toolset \(always on\)的直接链接")
...
### 2. Native Codex plugins (auto-migrated from your `codex plugin` install)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#2-native-codex-plugins-auto-migrated-from-your-codex-plugin-install "2-native-codex-plugins-auto-migrated-from-your-codex-plugin-install的直接链接")
...
### 3. Hermes tool callback (MCP server, registered in `~/.codex/config.toml`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#3-hermes-tool-callback-mcp-server-registered-in-codexconfigtoml "3-hermes-tool-callback-mcp-server-registered-in-codexconfigtoml的直接链接")
...
### What's NOT available on this runtime[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#whats-not-available-on-this-runtime "What's NOT available on this runtime的直接链接")
...
## Workflow features (`/goal`, kanban, cron)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#workflow-features-goal-kanban-cron "workflow-features-goal-kanban-cron的直接链接")
###  `/goal` (the Ralph loop)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#goal-the-ralph-loop "goal-the-ralph-loop的直接链接")
...
### Kanban (multi-agent worktree dispatch)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#kanban-multi-agent-worktree-dispatch "Kanban \(multi-agent worktree dispatch\)的直接链接")
...
### Cron jobs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#cron-jobs "Cron jobs的直接链接")
...
## Trade-offs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#trade-offs "Trade-offs的直接链接")  
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#prerequisites "Prerequisites的直接链接")
...
## Enabling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#enabling "Enabling的直接链接")
In a Hermes session:
...
## Self-improvement loop (memory + skill nudges)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#self-improvement-loop-memory--skill-nudges "Self-improvement loop \(memory + skill nudges\)的直接链接")
...
## How approvals work[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#how-approvals-work "How approvals work的直接链接")
...
## Permission profiles[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#permission-profiles "Permission profiles的直接链接")
...
## Auxiliary tasks and ChatGPT subscription token cost[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#auxiliary-tasks-and-chatgpt-subscription-token-cost "Auxiliary tasks and ChatGPT subscription token cost的直接链接")
...
```
auxiliary:title_generation:provider: openroutermodel: google/gemini-3-flash-previewcontext_compression:provider: openroutermodel: google/gemini-3-flash-previewvision_detect:provider: openroutermodel: google/gemini-3-flash-previewsession_search:provider: openroutermodel: google/gemini-3-flash-previewgoal_judge:provider: openroutermodel: google/gemini-3-flash-preview
```
...
## Editing `~/.codex/config.toml` safely[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#editing-codexconfigtoml-safely "editing-codexconfigtoml-safely的直接链接")
...
## Multi-profile / multi-tenant setups[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#multi-profile--multi-tenant-setups "Multi-profile / multi-tenant setups的直接链接")
...
## HOME environment variable passthrough[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#home-environment-variable-passthrough "HOME environment variable passthrough的直接链接")
...
## MCP server migration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#mcp-server-migration "MCP server migration的直接链接")
...
## Native Codex plugin migration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#native-codex-plugin-migration "Native Codex plugin migration的直接链接")
...
## Hermes tool callback (the new MCP server)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#hermes-tool-callback-the-new-mcp-server "Hermes tool callback \(the new MCP server\)的直接链接")
...
## Disabling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#disabling "Disabling的直接链接")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#limitations "Limitations的直接链接")
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#architecture "Architecture的直接链接")
...
For implementation details, see [PR #24182](https://github.com/NousResearch/hermes-agent/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
  * [What tools the model actually has](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#what-tools-the-model-actually-has)
    * [1. Codex's built-in toolset (always on)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#1-codexs-built-in-toolset-always-on)
    * [2. Native Codex plugins (auto-migrated from your `codex plugin` install)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#2-native-codex-plugins-auto-migrated-from-your-codex-plugin-install)
    * [3. Hermes tool callback (MCP server, registered in `~/.codex/config.toml`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#3-hermes-tool-callback-mcp-server-registered-in-codexconfigtoml)
    * [What's NOT available on this runtime](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#whats-not-available-on-this-runtime)
  * [Workflow features (`/goal`, kanban, cron)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#workflow-features-goal-kanban-cron)
    * [`/goal` (the Ralph loop)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#goal-the-ralph-loop)
    * [Kanban (multi-agent worktree dispatch)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#kanban-multi-agent-worktree-dispatch)
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#prerequisites)
  * [Self-improvement loop (memory + skill nudges)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#self-improvement-loop-memory--skill-nudges)
  * [How approvals work](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#how-approvals-work)
  * [Permission profiles](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#permission-profiles)
  * [Auxiliary tasks and ChatGPT subscription token cost](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#auxiliary-tasks-and-chatgpt-subscription-token-cost)
  * [Editing `~/.codex/config.toml` safely](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#editing-codexconfigtoml-safely)
  * [Multi-profile / multi-tenant setups](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#multi-profile--multi-tenant-setups)
  * [HOME environment variable passthrough](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#home-environment-variable-passthrough)
  * [MCP server migration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#mcp-server-migration)
  * [Native Codex plugin migration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#native-codex-plugin-migration)
  * [Hermes tool callback (the new MCP server)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#hermes-tool-callback-the-new-mcp-server)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#limitations)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime#architecture)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban -->

本页总览
> **Want a walkthrough?** Read the [Kanban tutorial](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban-tutorial) — four user stories (solo dev, fleet farming, role pipeline with retry, circuit breaker) with dashboard screenshots of each. This page is the reference; the tutorial is the narrative.
...
### Two surfaces: the model talks through tools, you talk through the CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#two-surfaces-the-model-talks-through-tools-you-talk-through-the-cli "Two surfaces: the model talks through tools, you talk through the CLI的直接链接")
The board has two front doors, both backed by the same `~/.hermes/kanban.db`:
  * **Agents drive the board through a dedicated`kanban_*` toolset** — `kanban_show`, `kanban_list`, `kanban_complete`, `kanban_block`, `kanban_heartbeat`, `kanban_comment`, `kanban_create`, `kanban_link`, `kanban_unblock`. The dispatcher spawns each worker with these tools already in its schema; orchestrator profiles can also enable the `kanban` toolset explicitly. The model reads and routes tasks by calling tools directly, _not_ by shelling out to `hermes kanban`. See [How workers interact with the board](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#how-workers-interact-with-the-board) below.
...
## Kanban vs. `delegate_task`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#kanban-vs-delegate_task "kanban-vs-delegate_task的直接链接")
...
## Boards (multi-project)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#boards-multi-project "Boards \(multi-project\)的直接链接")
...
### Managing boards from the CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#managing-boards-from-the-cli "Managing boards from the CLI的直接链接")
...
### Managing boards from the dashboard[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#managing-boards-from-the-dashboard "Managing boards from the dashboard的直接链接")
...
### Gateway-embedded dispatcher (default)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#gateway-embedded-dispatcher-default "Gateway-embedded dispatcher \(default\)的直接链接")
...
```
# config.yamlkanban:dispatch_in_gateway:true# defaultdispatch_interval_seconds:60# default
```
...
### Idempotent create (for automation / webhooks)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#idempotent-create-for-automation--webhooks "Idempotent create \(for automation / webhooks\)的直接链接")
...
### Bulk CLI verbs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#bulk-cli-verbs "Bulk CLI verbs的直接链接")
...
## How workers interact with the board[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#how-workers-interact-with-the-board "How workers interact with the board的直接链接")
...
### Why tools instead of shelling to `hermes kanban`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#why-tools-instead-of-shelling-to-hermes-kanban "why-tools-instead-of-shelling-to-hermes-kanban的直接链接")
Three reasons:
...
### Recommended handoff evidence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#recommended-handoff-evidence "Recommended handoff evidence的直接链接")
...
### The worker skill[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#the-worker-skill "The worker skill的直接链接")
...
### Pinning extra skills to a specific task[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#pinning-extra-skills-to-a-specific-task "Pinning extra skills to a specific task的直接链接")
...
### The orchestrator skill[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#the-orchestrator-skill "The orchestrator skill的直接链接")
...
### What the plugin gives you[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#what-the-plugin-gives-you "What the plugin gives you的直接链接")
...
### Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#architecture "Architecture的直接链接")
...
### REST surface[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#rest-surface "REST surface的直接链接")
...
### Dashboard config[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#dashboard-config "Dashboard config的直接链接")
...
```
dashboard:kanban:default_tenant: acme              # preselects the tenant filterlane_by_profile:true# default for the "lanes by profile" toggleinclude_archived_by_default:falserender_markdown:true# set false for plain <pre> rendering
```

Each key is optional and falls back to the shown default.
### Security model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#security-model "Security model的直接链接")
The dashboard's HTTP auth middleware [explicitly skips `/api/plugins/`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/extending-the-dashboard#backend-api-routes) — plugin routes are unauthenticated by design because the dashboard binds to localhost by default. That means the kanban REST surface is reachable from any process on the host.
...
### Live updates[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#live-updates "Live updates的直接链接")
...
### Extending it[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#extending-it "Extending it的直接链接")
The plugin uses the standard Hermes dashboard plugin contract — see [Extending the Dashboard](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/extending-the-dashboard) for the full manifest reference, shell slots, page-scoped slots, and the Plugin SDK. Extra columns, custom card chrome, tenant-filtered layouts, or full `tab.override` replacements are all expressible without forking this plugin.
...
### Scope boundary[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#scope-boundary "Scope boundary的直接链接")
...
## CLI command reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#cli-command-reference "CLI command reference的直接链接")
This is the surface **you** (or scripts, cron, the dashboard) use to drive the board. Workers running inside the dispatcher use the `kanban_*` [tool surface](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#how-workers-interact-with-the-board) for the same operations — the CLI here and the tools there both route through `kanban_db`, so the two surfaces agree by construction.
...
All commands are also available as a slash command in the interactive CLI and in the messaging gateway (see [`/kanban` slash command](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#kanban-slash-command) below).
##  `/kanban` slash command[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#kanban-slash-command "kanban-slash-command的直接链接")
...
### Mid-run usage: `/kanban` bypasses the running-agent guard[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#mid-run-usage-kanban-bypasses-the-running-agent-guard "mid-run-usage-kanban-bypasses-the-running-agent-guard的直接链接")
...
### Auto-subscribe on `/kanban create` (gateway only)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#auto-subscribe-on-kanban-create-gateway-only "auto-subscribe-on-kanban-create-gateway-only的直接链接")
...
### Output truncation in messaging[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#output-truncation-in-messaging "Output truncation in messaging的直接链接")
...
### Autocomplete[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#autocomplete "Autocomplete的直接链接")
...
## Collaboration patterns[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#collaboration-patterns "Collaboration patterns的直接链接")
...
## Multi-tenant usage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#multi-tenant-usage "Multi-tenant usage的直接链接")
...
## Gateway notifications[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#gateway-notifications "Gateway notifications的直接链接")
...
## Runs — one row per attempt[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#runs--one-row-per-attempt "Runs — one row per attempt的直接链接")
...
### Forward compatibility[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#forward-compatibility "Forward compatibility的直接链接")
...
## Event reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#event-reference "Event reference的直接链接")
...
## Out of scope[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#out-of-scope "Out of scope的直接链接")
...
## Design spec[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#design-spec "Design spec的直接链接")
The complete design — architecture, concurrency correctness, comparison with other systems, implementation plan, risks, open questions — lives in `docs/hermes-kanban-v1-spec.pdf`. Read that before filing any behavior-change PR.
  * [Two surfaces: the model talks through tools, you talk through the CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#two-surfaces-the-model-talks-through-tools-you-talk-through-the-cli)
  * [Kanban vs. `delegate_task`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#kanban-vs-delegate_task)
  * [Core concepts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#core-concepts)
  * [Boards (multi-project)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#boards-multi-project)
    * [Managing boards from the CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#managing-boards-from-the-cli)
    * [Managing boards from the dashboard](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#managing-boards-from-the-dashboard)
  * [Quick start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#quick-start)
    * [Gateway-embedded dispatcher (default)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#gateway-embedded-dispatcher-default)
    * [Idempotent create (for automation / webhooks)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#idempotent-create-for-automation--webhooks)
    * [Bulk CLI verbs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#bulk-cli-verbs)
  * [How workers interact with the board](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#how-workers-interact-with-the-board)
    * [Why tools instead of shelling to `hermes kanban`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#why-tools-instead-of-shelling-to-hermes-kanban)
    * [Recommended handoff evidence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#recommended-handoff-evidence)
    * [The worker skill](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#the-worker-skill)
    * [Pinning extra skills to a specific task](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#pinning-extra-skills-to-a-specific-task)
    * [The orchestrator skill](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#the-orchestrator-skill)
  * [Dashboard (GUI)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#dashboard-gui)
    * [What the plugin gives you](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#what-the-plugin-gives-you)
    * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#architecture)
    * [REST surface](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#rest-surface)
    * [Dashboard config](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#dashboard-config)
    * [Security model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#security-model)
    * [Live updates](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#live-updates)
    * [Extending it](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#extending-it)
    * [Scope boundary](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#scope-boundary)
  * [CLI command reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#cli-command-reference)
  * [`/kanban` slash command](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#kanban-slash-command)
    * [Mid-run usage: `/kanban` bypasses the running-agent guard](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#mid-run-usage-kanban-bypasses-the-running-agent-guard)
    * [Auto-subscribe on `/kanban create` (gateway only)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#auto-subscribe-on-kanban-create-gateway-only)
    * [Output truncation in messaging](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#output-truncation-in-messaging)
    * [Autocomplete](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#autocomplete)
  * [Collaboration patterns](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#collaboration-patterns)
  * [Multi-tenant usage](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#multi-tenant-usage)
  * [Gateway notifications](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#gateway-notifications)
  * [Runs — one row per attempt](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#runs--one-row-per-attempt)
    * [Forward compatibility](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#forward-compatibility)
  * [Event reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#event-reference)
  * [Out of scope](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#out-of-scope)
  * [Design spec](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/kanban#design-spec)

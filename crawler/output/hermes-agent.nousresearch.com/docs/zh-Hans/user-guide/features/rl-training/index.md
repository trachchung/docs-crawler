<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training -->
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#overview "Overview的直接链接")
The RL training system consists of three components:
  1. — A trajectory API server that coordinates environment interactions, manages rollout groups, and computes advantages
  2. — A training service that handles model weights, LoRA training, sampling/inference, and optimizer steps
...
## Requirements[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#requirements "Requirements的直接链接")
...
```
# Set up API keyshermes config set TINKER_API_KEY your-tinker-keyhermes config set WANDB_API_KEY your-wandb-key
```

When both keys are present and Python >= 3.11 is available, the `rl` toolset is automatically enabled.
## Available Tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#available-tools "Available Tools的直接链接")  
| Tool  | Description  |  
| --- | --- |  
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#workflow "Workflow的直接链接")
### 1. Discover Environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#1-discover-environments "1. Discover Environments的直接链接")
...
### 2. Select and Configure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#2-select-and-configure "2. Select and Configure的直接链接")
...
### 3. Start Training[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#3-start-training "3. Start Training的直接链接")
...
### 4. Monitor Progress[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#4-monitor-progress "4. Monitor Progress的直接链接")
...
### 5. Stop or Get Results[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#5-stop-or-get-results "5. Stop or Get Results的直接链接")

```
Stop the training run# orGet the final results for run abc12345
```
...
## Inference Testing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#inference-testing "Inference Testing的直接链接")
...
## Tinker API Integration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#tinker-api-integration "Tinker API Integration的直接链接")
...
## Architecture Diagram[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#architecture-diagram "Architecture Diagram的直接链接")
batches: tokens, scores, logprobs
serves inference
Atropos APIrun-apiport 8000
EnvironmentBaseEnv implementation
OpenAI / sglanginference APIport 8001
Tinker TrainerLoRA training + FastAPI
## Creating Custom Environments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#creating-custom-environments "Creating Custom Environments的直接链接")
...
## WandB Metrics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#wandb-metrics "WandB Metrics的直接链接")
...
## Log Files[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#log-files "Log Files的直接链接")
Each training run generates log files in `~/.hermes/logs/rl_training/`:

```
logs/├── api_{run_id}.log        # Atropos API server logs├── trainer_{run_id}.log    # Tinker trainer logs├── env_{run_id}.log        # Environment process logs└── inference_tests/        # Inference test results    ├── test_{env}_{model}.jsonl    └── test_{env}_{model}.log
```

These are invaluable for debugging when training fails or produces unexpected results.
  * [Requirements](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#requirements)
  * [Available Tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#available-tools)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#workflow)
    * [1. Discover Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#1-discover-environments)
    * [2. Select and Configure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#2-select-and-configure)
    * [3. Start Training](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#3-start-training)
    * [4. Monitor Progress](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#4-monitor-progress)
    * [5. Stop or Get Results](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#5-stop-or-get-results)
  * [Inference Testing](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#inference-testing)
  * [Tinker API Integration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#tinker-api-integration)
  * [Architecture Diagram](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#architecture-diagram)
  * [Creating Custom Environments](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#creating-custom-environments)
  * [WandB Metrics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/rl-training#wandb-metrics)

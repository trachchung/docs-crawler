<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory -->
...
## How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#how-it-works "How It Works的直接链接")
...
## How Memory Appears in the System Prompt[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#how-memory-appears-in-the-system-prompt "How Memory Appears in the System Prompt的直接链接")
At the start of every session, memory entries are loaded from disk and rendered into the system prompt as a frozen block:

```
══════════════════════════════════════════════MEMORY (your personal notes) [67% — 1,474/2,200 chars]══════════════════════════════════════════════User's project is a Rust web service at ~/code/myapi using Axum + SQLxThis machine runs Ubuntu 22.04, has Docker and Podman installedUser prefers concise responses, dislikes verbose explanations
```
...
## Memory Tool Actions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#memory-tool-actions "Memory Tool Actions的直接链接")
...
### Substring Matching[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#substring-matching "Substring Matching的直接链接")
...
## Two Targets Explained[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#two-targets-explained "Two Targets Explained的直接链接")
###  `memory` — Agent's Personal Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#memory--agents-personal-notes "memory--agents-personal-notes的直接链接")
...
###  `user` — User Profile[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#user--user-profile "user--user-profile的直接链接")
...
## What to Save vs Skip[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#what-to-save-vs-skip "What to Save vs Skip的直接链接")
### Save These (Proactively)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#save-these-proactively "Save These \(Proactively\)的直接链接")
...
### Skip These[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#skip-these "Skip These的直接链接")
...
## Capacity Management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#capacity-management "Capacity Management的直接链接")
...
### What Happens When Memory is Full[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#what-happens-when-memory-is-full "What Happens When Memory is Full的直接链接")
...
### Practical Examples of Good Memory Entries[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#practical-examples-of-good-memory-entries "Practical Examples of Good Memory Entries的直接链接")
...
## Duplicate Prevention[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#duplicate-prevention "Duplicate Prevention的直接链接")
...
## Security Scanning[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#security-scanning "Security Scanning的直接链接")
...
## Session Search[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#session-search "Session Search的直接链接")
...
### session_search vs memory[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#session_search-vs-memory "session_search vs memory的直接链接")  
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#configuration "Configuration的直接链接")
...
## External Memory Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#external-memory-providers "External Memory Providers的直接链接")
...
See the [Memory Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory-providers) guide for full details on each provider, setup instructions, and comparison.
  * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#how-it-works)
  * [How Memory Appears in the System Prompt](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#how-memory-appears-in-the-system-prompt)
  * [Memory Tool Actions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#memory-tool-actions)
    * [Substring Matching](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#substring-matching)
  * [Two Targets Explained](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#two-targets-explained)
    * [`memory` — Agent's Personal Notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#memory--agents-personal-notes)
    * [`user` — User Profile](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#user--user-profile)
  * [What to Save vs Skip](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#what-to-save-vs-skip)
    * [Save These (Proactively)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#save-these-proactively)
  * [Capacity Management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#capacity-management)
    * [What Happens When Memory is Full](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#what-happens-when-memory-is-full)
    * [Practical Examples of Good Memory Entries](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#practical-examples-of-good-memory-entries)
  * [Duplicate Prevention](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#duplicate-prevention)
  * [Security Scanning](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#security-scanning)
  * [Session Search](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#session-search)
    * [session_search vs memory](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#session_search-vs-memory)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#configuration)
  * [External Memory Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory#external-memory-providers)

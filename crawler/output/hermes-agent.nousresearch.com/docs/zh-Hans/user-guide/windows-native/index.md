<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native -->

本页总览
Native Windows support is **early beta**. It installs, runs, and passes our Windows-footgun lint, but it hasn't been road-tested at the scale our Linux/macOS/WSL2 paths have. Expect rough edges — especially around subprocess handling, path quirks, and non-ASCII console output. Please [file issues](https://github.com/NousResearch/hermes-agent/issues) with repro steps when you hit something. If you want a battle-tested setup today, use the [Linux/macOS installer under WSL2](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-wsl-quickstart.md) instead.
...
If you just want to install, the one-liner on the [landing page](https://hermes-agent.nousresearch.com/docs/zh-Hans/) or [Installation page](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation#windows-native-powershell--early-beta) is all you need. Come back here when something surprises you.
If you prefer a real POSIX environment (for the dashboard's embedded terminal, `fork` semantics, Linux-style file watchers, etc.), see the **[Windows (WSL2) Guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-wsl-quickstart.md)**. Both coexist cleanly: native data lives under `%LOCALAPPDATA%\hermes`, WSL data lives under `~/.hermes`.
## Quick install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#quick-install "Quick install的直接链接")
...
## What the installer actually does[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#what-the-installer-actually-does "What the installer actually does的直接链接")
...
## Feature matrix[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#feature-matrix "Feature matrix的直接链接")
...
## How Hermes runs shell commands on Windows[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#how-hermes-runs-shell-commands-on-windows "How Hermes runs shell commands on Windows的直接链接")
...
## UTF-8 console on Windows[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#utf-8-console-on-windows "UTF-8 console on Windows的直接链接")
...
## The editor (`Ctrl-X Ctrl-E`, `/edit`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#the-editor-ctrl-x-ctrl-e-edit "the-editor-ctrl-x-ctrl-e-edit的直接链接")
...
##  `Ctrl+Enter` for newline in the CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#ctrlenter-for-newline-in-the-cli "ctrlenter-for-newline-in-the-cli的直接链接")
...
## Running the gateway at Windows login[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#running-the-gateway-at-windows-login "Running the gateway at Windows login的直接链接")
`hermes gateway install` on Windows uses **Scheduled Tasks** with a Startup-folder fallback — no admin required.
### Install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#install "Install的直接链接")
...
### Manage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#manage "Manage的直接链接")
...
### Why not a Windows Service?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#why-not-a-windows-service "Why not a Windows Service?的直接链接")
...
## Data layout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#data-layout "Data layout的直接链接")  
| Path  | Contents  |  
| --- | --- |  
...
## Browser tool[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#browser-tool "Browser tool的直接链接")
...
## Running Hermes on Windows — practical notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#running-hermes-on-windows--practical-notes "Running Hermes on Windows — practical notes的直接链接")
### PATH after install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#path-after-install "PATH after install的直接链接")
...
```
Get-Command hermes        # should print C:\Users\<you>\AppData\Local\hermes\bin\hermes.cmdhermes --version
```

### Environment variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#environment-variables "Environment variables的直接链接")
...
### Windows-specific env vars[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#windows-specific-env-vars "Windows-specific env vars的直接链接")
...
## Uninstall[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#uninstall "Uninstall的直接链接")
From PowerShell:
...
```
hermes uninstallRemove-Item -Recurse -Force "$env:USERPROFILE\.hermes"Remove-Item -Recurse -Force "$env:LOCALAPPDATA\hermes"
```
...
## Process management internals[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#process-management-internals "Process management internals的直接链接")
...
## Common pitfalls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#common-pitfalls "Common pitfalls的直接链接")
...
## Where to go next[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#where-to-go-next "Where to go next的直接链接")
  * **[Installation](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/installation)** — the full install page, including Linux/macOS/WSL2/Termux.
  * **[Windows (WSL2) Guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-wsl-quickstart.md)** — if you want POSIX semantics or the dashboard terminal pane.
  * **[CLI Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/cli-commands)** — every `hermes` subcommand.
  * — common non-Windows-specific questions.
  * **[Messaging Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/)** — running Telegram/Discord/Slack on Windows.


  * [Quick install](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#quick-install)
  * [What the installer actually does](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#what-the-installer-actually-does)
  * [Feature matrix](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#feature-matrix)
  * [How Hermes runs shell commands on Windows](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#how-hermes-runs-shell-commands-on-windows)
  * [UTF-8 console on Windows](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#utf-8-console-on-windows)
  * [The editor (`Ctrl-X Ctrl-E`, `/edit`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#the-editor-ctrl-x-ctrl-e-edit)
  * [`Ctrl+Enter` for newline in the CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#ctrlenter-for-newline-in-the-cli)
  * [Running the gateway at Windows login](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#running-the-gateway-at-windows-login)
    * [Why not a Windows Service?](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#why-not-a-windows-service)
  * [Data layout](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#data-layout)
  * [Browser tool](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#browser-tool)
  * [Running Hermes on Windows — practical notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#running-hermes-on-windows--practical-notes)
    * [PATH after install](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#path-after-install)
    * [Environment variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#environment-variables)
    * [Windows-specific env vars](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#windows-specific-env-vars)
  * [Process management internals](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#process-management-internals)
  * [Common pitfalls](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#common-pitfalls)
  * [Where to go next](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/windows-native#where-to-go-next)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli -->

本页总览
Hermes Agent's CLI is a full terminal user interface (TUI) — not a web UI. It features multiline editing, slash-command autocomplete, conversation history, interrupt-and-redirect, and streaming tool output. Built for people who live in the terminal.
Hermes also ships a modern TUI with modal overlays, mouse selection, and non-blocking input. Launch it with `hermes --tui` — see the [TUI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui) guide.
## Running the CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#running-the-cli "Running the CLI的直接链接")
...
## Interface Layout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#interface-layout "Interface Layout的直接链接")
...
### Status Bar[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#status-bar "Status Bar的直接链接")
...
### Session Resume Display[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#session-resume-display "Session Resume Display的直接链接")
When resuming a previous session (`hermes -c` or `hermes --resume <id>`), a "Previous Conversation" panel appears between the banner and the input prompt, showing a compact recap of the conversation history. See [Sessions — Conversation Recap on Resume](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/sessions#conversation-recap-on-resume) for details and configuration.
## Keybindings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#keybindings "Keybindings的直接链接")  
| Key  | Action  |  
| --- | --- |  
| `Enter`  | Send message  |  
...
## Slash Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#slash-commands "Slash Commands的直接链接")
...
For the full built-in CLI and messaging lists, see [Slash Commands Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands).
For setup, providers, silence tuning, and messaging/Discord voice usage, see [Voice Mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/voice-mode).
Commands are case-insensitive — `/HELP` works the same as `/help`. Installed skills also become slash commands automatically.
## Quick Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#quick-commands "Quick Commands的直接链接")
...
Then type `/status`, `/gpu`, or `/restart` in any chat. See the [Configuration guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/configuration#quick-commands) for more examples.
## Preloading Skills at Launch[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#preloading-skills-at-launch "Preloading Skills at Launch的直接链接")
...
## Skill Slash Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#skill-slash-commands "Skill Slash Commands的直接链接")
...
## Personalities[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#personalities "Personalities的直接链接")
...
## Multi-line Input[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#multi-line-input "Multi-line Input的直接链接")
...
### Shift+Enter compatibility[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#shiftenter-compatibility "Shift+Enter compatibility的直接链接")
...
## Interrupting the Agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#interrupting-the-agent "Interrupting the Agent的直接链接")
...
### Busy Input Mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#busy-input-mode "Busy Input Mode的直接链接")
...
### Suspending to Background[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#suspending-to-background "Suspending to Background的直接链接")
...
## Tool Progress Display[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#tool-progress-display "Tool Progress Display的直接链接")
...
Cycle through display modes with `/verbose`: `off → new → all → verbose`. This command can also be enabled for messaging platforms — see [configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/configuration#display-settings).
### Tool Preview Length[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#tool-preview-length "Tool Preview Length的直接链接")
...
## Session Management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#session-management "Session Management的直接链接")
### Resuming Sessions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#resuming-sessions "Resuming Sessions的直接链接")
...
### Session Storage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#session-storage "Session Storage的直接链接")
...
### Context Compression[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#context-compression "Context Compression的直接链接")
Long conversations are automatically summarized when approaching context limits:

```
# In ~/.hermes/config.yamlcompression:enabled:truethreshold:0.50# Compress at 50% of context limit by default# Summarization model configured under auxiliary:auxiliary:compression:model:""# Leave empty to use the main chat model (default). Or pin a cheap fast model, e.g. "google/gemini-3-flash-preview".
```

When compression triggers, middle turns are summarized while the first 3 and last 20 turns are always preserved.
## Background Sessions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#background-sessions "Background Sessions的直接链接")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#how-it-works "How It Works的直接链接")
...
### Results[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#results "Results的直接链接")
...
### Use Cases[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#use-cases "Use Cases的直接链接")
...
## Quiet Mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#quiet-mode "Quiet Mode的直接链接")
...
```
  ...
  * [Running the CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#running-the-cli)
  * [Interface Layout](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#interface-layout)
    * [Session Resume Display](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#session-resume-display)
  * [Keybindings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#keybindings)
  * [Slash Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#slash-commands)
  * [Quick Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#quick-commands)
  * [Preloading Skills at Launch](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#preloading-skills-at-launch)
  * [Skill Slash Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#skill-slash-commands)
  * [Personalities](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#personalities)
  * [Multi-line Input](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#multi-line-input)
    * [Shift+Enter compatibility](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#shiftenter-compatibility)
  * [Interrupting the Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#interrupting-the-agent)
    * [Busy Input Mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#busy-input-mode)
    * [Suspending to Background](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#suspending-to-background)
  * [Tool Progress Display](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#tool-progress-display)
    * [Tool Preview Length](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#tool-preview-length)
  * [Session Management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#session-management)
    * [Resuming Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#resuming-sessions)
    * [Session Storage](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#session-storage)
    * [Context Compression](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#context-compression)
  * [Background Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#background-sessions)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#how-it-works)

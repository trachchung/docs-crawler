<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas -->

本页总览
Canvas LMS integration — fetch enrolled courses and assignments using API token authentication.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#skill-metadata "Skill metadata的直接链接")  
...
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## Scripts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#scripts "Scripts的直接链接")
  * `scripts/canvas_api.py` — Python CLI for Canvas API calls


## Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#setup "Setup的直接链接")
...
## Usage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#usage "Usage的直接链接")
...
## Output Format[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#output-format "Output Format的直接链接")
...
## API Reference (curl)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#api-reference-curl "API Reference \(curl\)的直接链接")
...
## Rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#rules "Rules的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Fix  |  
| --- | --- |  
...
| Timeout errors  | Check network connectivity to your Canvas instance  |  
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#reference-full-skillmd)
  * [Output Format](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#output-format)
  * [API Reference (curl)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#api-reference-curl)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/productivity/productivity-canvas#troubleshooting)

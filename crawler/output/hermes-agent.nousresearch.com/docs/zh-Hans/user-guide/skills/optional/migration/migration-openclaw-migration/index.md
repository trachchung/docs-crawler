<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration -->
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## CLI Command[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#cli-command "CLI Command的直接链接")
For a quick, non-interactive migration, use the built-in CLI command:

```
hermes claw migrate              # Full interactive migrationhermes claw migrate --dry-run    # Preview what would be migratedhermes claw migrate --preset user-data   # Migrate without secretshermes claw migrate --overwrite# Overwrite existing conflictshermes claw migrate --source /custom/path/.openclaw  # Custom source
```
...
## What this skill does[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#what-this-skill-does "What this skill does的直接链接")
...
## Path resolution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#path-resolution "Path resolution的直接链接")
...
## Default workflow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#default-workflow "Default workflow的直接链接")
...
## User interaction protocol[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#user-interaction-protocol "User interaction protocol的直接链接")
...
## Decision-to-command mapping[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#decision-to-command-mapping "Decision-to-command mapping的直接链接")
...
## Post-run reporting rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#post-run-reporting-rules "Post-run reporting rules的直接链接")
...
## Migration presets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#migration-presets "Migration presets的直接链接")
...
## Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#commands "Commands的直接链接")
...
## Important rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#important-rules "Important rules的直接链接")
...
## Expected result[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#expected-result "Expected result的直接链接")
After a successful run, the user should have:
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#reference-full-skillmd)
  * [CLI Command](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#cli-command)
  * [What this skill does](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#what-this-skill-does)
  * [Path resolution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#path-resolution)
  * [Default workflow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#default-workflow)
  * [User interaction protocol](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#user-interaction-protocol)
  * [Decision-to-command mapping](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#decision-to-command-mapping)
  * [Post-run reporting rules](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#post-run-reporting-rules)
  * [Migration presets](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#migration-presets)
  * [Important rules](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#important-rules)
  * [Expected result](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/migration/migration-openclaw-migration#expected-result)

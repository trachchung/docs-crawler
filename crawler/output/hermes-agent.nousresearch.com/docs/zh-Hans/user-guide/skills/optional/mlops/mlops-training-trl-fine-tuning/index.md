<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning -->

本页总览
TRL: SFT, DPO, PPO, GRPO, reward modeling for LLM RLHF.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#skill-metadata "Skill metadata的直接链接")  
...
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#reference-full-skillmd "Reference: full SKILL.md的直接链接")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
# TRL - Transformer Reinforcement Learning
## Quick start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#quick-start "Quick start的直接链接")
...
## Common workflows[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#common-workflows "Common workflows的直接链接")
### Workflow 1: Full RLHF pipeline (SFT → Reward Model → PPO)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#workflow-1-full-rlhf-pipeline-sft--reward-model--ppo "Workflow 1: Full RLHF pipeline \(SFT → Reward Model → PPO\)的直接链接")
...
### Workflow 2: Simple preference alignment with DPO[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#workflow-2-simple-preference-alignment-with-dpo "Workflow 2: Simple preference alignment with DPO的直接链接")
...
### Workflow 3: Memory-efficient online RL with GRPO[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#workflow-3-memory-efficient-online-rl-with-grpo "Workflow 3: Memory-efficient online RL with GRPO的直接链接")
...
## When to use vs alternatives[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#when-to-use-vs-alternatives "When to use vs alternatives的直接链接")
**Use TRL when:**
...
## Common issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#common-issues "Common issues的直接链接")
...
## Advanced topics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#advanced-topics "Advanced topics的直接链接")
...
## Hardware requirements[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#hardware-requirements "Hardware requirements的直接链接")
...
## Resources[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#resources "Resources的直接链接")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#reference-full-skillmd)
  * [Quick start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#quick-start)
  * [Common workflows](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#common-workflows)
    * [Workflow 1: Full RLHF pipeline (SFT → Reward Model → PPO)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#workflow-1-full-rlhf-pipeline-sft--reward-model--ppo)
    * [Workflow 2: Simple preference alignment with DPO](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#workflow-2-simple-preference-alignment-with-dpo)
    * [Workflow 3: Memory-efficient online RL with GRPO](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#workflow-3-memory-efficient-online-rl-with-grpo)
  * [When to use vs alternatives](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#when-to-use-vs-alternatives)
  * [Common issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#common-issues)
  * [Advanced topics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#advanced-topics)
  * [Hardware requirements](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning#hardware-requirements)

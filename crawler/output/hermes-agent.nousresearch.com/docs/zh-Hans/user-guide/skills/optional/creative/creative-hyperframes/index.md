<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes -->
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  [`manim-video`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/bundled/creative/creative-manim-video), [`meme-generation`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/creative/creative-meme-generation)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## When to Use[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#when-to-use "When to Use的直接链接")
...
## Quick Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#quick-reference "Quick Reference的直接链接")

```
npx hyperframes init my-video               # scaffold a projectcd my-videonpx hyperframes lint                        # validate before preview/rendernpx hyperframes preview                     # live-reload browser preview (port 3002)npx hyperframes render --output final.mp4   # render to MP4npx hyperframes doctor                      # diagnose environment issues
```
...
## Setup (one-time)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#setup-one-time "Setup \(one-time\)的直接链接")
...
## Procedure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#procedure "Procedure的直接链接")
### 1. Plan before writing HTML[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#1-plan-before-writing-html "1. Plan before writing HTML的直接链接")
...
### 2. Scaffold[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#2-scaffold "2. Scaffold的直接链接")
...
### 3. Layout before animation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#3-layout-before-animation "3. Layout before animation的直接链接")
...
### 4. Animate with GSAP[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#4-animate-with-gsap "4. Animate with GSAP的直接链接")
...
### 5. Transitions between scenes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#5-transitions-between-scenes "5. Transitions between scenes的直接链接")
...
### 6. Audio, captions, TTS, audio-reactive, highlighting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#6-audio-captions-tts-audio-reactive-highlighting "6. Audio, captions, TTS, audio-reactive, highlighting的直接链接")
...
### 7. Lint, validate, inspect, preview, render[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#7-lint-validate-inspect-preview-render "7. Lint, validate, inspect, preview, render的直接链接")

```
npx hyperframes lint              # catches missing data-composition-id, overlapping tracks, unregistered timelinesnpx hyperframes validate          # WCAG contrast audit at 5 timestampsnpx hyperframes inspect           # visual layout audit — overflow, off-frame elements, occluded textnpx hyperframes preview           # live browser previewnpx hyperframes render --quality draft --output draft.mp4    # fast iterationnpx hyperframes render --quality high --output final.mp4     # final delivery
```
...
### 8. Website-to-video (if the user gives a URL)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#8-website-to-video-if-the-user-gives-a-url "8. Website-to-video \(if the user gives a URL\)的直接链接")
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#pitfalls "Pitfalls的直接链接")
...
## Verification[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#verification "Verification的直接链接")
...
```
node skills/hyperframes/scripts/animation-map.mjs <composition-dir>\--out<composition-dir>/.hyperframes/anim-map
```
...
## References[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#references "References的直接链接")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#reference-full-skillmd)
  * [When to Use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#when-to-use)
  * [Quick Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#quick-reference)
  * [Setup (one-time)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#setup-one-time)
  * [Procedure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#procedure)
    * [1. Plan before writing HTML](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#1-plan-before-writing-html)
    * [2. Scaffold](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#2-scaffold)
    * [3. Layout before animation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#3-layout-before-animation)
    * [4. Animate with GSAP](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#4-animate-with-gsap)
    * [5. Transitions between scenes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#5-transitions-between-scenes)
    * [6. Audio, captions, TTS, audio-reactive, highlighting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#6-audio-captions-tts-audio-reactive-highlighting)
    * [7. Lint, validate, inspect, preview, render](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#7-lint-validate-inspect-preview-render)
    * [8. Website-to-video (if the user gives a URL)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#8-website-to-video-if-the-user-gives-a-url)
  * [Verification](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/creative/creative-hyperframes#verification)

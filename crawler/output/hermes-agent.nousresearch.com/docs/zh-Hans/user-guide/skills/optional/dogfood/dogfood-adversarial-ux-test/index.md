<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test -->
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## Why This Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#why-this-works "Why This Works的直接链接")
...
## How to Use[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#how-to-use "How to Use的直接链接")
Tell the agent:
...
## Step 1: Define the Persona[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-1-define-the-persona "Step 1: Define the Persona的直接链接")
...
### Good Persona Example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#good-persona-example "Good Persona Example的直接链接")
...
### Bad Persona Example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#bad-persona-example "Bad Persona Example的直接链接")
...
## Step 2: Become the Asshole (Browse as the Persona)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-2-become-the-asshole-browse-as-the-persona "Step 2: Become the Asshole \(Browse as the Persona\)的直接链接")
...
## Step 3: The Rant (Write Feedback in Character)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-3-the-rant-write-feedback-in-character "Step 3: The Rant \(Write Feedback in Character\)的直接链接")
...
## Step 4: The Pragmatism Filter (Critical — Do Not Skip)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-4-the-pragmatism-filter-critical--do-not-skip "Step 4: The Pragmatism Filter \(Critical — Do Not Skip\)的直接链接")
...
### Filter Criteria[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#filter-criteria "Filter Criteria的直接链接")
...
## Step 5: Create Tickets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-5-create-tickets "Step 5: Create Tickets的直接链接")
...
## Step 6: Report[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-6-report "Step 6: Report的直接链接")
Deliver:
...
## Tips[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#tips "Tips的直接链接")
...
## Example Personas by Industry[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#example-personas-by-industry "Example Personas by Industry的直接链接")
...
## Rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#rules "Rules的直接链接")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#reference-full-skillmd)
  * [Why This Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#why-this-works)
  * [Step 1: Define the Persona](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-1-define-the-persona)
    * [Good Persona Example](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#good-persona-example)
    * [Bad Persona Example](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#bad-persona-example)
  * [Step 2: Become the Asshole (Browse as the Persona)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-2-become-the-asshole-browse-as-the-persona)
  * [Step 3: The Rant (Write Feedback in Character)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-3-the-rant-write-feedback-in-character)
  * [Step 4: The Pragmatism Filter (Critical — Do Not Skip)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-4-the-pragmatism-filter-critical--do-not-skip)
    * [Filter Criteria](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#filter-criteria)
  * [Step 5: Create Tickets](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-5-create-tickets)
  * [Step 6: Report](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-6-report)
  * [Example Personas by Industry](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#example-personas-by-industry)

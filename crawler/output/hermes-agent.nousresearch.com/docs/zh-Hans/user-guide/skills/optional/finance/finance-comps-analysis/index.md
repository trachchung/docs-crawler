<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis -->
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  [`excel-author`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/finance/finance-excel-author), [`pptx-author`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/finance/finance-pptx-author), [`dcf-model`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/finance/finance-dcf-model), [`lbo-model`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/finance/finance-lbo-model)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#reference-full-skillmd "Reference: full SKILL.md的直接链接")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
## Environment[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#environment "Environment的直接链接")
...
## ⚠️ CRITICAL: Data Source Priority (READ FIRST)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#%EF%B8%8F-critical-data-source-priority-read-first "⚠️ CRITICAL: Data Source Priority \(READ FIRST\)的直接链接")
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#overview "Overview的直接链接")
...
## Core Philosophy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#core-philosophy "Core Philosophy的直接链接")
...
## ⚠️ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#%EF%B8%8F-critical-formulas-over-hardcodes--step-by-step-verification "⚠️ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification的直接链接")
...
## Section 1: Document Structure & Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-1-document-structure--setup "Section 1: Document Structure & Setup的直接链接")
### Header Block (Rows 1-3)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#header-block-rows-1-3 "Header Block \(Rows 1-3\)的直接链接")

```
Row 1: [ANALYSIS TITLE] - COMPARABLE COMPANY ANALYSISRow 2: [List of Companies with Tickers] • [Company 1 (TICK1)] • [Company 2 (TICK2)] • [Company 3 (TICK3)]Row 3: As of [Period] | All figures in [USD Millions/Billions] except per-share amounts and ratios
```
...
### Visual Convention Standards (OPTIONAL - User preferences and uploaded templates always override)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#visual-convention-standards-optional---user-preferences-and-uploaded-templates-always-override "Visual Convention Standards \(OPTIONAL - User preferences and uploaded templates always override\)的直接链接")
...
## Section 2: Operating Statistics & Financial Metrics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-2-operating-statistics--financial-metrics "Section 2: Operating Statistics & Financial Metrics的直接链接")
### Core Columns (Start with these)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#core-columns-start-with-these "Core Columns \(Start with these\)的直接链接")
...
### Optional Additions (Choose based on industry/purpose)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#optional-additions-choose-based-on-industrypurpose "Optional Additions \(Choose based on industry/purpose\)的直接链接")
...
### Formula Examples (Using Row 7 as example)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#formula-examples-using-row-7-as-example "Formula Examples \(Using Row 7 as example\)的直接链接")

```
// Core ratios - these are always calculatedGross Margin (F7): =E7/C7EBITDA Margin (H7): =G7/C7// Optional ratios - include if relevantFCF Margin: =[FCF]/[Revenue]Net Margin: =[Net Income]/[Revenue]Rule of 40: =[Growth %]+[FCF Margin %]
```

**Golden Rule:** Every ratio should be [Something] / [Revenue] or [Something] / [Something from this sheet]. Keep it simple.
### Statistics Block (After company data)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#statistics-block-after-company-data "Statistics Block \(After company data\)的直接链接")
...
## Section 3: Valuation Multiples & Investment Metrics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-3-valuation-multiples--investment-metrics "Section 3: Valuation Multiples & Investment Metrics的直接链接")
### Core Valuation Columns (Start with these)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#core-valuation-columns-start-with-these "Core Valuation Columns \(Start with these\)的直接链接")
...
### Optional Valuation Metrics (Choose based on context)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#optional-valuation-metrics-choose-based-on-context "Optional Valuation Metrics \(Choose based on context\)的直接链接")
...
### Formula Examples[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#formula-examples "Formula Examples的直接链接")

```
// Core multiples - always include theseEV/Revenue: =[Enterprise Value]/[LTM Revenue]EV/EBITDA: =[Enterprise Value]/[LTM EBITDA]P/E Ratio: =[Market Cap]/[Net Income]// Optional multiples - include if data availableFCF Yield: =[LTM FCF]/[Market Cap]PEG Ratio: =[P/E]/[Growth Rate %]
```

### Cross-Reference Rule[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#cross-reference-rule "Cross-Reference Rule的直接链接")
...
### Statistics Block[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#statistics-block "Statistics Block的直接链接")
...
## Section 4: Notes & Methodology Documentation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-4-notes--methodology-documentation "Section 4: Notes & Methodology Documentation的直接链接")
### Required Components[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#required-components "Required Components的直接链接")
...
## Section 5: Choosing the Right Metrics (Decision Framework)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-5-choosing-the-right-metrics-decision-framework "Section 5: Choosing the Right Metrics \(Decision Framework\)的直接链接")
### Start with "What question am I answering?"[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#start-with-what-question-am-i-answering "Start with "What question am I answering?"的直接链接")
...
### Industry-Specific Metric Selection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#industry-specific-metric-selection "Industry-Specific Metric Selection的直接链接")
...
### The "5-10 Rule"[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#the-5-10-rule "The "5-10 Rule"的直接链接")
...
## Section 6: Best Practices & Quality Checks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-6-best-practices--quality-checks "Section 6: Best Practices & Quality Checks的直接链接")
### Before You Start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#before-you-start "Before You Start的直接链接")
...
### As You Build[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#as-you-build "As You Build的直接链接")
...
### Sanity Checks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#sanity-checks "Sanity Checks的直接链接")
...
### Common Mistakes to Avoid[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#common-mistakes-to-avoid "Common Mistakes to Avoid的直接链接")
...
## Section 6: Advanced Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-6-advanced-features "Section 6: Advanced Features的直接链接")
### Dynamic Headers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#dynamic-headers "Dynamic Headers的直接链接")
...
### Quartile Analysis Benefits[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#quartile-analysis-benefits "Quartile Analysis Benefits的直接链接")
...
### Industry-Specific Modifications[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#industry-specific-modifications "Industry-Specific Modifications的直接链接")
**Software/SaaS:**
...
## Section 7: Workflow & Practical Tips[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-7-workflow--practical-tips "Section 7: Workflow & Practical Tips的直接链接")
### Step-by-Step Process[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#step-by-step-process "Step-by-Step Process的直接链接")
...
### Pro Tips[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#pro-tips "Pro Tips的直接链接")
...
### Excel Formatting Checklist (Optional - adapt to user preferences)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#excel-formatting-checklist-optional---adapt-to-user-preferences "Excel Formatting Checklist \(Optional - adapt to user preferences\)的直接链接")
...
## Section 8: Example Template Layout[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-8-example-template-layout "Section 8: Example Template Layout的直接链接")
...
## Section 9: Industry-Specific Additions (Optional)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-9-industry-specific-additions-optional "Section 9: Industry-Specific Additions \(Optional\)的直接链接")
...
## Section 10: Red Flags & Warning Signs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-10-red-flags--warning-signs "Section 10: Red Flags & Warning Signs的直接链接")
### Data Quality Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#data-quality-issues "Data Quality Issues的直接链接")
...
### Valuation Red Flags[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#valuation-red-flags "Valuation Red Flags的直接链接")
...
### Comparability Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#comparability-issues "Comparability Issues的直接链接")
...
## Section 11: Formulas Reference Guide[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-11-formulas-reference-guide "Section 11: Formulas Reference Guide的直接链接")
### Essential Excel Formulas[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#essential-excel-formulas "Essential Excel Formulas的直接链接")
...
### Common Ratio Formulas[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#common-ratio-formulas "Common Ratio Formulas的直接链接")

```
Gross Margin = Gross Profit / RevenueEBITDA Margin = EBITDA / RevenueFCF Margin = Free Cash Flow / RevenueFCF Conversion = FCF / Operating Cash FlowROE = Net Income / Shareholders' EquityROA = Net Income / Total AssetsAsset Turnover = Revenue / Total AssetsDebt/Equity = Total Debt / Shareholders' Equity
```

## Key Principles Summary[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#key-principles-summary "Key Principles Summary的直接链接")
...
## Output Checklist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#output-checklist "Output Checklist的直接链接")
...
## Continuous Improvement[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#continuous-improvement "Continuous Improvement的直接链接")
...
## Data sources — MCP first, web fallback[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#data-sources--mcp-first-web-fallback "Data sources — MCP first, web fallback的直接链接")
...
## Attribution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#attribution "Attribution的直接链接")
This skill is adapted from Anthropic's Claude for Financial Services plugin suite (Apache-2.0). The Office-JS / Cowork live-Excel paths have been removed; this version targets headless openpyxl via the `excel-author` skill's conventions. Original: <https://github.com/anthropics/financial-services>
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#reference-full-skillmd)
  * [Environment](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#environment)
  * [⚠️ CRITICAL: Data Source Priority (READ FIRST)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#%EF%B8%8F-critical-data-source-priority-read-first)
  * [Core Philosophy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#core-philosophy)
  * [⚠️ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#%EF%B8%8F-critical-formulas-over-hardcodes--step-by-step-verification)
  * [Section 1: Document Structure & Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-1-document-structure--setup)
    * [Header Block (Rows 1-3)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#header-block-rows-1-3)
    * [Visual Convention Standards (OPTIONAL - User preferences and uploaded templates always override)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#visual-convention-standards-optional---user-preferences-and-uploaded-templates-always-override)
  * [Section 2: Operating Statistics & Financial Metrics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-2-operating-statistics--financial-metrics)
    * [Core Columns (Start with these)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#core-columns-start-with-these)
    * [Optional Additions (Choose based on industry/purpose)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#optional-additions-choose-based-on-industrypurpose)
    * [Formula Examples (Using Row 7 as example)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#formula-examples-using-row-7-as-example)
    * [Statistics Block (After company data)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#statistics-block-after-company-data)
  * [Section 3: Valuation Multiples & Investment Metrics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-3-valuation-multiples--investment-metrics)
    * [Core Valuation Columns (Start with these)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#core-valuation-columns-start-with-these)
    * [Optional Valuation Metrics (Choose based on context)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#optional-valuation-metrics-choose-based-on-context)
    * [Formula Examples](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#formula-examples)
    * [Cross-Reference Rule](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#cross-reference-rule)
    * [Statistics Block](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#statistics-block)
  * [Section 4: Notes & Methodology Documentation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-4-notes--methodology-documentation)
    * [Required Components](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#required-components)
  * [Section 5: Choosing the Right Metrics (Decision Framework)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-5-choosing-the-right-metrics-decision-framework)
    * [Start with "What question am I answering?"](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#start-with-what-question-am-i-answering)
    * [Industry-Specific Metric Selection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#industry-specific-metric-selection)
    * [The "5-10 Rule"](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#the-5-10-rule)
  * [Section 6: Best Practices & Quality Checks](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-6-best-practices--quality-checks)
    * [Before You Start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#before-you-start)
    * [As You Build](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#as-you-build)
    * [Sanity Checks](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#sanity-checks)
    * [Common Mistakes to Avoid](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#common-mistakes-to-avoid)
  * [Section 6: Advanced Features](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-6-advanced-features)
    * [Dynamic Headers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#dynamic-headers)
    * [Quartile Analysis Benefits](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#quartile-analysis-benefits)
    * [Industry-Specific Modifications](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#industry-specific-modifications)
  * [Section 7: Workflow & Practical Tips](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-7-workflow--practical-tips)
    * [Step-by-Step Process](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#step-by-step-process)
    * [Excel Formatting Checklist (Optional - adapt to user preferences)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#excel-formatting-checklist-optional---adapt-to-user-preferences)
  * [Section 8: Example Template Layout](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-8-example-template-layout)
  * [Section 9: Industry-Specific Additions (Optional)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-9-industry-specific-additions-optional)
  * [Section 10: Red Flags & Warning Signs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-10-red-flags--warning-signs)
    * [Data Quality Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#data-quality-issues)
    * [Valuation Red Flags](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#valuation-red-flags)
    * [Comparability Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#comparability-issues)
  * [Section 11: Formulas Reference Guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#section-11-formulas-reference-guide)
    * [Essential Excel Formulas](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#essential-excel-formulas)
    * [Common Ratio Formulas](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#common-ratio-formulas)
  * [Key Principles Summary](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#key-principles-summary)
  * [Output Checklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#output-checklist)
  * [Continuous Improvement](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#continuous-improvement)
  * [Data sources — MCP first, web fallback](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#data-sources--mcp-first-web-fallback)
  * [Attribution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/finance/finance-comps-analysis#attribution)

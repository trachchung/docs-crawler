<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search -->
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  [`duckduckgo-search`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/research/research-duckduckgo-search), [`domain-intel`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/optional/research/research-domain-intel)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#configuration "Configuration的直接链接")
...
## Detection Flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#detection-flow "Detection Flow的直接链接")
...
## Method 1: CLI via curl (Preferred)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#method-1-cli-via-curl-preferred "Method 1: CLI via curl \(Preferred\)的直接链接")
...
### Common CLI Flags[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#common-cli-flags "Common CLI Flags的直接链接")  
...
### Parsing JSON Results[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#parsing-json-results "Parsing JSON Results的直接链接")
...
## Method 2: Python API via `requests`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#method-2-python-api-via-requests "method-2-python-api-via-requests的直接链接")
...
## Method 3: searxng-data Python Package[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#method-3-searxng-data-python-package "Method 3: searxng-data Python Package的直接链接")
...
## Self-Hosting SearXNG[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#self-hosting-searxng "Self-Hosting SearXNG的直接链接")
...
## Workflow: Search then Extract[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#workflow-search-then-extract "Workflow: Search then Extract的直接链接")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#limitations "Limitations的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#troubleshooting "Troubleshooting的直接链接")  
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#pitfalls "Pitfalls的直接链接")
...
## Instance Discovery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#instance-discovery "Instance Discovery的直接链接")
...
Public instances are listed at: <https://searxng.org/>
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#reference-full-skillmd)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#configuration)
  * [Detection Flow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#detection-flow)
  * [Method 1: CLI via curl (Preferred)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#method-1-cli-via-curl-preferred)
    * [Common CLI Flags](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#common-cli-flags)
    * [Parsing JSON Results](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#parsing-json-results)
  * [Method 2: Python API via `requests`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#method-2-python-api-via-requests)
  * [Method 3: searxng-data Python Package](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#method-3-searxng-data-python-package)
  * [Self-Hosting SearXNG](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#self-hosting-searxng)
  * [Workflow: Search then Extract](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#workflow-search-then-extract)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#limitations)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#troubleshooting)
  * [Instance Discovery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/optional/research/research-searxng-search#instance-discovery)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art -->

本页总览
Pixel art w/ era palettes (NES, Game Boy, PICO-8).
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#skill-metadata "Skill metadata的直接链接")  
...
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## When to Use[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#when-to-use "When to Use的直接链接")
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#workflow "Workflow的直接链接")
...
### Step 1 — Offer a style[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#step-1--offer-a-style "Step 1 — Offer a style的直接链接")
...
### Step 2 — Offer animation (optional)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#step-2--offer-animation-optional "Step 2 — Offer animation \(optional\)的直接链接")
...
### Step 3 — Generate[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#step-3--generate "Step 3 — Generate的直接链接")
Run `pixel_art()` first; if animation was requested, chain into `pixel_art_video()` on the result.
## Preset Catalog[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#preset-catalog "Preset Catalog的直接链接")  
...
## Scene Catalog (for video)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#scene-catalog-for-video "Scene Catalog \(for video\)的直接链接")  
| Scene  | Effects  |  
| --- | --- |  
...
## Invocation Patterns[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#invocation-patterns "Invocation Patterns的直接链接")
### Python (import)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#python-import "Python \(import\)的直接链接")
...
### CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#cli "CLI的直接链接")
...
## Pipeline Rationale[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#pipeline-rationale "Pipeline Rationale的直接链接")
**Pixel conversion:**
...
## Dependencies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#dependencies "Dependencies的直接链接")
  * Python 3.9+
  * Pillow (`pip install Pillow`)
  * ffmpeg on PATH (only needed for video — Hermes installs package this)


## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#pitfalls "Pitfalls的直接链接")
...
## Verification[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#verification "Verification的直接链接")
...
## Attribution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#attribution "Attribution的直接链接")
Named hardware palettes and the procedural animation loops in `pixel_art_video.py` are ported from [pixel-art-studio](https://github.com/Synero/pixel-art-studio) (MIT). See `ATTRIBUTION.md` in this skill directory for details.
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#reference-full-skillmd)
  * [When to Use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#when-to-use)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#workflow)
    * [Step 1 — Offer a style](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#step-1--offer-a-style)
    * [Step 2 — Offer animation (optional)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#step-2--offer-animation-optional)
    * [Step 3 — Generate](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#step-3--generate)
  * [Preset Catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#preset-catalog)
  * [Scene Catalog (for video)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#scene-catalog-for-video)
  * [Invocation Patterns](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#invocation-patterns)
    * [Python (import)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#python-import)
  * [Pipeline Rationale](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#pipeline-rationale)
  * [Dependencies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#dependencies)
  * [Verification](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#verification)
  * [Attribution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-pixel-art#attribution)

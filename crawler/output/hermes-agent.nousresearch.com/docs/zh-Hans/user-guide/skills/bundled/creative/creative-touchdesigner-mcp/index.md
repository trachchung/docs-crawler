<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp -->

本页总览
Control a running TouchDesigner instance via twozero MCP — create operators, set parameters, wire connections, execute Python, build real-time visuals. 36 native tools.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  [`native-mcp`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/bundled/mcp/mcp-native-mcp), [`ascii-video`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/bundled/creative/creative-manim-video), `hermes-video`  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#reference-full-skillmd "Reference: full SKILL.md的直接链接")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
# TouchDesigner Integration (twozero MCP)
## CRITICAL RULES[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-rules "CRITICAL RULES的直接链接")
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#architecture "Architecture的直接链接")
...
## Setup (Automated)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#setup-automated "Setup \(Automated\)的直接链接")
...
### Manual steps (one-time, cannot be automated)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#manual-steps-one-time-cannot-be-automated "Manual steps \(one-time, cannot be automated\)的直接链接")
...
```
nc-z127.0.0.1 40404&&echo"twozero MCP: READY"
```

## Environment Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#environment-notes "Environment Notes的直接链接")
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#workflow "Workflow的直接链接")
### Step 0: Discover (before building anything)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-0-discover-before-building-anything "Step 0: Discover \(before building anything\)的直接链接")
...
### Step 1: Clean + Build[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-1-clean--build "Step 1: Clean + Build的直接链接")
...
```
# td_execute_python script:root = op('/project1')nodes =[]for name, optype in[('bg', noiseTOP),('fx', levelTOP),('out', nullTOP)]:= root.create(optype, name)    nodes.append(n.path)# Wire chainfor i inrange(len(nodes)-1):    op(nodes[i]).outputConnectors[0].connect(op(nodes[i+1]).inputConnectors[0])result ={'created': nodes}
```

### Step 2: Set Parameters[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-2-set-parameters "Step 2: Set Parameters的直接链接")
...
### Step 3: Wire[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-3-wire "Step 3: Wire的直接链接")
...
### Step 4: Verify[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-4-verify "Step 4: Verify的直接链接")

```
td_get_errors(path="/project1", recursive=true)td_get_perf()td_get_operator_info(path="/project1/out", detail="full")
```

### Step 5: Display / Capture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-5-display--capture "Step 5: Display / Capture的直接链接")
...
```
win = op('/project1').create(windowCOMP,'display')win.par.winop = op('/project1/out').pathwin.par.winw =1280; win.par.winh =720win.par.winopen.pulse()
```

## MCP Tool Quick Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#mcp-tool-quick-reference "MCP Tool Quick Reference的直接链接")
**Core (use these most):**  
| Tool  | What  |  
| --- | --- |  
...
## Key Implementation Rules[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#key-implementation-rules "Key Implementation Rules的直接链接")
**GLSL time:** No `uTDCurrentTime` in GLSL TOP. Use the Values page:

```
# Call td_get_par_info(op_type="glslTOP") first to confirm param namestd_set_operator_pars(path="/project1/shader", parameters={"value0name":"uTime"})# Then set expression via script:# op('/project1/shader').par.value0.expr = "absTime.seconds"# In GLSL: uniform float uTime;
```
...
## Recording / Exporting Video[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#recording--exporting-video "Recording / Exporting Video的直接链接")

```
# via td_execute_python:root = op('/project1')rec = root.create(moviefileoutTOP,'recorder')op('/project1/out').outputConnectors[0].connect(rec.inputConnectors[0])rec.par.type='movie'rec.par.file='/tmp/output.mov'rec.par.videocodec ='prores'# Apple ProRes — NOT license-restricted on macOSrec.par.record =True# start# rec.par.record = False  # stop (call separately later)
```
...
### Before Recording: Checklist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#before-recording-checklist "Before Recording: Checklist的直接链接")
...
## Audio-Reactive GLSL (Proven Recipe)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#audio-reactive-glsl-proven-recipe "Audio-Reactive GLSL \(Proven Recipe\)的直接链接")
### Correct signal chain (tested April 2026)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#correct-signal-chain-tested-april-2026 "Correct signal chain \(tested April 2026\)的直接链接")

```
AudioFileIn CHOP (playmode=sequential)  → AudioSpectrum CHOP (FFT=512, outputmenu=setmanually, outlength=256, timeslice=ON)  → Math CHOP (gain=10)  → CHOP to TOP (dataformat=r, layout=rowscropped)  → GLSL TOP input 1 (spectrum texture, 256x2)Constant TOP (rgba32float, time) → GLSL TOP input 0GLSL TOP → Null TOP → MovieFileOut
```

### Critical audio-reactive rules (empirically verified)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-audio-reactive-rules-empirically-verified "Critical audio-reactive rules \(empirically verified\)的直接链接")
...
### GLSL spectrum sampling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#glsl-spectrum-sampling "GLSL spectrum sampling的直接链接")
...
## Operator Quick Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#operator-quick-reference "Operator Quick Reference的直接链接")  
...
## Security Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#security-notes "Security Notes的直接链接")
...
## References[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#references "References的直接链接")  
| File  | What  |  
| --- | --- |  
...
> You're not writing code. You're conducting light.
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#reference-full-skillmd)
  * [CRITICAL RULES](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-rules)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#architecture)
  * [Setup (Automated)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#setup-automated)
    * [Manual steps (one-time, cannot be automated)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#manual-steps-one-time-cannot-be-automated)
  * [Environment Notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#environment-notes)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#workflow)
    * [Step 0: Discover (before building anything)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-0-discover-before-building-anything)
    * [Step 1: Clean + Build](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-1-clean--build)
    * [Step 2: Set Parameters](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-2-set-parameters)
    * [Step 3: Wire](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-3-wire)
    * [Step 4: Verify](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-4-verify)
    * [Step 5: Display / Capture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-5-display--capture)
  * [MCP Tool Quick Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#mcp-tool-quick-reference)
  * [Key Implementation Rules](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#key-implementation-rules)
  * [Recording / Exporting Video](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#recording--exporting-video)
    * [Before Recording: Checklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#before-recording-checklist)
  * [Audio-Reactive GLSL (Proven Recipe)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#audio-reactive-glsl-proven-recipe)
    * [Correct signal chain (tested April 2026)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#correct-signal-chain-tested-april-2026)
    * [Critical audio-reactive rules (empirically verified)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-audio-reactive-rules-empirically-verified)
    * [GLSL spectrum sampling](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#glsl-spectrum-sampling)
  * [Operator Quick Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#operator-quick-reference)
  * [Security Notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#security-notes)

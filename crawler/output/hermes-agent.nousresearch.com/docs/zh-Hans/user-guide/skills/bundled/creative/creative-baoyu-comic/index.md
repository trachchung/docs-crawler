<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic -->

本页总览
Knowledge comics (知识漫画): educational, biography, tutorial.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#skill-metadata "Skill metadata的直接链接")  
...
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## When to Use[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#when-to-use "When to Use的直接链接")
...
## Reference Images[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-images "Reference Images的直接链接")
...
```
references:-ref_id:01filename: 01-ref-scene.pngusage: styletraits:"muted earth tones, soft-edged ink wash, low-contrast backgrounds"
```
...
## Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#options "Options的直接链接")
### Visual Dimensions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#visual-dimensions "Visual Dimensions的直接链接")  
...
| Refs  | File paths  | Reference images used for style / palette trait extraction (not passed to the image model). See [Reference Images](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-images) above.  |  
### Partial Workflow Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#partial-workflow-options "Partial Workflow Options的直接链接")  
| Option  | Description  |  
| --- | --- |  
...
### Art, Tone & Preset Catalogue[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#art-tone--preset-catalogue "Art, Tone & Preset Catalogue的直接链接")
...
## File Structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#file-structure "File Structure的直接链接")
...
## Language Handling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#language-handling "Language Handling的直接链接")
**Detection Priority** :
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#workflow "Workflow的直接链接")
### Progress Checklist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#progress-checklist "Progress Checklist的直接链接")

```
Comic Progress:- [ ] Step 1: Setup & Analyze  - [ ] 1.1 Analyze content  - [ ] 1.2 Check existing directory- [ ] Step 2: Confirmation - Style & options ⚠️ REQUIRED- [ ] Step 3: Generate storyboard + characters- [ ] Step 4: Review outline (conditional)- [ ] Step 5: Generate prompts- [ ] Step 6: Review prompts (conditional)- [ ] Step 7: Generate images  - [ ] 7.1 Generate character sheet (if needed) → characters/characters.png  - [ ] 7.2 Generate pages (with character descriptions embedded in prompt)- [ ] Step 8: Completion report
```

### Flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#flow "Flow的直接链接")

```
Input → Analyze → [Check Existing?] → [Confirm: Style + Reviews] → Storyboard → [Review?] → Prompts → [Review?] → Images → Complete
```

### Step Summary[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#step-summary "Step Summary的直接链接")  
...
### User Questions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#user-questions "User Questions的直接链接")
...
### Step 7: Image Generation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#step-7-image-generation "Step 7: Image Generation的直接链接")
...
## References[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#references "References的直接链接")
**Core Templates** :
...
## Page Modification[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#page-modification "Page Modification的直接链接")  
| Action  | Steps  |  
| --- | --- |  
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#pitfalls "Pitfalls的直接链接")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-full-skillmd)
  * [When to Use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#when-to-use)
  * [Reference Images](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-images)
  * [Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#options)
    * [Visual Dimensions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#visual-dimensions)
    * [Partial Workflow Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#partial-workflow-options)
    * [Art, Tone & Preset Catalogue](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#art-tone--preset-catalogue)
  * [File Structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#file-structure)
  * [Language Handling](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#language-handling)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#workflow)
    * [Progress Checklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#progress-checklist)
    * [Step Summary](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#step-summary)
    * [User Questions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#user-questions)
    * [Step 7: Image Generation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#step-7-image-generation)
  * [Page Modification](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-baoyu-comic#page-modification)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video -->

本页总览
ASCII video: convert video/audio to colored ASCII MP4/GIF.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#skill-metadata "Skill metadata的直接链接")  
| Source  | Bundled (installed by default)  |  
| --- | --- |  
| Path  | `skills/creative/ascii-video`  |  
| Platforms  | linux, macos, windows  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#reference-full-skillmd "Reference: full SKILL.md的直接链接")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
# ASCII Video Production Pipeline
## When to use[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#when-to-use "When to use的直接链接")
...
## What's inside[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#whats-inside "What's inside的直接链接")
Production pipeline for ASCII art video — any format. Converts video/audio/images/generative input into colored ASCII character video output (MP4, GIF, image sequence). Covers: video-to-ASCII conversion, audio-reactive music visualizers, generative ASCII art animations, hybrid video+audio reactive, text/lyrics overlays, real-time terminal rendering.
## Creative Standard[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#creative-standard "Creative Standard的直接链接")
...
## Modes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#modes "Modes的直接链接")  
...
## Stack[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#stack "Stack的直接链接")
...
## Pipeline Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#pipeline-architecture "Pipeline Architecture的直接链接")
...
## Creative Direction[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#creative-direction "Creative Direction的直接链接")
### Aesthetic Dimensions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#aesthetic-dimensions "Aesthetic Dimensions的直接链接")  
...
### Per-Section Variation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#per-section-variation "Per-Section Variation的直接链接")
...
### Project-Specific Invention[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#project-specific-invention "Project-Specific Invention的直接链接")
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#workflow "Workflow的直接链接")
### Step 1: Creative Vision[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-1-creative-vision "Step 1: Creative Vision的直接链接")
...
### Step 2: Technical Design[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-2-technical-design "Step 2: Technical Design的直接链接")
...
### Step 3: Build the Script[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-3-build-the-script "Step 3: Build the Script的直接链接")
...
### Step 4: Quality Verification[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-4-quality-verification "Step 4: Quality Verification的直接链接")
...
## Critical Implementation Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#critical-implementation-notes "Critical Implementation Notes的直接链接")
### Brightness — Use `tonemap()`, Not Linear Multipliers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#brightness--use-tonemap-not-linear-multipliers "brightness--use-tonemap-not-linear-multipliers的直接链接")
...
```
deftonemap(canvas, gamma=0.75):= canvas.astype(np.float32)    lo, hi = np.percentile(f[::4,::4],[1,99.5])if hi - lo <10: hi = lo +10= np.clip((f - lo)/(hi - lo),0,1)** gammareturn(f *255).astype(np.uint8)
```
...
### Font Cell Height[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#font-cell-height "Font Cell Height的直接链接")
...
### ffmpeg Pipe Deadlock[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#ffmpeg-pipe-deadlock "ffmpeg Pipe Deadlock的直接链接")
...
### Font Compatibility[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#font-compatibility "Font Compatibility的直接链接")
...
### Per-Clip Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#per-clip-architecture "Per-Clip Architecture的直接链接")
...
## Performance Targets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#performance-targets "Performance Targets的直接链接")  
| Component  | Budget  |  
| --- | --- |  
...
## References[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#references "References的直接链接")  
| File  | Contents  |  
| --- | --- |  
...
### Forced Connections[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#forced-connections "Forced Connections的直接链接")
...
### Conceptual Blending[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#conceptual-blending "Conceptual Blending的直接链接")
...
### Oblique Strategies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#oblique-strategies "Oblique Strategies的直接链接")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#reference-full-skillmd)
  * [When to use](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#when-to-use)
  * [What's inside](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#whats-inside)
  * [Creative Standard](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#creative-standard)
  * [Pipeline Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#pipeline-architecture)
  * [Creative Direction](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#creative-direction)
    * [Aesthetic Dimensions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#aesthetic-dimensions)
    * [Per-Section Variation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#per-section-variation)
    * [Project-Specific Invention](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#project-specific-invention)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#workflow)
    * [Step 1: Creative Vision](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-1-creative-vision)
    * [Step 2: Technical Design](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-2-technical-design)
    * [Step 3: Build the Script](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-3-build-the-script)
    * [Step 4: Quality Verification](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#step-4-quality-verification)
  * [Critical Implementation Notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#critical-implementation-notes)
    * [Brightness — Use `tonemap()`, Not Linear Multipliers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#brightness--use-tonemap-not-linear-multipliers)
    * [Font Cell Height](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#font-cell-height)
    * [ffmpeg Pipe Deadlock](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#ffmpeg-pipe-deadlock)
    * [Font Compatibility](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#font-compatibility)
    * [Per-Clip Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#per-clip-architecture)
  * [Performance Targets](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#performance-targets)
  * [Creative Divergence (use only when user requests experimental/creative/unique output)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#creative-divergence-use-only-when-user-requests-experimentalcreativeunique-output)
    * [Forced Connections](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#forced-connections)
    * [Conceptual Blending](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#conceptual-blending)
    * [Oblique Strategies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/creative/creative-ascii-video#oblique-strategies)

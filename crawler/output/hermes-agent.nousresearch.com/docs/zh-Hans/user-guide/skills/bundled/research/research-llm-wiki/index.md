<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki -->

本页总览
Karpathy's LLM Wiki: build/query interlinked markdown KB.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#skill-metadata "Skill metadata的直接链接")  
...
| Related skills  |  [`obsidian`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`arxiv`](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/skills/bundled/research/research-arxiv)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#reference-full-skillmd "Reference: full SKILL.md的直接链接")
...
## When This Skill Activates[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#when-this-skill-activates "When This Skill Activates的直接链接")
...
## Wiki Location[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#wiki-location "Wiki Location的直接链接")
...
## Architecture: Three Layers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#architecture-three-layers "Architecture: Three Layers的直接链接")
...
## Resuming an Existing Wiki (CRITICAL — do this every session)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#resuming-an-existing-wiki-critical--do-this-every-session "Resuming an Existing Wiki \(CRITICAL — do this every session\)的直接链接")
...
## Initializing a New Wiki[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#initializing-a-new-wiki "Initializing a New Wiki的直接链接")
...
### SCHEMA.md Template[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#schemamd-template "SCHEMA.md Template的直接链接")
...
### raw/ Frontmatter[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#raw-frontmatter "raw/ Frontmatter的直接链接")
...
## Tag Taxonomy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#tag-taxonomy "Tag Taxonomy的直接链接")
...
## Page Thresholds[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#page-thresholds "Page Thresholds的直接链接")
...
## Entity Pages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#entity-pages "Entity Pages的直接链接")
...
## Concept Pages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#concept-pages "Concept Pages的直接链接")
...
## Comparison Pages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#comparison-pages "Comparison Pages的直接链接")
...
## Update Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#update-policy "Update Policy的直接链接")
...
### log.md Template[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#logmd-template "log.md Template的直接链接")
...
## Core Operations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#core-operations "Core Operations的直接链接")
### 1. Ingest[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#1-ingest "1. Ingest的直接链接")
...
### 2. Query[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#2-query "2. Query的直接链接")
...
### 3. Lint[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#3-lint "3. Lint的直接链接")
...
## Working with the Wiki[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#working-with-the-wiki "Working with the Wiki的直接链接")
### Searching[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#searching "Searching的直接链接")
...
### Bulk Ingest[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#bulk-ingest "Bulk Ingest的直接链接")
...
### Archiving[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#archiving "Archiving的直接链接")
...
### Obsidian Integration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#obsidian-integration "Obsidian Integration的直接链接")
...
### Obsidian Headless (servers and headless machines)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#obsidian-headless-servers-and-headless-machines "Obsidian Headless \(servers and headless machines\)的直接链接")
...
```
# Requires Node.js 22+npminstall-g obsidian-headless# Login (requires Obsidian account with Sync subscription)ob login --email<email>--password'<password>'# Create a remote vault for the wikiob sync-create-remote --name"LLM Wiki"# Connect the wiki directory to the vaultcd ~/wikiob sync-setup --vault"<vault-id>"# Initial syncob sync# Continuous sync (foreground — use systemd for background)ob sync--continuous
```

**Continuous background sync via systemd:**

```
# ~/.config/systemd/user/obsidian-wiki-sync.service[Unit]Description=Obsidian LLM Wiki SyncAfter=network-online.targetWants=network-online.target[Service]ExecStart=/path/to/ob sync --continuousWorkingDirectory=/home/user/wikiRestart=on-failureRestartSec=10[Install]WantedBy=default.target
```


```
systemctl --user daemon-reloadsystemctl --userenable--now obsidian-wiki-sync# Enable linger so sync survives logout:sudo loginctl enable-linger $USER
```
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#pitfalls "Pitfalls的直接链接")
...
## Related Tools[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#related-tools "Related Tools的直接链接")
[llm-wiki-compiler](https://github.com/atomicmemory/llm-wiki-compiler) is a Node.js CLI that compiles sources into a concept wiki with the same Karpathy inspiration. It's Obsidian-compatible, so users who want a scheduled/CLI-driven compile pipeline can point it at the same vault this skill maintains. Trade-offs: it owns page generation (replaces the agent's judgment on page creation) and is tuned for small corpora. Use this skill when you want agent-in-the-loop curation; use llmwiki when you want batch compile of a source directory.
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#reference-full-skillmd)
  * [When This Skill Activates](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#when-this-skill-activates)
  * [Wiki Location](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#wiki-location)
  * [Architecture: Three Layers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#architecture-three-layers)
  * [Resuming an Existing Wiki (CRITICAL — do this every session)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#resuming-an-existing-wiki-critical--do-this-every-session)
  * [Initializing a New Wiki](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#initializing-a-new-wiki)
    * [SCHEMA.md Template](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#schemamd-template)
    * [raw/ Frontmatter](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#raw-frontmatter)
  * [Tag Taxonomy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#tag-taxonomy)
  * [Page Thresholds](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#page-thresholds)
  * [Entity Pages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#entity-pages)
  * [Concept Pages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#concept-pages)
  * [Comparison Pages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#comparison-pages)
  * [Update Policy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#update-policy)
    * [log.md Template](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#logmd-template)
  * [Core Operations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#core-operations)
  * [Working with the Wiki](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#working-with-the-wiki)
    * [Bulk Ingest](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#bulk-ingest)
    * [Obsidian Integration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#obsidian-integration)
    * [Obsidian Headless (servers and headless machines)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#obsidian-headless-servers-and-headless-machines)
  * [Related Tools](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/skills/bundled/research/research-llm-wiki#related-tools)

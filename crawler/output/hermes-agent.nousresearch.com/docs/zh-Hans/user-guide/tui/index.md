<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui -->

本页总览
The TUI is the modern front-end for Hermes — a terminal UI backed by the same Python runtime as the [Classic CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli). Same agent, same sessions, same slash commands; a cleaner, more responsive surface for interacting with them.
It's the recommended way to run Hermes interactively.
## Launch[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#launch "Launch的直接链接")
...
The classic CLI remains available as the default. Anything documented in [CLI Interface](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli) — slash commands, quick commands, skill preloading, personalities, multi-line input, interrupts — works in the TUI identically.
## Why the TUI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#why-the-tui "Why the TUI的直接链接")
...
Same [skins](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins) and [personalities](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/personality) apply. Switch mid-session with `/skin ares`, `/personality pirate`, and the UI repaints live. See [Skins & Themes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins) for the full list of customizable keys and which ones apply to classic vs TUI — the TUI honors the banner palette, UI colors, prompt glyph/color, session display, completion menu, selection bg, `tool_prefix`, and `help_header`.
## Requirements[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#requirements "Requirements的直接链接")
...
### External prebuild[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#external-prebuild "External prebuild的直接链接")
...
## Keybindings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#keybindings "Keybindings的直接链接")
Keybindings match the [Classic CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli#keybindings) exactly. The only behavioral differences:
...
## Slash commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#slash-commands "Slash commands的直接链接")
...
Every other slash command (including installed skills, quick commands, and personality toggles) works identically to the classic CLI. See [Slash Commands Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands).
## LaTeX math rendering[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#latex-math-rendering "LaTeX math rendering的直接链接")
...
## Light-terminal detection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#light-terminal-detection "Light-terminal detection的直接链接")
...
## Busy indicator styles[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#busy-indicator-styles "Busy indicator styles的直接链接")
...
## Auto-resume[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#auto-resume "Auto-resume的直接链接")
...
## Status line[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#status-line "Status line的直接链接")
...
The per-skin status-bar colors and thresholds are shared with the classic CLI — see [Skins](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins) for customization.
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#configuration "Configuration的直接链接")
...
## Sessions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#sessions "Sessions的直接链接")
...
See [Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/sessions) for lifecycle, search, compression, and export.
## Reverting to the classic CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#reverting-to-the-classic-cli "Reverting to the classic CLI的直接链接")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#see-also "See also的直接链接")
  * [CLI Interface](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/cli) — full slash command and keybinding reference (shared)
  * [Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/sessions) — resume, branch, and history
  * [Skins & Themes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skins) — theme the banner, status bar, and overlays
  * [Voice Mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/voice-mode) — works in both interfaces
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration) — all config keys


  * [Why the TUI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#why-the-tui)
  * [Requirements](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#requirements)
    * [External prebuild](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#external-prebuild)
  * [Keybindings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#keybindings)
  * [Slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#slash-commands)
  * [LaTeX math rendering](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#latex-math-rendering)
  * [Light-terminal detection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#light-terminal-detection)
  * [Busy indicator styles](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#busy-indicator-styles)
  * [Auto-resume](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#auto-resume)
  * [Status line](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#status-line)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#configuration)
  * [Reverting to the classic CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/tui#reverting-to-the-classic-cli)

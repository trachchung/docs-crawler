<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions -->
...
If a [profile](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profiles) is a local agent, a distribution is that agent made shareable.
## What this means[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#what-this-means "What this means的直接链接")
...
## Why git?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#why-git "Why git?的直接链接")
...
## When should you use a distribution?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#when-should-you-use-a-distribution "When should you use a distribution?的直接链接")
Good fits:
...
Not a fit:
  * **You just want to back up a profile on your own machine.** Use [`hermes profile export` / `import`](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/profile-commands#hermes-profile-export) — that's what those are for.
...
## The lifecycle: author to installer to update[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#the-lifecycle-author-to-installer-to-update "The lifecycle: author to installer to update的直接链接")
Below is the full end-to-end flow. Pick the side you care about.
## For authors: publishing a distribution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#for-authors-publishing-a-distribution "For authors: publishing a distribution的直接链接")
### Step 1 — Start from a working profile[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-1--start-from-a-working-profile "Step 1 — Start from a working profile的直接链接")
...
### Step 2 — Add a `distribution.yaml`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-2--add-a-distributionyaml "step-2--add-a-distributionyaml的直接链接")
...
### Step 3 — Push to a git repo[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-3--push-to-a-git-repo "Step 3 — Push to a git repo的直接链接")
...
### Step 4 — Tag versioned releases[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-4--tag-versioned-releases "Step 4 — Tag versioned releases的直接链接")
...
### What the repo looks like[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#what-the-repo-looks-like "What the repo looks like的直接链接")
...
### Distribution-owned vs user-owned[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#distribution-owned-vs-user-owned "Distribution-owned vs user-owned的直接链接")
...
## For installers: using a distribution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#for-installers-using-a-distribution "For installers: using a distribution的直接链接")
### Install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#install "Install的直接链接")
...
### Source types[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#source-types "Source types的直接链接")
Any git URL works:
...
### Override the profile name[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#override-the-profile-name "Override the profile name的直接链接")
...
### Fill in env vars[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#fill-in-env-vars "Fill in env vars的直接链接")
...
### Check what you installed[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#check-what-you-installed "Check what you installed的直接链接")
...
### Update[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#update "Update的直接链接")
...
### Remove[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#remove "Remove的直接链接")
...
## Use cases and patterns[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#use-cases-and-patterns "Use cases and patterns的直接链接")
### Personal: sync one agent across machines[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#personal-sync-one-agent-across-machines "Personal: sync one agent across machines的直接链接")
...
### Team: ship a reviewed internal agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#team-ship-a-reviewed-internal-agent "Team: ship a reviewed internal agent的直接链接")
...
### Community: publish a public agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#community-publish-a-public-agent "Community: publish a public agent的直接链接")
...
### Product: ship an opinionated agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#product-ship-an-opinionated-agent "Product: ship an opinionated agent的直接链接")
...
### Ephemeral: one-off scripts on shared infra[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#ephemeral-one-off-scripts-on-shared-infra "Ephemeral: one-off scripts on shared infra的直接链接")
...
## Recipes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#recipes "Recipes的直接链接")
### Pin to a specific version[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#pin-to-a-specific-version "Pin to a specific version的直接链接")
...
### Check what version you're on vs. latest[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#check-what-version-youre-on-vs-latest "Check what version you're on vs. latest的直接链接")
...
### Keep local config customizations through updates[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#keep-local-config-customizations-through-updates "Keep local config customizations through updates的直接链接")
...
### Force a clean re-install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#force-a-clean-re-install "Force a clean re-install的直接链接")
...
### Fork and customize[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#fork-and-customize "Fork and customize的直接链接")
...
### Test a distribution before pushing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#test-a-distribution-before-pushing "Test a distribution before pushing的直接链接")
...
## What's NOT in a distribution (ever)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#whats-not-in-a-distribution-ever "What's NOT in a distribution \(ever\)的直接链接")
...
## Security and trust[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#security-and-trust "Security and trust的直接链接")
...
## Under the hood[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#under-the-hood "Under the hood的直接链接")
For implementation details, precise CLI behavior, and all flags, see the [Profile Commands reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/profile-commands#distribution-commands).
The short version:
...
## See also[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#see-also "See also的直接链接")
  * [Profiles: Running Multiple Agents](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profiles) — the base concept
  * [Profile Commands reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/profile-commands) — every flag, every option
  * [`hermes profile export` / `import`](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/profile-commands#hermes-profile-export) — local backup / restore (not distribution)
  * [Using SOUL with Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/use-soul-with-hermes) — authoring personalities
  * [Personality & SOUL](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/personality) — how SOUL fits into the agent
  * [Skills catalog](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/skills-catalog) — skills you can bundle


  * [What this means](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#what-this-means)
  * [When should you use a distribution?](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#when-should-you-use-a-distribution)
  * [The lifecycle: author to installer to update](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#the-lifecycle-author-to-installer-to-update)
  * [For authors: publishing a distribution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#for-authors-publishing-a-distribution)
    * [Step 1 — Start from a working profile](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-1--start-from-a-working-profile)
    * [Step 2 — Add a `distribution.yaml`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-2--add-a-distributionyaml)
    * [Step 3 — Push to a git repo](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-3--push-to-a-git-repo)
    * [Step 4 — Tag versioned releases](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#step-4--tag-versioned-releases)
    * [What the repo looks like](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#what-the-repo-looks-like)
    * [Distribution-owned vs user-owned](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#distribution-owned-vs-user-owned)
  * [For installers: using a distribution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#for-installers-using-a-distribution)
    * [Source types](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#source-types)
    * [Override the profile name](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#override-the-profile-name)
    * [Fill in env vars](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#fill-in-env-vars)
    * [Check what you installed](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#check-what-you-installed)
  * [Use cases and patterns](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#use-cases-and-patterns)
    * [Personal: sync one agent across machines](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#personal-sync-one-agent-across-machines)
    * [Team: ship a reviewed internal agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#team-ship-a-reviewed-internal-agent)
    * [Community: publish a public agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#community-publish-a-public-agent)
    * [Product: ship an opinionated agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#product-ship-an-opinionated-agent)
    * [Ephemeral: one-off scripts on shared infra](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#ephemeral-one-off-scripts-on-shared-infra)
  * [Recipes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#recipes)
    * [Pin to a specific version](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#pin-to-a-specific-version)
    * [Check what version you're on vs. latest](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#check-what-version-youre-on-vs-latest)
    * [Keep local config customizations through updates](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#keep-local-config-customizations-through-updates)
    * [Force a clean re-install](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#force-a-clean-re-install)
    * [Fork and customize](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#fork-and-customize)
    * [Test a distribution before pushing](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#test-a-distribution-before-pushing)
  * [What's NOT in a distribution (ever)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#whats-not-in-a-distribution-ever)
  * [Security and trust](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#security-and-trust)
  * [Under the hood](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profile-distributions#under-the-hood)

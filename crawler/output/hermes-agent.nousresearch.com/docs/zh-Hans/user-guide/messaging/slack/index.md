<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack -->
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#overview "Overview的直接链接")  
| Component  | Value  |  
| --- | --- |  
...
## Step 1: Create a Slack App[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-1-create-a-slack-app "Step 1: Create a Slack App的直接链接")
...
### Option A: From a Hermes-generated manifest (recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#option-a-from-a-hermes-generated-manifest-recommended "Option A: From a Hermes-generated manifest \(recommended\)的直接链接")
...
### Option B: From scratch (manual)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#option-b-from-scratch-manual "Option B: From scratch \(manual\)的直接链接")
...
## Step 2: Configure Bot Token Scopes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-2-configure-bot-token-scopes "Step 2: Configure Bot Token Scopes的直接链接")
...
## Step 3: Enable Socket Mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-3-enable-socket-mode "Step 3: Enable Socket Mode的直接链接")
...
## Step 4: Subscribe to Events[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-4-subscribe-to-events "Step 4: Subscribe to Events的直接链接")
...
## Step 5: Enable the Messages Tab[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-5-enable-the-messages-tab "Step 5: Enable the Messages Tab的直接链接")
...
## Step 6: Install App to Workspace[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-6-install-app-to-workspace "Step 6: Install App to Workspace的直接链接")
...
## Step 7: Find User IDs for the Allowlist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-7-find-user-ids-for-the-allowlist "Step 7: Find User IDs for the Allowlist的直接链接")
...
## Step 8: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-8-configure-hermes "Step 8: Configure Hermes的直接链接")
...
## Step 9: Invite the Bot to Channels[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-9-invite-the-bot-to-channels "Step 9: Invite the Bot to Channels的直接链接")
...
## Slash Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#slash-commands "Slash Commands的直接链接")
...
### Refreshing slash commands after updates[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#refreshing-slash-commands-after-updates "Refreshing slash commands after updates的直接链接")
...
### Legacy `/hermes <subcommand>` still works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#legacy-hermes-subcommand-still-works "legacy-hermes-subcommand-still-works的直接链接")
...
### Using commands inside threads (the `!cmd` prefix)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#using-commands-inside-threads-the-cmd-prefix "using-commands-inside-threads-the-cmd-prefix的直接链接")
...
### Advanced: emit only the slash-commands array[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#advanced-emit-only-the-slash-commands-array "Advanced: emit only the slash-commands array的直接链接")
...
## How the Bot Responds[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#how-the-bot-responds "How the Bot Responds的直接链接")
...
## Configuration Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#configuration-options "Configuration Options的直接链接")
Beyond the required environment variables from Step 8, you can customize Slack bot behavior through `~/.hermes/config.yaml`.
### Thread & Reply Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#thread--reply-behavior "Thread & Reply Behavior的直接链接")
...
### Session Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#session-isolation "Session Isolation的直接链接")
...
### Mention & Trigger Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#mention--trigger-behavior "Mention & Trigger Behavior的直接链接")

```
slack:# Require @mention in channels (this is the default behavior;# the Slack adapter enforces @mention gating in channels regardless,# but you can set this explicitly for consistency with other platforms)require_mention:true# Prevent thread auto-engagement: only reply to channel messages that# contain an explicit @mention. With this OFF (default), Slack can# "auto-engage" — remembering past mentions in a thread and following# up on bot-message replies, and resuming active sessions without a# fresh mention. With strict_mention ON, every new channel message# must @mention the bot before Hermes will respond.strict_mention:false# Custom mention patterns that trigger the bot# (in addition to the default @mention detection)mention_patterns:-"hey hermes"-"hermes,"# Text prepended to every outgoing messagereply_prefix:""
```
...
### Unauthorized User Handling[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#unauthorized-user-handling "Unauthorized User Handling的直接链接")
...
### Voice Transcription[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#voice-transcription "Voice Transcription的直接链接")
...
### Full Example[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#full-example "Full Example的直接链接")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#home-channel "Home Channel的直接链接")
...
## Multi-Workspace Support[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#multi-workspace-support "Multi-Workspace Support的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#configuration "Configuration的直接链接")
...
### OAuth Token File[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#oauth-token-file "OAuth Token File的直接链接")
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#how-it-works "How it works的直接链接")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#voice-messages "Voice Messages的直接链接")
...
## Per-Channel Prompts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#per-channel-prompts "Per-Channel Prompts的直接链接")
...
## Per-Channel Skill Bindings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#per-channel-skill-bindings "Per-Channel Skill Bindings的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
### Quick Checklist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#quick-checklist "Quick Checklist的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#security "Security的直接链接")
**Always set`SLACK_ALLOWED_USERS`** with the Member IDs of authorized users. Without this setting, the gateway will **deny all messages** by default as a safety measure. Never share your bot tokens — treat them like passwords.
  ...
  * [Step 1: Create a Slack App](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-1-create-a-slack-app)
    * [Option A: From a Hermes-generated manifest (recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#option-a-from-a-hermes-generated-manifest-recommended)
    * [Option B: From scratch (manual)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#option-b-from-scratch-manual)
  * [Step 2: Configure Bot Token Scopes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-2-configure-bot-token-scopes)
  * [Step 3: Enable Socket Mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-3-enable-socket-mode)
  * [Step 4: Subscribe to Events](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-4-subscribe-to-events)
  * [Step 5: Enable the Messages Tab](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-5-enable-the-messages-tab)
  * [Step 6: Install App to Workspace](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-6-install-app-to-workspace)
  * [Step 7: Find User IDs for the Allowlist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-7-find-user-ids-for-the-allowlist)
  * [Step 8: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-8-configure-hermes)
  * [Step 9: Invite the Bot to Channels](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#step-9-invite-the-bot-to-channels)
  * [Slash Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#slash-commands)
    * [Refreshing slash commands after updates](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#refreshing-slash-commands-after-updates)
    * [Legacy `/hermes <subcommand>` still works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#legacy-hermes-subcommand-still-works)
    * [Using commands inside threads (the `!cmd` prefix)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#using-commands-inside-threads-the-cmd-prefix)
    * [Advanced: emit only the slash-commands array](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#advanced-emit-only-the-slash-commands-array)
  * [How the Bot Responds](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#how-the-bot-responds)
  * [Configuration Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#configuration-options)
    * [Thread & Reply Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#thread--reply-behavior)
    * [Session Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#session-isolation)
    * [Mention & Trigger Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#mention--trigger-behavior)
    * [Unauthorized User Handling](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#unauthorized-user-handling)
    * [Voice Transcription](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#voice-transcription)
    * [Full Example](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#full-example)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#home-channel)
  * [Multi-Workspace Support](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#multi-workspace-support)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#configuration)
    * [OAuth Token File](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#oauth-token-file)
    * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#how-it-works)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#voice-messages)
  * [Per-Channel Prompts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#per-channel-prompts)
  * [Per-Channel Skill Bindings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#per-channel-skill-bindings)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#troubleshooting)
    * [Quick Checklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack#quick-checklist)

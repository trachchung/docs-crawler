<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams -->
...
Need meeting summaries from Microsoft Graph events rather than normal bot conversations? Use the dedicated setup page: [Teams Meetings](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/teams-meetings).
## How the Bot Responds[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#how-the-bot-responds "How the Bot Responds的直接链接")  
| Context  | Behavior  |  
| --- | --- |  
...
## Step 1: Install the Teams CLI[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-1-install-the-teams-cli "Step 1: Install the Teams CLI的直接链接")
...
## Step 2: Expose the Webhook Port[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-2-expose-the-webhook-port "Step 2: Expose the Webhook Port的直接链接")
...
For production, point your bot's endpoint at your server's public domain instead (see [Production Deployment](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#production-deployment)).
## Step 3: Create the Bot[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-3-create-the-bot "Step 3: Create the Bot的直接链接")
...
## Step 4: Configure Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-4-configure-environment-variables "Step 4: Configure Environment Variables的直接链接")
Add to `~/.hermes/.env`:
...
## Step 5: Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-5-start-the-gateway "Step 5: Start the Gateway的直接链接")
...
## Step 6: Install the App in Teams[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-6-install-the-app-in-teams "Step 6: Install the App in Teams的直接链接")
...
## Configuration Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#configuration-reference "Configuration Reference的直接链接")
### Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#environment-variables "Environment Variables的直接链接")  
...
### config.yaml[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#configyaml "config.yaml的直接链接")
...
## Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#features "Features的直接链接")
### Interactive Approval Cards[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#interactive-approval-cards "Interactive Approval Cards的直接链接")
...
### Meeting Summary Delivery (Teams Meeting Pipeline)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#meeting-summary-delivery-teams-meeting-pipeline "Meeting Summary Delivery \(Teams Meeting Pipeline\)的直接链接")
When the [Teams meeting pipeline plugin](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/msgraph-webhook) is enabled, this adapter also handles outbound delivery of meeting summaries — one Teams integration surface, not two. After a meeting's transcript is summarized, the writer posts the summary into your chosen Teams target.
...
| `graph`  | Threaded channel posts or 1:1/group chat posts under the bot's identity via Microsoft Graph.  | Requires the [Graph app registration](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/microsoft-graph-app-registration) with `ChannelMessage.Send` (channel) or `Chat.ReadWrite.All` (chat) application permissions.  |  
...
## Production Deployment[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#production-deployment "Production Deployment的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#security "Security的直接链接")
...
## Related Docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#related-docs "Related Docs的直接链接")
  * [Teams Meetings](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/teams-meetings)
  ...
  * [How the Bot Responds](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#how-the-bot-responds)
  * [Step 1: Install the Teams CLI](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-1-install-the-teams-cli)
  * [Step 2: Expose the Webhook Port](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-2-expose-the-webhook-port)
  * [Step 3: Create the Bot](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-3-create-the-bot)
  * [Step 4: Configure Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-4-configure-environment-variables)
  * [Step 5: Start the Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-5-start-the-gateway)
  * [Step 6: Install the App in Teams](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#step-6-install-the-app-in-teams)
  * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#configuration-reference)
    * [Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#environment-variables)
    * [config.yaml](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#configyaml)
  * [Features](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#features)
    * [Interactive Approval Cards](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#interactive-approval-cards)
    * [Meeting Summary Delivery (Teams Meeting Pipeline)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#meeting-summary-delivery-teams-meeting-pipeline)
  * [Production Deployment](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#production-deployment)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#troubleshooting)
  * [Related Docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams#related-docs)

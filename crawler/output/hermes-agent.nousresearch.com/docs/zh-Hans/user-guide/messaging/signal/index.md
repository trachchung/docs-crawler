<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal -->
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#prerequisites "Prerequisites的直接链接")
...
### Installing signal-cli[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#installing-signal-cli "Installing signal-cli的直接链接")

```
# macOSbrew install signal-cli# Linux (download latest release)VERSION=$(curl-Ls-o /dev/null -w %{url_effective}\  https://github.com/AsamK/signal-cli/releases/latest |sed's/^.*\/v//')curl-L-O"https://github.com/AsamK/signal-cli/releases/download/v${VERSION}/signal-cli-${VERSION}.tar.gz"sudotar xf "signal-cli-${VERSION}.tar.gz"-C /optsudoln-sf"/opt/signal-cli-${VERSION}/bin/signal-cli" /usr/local/bin/
```
...
## Step 1: Link Your Signal Account[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#step-1-link-your-signal-account "Step 1: Link Your Signal Account的直接链接")
...
## Step 2: Start the signal-cli Daemon[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#step-2-start-the-signal-cli-daemon "Step 2: Start the signal-cli Daemon的直接链接")

```
# Replace +1234567890 with your Signal phone number (E.164 format)signal-cli --account +1234567890 daemon --http127.0.0.1:8080
```
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#step-3-configure-hermes "Step 3: Configure Hermes的直接链接")
The easiest way:
...
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#manual-configuration "Manual Configuration的直接链接")
Add to `~/.hermes/.env`:
...
## Access Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#access-control "Access Control的直接链接")
### DM Access[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#dm-access "DM Access的直接链接")
...
### Group Access[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#group-access "Group Access的直接链接")
...
## Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#features "Features的直接链接")
### Attachments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#attachments "Attachments的直接链接")
...
### Native Formatting, Reply Quotes, and Reactions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#native-formatting-reply-quotes-and-reactions "Native Formatting, Reply Quotes, and Reactions的直接链接")
...
### Typing Indicators[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#typing-indicators "Typing Indicators的直接链接")
The bot sends typing indicators while processing messages, refreshing every 8 seconds.
### Phone Number Redaction[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#phone-number-redaction "Phone Number Redaction的直接链接")
...
### Note to Self (Single-Number Setup)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#note-to-self-single-number-setup "Note to Self \(Single-Number Setup\)的直接链接")
...
### Health Monitoring[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#health-monitoring "Health Monitoring的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#security "Security的直接链接")
...
## Environment Variables Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#environment-variables-reference "Environment Variables Reference的直接链接")  
...
| `SIGNAL_HOME_CHANNEL`  | No  | —  | Default delivery target for cron jobs  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#prerequisites)
    * [Installing signal-cli](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#installing-signal-cli)
  * [Step 1: Link Your Signal Account](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#step-1-link-your-signal-account)
  * [Step 2: Start the signal-cli Daemon](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#step-2-start-the-signal-cli-daemon)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#step-3-configure-hermes)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#manual-configuration)
  * [Access Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#access-control)
    * [Group Access](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#group-access)
  * [Features](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#features)
    * [Attachments](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#attachments)
    * [Native Formatting, Reply Quotes, and Reactions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#native-formatting-reply-quotes-and-reactions)
    * [Typing Indicators](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#typing-indicators)
    * [Phone Number Redaction](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#phone-number-redaction)
    * [Note to Self (Single-Number Setup)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#note-to-self-single-number-setup)
    * [Health Monitoring](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#health-monitoring)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#troubleshooting)
  * [Environment Variables Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal#environment-variables-reference)

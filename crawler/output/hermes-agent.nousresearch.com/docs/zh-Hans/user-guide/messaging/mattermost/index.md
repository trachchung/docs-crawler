<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost -->
...
## How Hermes Behaves[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#how-hermes-behaves "How Hermes Behaves的直接链接")  
| Context  | Behavior  |  
| --- | --- |  
...
### Session Model in Mattermost[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#session-model-in-mattermost "Session Model in Mattermost的直接链接")
By default:
...
## Step 1: Enable Bot Accounts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-1-enable-bot-accounts "Step 1: Enable Bot Accounts的直接链接")
...
## Step 2: Create a Bot Account[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-2-create-a-bot-account "Step 2: Create a Bot Account的直接链接")
...
## Step 3: Add the Bot to Channels[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-3-add-the-bot-to-channels "Step 3: Add the Bot to Channels的直接链接")
...
## Step 4: Find Your Mattermost User ID[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-4-find-your-mattermost-user-id "Step 4: Find Your Mattermost User ID的直接链接")
...
## Step 5: Configure Hermes Agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-5-configure-hermes-agent "Step 5: Configure Hermes Agent的直接链接")
### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#option-a-interactive-setup-recommended "Option A: Interactive Setup \(Recommended\)的直接链接")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#option-b-manual-configuration "Option B: Manual Configuration的直接链接")
...
### Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#start-the-gateway "Start the Gateway的直接链接")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#home-channel "Home Channel的直接链接")
...
### Using the Slash Command[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#using-the-slash-command "Using the Slash Command的直接链接")
Type `/sethome` in any Mattermost channel where the bot is present. That channel becomes the home channel.
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#manual-configuration "Manual Configuration的直接链接")
...
## Reply Mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#reply-mode "Reply Mode的直接链接")
...
## Mention Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#mention-behavior "Mention Behavior的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#troubleshooting "Troubleshooting的直接链接")
### Bot is not responding to messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#bot-is-not-responding-to-messages "Bot is not responding to messages的直接链接")
...
### 403 Forbidden errors[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#403-forbidden-errors "403 Forbidden errors的直接链接")
...
### WebSocket disconnects / reconnection loops[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#websocket-disconnects--reconnection-loops "WebSocket disconnects / reconnection loops的直接链接")
...
### "Failed to authenticate" on startup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#failed-to-authenticate-on-startup ""Failed to authenticate" on startup的直接链接")
...
### Bot is offline[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#bot-is-offline "Bot is offline的直接链接")
...
### "User not allowed" / Bot ignores you[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#user-not-allowed--bot-ignores-you ""User not allowed" / Bot ignores you的直接链接")
...
## Per-Channel Prompts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#per-channel-prompts "Per-Channel Prompts的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#security "Security的直接链接")
...
## Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#notes "Notes的直接链接")
  ...
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#how-hermes-behaves)
    * [Session Model in Mattermost](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#session-model-in-mattermost)
  * [Step 1: Enable Bot Accounts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-1-enable-bot-accounts)
  * [Step 2: Create a Bot Account](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-2-create-a-bot-account)
  * [Step 3: Add the Bot to Channels](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-3-add-the-bot-to-channels)
  * [Step 4: Find Your Mattermost User ID](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-4-find-your-mattermost-user-id)
  * [Step 5: Configure Hermes Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#step-5-configure-hermes-agent)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#option-b-manual-configuration)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#start-the-gateway)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#home-channel)
    * [Using the Slash Command](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#using-the-slash-command)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#manual-configuration)
  * [Mention Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#mention-behavior)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#troubleshooting)
    * [Bot is not responding to messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#bot-is-not-responding-to-messages)
    * [403 Forbidden errors](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#403-forbidden-errors)
    * [WebSocket disconnects / reconnection loops](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#websocket-disconnects--reconnection-loops)
    * ["Failed to authenticate" on startup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#failed-to-authenticate-on-startup)
    * [Bot is offline](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#bot-is-offline)
    * ["User not allowed" / Bot ignores you](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#user-not-allowed--bot-ignores-you)
  * [Per-Channel Prompts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost#per-channel-prompts)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook -->
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#prerequisites "Prerequisites的直接链接")
  * Microsoft Graph application credentials — [Register a Microsoft Graph Application](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/microsoft-graph-app-registration)
...
## Quick Start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#quick-start "Quick Start的直接链接")
Minimum `~/.hermes/config.yaml`:

```
platforms:msgraph_webhook:enabled:trueextra:port:8646client_state:"replace-with-a-strong-secret"accepted_resources:-"communications/onlineMeetings"
```
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#configuration "Configuration的直接链接")
...
Each setting also has an equivalent env var (`MSGRAPH_WEBHOOK_*`) that merges into the config at gateway startup — see the [environment variables reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/reference/environment-variables#microsoft-graph-teams-meetings).
## Security Hardening[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#security-hardening "Security Hardening的直接链接")
### clientState is the primary auth check[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#clientstate-is-the-primary-auth-check "clientState is the primary auth check的直接链接")
...
### Source-IP allowlisting (production deployments)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#source-ip-allowlisting-production-deployments "Source-IP allowlisting \(production deployments\)的直接链接")
...
```
platforms:msgraph_webhook:enabled:trueextra:client_state:"..."allowed_source_cidrs:-"52.96.0.0/14"-"52.104.0.0/14"# ...add the current Microsoft 365 "Common" + "Teams" category egress ranges
```
...
### HTTPS termination[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#https-termination "HTTPS termination的直接链接")
...
### Response hygiene[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#response-hygiene "Response hygiene的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#troubleshooting "Troubleshooting的直接链接")  
...
## Related Docs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#related-docs "Related Docs的直接链接")
  * [Register a Microsoft Graph Application](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/microsoft-graph-app-registration) — Azure app registration prereq
  * [Environment Variables → Microsoft Graph](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/reference/environment-variables#microsoft-graph-teams-meetings) — full env var list
  * [Microsoft Teams bot setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/teams) — the different platform that lets users chat with Hermes in Teams


  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#prerequisites)
  * [Quick Start](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#quick-start)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#configuration)
  * [Security Hardening](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#security-hardening)
    * [clientState is the primary auth check](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#clientstate-is-the-primary-auth-check)
    * [Source-IP allowlisting (production deployments)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#source-ip-allowlisting-production-deployments)
    * [HTTPS termination](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#https-termination)
    * [Response hygiene](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#response-hygiene)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#troubleshooting)
  * [Related Docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/msgraph-webhook#related-docs)

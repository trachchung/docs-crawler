...
This adapter is for **personal WeChat accounts** (微信). If you need enterprise/corporate WeChat, see the [WeCom adapter](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom) instead.
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#prerequisites "Prerequisites的直接链接")
...
```
pip install aiohttp cryptography# Optional: for terminal QR code displaypip install hermes-agent[messaging]
```

## Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#setup "Setup的直接链接")
### 1. Run the Setup Wizard[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#1-run-the-setup-wizard "1. Run the Setup Wizard的直接链接")
...
### 2. Configure Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#2-configure-environment-variables "2. Configure Environment Variables的直接链接")
...
### 3. Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#3-start-the-gateway "3. Start the Gateway的直接链接")
...
## Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#features "Features的直接链接")
...
## Configuration Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#configuration-options "Configuration Options的直接链接")
...
## Access Policies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#access-policies "Access Policies的直接链接")
### DM Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#dm-policy "DM Policy的直接链接")
...
### Group Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#group-policy "Group Policy的直接链接")
...
## Media Support[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#media-support "Media Support的直接链接")
### Inbound (receiving)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#inbound-receiving "Inbound \(receiving\)的直接链接")
...
### AES-128-ECB Encrypted CDN[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#aes-128-ecb-encrypted-cdn "AES-128-ECB Encrypted CDN的直接链接")
...
### Outbound (sending)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#outbound-sending "Outbound \(sending\)的直接链接")  
...
## Context Token Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#context-token-persistence "Context Token Persistence的直接链接")
...
## Markdown Formatting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#markdown-formatting "Markdown Formatting的直接链接")
...
## Message Chunking[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#message-chunking "Message Chunking的直接链接")
...
## Typing Indicators[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#typing-indicators "Typing Indicators的直接链接")
...
## Long-Poll Connection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#long-poll-connection "Long-Poll Connection的直接链接")
The adapter uses HTTP long-polling (not WebSocket) to receive messages:
### How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#how-it-works "How It Works的直接链接")
...
### Retry Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#retry-behavior "Retry Behavior的直接链接")
...
### Deduplication[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#deduplication "Deduplication的直接链接")
...
### Token Lock[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#token-lock "Token Lock的直接链接")
...
## All Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#all-environment-variables "All Environment Variables的直接链接")  
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Fix  |  
| --- | --- |  
...
| Terminal QR code doesn't render  | Reinstall with the messaging extra: `pip install hermes-agent[messaging]`. Alternatively, open the URL printed above the QR  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#prerequisites)
  * [Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#setup)
    * [1. Run the Setup Wizard](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#1-run-the-setup-wizard)
    * [2. Configure Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#2-configure-environment-variables)
    * [3. Start the Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#3-start-the-gateway)
  * [Configuration Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#configuration-options)
  * [Access Policies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#access-policies)
    * [Group Policy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#group-policy)
  * [Media Support](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#media-support)
    * [Inbound (receiving)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#inbound-receiving)
    * [AES-128-ECB Encrypted CDN](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#aes-128-ecb-encrypted-cdn)
    * [Outbound (sending)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#outbound-sending)
  * [Context Token Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#context-token-persistence)
  * [Markdown Formatting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#markdown-formatting)
  * [Message Chunking](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#message-chunking)
  * [Typing Indicators](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#typing-indicators)
  * [Long-Poll Connection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#long-poll-connection)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#how-it-works)
    * [Retry Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#retry-behavior)
    * [Deduplication](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#deduplication)
  * [All Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#all-environment-variables)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin#troubleshooting)

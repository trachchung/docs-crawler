<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord -->
...
## How Hermes Behaves[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#how-hermes-behaves "How Hermes Behaves的直接链接")  
| Context  | Behavior  |  
| --- | --- |  
...
### Discord Gateway Model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discord-gateway-model "Discord Gateway Model的直接链接")
...
### Session Model in Discord[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#session-model-in-discord "Session Model in Discord的直接链接")
By default:
...
### Interrupts and Concurrency[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#interrupts-and-concurrency "Interrupts and Concurrency的直接链接")
...
## Step 1: Create a Discord Application[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-1-create-a-discord-application "Step 1: Create a Discord Application的直接链接")
...
## Step 2: Create the Bot[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-2-create-the-bot "Step 2: Create the Bot的直接链接")
...
## Step 3: Enable Privileged Gateway Intents[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-3-enable-privileged-gateway-intents "Step 3: Enable Privileged Gateway Intents的直接链接")
...
## Step 4: Get the Bot Token[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-4-get-the-bot-token "Step 4: Get the Bot Token的直接链接")
...
## Step 5: Generate the Invite URL[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-5-generate-the-invite-url "Step 5: Generate the Invite URL的直接链接")
You need an OAuth2 URL to invite the bot to your server. There are two ways to do this:
### Option A: Using the Installation Tab (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-a-using-the-installation-tab-recommended "Option A: Using the Installation Tab \(Recommended\)的直接链接")
...
### Option B: Manual URL[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-b-manual-url "Option B: Manual URL的直接链接")
...
### Required Permissions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#required-permissions "Required Permissions的直接链接")
...
### Recommended Additional Permissions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#recommended-additional-permissions "Recommended Additional Permissions的直接链接")
  * **Send Messages in Threads** — respond in thread conversations
  * **Add Reactions** — react to messages for acknowledgment


### Permission Integers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#permission-integers "Permission Integers的直接链接")  
...
## Step 6: Invite to Your Server[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-6-invite-to-your-server "Step 6: Invite to Your Server的直接链接")
...
## Step 7: Find Your Discord User ID[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-7-find-your-discord-user-id "Step 7: Find Your Discord User ID的直接链接")
...
## Step 8: Configure Hermes Agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-8-configure-hermes-agent "Step 8: Configure Hermes Agent的直接链接")
### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-a-interactive-setup-recommended "Option A: Interactive Setup \(Recommended\)的直接链接")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-b-manual-configuration "Option B: Manual Configuration的直接链接")
...
## Configuration Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#configuration-reference "Configuration Reference的直接链接")
...
### Environment Variables (`.env`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#environment-variables-env "environment-variables-env的直接链接")  
...
| `DISCORD_ALLOW_MENTION_EVERYONE`  | No  | `false`  | When `false` (default), the bot cannot ping `@everyone` or `@here` even if its response contains those tokens. Set to `true` to opt back in. See [Mention Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#mention-control) below.  |  
...
### Config File (`config.yaml`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#config-file-configyaml "config-file-configyaml的直接链接")
...
####  `discord.thread_require_mention`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discordthread_require_mention "discordthread_require_mention的直接链接")
...
```
discord:require_mention:truethread_require_mention:true# multi-bot setup
```

####  `discord.free_response_channels`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discordfree_response_channels "discordfree_response_channels的直接链接")
...
####  `discord.reactions`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discordreactions "discordreactions的直接链接")
**Type:** boolean — **Default:** `true`
...
####  `discord.ignored_channels`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discordignored_channels "discordignored_channels的直接链接")
**Type:** string or list — **Default:** `[]`
...
####  `discord.no_thread_channels`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discordno_thread_channels "discordno_thread_channels的直接链接")
**Type:** string or list — **Default:** `[]`
...
####  `discord.channel_prompts`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discordchannel_prompts "discordchannel_prompts的直接链接")
...
####  `group_sessions_per_user`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#group_sessions_per_user "group_sessions_per_user的直接链接")
**Type:** boolean — **Default:** `true`
...
See the [Session Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#session-model-in-discord) section above for the full implications of each mode.
####  `display.tool_progress`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#displaytool_progress "displaytool_progress的直接链接")
...
####  `display.tool_progress_command`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#displaytool_progress_command "displaytool_progress_command的直接链接")
**Type:** boolean — **Default:** `false`
...
## Slash Command Access Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#slash-command-access-control "Slash Command Access Control的直接链接")
...
## Interactive Model Picker[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#interactive-model-picker "Interactive Model Picker的直接链接")
...
## Native Slash Commands for Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#native-slash-commands-for-skills "Native Slash Commands for Skills的直接链接")
...
### Disabling Slash Command Registration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#disabling-slash-command-registration "Disabling Slash Command Registration的直接链接")
...
## Sending Media (`send_message` + `MEDIA:` tags)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#sending-media-send_message--media-tags "sending-media-send_message--media-tags的直接链接")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#home-channel "Home Channel的直接链接")
...
### Using the Slash Command[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#using-the-slash-command "Using the Slash Command的直接链接")
Type `/sethome` in any Discord channel where the bot is present. That channel becomes the home channel.
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#manual-configuration "Manual Configuration的直接链接")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#voice-messages "Voice Messages的直接链接")
...
For the full setup and operational guide, see:
  * [Use Voice Mode with Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/guides/use-voice-mode-with-hermes)


## Forum Channels[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#forum-channels "Forum Channels的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#troubleshooting "Troubleshooting的直接链接")
### Bot is online but not responding to messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#bot-is-online-but-not-responding-to-messages "Bot is online but not responding to messages的直接链接")
...
### "Disallowed Intents" error on startup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#disallowed-intents-error-on-startup ""Disallowed Intents" error on startup的直接链接")
...
### Bot can't see messages in a specific channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#bot-cant-see-messages-in-a-specific-channel "Bot can't see messages in a specific channel的直接链接")
...
### 403 Forbidden errors[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#403-forbidden-errors "403 Forbidden errors的直接链接")
...
### Bot is offline[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#bot-is-offline "Bot is offline的直接链接")
...
### "User not allowed" / Bot ignores you[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#user-not-allowed--bot-ignores-you ""User not allowed" / Bot ignores you的直接链接")
...
### People in the same channel are sharing context unexpectedly[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#people-in-the-same-channel-are-sharing-context-unexpectedly "People in the same channel are sharing context unexpectedly的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#security "Security的直接链接")
...
### Role-Based Access Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#role-based-access-control "Role-Based Access Control的直接链接")
...
### Mention Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#mention-control "Mention Control的直接链接")
...
For more information on securing your Hermes Agent deployment, see the [Security Guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security).
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#how-hermes-behaves)
    * [Discord Gateway Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#discord-gateway-model)
    * [Session Model in Discord](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#session-model-in-discord)
    * [Interrupts and Concurrency](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#interrupts-and-concurrency)
  * [Step 1: Create a Discord Application](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-1-create-a-discord-application)
  * [Step 2: Create the Bot](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-2-create-the-bot)
  * [Step 3: Enable Privileged Gateway Intents](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-3-enable-privileged-gateway-intents)
  * [Step 4: Get the Bot Token](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-4-get-the-bot-token)
  * [Step 5: Generate the Invite URL](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-5-generate-the-invite-url)
    * [Option A: Using the Installation Tab (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-a-using-the-installation-tab-recommended)
    * [Option B: Manual URL](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-b-manual-url)
    * [Required Permissions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#required-permissions)
    * [Recommended Additional Permissions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#recommended-additional-permissions)
    * [Permission Integers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#permission-integers)
  * [Step 6: Invite to Your Server](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-6-invite-to-your-server)
  * [Step 7: Find Your Discord User ID](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-7-find-your-discord-user-id)
  * [Step 8: Configure Hermes Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#step-8-configure-hermes-agent)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#option-b-manual-configuration)
  * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#configuration-reference)
    * [Environment Variables (`.env`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#environment-variables-env)
    * [Config File (`config.yaml`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#config-file-configyaml)
  * [Slash Command Access Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#slash-command-access-control)
  * [Interactive Model Picker](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#interactive-model-picker)
  * [Native Slash Commands for Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#native-slash-commands-for-skills)
    * [Disabling Slash Command Registration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#disabling-slash-command-registration)
  * [Sending Media (`send_message` + `MEDIA:` tags)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#sending-media-send_message--media-tags)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#home-channel)
    * [Using the Slash Command](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#using-the-slash-command)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#manual-configuration)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#voice-messages)
  * [Forum Channels](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#forum-channels)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#troubleshooting)
    * [Bot is online but not responding to messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#bot-is-online-but-not-responding-to-messages)
    * ["Disallowed Intents" error on startup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#disallowed-intents-error-on-startup)
    * [Bot can't see messages in a specific channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#bot-cant-see-messages-in-a-specific-channel)
    * [403 Forbidden errors](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#403-forbidden-errors)
    * [Bot is offline](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#bot-is-offline)
    * ["User not allowed" / Bot ignores you](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#user-not-allowed--bot-ignores-you)
    * [People in the same channel are sharing context unexpectedly](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#people-in-the-same-channel-are-sharing-context-unexpectedly)
  * [Security](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#security)
    * [Role-Based Access Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#role-based-access-control)
    * [Mention Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord#mention-control)

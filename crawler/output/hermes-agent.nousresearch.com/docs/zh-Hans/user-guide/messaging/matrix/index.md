<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix -->
...
## How Hermes Behaves[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#how-hermes-behaves "How Hermes Behaves的直接链接")  
| Context  | Behavior  |  
| --- | --- |  
...
### Session Model in Matrix[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#session-model-in-matrix "Session Model in Matrix的直接链接")
By default:
...
### Mention and Threading Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#mention-and-threading-configuration "Mention and Threading Configuration的直接链接")
...
## Step 1: Create a Bot Account[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-1-create-a-bot-account "Step 1: Create a Bot Account的直接链接")
You need a Matrix user account for the bot. There are several ways to do this:
### Option A: Register on Your Homeserver (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-a-register-on-your-homeserver-recommended "Option A: Register on Your Homeserver \(Recommended\)的直接链接")
...
### Option B: Use matrix.org or Another Public Homeserver[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-b-use-matrixorg-or-another-public-homeserver "Option B: Use matrix.org or Another Public Homeserver的直接链接")
  1. Go to [Element Web](https://app.element.io) and create a new account.
  2. Pick a username for your bot (e.g., `hermes-bot`).


### Option C: Use Your Own Account[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-c-use-your-own-account "Option C: Use Your Own Account的直接链接")
You can also run Hermes as your own user. This means the bot posts as you — useful for personal assistants.
## Step 2: Get an Access Token[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-2-get-an-access-token "Step 2: Get an Access Token的直接链接")
Hermes needs an access token to authenticate with the homeserver. You have two options:
### Option A: Access Token (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-a-access-token-recommended "Option A: Access Token \(Recommended\)的直接链接")
...
### Option B: Password Login[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-b-password-login "Option B: Password Login的直接链接")
...
## Step 3: Find Your Matrix User ID[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-3-find-your-matrix-user-id "Step 3: Find Your Matrix User ID的直接链接")
...
## Step 4: Configure Hermes Agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-4-configure-hermes-agent "Step 4: Configure Hermes Agent的直接链接")
### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-a-interactive-setup-recommended "Option A: Interactive Setup \(Recommended\)的直接链接")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-b-manual-configuration "Option B: Manual Configuration的直接链接")
...
### Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#start-the-gateway "Start the Gateway的直接链接")
...
## End-to-End Encryption (E2EE)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#end-to-end-encryption-e2ee "End-to-End Encryption \(E2EE\)的直接链接")
Hermes supports Matrix end-to-end encryption, so you can chat with your bot in encrypted rooms.
### Requirements[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#requirements "Requirements的直接链接")
...
```
# Debian/Ubuntusudoaptinstall libolm-dev# macOSbrew install libolm# Fedorasudo dnf install libolm-devel
```

### Enable E2EE[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#enable-e2ee "Enable E2EE的直接链接")
...
### Cross-Signing Verification (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#cross-signing-verification-recommended "Cross-Signing Verification \(Recommended\)的直接链接")
...
## Home Room[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#home-room "Home Room的直接链接")
...
### Using the Slash Command[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#using-the-slash-command "Using the Slash Command的直接链接")
Type `/sethome` in any Matrix room where the bot is present. That room becomes the home room.
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#manual-configuration "Manual Configuration的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#troubleshooting "Troubleshooting的直接链接")
### Bot is not responding to messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#bot-is-not-responding-to-messages "Bot is not responding to messages的直接链接")
...
### "Failed to authenticate" / "whoami failed" on startup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#failed-to-authenticate--whoami-failed-on-startup ""Failed to authenticate" / "whoami failed" on startup的直接链接")
...
### "mautrix not installed" error[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#mautrix-not-installed-error ""mautrix not installed" error的直接链接")
...
### Encryption errors / "could not decrypt event"[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#encryption-errors--could-not-decrypt-event "Encryption errors / "could not decrypt event"的直接链接")
...
### Upgrading from a previous version with E2EE[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#upgrading-from-a-previous-version-with-e2ee "Upgrading from a previous version with E2EE的直接链接")
...
## Proxy Mode (E2EE on macOS)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#proxy-mode-e2ee-on-macos "Proxy Mode \(E2EE on macOS\)的直接链接")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#how-it-works "How It Works的直接链接")
...
### Step 1: Configure the Host (macOS)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-1-configure-the-host-macos "Step 1: Configure the Host \(macOS\)的直接链接")
...
### Step 2: Configure the Docker Container (Linux VM)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-2-configure-the-docker-container-linux-vm "Step 2: Configure the Docker Container \(Linux VM\)的直接链接")
The container needs Matrix credentials and the proxy URL. It does NOT need LLM API keys.
**`docker-compose.yml`:**

```
services:hermes-matrix:build: .environment:# Matrix credentialsMATRIX_HOMESERVER:"https://matrix.example.org"MATRIX_ACCESS_TOKEN:"syt_..."MATRIX_ALLOWED_USERS:"@you:matrix.example.org"MATRIX_ENCRYPTION:"true"MATRIX_DEVICE_ID:"HERMES_BOT"# Proxy mode — forward to host agentGATEWAY_PROXY_URL:"http://192.168.1.100:8642"GATEWAY_PROXY_KEY:"your-secret-key-here"volumes:- ./matrix-store:/root/.hermes/platforms/matrix/store
```
...
### Step 3: Start Both[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-3-start-both "Step 3: Start Both的直接链接")
...
### Configuration Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#configuration-reference "Configuration Reference的直接链接")
...
### Works for Any Platform[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#works-for-any-platform "Works for Any Platform的直接链接")
...
### Sync issues / bot falls behind[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#sync-issues--bot-falls-behind "Sync issues / bot falls behind的直接链接")
...
### Bot is offline[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#bot-is-offline "Bot is offline的直接链接")
...
### "User not allowed" / Bot ignores you[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#user-not-allowed--bot-ignores-you ""User not allowed" / Bot ignores you的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#security "Security的直接链接")
...
## Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#notes "Notes的直接链接")
  ...
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#how-hermes-behaves)
    * [Session Model in Matrix](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#session-model-in-matrix)
    * [Mention and Threading Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#mention-and-threading-configuration)
  * [Step 1: Create a Bot Account](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-1-create-a-bot-account)
    * [Option A: Register on Your Homeserver (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-a-register-on-your-homeserver-recommended)
    * [Option B: Use matrix.org or Another Public Homeserver](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-b-use-matrixorg-or-another-public-homeserver)
    * [Option C: Use Your Own Account](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-c-use-your-own-account)
  * [Step 2: Get an Access Token](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-2-get-an-access-token)
    * [Option A: Access Token (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-a-access-token-recommended)
    * [Option B: Password Login](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-b-password-login)
  * [Step 3: Find Your Matrix User ID](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-3-find-your-matrix-user-id)
  * [Step 4: Configure Hermes Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-4-configure-hermes-agent)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#option-b-manual-configuration)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#start-the-gateway)
  * [End-to-End Encryption (E2EE)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#end-to-end-encryption-e2ee)
    * [Requirements](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#requirements)
    * [Enable E2EE](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#enable-e2ee)
    * [Cross-Signing Verification (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#cross-signing-verification-recommended)
  * [Home Room](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#home-room)
    * [Using the Slash Command](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#using-the-slash-command)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#manual-configuration)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#troubleshooting)
    * [Bot is not responding to messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#bot-is-not-responding-to-messages)
    * ["Failed to authenticate" / "whoami failed" on startup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#failed-to-authenticate--whoami-failed-on-startup)
    * ["mautrix not installed" error](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#mautrix-not-installed-error)
    * [Encryption errors / "could not decrypt event"](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#encryption-errors--could-not-decrypt-event)
    * [Upgrading from a previous version with E2EE](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#upgrading-from-a-previous-version-with-e2ee)
  * [Proxy Mode (E2EE on macOS)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#proxy-mode-e2ee-on-macos)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#how-it-works)
    * [Step 1: Configure the Host (macOS)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-1-configure-the-host-macos)
    * [Step 2: Configure the Docker Container (Linux VM)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-2-configure-the-docker-container-linux-vm)
    * [Step 3: Start Both](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#step-3-start-both)
    * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#configuration-reference)
    * [Works for Any Platform](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#works-for-any-platform)
    * [Sync issues / bot falls behind](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#sync-issues--bot-falls-behind)
    * [Bot is offline](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#bot-is-offline)
    * ["User not allowed" / Bot ignores you](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix#user-not-allowed--bot-ignores-you)

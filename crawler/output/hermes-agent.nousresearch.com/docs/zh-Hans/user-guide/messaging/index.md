<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging -->
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#architecture "Architecture的直接链接")
Hermes Gateway
Platform adapters
Telegram
...
## Quick Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#quick-setup "Quick Setup的直接链接")
...
## Gateway Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#gateway-commands "Gateway Commands的直接链接")
...
## Chat Commands (Inside Messaging)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#chat-commands-inside-messaging "Chat Commands \(Inside Messaging\)的直接链接")  
| Command  | Description  |  
| --- | --- |  
...
## Session Management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#session-management "Session Management的直接链接")
### Session Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#session-persistence "Session Persistence的直接链接")
Sessions persist across messages until they reset. The agent remembers your conversation context.
### Reset Policies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#reset-policies "Reset Policies的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#security "Security的直接链接")
...
### DM Pairing (Alternative to Allowlists)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#dm-pairing-alternative-to-allowlists "DM Pairing \(Alternative to Allowlists\)的直接链接")
...
### Slash Command Access Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#slash-command-access-control "Slash Command Access Control的直接链接")
...
Use `/whoami` from any platform to see the active scope, your tier (admin / user / unrestricted), and which slash commands you can run. See the [Telegram](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/telegram#slash-command-access-control) and [Discord](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/discord#slash-command-access-control) pages for platform-specific examples.
## Interrupting the Agent[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#interrupting-the-agent "Interrupting the Agent的直接链接")
...
### Queue vs interrupt vs steer (busy-input mode)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#queue-vs-interrupt-vs-steer-busy-input-mode "Queue vs interrupt vs steer \(busy-input mode\)的直接链接")
...
## Tool Progress Notifications[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#tool-progress-notifications "Tool Progress Notifications的直接链接")
...
## Background Sessions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#background-sessions "Background Sessions的直接链接")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#how-it-works "How It Works的直接链接")
...
### Background Process Notifications[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#background-process-notifications "Background Process Notifications的直接链接")
...
### Use Cases[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#use-cases "Use Cases的直接链接")
...
## Service Management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#service-management "Service Management的直接链接")
### Linux (systemd)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#linux-systemd "Linux \(systemd\)的直接链接")
...
### macOS (launchd)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#macos-launchd "macOS \(launchd\)的直接链接")
...
## Platform-Specific Toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#platform-specific-toolsets "Platform-Specific Toolsets的直接链接")
...
## Next Steps[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#next-steps "Next Steps的直接链接")
  * [Telegram Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram)
  * [Discord Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/discord)
  * [Slack Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/slack)
  * [Google Chat Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat)
  * [WhatsApp Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp)
  * [Signal Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/signal)
  * [SMS Setup (Twilio)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/sms)
  * [Email Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email)
  * [Home Assistant Integration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/homeassistant)
  * [Mattermost Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/mattermost)
  * [Matrix Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/matrix)
  * [DingTalk Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/dingtalk)
  * [Feishu/Lark Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/feishu)
  * [WeCom Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom)
  * [WeCom Callback Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom-callback)
  * [Weixin Setup (WeChat)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/weixin)
  * [BlueBubbles Setup (iMessage)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/bluebubbles)
  * [QQBot Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/qqbot)
  * [Yuanbao Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/yuanbao)
  * [Microsoft Teams Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams)
  * [Teams Meetings Pipeline](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/teams-meetings)
  * [Open WebUI + API Server](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/open-webui)


  * [Platform Comparison](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#platform-comparison)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#architecture)
  * [Quick Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#quick-setup)
  * [Gateway Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#gateway-commands)
  * [Chat Commands (Inside Messaging)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#chat-commands-inside-messaging)
  * [Session Management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#session-management)
    * [Session Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#session-persistence)
    * [Reset Policies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#reset-policies)
  * [Security](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#security)
    * [DM Pairing (Alternative to Allowlists)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#dm-pairing-alternative-to-allowlists)
    * [Slash Command Access Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#slash-command-access-control)
  * [Interrupting the Agent](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#interrupting-the-agent)
    * [Queue vs interrupt vs steer (busy-input mode)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#queue-vs-interrupt-vs-steer-busy-input-mode)
  * [Tool Progress Notifications](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#tool-progress-notifications)
  * [Background Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#background-sessions)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#how-it-works)
    * [Background Process Notifications](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#background-process-notifications)
  * [Service Management](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#service-management)
    * [Linux (systemd)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#linux-systemd)
    * [macOS (launchd)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#macos-launchd)
  * [Platform-Specific Toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#platform-specific-toolsets)

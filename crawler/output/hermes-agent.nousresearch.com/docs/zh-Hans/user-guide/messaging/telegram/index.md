<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram -->
...
## Step 1: Create a Bot via BotFather[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-1-create-a-bot-via-botfather "Step 1: Create a Bot via BotFather的直接链接")
...
## Step 2: Customize Your Bot (Optional)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-2-customize-your-bot-optional "Step 2: Customize Your Bot \(Optional\)的直接链接")
...
## Step 3: Privacy Mode (Critical for Groups)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-3-privacy-mode-critical-for-groups "Step 3: Privacy Mode \(Critical for Groups\)的直接链接")
...
### How to disable privacy mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-to-disable-privacy-mode "How to disable privacy mode的直接链接")
  1. Message **@BotFather**
  2. Send `/mybots`
  3. Select your bot
...
## Step 4: Find Your User ID[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-4-find-your-user-id "Step 4: Find Your User ID的直接链接")
...
## Step 5: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-5-configure-hermes "Step 5: Configure Hermes的直接链接")
### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#option-a-interactive-setup-recommended "Option A: Interactive Setup \(Recommended\)的直接链接")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#option-b-manual-configuration "Option B: Manual Configuration的直接链接")
...
### Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#start-the-gateway "Start the Gateway的直接链接")
...
## Sending Generated Files from Docker-backed Terminals[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#sending-generated-files-from-docker-backed-terminals "Sending Generated Files from Docker-backed Terminals的直接链接")
...
```
terminal:backend: dockerdocker_volumes:-"/home/user/.hermes/cache/documents:/output"
```
...
### Supported `MEDIA:` file extensions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#supported-media-file-extensions "supported-media-file-extensions的直接链接")
...
## Webhook Mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#webhook-mode "Webhook Mode的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration "Configuration的直接链接")
Add the following to `~/.hermes/.env`:

```
TELEGRAM_WEBHOOK_URL=https://my-app.fly.dev/telegramTELEGRAM_WEBHOOK_SECRET="$(openssl rand -hex32)"# required# TELEGRAM_WEBHOOK_PORT=8443        # optional, default 8443
```
...
### Cloud deployment example (Fly.io)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#cloud-deployment-example-flyio "Cloud deployment example \(Fly.io\)的直接链接")
  1. Add the env vars to your Fly.io app secrets:



```
fly secrets setTELEGRAM_WEBHOOK_URL=https://my-app.fly.dev/telegramfly secrets setTELEGRAM_WEBHOOK_SECRET=$(openssl rand -hex32)
```
...
```
[[services]]internal_port=8443protocol="tcp"[[services.ports]]handlers=["tls","http"]port=443
```
...
## Proxy Support[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#proxy-support "Proxy Support的直接链接")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#home-channel "Home Channel的直接链接")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#voice-messages "Voice Messages的直接链接")
### Incoming Voice (Speech-to-Text)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#incoming-voice-speech-to-text "Incoming Voice \(Speech-to-Text\)的直接链接")
...
### Outgoing Voice (Text-to-Speech)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#outgoing-voice-text-to-speech "Outgoing Voice \(Text-to-Speech\)的直接链接")
...
```
# Ubuntu/Debiansudoaptinstall ffmpeg# macOSbrew install ffmpeg
```
...
## Group Chat Usage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#group-chat-usage "Group Chat Usage的直接链接")
Hermes Agent works in Telegram group chats with a few considerations:
  * **Privacy mode** determines what messages the bot can see (see [Step 3](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-3-privacy-mode-critical-for-groups))
...
### Troubleshooting: works in DMs but not groups[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#troubleshooting-works-in-dms-but-not-groups "Troubleshooting: works in DMs but not groups的直接链接")
...
### Example group trigger configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#example-group-trigger-configuration "Example group trigger configuration的直接链接")
Add this to `~/.hermes/config.yaml`:

```
telegram:require_mention:truemention_patterns:-"^\\s*chompy\\b"ignored_threads:-31-"42"
```
...
### Notes on `mention_patterns`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#notes-on-mention_patterns "notes-on-mention_patterns的直接链接")
...
## Private Chat Topics (Bot API 9.4)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#private-chat-topics-bot-api-94 "Private Chat Topics \(Bot API 9.4\)的直接链接")
...
### Use case[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#use-case "Use case的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-1 "Configuration的直接链接")
...
```
platforms:telegram:extra:dm_topics:-chat_id:123456789# Your Telegram user IDtopics:-name: Generalicon_color:7322096-name: Websiteicon_color:9367192-name: Researchicon_color:16766590skill: arxiv              # Auto-load a skill in this topic
```
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-it-works "How it works的直接链接")
...
### Skill binding[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#skill-binding "Skill binding的直接链接")
...
## Multi-session DM mode (`/topic`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#multi-session-dm-mode-topic "multi-session-dm-mode-topic的直接链接")
...
###  `/topic` subcommands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#topic-subcommands "topic-subcommands的直接链接")  
| Form  | Context  | Effect  |  
| --- | --- | --- |  
...
### DM Topics vs Multi-session DM mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#dm-topics-vs-multi-session-dm-mode "DM Topics vs Multi-session DM mode的直接链接")  
...
### Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#prerequisites "Prerequisites的直接链接")
...
### Activation flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#activation-flow "Activation flow的直接链接")
...
### Creating a new topic (end-user flow)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#creating-a-new-topic-end-user-flow "Creating a new topic \(end-user flow\)的直接链接")
...
### Auto-renamed topics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#auto-renamed-topics "Auto-renamed topics的直接链接")
...
###  `/new` inside a topic[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#new-inside-a-topic "new-inside-a-topic的直接链接")
...
### Restoring a previous session[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#restoring-a-previous-session "Restoring a previous session的直接链接")
Inside a topic, send:
...
###  `/topic` inside a topic (no argument)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#topic-inside-a-topic-no-argument "topic-inside-a-topic-no-argument的直接链接")
Shows the current topic's binding: session title, session ID, and hints for `/new` vs creating another topic.
### Under the hood[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#under-the-hood "Under the hood的直接链接")
...
### Disabling multi-session mode[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#disabling-multi-session-mode "Disabling multi-session mode的直接链接")
...
### Downgrading Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#downgrading-hermes "Downgrading Hermes的直接链接")
...
## Group Forum Topic Skill Binding[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#group-forum-topic-skill-binding "Group Forum Topic Skill Binding的直接链接")
...
### Use case[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#use-case-1 "Use case的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-2 "Configuration的直接链接")
Add topic bindings under `platforms.telegram.extra.group_topics` in `~/.hermes/config.yaml`:

```
platforms:telegram:extra:group_topics:-chat_id:-1001234567890# Supergroup IDtopics:-name: Engineeringthread_id:5skill: software-development-name: Researchthread_id:12skill: arxiv-name: Generalthread_id:1# No skill — general purpose
```
...
| `skill`  | No  | Skill to auto-load on new sessions in this topic  |  
### How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-it-works-1 "How it works的直接链接")
...
### Differences from DM Topics[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#differences-from-dm-topics "Differences from DM Topics的直接链接")  
...
## Recent Bot API Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#recent-bot-api-features "Recent Bot API Features的直接链接")
  * **Bot API 9.4 (Feb 2026):** Private Chat Topics — bots can create forum topics in 1-on-1 DM chats via `createForumTopic`. Hermes uses this for two distinct features: operator-curated [Private Chat Topics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#private-chat-topics-bot-api-94) (config-driven, fixed topic list) and user-driven [Multi-session DM mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#multi-session-dm-mode-topic) (activated by `/topic`, unlimited user-created topics).
...
### Streaming transport (`gateway.streaming.transport`)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#streaming-transport-gatewaystreamingtransport "streaming-transport-gatewaystreamingtransport的直接链接")
...
```
gateway:streaming:enabled:truetransport: auto    # auto | draft | edit | off
```
...
## Rendering: Tables and Link Previews[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#rendering-tables-and-link-previews "Rendering: Tables and Link Previews的直接链接")
...
## Group Allowlisting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#group-allowlisting "Group Allowlisting的直接链接")
...
### Migration from before PR #17686[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#migration-from-before-pr-17686 "Migration from before PR #17686的直接链接")
...
## Slash Command Access Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#slash-command-access-control "Slash Command Access Control的直接链接")
...
## Interactive Model Picker[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#interactive-model-picker "Interactive Model Picker的直接链接")
...
## DNS-over-HTTPS Fallback IPs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#dns-over-https-fallback-ips "DNS-over-HTTPS Fallback IPs的直接链接")
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-it-works-2 "How it works的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-3 "Configuration的直接链接")
...
## Proxy Support[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#proxy-support-1 "Proxy Support的直接链接")
...
### Supported variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#supported-variables "Supported variables的直接链接")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-4 "Configuration的直接链接")
Set the proxy in your environment before starting the gateway:

```
exportHTTPS_PROXY=http://proxy.example.com:8080hermes gateway
```
...
## Message Reactions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#message-reactions "Message Reactions的直接链接")
...
## Per-Channel Prompts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#per-channel-prompts "Per-Channel Prompts的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
## Exec Approval[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#exec-approval "Exec Approval的直接链接")
...
## Interactive Prompts (clarify)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#interactive-prompts-clarify "Interactive Prompts \(clarify\)的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#security "Security的直接链接")
...
For more details, see the [Security documentation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security). You can also use [DM pairing](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging#dm-pairing-alternative-to-allowlists) for a more dynamic approach to user authorization.
  * [Step 1: Create a Bot via BotFather](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-1-create-a-bot-via-botfather)
  * [Step 2: Customize Your Bot (Optional)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-2-customize-your-bot-optional)
  * [Step 3: Privacy Mode (Critical for Groups)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-3-privacy-mode-critical-for-groups)
    * [How to disable privacy mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-to-disable-privacy-mode)
  * [Step 4: Find Your User ID](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-4-find-your-user-id)
  * [Step 5: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#step-5-configure-hermes)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#option-b-manual-configuration)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#start-the-gateway)
  * [Sending Generated Files from Docker-backed Terminals](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#sending-generated-files-from-docker-backed-terminals)
    * [Supported `MEDIA:` file extensions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#supported-media-file-extensions)
  * [Webhook Mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#webhook-mode)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration)
    * [Cloud deployment example (Fly.io)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#cloud-deployment-example-flyio)
  * [Proxy Support](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#proxy-support)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#home-channel)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#voice-messages)
    * [Incoming Voice (Speech-to-Text)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#incoming-voice-speech-to-text)
    * [Outgoing Voice (Text-to-Speech)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#outgoing-voice-text-to-speech)
  * [Group Chat Usage](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#group-chat-usage)
    * [Troubleshooting: works in DMs but not groups](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#troubleshooting-works-in-dms-but-not-groups)
    * [Example group trigger configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#example-group-trigger-configuration)
    * [Notes on `mention_patterns`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#notes-on-mention_patterns)
  * [Private Chat Topics (Bot API 9.4)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#private-chat-topics-bot-api-94)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-1)
    * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-it-works)
    * [Skill binding](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#skill-binding)
  * [Multi-session DM mode (`/topic`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#multi-session-dm-mode-topic)
    * [`/topic` subcommands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#topic-subcommands)
    * [DM Topics vs Multi-session DM mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#dm-topics-vs-multi-session-dm-mode)
    * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#prerequisites)
    * [Activation flow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#activation-flow)
    * [Creating a new topic (end-user flow)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#creating-a-new-topic-end-user-flow)
    * [Auto-renamed topics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#auto-renamed-topics)
    * [`/new` inside a topic](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#new-inside-a-topic)
    * [Restoring a previous session](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#restoring-a-previous-session)
    * [`/topic` inside a topic (no argument)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#topic-inside-a-topic-no-argument)
    * [Under the hood](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#under-the-hood)
    * [Disabling multi-session mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#disabling-multi-session-mode)
    * [Downgrading Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#downgrading-hermes)
  * [Group Forum Topic Skill Binding](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#group-forum-topic-skill-binding)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-2)
    * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-it-works-1)
    * [Differences from DM Topics](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#differences-from-dm-topics)
  * [Recent Bot API Features](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#recent-bot-api-features)
    * [Streaming transport (`gateway.streaming.transport`)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#streaming-transport-gatewaystreamingtransport)
  * [Rendering: Tables and Link Previews](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#rendering-tables-and-link-previews)
  * [Group Allowlisting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#group-allowlisting)
    * [Migration from before PR #17686](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#migration-from-before-pr-17686)
  * [Slash Command Access Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#slash-command-access-control)
  * [Interactive Model Picker](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#interactive-model-picker)
  * [DNS-over-HTTPS Fallback IPs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#dns-over-https-fallback-ips)
    * [How it works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#how-it-works-2)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-3)
  * [Proxy Support](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#proxy-support-1)
    * [Supported variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#supported-variables)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#configuration-4)
  * [Message Reactions](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#message-reactions)
  * [Per-Channel Prompts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#per-channel-prompts)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#troubleshooting)
  * [Exec Approval](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#exec-approval)
  * [Interactive Prompts (clarify)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/telegram#interactive-prompts-clarify)

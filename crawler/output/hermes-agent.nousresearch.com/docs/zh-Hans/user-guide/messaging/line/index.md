<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line -->
...
## How the bot responds[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#how-the-bot-responds "How the bot responds的直接链接")  
| Context  | Behavior  |  
| --- | --- |  
...
## Step 1: Create a LINE Messaging API channel[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-1-create-a-line-messaging-api-channel "Step 1: Create a LINE Messaging API channel的直接链接")
...
## Step 2: Expose the webhook port[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-2-expose-the-webhook-port "Step 2: Expose the webhook port的直接链接")
LINE delivers webhooks over public HTTPS. The default port is `8646` — override with `LINE_PORT` if needed.

```
# Cloudflare Tunnel (recommended for production — fixed hostname)cloudflared tunnel --url http://localhost:8646# ngrok (good for dev)ngrok http 8646# devtunneldevtunnel create hermes-line --allow-anonymousdevtunnel port create hermes-line -p8646--protocol httpsdevtunnel host hermes-line
```
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-3-configure-hermes "Step 3: Configure Hermes的直接链接")
Add to `~/.hermes/.env`:
...
## Step 4: Set the webhook URL[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-4-set-the-webhook-url "Step 4: Set the webhook URL的直接链接")
...
## Step 5: Run the gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-5-run-the-gateway "Step 5: Run the gateway的直接链接")
...
## Slow LLM responses[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#slow-llm-responses "Slow LLM responses的直接链接")
...
```
# ~/.hermes/config.yamldisplay:interim_assistant_messages:falseplatforms:line:tool_progress: off
```

## Cron / notification delivery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#cron--notification-delivery "Cron / notification delivery的直接链接")
...
## Environment variable reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#environment-variable-reference "Environment variable reference的直接链接")  
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#troubleshooting "Troubleshooting的直接链接")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#limitations "Limitations的直接链接")
  ...
  * [How the bot responds](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#how-the-bot-responds)
  * [Step 1: Create a LINE Messaging API channel](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-1-create-a-line-messaging-api-channel)
  * [Step 2: Expose the webhook port](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-2-expose-the-webhook-port)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-3-configure-hermes)
  * [Step 4: Set the webhook URL](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-4-set-the-webhook-url)
  * [Step 5: Run the gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#step-5-run-the-gateway)
  * [Slow LLM responses](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#slow-llm-responses)
  * [Cron / notification delivery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#cron--notification-delivery)
  * [Environment variable reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#environment-variable-reference)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#troubleshooting)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/line#limitations)

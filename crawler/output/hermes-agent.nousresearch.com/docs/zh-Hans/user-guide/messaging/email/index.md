<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email -->
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#prerequisites "Prerequisites的直接链接")
...
### Gmail Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#gmail-setup "Gmail Setup的直接链接")
...
### Outlook / Microsoft 365[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#outlook--microsoft-365 "Outlook / Microsoft 365的直接链接")
...
### Other Providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#other-providers "Other Providers的直接链接")
...
## Step 1: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#step-1-configure-hermes "Step 1: Configure Hermes的直接链接")
The easiest way:
...
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#manual-configuration "Manual Configuration的直接链接")
Add to `~/.hermes/.env`:
...
## Step 2: Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#step-2-start-the-gateway "Step 2: Start the Gateway的直接链接")
...
## How It Works[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#how-it-works "How It Works的直接链接")
### Receiving Messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#receiving-messages "Receiving Messages的直接链接")
...
### Sending Replies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#sending-replies "Sending Replies的直接链接")
...
### File Attachments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#file-attachments "File Attachments的直接链接")
...
### Skipping Attachments[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#skipping-attachments "Skipping Attachments的直接链接")
...
## Access Control[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#access-control "Access Control的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#security "Security的直接链接")
...
## Environment Variables Reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#environment-variables-reference "Environment Variables Reference的直接链接")  
...
| `EMAIL_ALLOW_ALL_USERS`  | No  | `false`  | Allow all senders (not recommended)  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#prerequisites)
    * [Gmail Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#gmail-setup)
    * [Outlook / Microsoft 365](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#outlook--microsoft-365)
    * [Other Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#other-providers)
  * [Step 1: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#step-1-configure-hermes)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#manual-configuration)
  * [Step 2: Start the Gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#step-2-start-the-gateway)
  * [How It Works](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#how-it-works)
    * [Receiving Messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#receiving-messages)
    * [Sending Replies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#sending-replies)
    * [File Attachments](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#file-attachments)
    * [Skipping Attachments](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#skipping-attachments)
  * [Access Control](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#access-control)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#troubleshooting)
  * [Environment Variables Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/email#environment-variables-reference)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom -->
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#prerequisites "Prerequisites的直接链接")
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#setup "Setup的直接链接")
### Step 1: Create an AI Bot[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#step-1-create-an-ai-bot "Step 1: Create an AI Bot的直接链接")
#### Recommended: Scan-to-Create (one command)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#recommended-scan-to-create-one-command "Recommended: Scan-to-Create \(one command\)的直接链接")
...
#### Alternative: Manual Setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#alternative-manual-setup "Alternative: Manual Setup的直接链接")
...
### Step 2: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#step-2-configure-hermes "Step 2: Configure Hermes的直接链接")
#### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#option-a-interactive-setup-recommended "Option A: Interactive Setup \(Recommended\)的直接链接")
...
#### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#option-b-manual-configuration "Option B: Manual Configuration的直接链接")
...
### Step 3: Start the gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#step-3-start-the-gateway "Step 3: Start the gateway的直接链接")

```
hermes gateway
```

## Features[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#features "Features的直接链接")
...
## Configuration Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#configuration-options "Configuration Options的直接链接")
...
## Access Policies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#access-policies "Access Policies的直接链接")
### DM Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#dm-policy "DM Policy的直接链接")
...
### Group Policy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#group-policy "Group Policy的直接链接")
...
### Per-Group Sender Allowlists[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#per-group-sender-allowlists "Per-Group Sender Allowlists的直接链接")
...
## Media Support[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#media-support "Media Support的直接链接")
### Inbound (receiving)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#inbound-receiving "Inbound \(receiving\)的直接链接")
...
### AES-Encrypted Media Decryption[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#aes-encrypted-media-decryption "AES-Encrypted Media Decryption的直接链接")
...
### Outbound (sending)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#outbound-sending "Outbound \(sending\)的直接链接")  
...
## Reply-Mode Stream Responses[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#reply-mode-stream-responses "Reply-Mode Stream Responses的直接链接")
...
## Connection and Reconnection[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#connection-and-reconnection "Connection and Reconnection的直接链接")
The adapter maintains a persistent WebSocket connection to WeCom's gateway at `wss://openws.work.weixin.qq.com`.
### Connection Lifecycle[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#connection-lifecycle "Connection Lifecycle的直接链接")
...
### Reconnection Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#reconnection-behavior "Reconnection Behavior的直接链接")
...
### Deduplication[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#deduplication "Deduplication的直接链接")
...
## All Environment Variables[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#all-environment-variables "All Environment Variables的直接链接")  
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Fix  |  
| --- | --- |  
...
| `WeCom websocket closed during authentication`  | Network issue or incorrect credentials. Verify bot_id and secret.  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#prerequisites)
  * [Setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#setup)
    * [Step 1: Create an AI Bot](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#step-1-create-an-ai-bot)
    * [Step 2: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#step-2-configure-hermes)
    * [Step 3: Start the gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#step-3-start-the-gateway)
  * [Configuration Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#configuration-options)
  * [Access Policies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#access-policies)
    * [Group Policy](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#group-policy)
    * [Per-Group Sender Allowlists](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#per-group-sender-allowlists)
  * [Media Support](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#media-support)
    * [Inbound (receiving)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#inbound-receiving)
    * [AES-Encrypted Media Decryption](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#aes-encrypted-media-decryption)
    * [Outbound (sending)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#outbound-sending)
  * [Reply-Mode Stream Responses](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#reply-mode-stream-responses)
  * [Connection and Reconnection](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#connection-and-reconnection)
    * [Connection Lifecycle](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#connection-lifecycle)
    * [Reconnection Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#reconnection-behavior)
    * [Deduplication](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#deduplication)
  * [All Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#all-environment-variables)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/wecom#troubleshooting)

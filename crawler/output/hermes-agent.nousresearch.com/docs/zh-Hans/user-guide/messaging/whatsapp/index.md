<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp -->
...
## Two Modes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#two-modes "Two Modes的直接链接")  
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#prerequisites "Prerequisites的直接链接")
...
## Step 1: Run the Setup Wizard[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#step-1-run-the-setup-wizard "Step 1: Run the Setup Wizard的直接链接")
...
## Step 2: Getting a Second Phone Number (Bot Mode)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#step-2-getting-a-second-phone-number-bot-mode "Step 2: Getting a Second Phone Number \(Bot Mode\)的直接链接")
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#step-3-configure-hermes "Step 3: Configure Hermes的直接链接")
...
## Session Persistence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#session-persistence "Session Persistence的直接链接")
...
## Re-pairing[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#re-pairing "Re-pairing的直接链接")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#voice-messages "Voice Messages的直接链接")
...
## Message Formatting & Delivery[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#message-formatting--delivery "Message Formatting & Delivery的直接链接")
...
### Chunking[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#chunking "Chunking的直接链接")
...
### WhatsApp-Compatible Markdown[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#whatsapp-compatible-markdown "WhatsApp-Compatible Markdown的直接链接")
...
### Tool Progress[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#tool-progress "Tool Progress的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#troubleshooting "Troubleshooting的直接链接")  
| Problem  | Solution  |  
| --- | --- |  
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#security "Security的直接链接")
...
```
  ...
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#prerequisites)
  * [Step 1: Run the Setup Wizard](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#step-1-run-the-setup-wizard)
  * [Step 2: Getting a Second Phone Number (Bot Mode)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#step-2-getting-a-second-phone-number-bot-mode)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#step-3-configure-hermes)
  * [Session Persistence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#session-persistence)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#voice-messages)
  * [Message Formatting & Delivery](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#message-formatting--delivery)
    * [WhatsApp-Compatible Markdown](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#whatsapp-compatible-markdown)
    * [Tool Progress](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#tool-progress)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp#troubleshooting)

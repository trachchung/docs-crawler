<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat -->
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#overview "Overview的直接链接")  
| Component  | Value  |  
| --- | --- |  
...
## Step 1: Create or pick a GCP project[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-1-create-or-pick-a-gcp-project "Step 1: Create or pick a GCP project的直接链接")
...
## Step 2: Enable two APIs[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-2-enable-two-apis "Step 2: Enable two APIs的直接链接")
...
## Step 3: Create a Service Account[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-3-create-a-service-account "Step 3: Create a Service Account的直接链接")
...
## Step 4: Create the Pub/Sub topic and subscription[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-4-create-the-pubsub-topic-and-subscription "Step 4: Create the Pub/Sub topic and subscription的直接链接")
...
## Step 5: IAM binding on the topic (critical)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-5-iam-binding-on-the-topic-critical "Step 5: IAM binding on the topic \(critical\)的直接链接")
...
## Step 6: IAM binding on the subscription[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-6-iam-binding-on-the-subscription "Step 6: IAM binding on the subscription的直接链接")
...
## Step 7: Configure the Chat app[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-7-configure-the-chat-app "Step 7: Configure the Chat app的直接链接")
...
Save.
## Step 8: Install the bot in a test space[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-8-install-the-bot-in-a-test-space "Step 8: Install the bot in a test space的直接链接")
...
## Step 9: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-9-configure-hermes "Step 9: Configure Hermes的直接链接")
Add the Google Chat section to `~/.hermes/.env`:

```
# RequiredGOOGLE_CHAT_PROJECT_ID=my-chat-bot-123GOOGLE_CHAT_SUBSCRIPTION_NAME=projects/my-chat-bot-123/subscriptions/hermes-chat-events-subGOOGLE_CHAT_SERVICE_ACCOUNT_JSON=/home/you/.hermes/google-chat-sa.json# Authorization — paste the emails of people allowed to talk to the botGOOGLE_CHAT_ALLOWED_USERS=you@yourdomain.com,coworker@yourdomain.com# OptionalGOOGLE_CHAT_HOME_CHANNEL=spaces/AAAA..# default delivery destination for cron jobsGOOGLE_CHAT_MAX_MESSAGES=1# Pub/Sub FlowControl; 1 serializes commands per sessionGOOGLE_CHAT_MAX_BYTES=16777216# 16 MiB — cap on in-flight message bytes
```
...
```
[GoogleChat] Connected; project=my-chat-bot-123, subscription=<redacted>,             bot_user_id=users/XXXX, flow_control(msgs=1, bytes=16777216)
```
...
## Formatting and capabilities[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#formatting-and-capabilities "Formatting and capabilities的直接链接")
...
## Step 10: Native attachment delivery (optional)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-10-native-attachment-delivery-optional "Step 10: Native attachment delivery \(optional\)的直接链接")
...
### Why a separate flow[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#why-a-separate-flow "Why a separate flow的直接链接")
...
### One-time host setup[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#one-time-host-setup "One-time host setup的直接链接")
...
```
python -m gateway.platforms.google_chat_user_oauth \    --client-secret /path/to/client_secret.json
```
...
### Per-user authorization (in chat)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#per-user-authorization-in-chat "Per-user authorization \(in chat\)的直接链接")
...
### Scope[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#scope "Scope的直接链接")
...
### Multi-user behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#multi-user-behavior "Multi-user behavior的直接链接")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#troubleshooting "Troubleshooting的直接链接")
...
## Security notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#security-notes "Security notes的直接链接")
  ...
  * [Step 1: Create or pick a GCP project](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-1-create-or-pick-a-gcp-project)
  * [Step 2: Enable two APIs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-2-enable-two-apis)
  * [Step 3: Create a Service Account](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-3-create-a-service-account)
  * [Step 4: Create the Pub/Sub topic and subscription](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-4-create-the-pubsub-topic-and-subscription)
  * [Step 5: IAM binding on the topic (critical)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-5-iam-binding-on-the-topic-critical)
  * [Step 6: IAM binding on the subscription](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-6-iam-binding-on-the-subscription)
  * [Step 7: Configure the Chat app](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-7-configure-the-chat-app)
  * [Step 8: Install the bot in a test space](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-8-install-the-bot-in-a-test-space)
  * [Step 9: Configure Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-9-configure-hermes)
  * [Formatting and capabilities](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#formatting-and-capabilities)
  * [Step 10: Native attachment delivery (optional)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#step-10-native-attachment-delivery-optional)
    * [Why a separate flow](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#why-a-separate-flow)
    * [One-time host setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#one-time-host-setup)
    * [Per-user authorization (in chat)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#per-user-authorization-in-chat)
    * [Multi-user behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#multi-user-behavior)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#troubleshooting)
  * [Security notes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/google_chat#security-notes)

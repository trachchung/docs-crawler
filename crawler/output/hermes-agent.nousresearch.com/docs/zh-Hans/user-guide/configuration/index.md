<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration -->

本页总览
All settings are stored in the `~/.hermes/` directory for easy access.
## Directory Structure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#directory-structure "Directory Structure的直接链接")
...
## Managing Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#managing-configuration "Managing Configuration的直接链接")
...
## Configuration Precedence[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#configuration-precedence "Configuration Precedence的直接链接")
...
## Environment Variable Substitution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#environment-variable-substitution "Environment Variable Substitution的直接链接")
...
For AI provider setup (OpenRouter, Anthropic, Copilot, custom endpoints, self-hosted LLMs, fallback models, etc.), see [AI Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/integrations/providers).
### Provider Timeouts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#provider-timeouts "Provider Timeouts的直接链接")
...
## Terminal Backend Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#terminal-backend-configuration "Terminal Backend Configuration的直接链接")
...
### Backend Overview[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#backend-overview "Backend Overview的直接链接")  
...
### Local Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#local-backend "Local Backend的直接链接")
...
### Docker Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#docker-backend "Docker Backend的直接链接")
...
### SSH Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#ssh-backend "SSH Backend的直接链接")
...
### Modal Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#modal-backend "Modal Backend的直接链接")
...
### Daytona Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#daytona-backend "Daytona Backend的直接链接")
...
### Vercel Sandbox Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#vercel-sandbox-backend "Vercel Sandbox Backend的直接链接")
...
### Singularity/Apptainer Backend[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#singularityapptainer-backend "Singularity/Apptainer Backend的直接链接")
...
### Common Terminal Backend Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#common-terminal-backend-issues "Common Terminal Backend Issues的直接链接")
...
### Remote-to-Host File Sync on Teardown[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#remote-to-host-file-sync-on-teardown "Remote-to-Host File Sync on Teardown的直接链接")
...
### Docker Volume Mounts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#docker-volume-mounts "Docker Volume Mounts的直接链接")
...
```
terminal:backend: dockerdocker_volumes:-"/home/user/projects:/workspace/projects"# Read-write (default)-"/home/user/datasets:/data:ro"# Read-only-"/home/user/.hermes/cache/documents:/output"# Gateway-visible exports
```
...
### Docker Credential Forwarding[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#docker-credential-forwarding "Docker Credential Forwarding的直接链接")
...
```
terminal:backend: dockerdocker_forward_env:-"GITHUB_TOKEN"-"NPM_TOKEN"
```
...
### Running the Container as Your Host User[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#running-the-container-as-your-host-user "Running the Container as Your Host User的直接链接")
...
```
terminal:backend: dockerdocker_run_as_host_user:true# default: false
```
...
### Optional: Mount the Launch Directory into `/workspace`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#optional-mount-the-launch-directory-into-workspace "optional-mount-the-launch-directory-into-workspace的直接链接")
...
```
terminal:backend: dockerdocker_mount_cwd_to_workspace:true
```
...
### Persistent Shell[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#persistent-shell "Persistent Shell的直接链接")
...
```
exportTERMINAL_LOCAL_PERSISTENT=true
```
...
See [Code Execution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/code-execution) and the [Terminal section of the README](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/tools) for details on each backend.
## Skill Settings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#skill-settings "Skill Settings的直接链接")
...
For details on declaring config settings in your own skills, see [Creating Skills — Config Settings](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/developer-guide/creating-skills#config-settings-configyaml).
### Guard on agent-created skill writes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#guard-on-agent-created-skill-writes "Guard on agent-created skill writes的直接链接")
...
## Memory Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#memory-configuration "Memory Configuration的直接链接")

```
memory:memory_enabled:trueuser_profile_enabled:truememory_char_limit:2200# ~800 tokensuser_char_limit:1375# ~500 tokens
```

## File Read Safety[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#file-read-safety "File Read Safety的直接链接")
...
## Tool Output Truncation Limits[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#tool-output-truncation-limits "Tool Output Truncation Limits的直接链接")
...
## Global Toolset Disable[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#global-toolset-disable "Global Toolset Disable的直接链接")
...
## Git Worktree Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#git-worktree-isolation "Git Worktree Isolation的直接链接")
...
## Context Compression[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-compression "Context Compression的直接链接")
...
### Full reference[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#full-reference "Full reference的直接链接")
...
### Common setups[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#common-setups "Common setups的直接链接")
**Default (auto-detect) — no configuration needed:**

```
compression:enabled:truethreshold:0.50
```
...
```
auxiliary:compression:provider: nousmodel: gemini-3-flash
```
...
```
auxiliary:compression:model: glm-4.7base_url: https://api.z.ai/api/coding/paas/v4
```

Points at a custom OpenAI-compatible endpoint. Uses `OPENAI_API_KEY` for auth.
### How the three knobs interact[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#how-the-three-knobs-interact "How the three knobs interact的直接链接")  
...
See [Memory Providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/memory-providers) for the analogous single-select system for memory plugins.
## Iteration Budget Pressure[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#iteration-budget-pressure "Iteration Budget Pressure的直接链接")
...
`agent.api_max_retries` controls how many times Hermes retries a provider API call on transient errors (rate limits, connection drops, 5xx) **before** fallback-provider switching engages. The default is `3` — four attempts total. If you have [fallback providers](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/fallback-providers) configured and want to fail over faster, drop this to `0` so the first transient error on your primary immediately hands off to the fallback instead of churning retries against the flaky endpoint.
### API Timeouts[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#api-timeouts "API Timeouts的直接链接")
...
## Context Pressure Warnings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-pressure-warnings "Context Pressure Warnings的直接链接")
...
## Credential Pool Strategies[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#credential-pool-strategies "Credential Pool Strategies的直接链接")
...
Options: `fill_first` (default), `round_robin`, `least_used`, `random`. See [Credential Pools](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/credential-pools) for full documentation.
## Auxiliary Models[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#auxiliary-models "Auxiliary Models的直接链接")
...
```
$ hermes model→ Configure auxiliary models[ ] vision               currently: auto / main model[ ] web_extract          currently: auto / main model[ ] session_search       currently: openrouter / google/gemini-2.5-flash[ ] title_generation     currently: openrouter / google/gemini-3-flash-preview[ ] compression          currently: auto / main model[ ] approval             currently: auto / main model[ ] triage_specifier     currently: auto / main model
```
...
### Video Tutorial[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#video-tutorial "Video Tutorial的直接链接")
### The universal config pattern[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#the-universal-config-pattern "The universal config pattern的直接链接")
...
Context compression has its own `compression:` block for thresholds and an `auxiliary.compression:` block for model/provider settings — see [Context Compression](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-compression) above. The fallback model uses a `fallback_model:` block — see [Fallback Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/integrations/providers#fallback-model). All three follow the same provider/model/base_url pattern.
### Session Search Tuning[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#session-search-tuning "Session Search Tuning的直接链接")
...
```
auxiliary:session_search:provider:"main"model:"glm-4.5-air"timeout:60max_concurrency:2extra_body:enable_thinking:false
```
...
### OpenRouter routing & Pareto Code for auxiliary tasks[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#openrouter-routing--pareto-code-for-auxiliary-tasks "OpenRouter routing & Pareto Code for auxiliary tasks的直接链接")
When an auxiliary task resolves to OpenRouter (either explicitly or via `provider: "main"` while your main agent is on OpenRouter), the main agent's `provider_routing` and `openrouter.min_coding_score` settings **do not propagate** — by design, each auxiliary task is independent. To set OpenRouter provider preferences or use the [Pareto Code router](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/integrations/providers#openrouter-pareto-code-router) for a specific aux task, set them per-task via `extra_body`:

```
auxiliary:compression:provider: openroutermodel: openrouter/pareto-code         # use the Pareto Code router for this taskextra_body:provider:# OpenRouter provider routing prefsorder:[anthropic, google]# try these providers in ordersort: throughput                   # or "price" | "latency"# only: [anthropic]                # restrict to a specific provider# ignore: [deepinfra]              # exclude specific providersplugins:# OpenRouter Pareto Code router knob-id: pareto-routermin_coding_score:0.5# 0.0–1.0; higher = stronger coders
```
...
### Changing the Vision Model[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#changing-the-vision-model "Changing the Vision Model的直接链接")
...
### Provider Options[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#provider-options "Provider Options的直接链接")
...
### Common Setups[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#common-setups-1 "Common Setups的直接链接")
...
Run `hermes model` and select **MiniMax (OAuth)** to log in and set this automatically. For the China region, the base URL will be `https://api.minimaxi.com/anthropic`. See the [MiniMax OAuth guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/minimax-oauth) for the full walkthrough.
...
### Environment Variables (legacy)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#environment-variables-legacy "Environment Variables \(legacy\)的直接链接")
...
## Reasoning Effort[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#reasoning-effort "Reasoning Effort的直接链接")
...
## Tool-Use Enforcement[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#tool-use-enforcement "Tool-Use Enforcement的直接链接")
...
### What it injects[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#what-it-injects "What it injects的直接链接")
...
### When to turn it on[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#when-to-turn-it-on "When to turn it on的直接链接")
...
## TTS Configuration[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#tts-configuration "TTS Configuration的直接链接")
...
## Display Settings[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#display-settings "Display Settings的直接链接")

```
display:tool_progress: all      # off | new | all | verbosetool_progress_command:false# Enable /verbose slash command in messaging gatewayplatforms:{}# Per-platform display overrides (see below)tool_progress_overrides:{}# DEPRECATED — use display.platforms insteadinterim_assistant_messages:true# Gateway: send natural mid-turn assistant updates as separate messagesskin: default           # Built-in or custom CLI skin (see user-guide/features/skins)personality:"kawaii"# Legacy cosmetic field still surfaced in some summariescompact:false# Compact output mode (less whitespace)resume_display: full    # full (show previous messages on resume) | minimal (one-liner only)bell_on_complete:false# Play terminal bell when agent finishes (great for long tasks)show_reasoning:false# Show model reasoning/thinking above each response (toggle with /reasoning show|hide)streaming:false# Stream tokens to terminal as they arrive (real-time output)show_cost:false# Show estimated $ cost in the CLI status bartool_preview_length:0# Max chars for tool call previews (0 = no limit, show full paths/commands)runtime_footer:# Gateway: append a runtime-context footer to final repliesenabled:falsefields:["model","context_pct","cwd"]file_mutation_verifier:true# Append an advisory footer when write_file/patch calls failed this turnlanguage: en            # UI language for static messages (approval prompts, some gateway replies). en | zh | ja | de | es | fr | tr | uk
```

### File-mutation verifier[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#file-mutation-verifier "File-mutation verifier的直接链接")
...
### UI language for static messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#ui-language-for-static-messages "UI language for static messages的直接链接")
...
### Runtime-metadata footer (gateway only)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#runtime-metadata-footer-gateway-only "Runtime-metadata footer \(gateway only\)的直接链接")
...
```
display:runtime_footer:enabled:truefields:["model","context_pct","cwd"]# any of: model, context_pct, cwd, duration, tokens, cost
```
...
### Per-platform progress overrides[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#per-platform-progress-overrides "Per-platform progress overrides的直接链接")
...
## Privacy[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#privacy "Privacy的直接链接")
...
## Speech-to-Text (STT)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#speech-to-text-stt "Speech-to-Text \(STT\)的直接链接")

```
stt:provider:"local"# "local" | "groq" | "openai" | "mistral"local:model:"base"# tiny, base, small, medium, large-v3openai:model:"whisper-1"# whisper-1 | gpt-4o-mini-transcribe | gpt-4o-transcribe# model: "whisper-1"         # Legacy fallback key still respected
```
...
## Voice Mode (CLI)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#voice-mode-cli "Voice Mode \(CLI\)的直接链接")
...
Use `/voice on` in the CLI to enable microphone mode, `record_key` to start/stop recording, and `/voice tts` to toggle spoken replies. See [Voice Mode](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/voice-mode) for end-to-end setup and platform-specific behavior.
## Streaming[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#streaming "Streaming的直接链接")
Stream tokens to the terminal or messaging platforms as they arrive, instead of waiting for the full response.
### CLI Streaming[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#cli-streaming "CLI Streaming的直接链接")
...
### Gateway Streaming (Telegram, Discord, Slack)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#gateway-streaming-telegram-discord-slack "Gateway Streaming \(Telegram, Discord, Slack\)的直接链接")
...
## Group Chat Session Isolation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#group-chat-session-isolation "Group Chat Session Isolation的直接链接")
...
For the behavior details and examples, see [Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/sessions) and the [Discord guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/discord).
## Unauthorized DM Behavior[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#unauthorized-dm-behavior "Unauthorized DM Behavior的直接链接")
...
## Quick Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#quick-commands "Quick Commands的直接链接")
...
```
quick_commands:status:type: execcommand: systemctl status hermes-agentdisk:type: execcommand: df -h /update:type: execcommand: cd ~/.hermes/hermes-agent && git pull && pip install -e .gpu:type: execcommand: nvidia-smi --query-gpu=name,utilization.gpu,memory.used,memory.total --format=csv,noheaderrestart:type: aliastarget: /gateway restart
```
...
## Human Delay[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#human-delay "Human Delay的直接链接")
...
## Code Execution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#code-execution "Code Execution的直接链接")
...
## Web Search Backends[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#web-search-backends "Web Search Backends的直接链接")
...
See the [browser feature page](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#browser_dialog) for the full dialog workflow.
The browser toolset supports multiple providers. See the [Browser feature page](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/browser) for details on Browserbase, Browser Use, and local Chrome CDP setup.
## Timezone[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#timezone "Timezone的直接链接")
...
## Discord[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#discord "Discord的直接链接")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#security "Security的直接链接")
...
## Website Blocklist[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#website-blocklist "Website Blocklist的直接链接")
...
## Smart Approvals[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#smart-approvals "Smart Approvals的直接链接")
...
## Checkpoints[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#checkpoints "Checkpoints的直接链接")
Automatic filesystem snapshots before destructive file operations. See the [Checkpoints & Rollback](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/checkpoints-and-rollback) for details.
...
## Delegation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#delegation "Delegation的直接链接")
...
## Context Files (SOUL.md, AGENTS.md)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-files-soulmd-agentsmd "Context Files \(SOUL.md, AGENTS.md\)的直接链接")
...
## Working Directory[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#working-directory "Working Directory的直接链接")  
| Context  | Default  |  
| --- | --- |  
...
```
  ...
  * [Directory Structure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#directory-structure)
  * [Managing Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#managing-configuration)
  * [Configuration Precedence](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#configuration-precedence)
  * [Environment Variable Substitution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#environment-variable-substitution)
    * [Provider Timeouts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#provider-timeouts)
  * [Terminal Backend Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#terminal-backend-configuration)
    * [Backend Overview](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#backend-overview)
    * [Local Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#local-backend)
    * [Docker Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#docker-backend)
    * [SSH Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#ssh-backend)
    * [Modal Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#modal-backend)
    * [Daytona Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#daytona-backend)
    * [Vercel Sandbox Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#vercel-sandbox-backend)
    * [Singularity/Apptainer Backend](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#singularityapptainer-backend)
    * [Common Terminal Backend Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#common-terminal-backend-issues)
    * [Remote-to-Host File Sync on Teardown](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#remote-to-host-file-sync-on-teardown)
    * [Docker Volume Mounts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#docker-volume-mounts)
    * [Docker Credential Forwarding](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#docker-credential-forwarding)
    * [Running the Container as Your Host User](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#running-the-container-as-your-host-user)
    * [Optional: Mount the Launch Directory into `/workspace`](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#optional-mount-the-launch-directory-into-workspace)
    * [Persistent Shell](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#persistent-shell)
  * [Skill Settings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#skill-settings)
    * [Guard on agent-created skill writes](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#guard-on-agent-created-skill-writes)
  * [Memory Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#memory-configuration)
  * [File Read Safety](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#file-read-safety)
  * [Tool Output Truncation Limits](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#tool-output-truncation-limits)
  * [Global Toolset Disable](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#global-toolset-disable)
  * [Git Worktree Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#git-worktree-isolation)
  * [Context Compression](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-compression)
    * [Full reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#full-reference)
    * [Common setups](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#common-setups)
    * [How the three knobs interact](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#how-the-three-knobs-interact)
  * [Context Engine](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-engine)
  * [Iteration Budget Pressure](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#iteration-budget-pressure)
    * [API Timeouts](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#api-timeouts)
  * [Context Pressure Warnings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-pressure-warnings)
  * [Credential Pool Strategies](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#credential-pool-strategies)
  * [Auxiliary Models](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#auxiliary-models)
    * [Configuring auxiliary models interactively](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#configuring-auxiliary-models-interactively)
    * [Video Tutorial](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#video-tutorial)
    * [The universal config pattern](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#the-universal-config-pattern)
    * [Full auxiliary config reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#full-auxiliary-config-reference)
    * [Session Search Tuning](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#session-search-tuning)
    * [OpenRouter routing & Pareto Code for auxiliary tasks](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#openrouter-routing--pareto-code-for-auxiliary-tasks)
    * [Changing the Vision Model](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#changing-the-vision-model)
    * [Provider Options](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#provider-options)
    * [Common Setups](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#common-setups-1)
    * [Environment Variables (legacy)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#environment-variables-legacy)
  * [Reasoning Effort](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#reasoning-effort)
  * [Tool-Use Enforcement](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#tool-use-enforcement)
    * [What it injects](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#what-it-injects)
    * [When to turn it on](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#when-to-turn-it-on)
  * [TTS Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#tts-configuration)
  * [Display Settings](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#display-settings)
    * [File-mutation verifier](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#file-mutation-verifier)
    * [UI language for static messages](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#ui-language-for-static-messages)
    * [Runtime-metadata footer (gateway only)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#runtime-metadata-footer-gateway-only)
    * [Per-platform progress overrides](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#per-platform-progress-overrides)
  * [Speech-to-Text (STT)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#speech-to-text-stt)
  * [Voice Mode (CLI)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#voice-mode-cli)
  * [Streaming](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#streaming)
    * [CLI Streaming](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#cli-streaming)
    * [Gateway Streaming (Telegram, Discord, Slack)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#gateway-streaming-telegram-discord-slack)
  * [Group Chat Session Isolation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#group-chat-session-isolation)
  * [Unauthorized DM Behavior](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#unauthorized-dm-behavior)
  * [Quick Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#quick-commands)
  * [Human Delay](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#human-delay)
  * [Code Execution](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#code-execution)
  * [Web Search Backends](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#web-search-backends)
  * [Website Blocklist](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#website-blocklist)
  * [Smart Approvals](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#smart-approvals)
  * [Checkpoints](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#checkpoints)
  * [Context Files (SOUL.md, AGENTS.md)](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#context-files-soulmd-agentsmd)
  * [Working Directory](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration#working-directory)

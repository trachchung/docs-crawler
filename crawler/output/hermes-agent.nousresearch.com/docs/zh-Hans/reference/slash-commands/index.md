<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands -->
...
## Interactive CLI slash commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#interactive-cli-slash-commands "Interactive CLI slash commands的直接链接")
Type `/` in the CLI to open the autocomplete menu. Built-in commands are case-insensitive.
### Session[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#session "Session的直接链接")  
| Command  | Description  |  
| --- | --- |  
...
### Tools & Skills[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#tools--skills "Tools & Skills的直接链接")  
| Command  | Description  |  
| --- | --- |  
...
### Info[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#info "Info的直接链接")  
| Command  | Description  |  
| --- | --- |  
...
### Exit[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#exit "Exit的直接链接")  
| Command  | Description  |  
| --- | --- |  
| `/quit`  | Exit the CLI (also: `/exit`).  |  
### Dynamic CLI slash commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#dynamic-cli-slash-commands "Dynamic CLI slash commands的直接链接")  
| Command  | Description  |  
| --- | --- |  
...
### Quick Commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#quick-commands "Quick Commands的直接链接")
...
```
quick_commands:status:type: execcommand: systemctl status hermes-agentdeploy:type: execcommand: scripts/deploy.shinbox:type: aliastarget: /gmail unread
```
...
### Custom model aliases[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#custom-model-aliases "Custom model aliases的直接链接")
...
```
model_aliases:fav:model: claude-sonnet-4.6provider: anthropicgrok:model: grok-4provider: x-aiollama-qwen:model: qwen3-coder:30bprovider: custombase_url: http://localhost:11434/v1
```
...
### Alias Resolution[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#alias-resolution "Alias Resolution的直接链接")
...
## Messaging slash commands[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#messaging-slash-commands "Messaging slash commands的直接链接")
...
| `/codex-runtime [auto|codex_app_server|on|off]`  | Toggle the optional [Codex app-server runtime](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/codex-app-server-runtime). Persists to `model.openai_runtime` in config.yaml and evicts the cached agent so the next message picks up the new runtime. Effective on next session.  |  
...
| `/background <prompt>`  | Run a prompt in a separate background session. Results are delivered back to the same chat when the task finishes. See [Messaging Background Sessions](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/messaging/#background-sessions).  |  
...
## Notes[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#notes "Notes的直接链接")
  ...
  * [Interactive CLI slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#interactive-cli-slash-commands)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#configuration)
    * [Tools & Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#tools--skills)
    * [Dynamic CLI slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#dynamic-cli-slash-commands)
    * [Quick Commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#quick-commands)
    * [Custom model aliases](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#custom-model-aliases)
    * [Alias Resolution](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#alias-resolution)
  * [Messaging slash commands](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/slash-commands#messaging-slash-commands)

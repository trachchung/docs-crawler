<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq -->

本页总览
Quick answers and fixes for the most common questions and issues.
## Frequently Asked Questions[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#frequently-asked-questions "Frequently Asked Questions的直接链接")
### What LLM providers work with Hermes?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#what-llm-providers-work-with-hermes "What LLM providers work with Hermes?的直接链接")
...
Set your provider with `hermes model` or by editing `~/.hermes/.env`. See the [Environment Variables](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/environment-variables) reference for all provider keys.
### Does it work on Windows?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#does-it-work-on-windows "Does it work on Windows?的直接链接")
...
### I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#i-run-hermes-in-wsl2-whats-the-best-way-to-control-my-normal-windows-chrome "I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?的直接链接")
...
See:
  * [Use MCP with Hermes](https://hermes-agent.nousresearch.com/docs/zh-Hans/guides/use-mcp-with-hermes#wsl2-bridge-hermes-in-wsl-to-windows-chrome)
  * [Browser Automation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/browser#wsl2--windows-chrome-prefer-mcp-over-browser-connect)


### Does it work on Android / Termux?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#does-it-work-on-android--termux "Does it work on Android / Termux?的直接链接")
...
For the fully explicit manual steps, supported extras, and current limitations, see the [Termux guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/getting-started/termux).
...
### Is my data sent anywhere?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#is-my-data-sent-anywhere "Is my data sent anywhere?的直接链接")
...
### Can I use it offline / with local models?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-i-use-it-offline--with-local-models "Can I use it offline / with local models?的直接链接")
...
```
model:default: qwen3.5:27bprovider: custombase_url: http://localhost:11434/v1
```
...
This works with Ollama, vLLM, llama.cpp server, SGLang, LocalAI, and others. See the [Configuration guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/configuration) for details.
...
### How much does it cost?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#how-much-does-it-cost "How much does it cost?的直接链接")
...
### Can multiple people use one instance?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-multiple-people-use-one-instance "Can multiple people use one instance?的直接链接")
Yes. The [messaging gateway](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/) lets multiple users interact with the same Hermes Agent instance via Telegram, Discord, Slack, WhatsApp, or Home Assistant. Access is controlled through allowlists (specific user IDs) and DM pairing (first user to message claims access).
### What's the difference between memory and skills?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#whats-the-difference-between-memory-and-skills "What's the difference between memory and skills?的直接链接")
...
Both persist across sessions. See [Memory](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/memory) and [Skills](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/skills) for details.
### Can I use it in my own Python project?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-i-use-it-in-my-own-python-project "Can I use it in my own Python project?的直接链接")
...
See the [Python Library guide](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/code-execution) for full API usage.
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#troubleshooting "Troubleshooting的直接链接")
### Installation Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#installation-issues "Installation Issues的直接链接")
####  `hermes: command not found` after installation[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#hermes-command-not-found-after-installation "hermes-command-not-found-after-installation的直接链接")
...
#### Python version too old[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#python-version-too-old "Python version too old的直接链接")
**Cause:** Hermes requires Python 3.11 or newer.
**Solution:**

```
python3 --version# Check current version# Install a newer Pythonsudoaptinstall python3.12   # Ubuntu/Debianbrew install python@3.12      # macOS
```

The installer handles this automatically — if you see this error during manual installation, upgrade Python first.
#### Terminal commands say `node: command not found` (or `nvm`, `pyenv`, `asdf`, …)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#terminal-commands-say-node-command-not-found-or-nvm-pyenv-asdf- "terminal-commands-say-node-command-not-found-or-nvm-pyenv-asdf-的直接链接")
...
####  `uv: command not found`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#uv-command-not-found "uv-command-not-found的直接链接")
...
#### Permission denied errors during install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#permission-denied-errors-during-install "Permission denied errors during install的直接链接")
**Cause:** Insufficient permissions to write to the install directory.
**Solution:**

```
# Don't use sudo with the installer — it installs to ~/.local/bin# If you previously installed with sudo, clean up:sudorm /usr/local/bin/hermes# Then re-run the standard installercurl-fsSL https://raw.githubusercontent.com/NousResearch/hermes-agent/main/scripts/install.sh |bash
```

### Provider & Model Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#provider--model-issues "Provider & Model Issues的直接链接")
####  `/model` only shows one provider / can't switch providers[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#model-only-shows-one-provider--cant-switch-providers "model-only-shows-one-provider--cant-switch-providers的直接链接")
...
#### API key not working[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#api-key-not-working "API key not working的直接链接")
...
#### Model not available / model not found[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#model-not-available--model-not-found "Model not available / model not found的直接链接")
...
#### Rate limiting (429 errors)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#rate-limiting-429-errors "Rate limiting \(429 errors\)的直接链接")
...
#### Context length exceeded[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#context-length-exceeded "Context length exceeded的直接链接")
...
```
# In ~/.hermes/config.yamlmodel:default: your-model-namecontext_length:131072# your model's actual context window
```
...
See [Context Length Detection](https://hermes-agent.nousresearch.com/docs/zh-Hans/integrations/providers#context-length-detection) for how auto-detection works and all override options.
### Terminal Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#terminal-issues "Terminal Issues的直接链接")
#### Command blocked as dangerous[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#command-blocked-as-dangerous "Command blocked as dangerous的直接链接")
...
**Solution:** When prompted, review the command and type `y` to approve it. You can also:
  ...
  * See the full list of dangerous patterns in the [Security docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/security)
...
####  `sudo` not working via messaging gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#sudo-not-working-via-messaging-gateway "sudo-not-working-via-messaging-gateway的直接链接")
...
#### Docker backend not connecting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#docker-backend-not-connecting "Docker backend not connecting的直接链接")
**Cause:** Docker daemon isn't running or the user lacks permissions.
**Solution:**

```
# Check Docker is runningdocker info# Add your user to the docker groupsudousermod-aGdocker$USERnewgrp docker# Verifydocker run hello-world
```

### Messaging Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#messaging-issues "Messaging Issues的直接链接")
#### Bot not responding to messages[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#bot-not-responding-to-messages "Bot not responding to messages的直接链接")
...
#### Messages not delivering[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#messages-not-delivering "Messages not delivering的直接链接")
...
#### Allowlist confusion — who can talk to the bot?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#allowlist-confusion--who-can-talk-to-the-bot "Allowlist confusion — who can talk to the bot?的直接链接")
...
Configure in `~/.hermes/config.yaml` under your gateway's settings. See the [Messaging docs](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/).
#### Gateway won't start[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#gateway-wont-start "Gateway won't start的直接链接")
...
#### WSL: Gateway keeps disconnecting or `hermes gateway start` fails[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails "wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails的直接链接")
...
#### macOS: Node.js / ffmpeg / other tools not found by gateway[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#macos-nodejs--ffmpeg--other-tools-not-found-by-gateway "macOS: Node.js / ffmpeg / other tools not found by gateway的直接链接")
...
### Performance Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#performance-issues "Performance Issues的直接链接")
#### Slow responses[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#slow-responses "Slow responses的直接链接")
...
#### High token usage[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#high-token-usage "High token usage的直接链接")
...
#### Session getting too long[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#session-getting-too-long "Session getting too long的直接链接")
...
### MCP Issues[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#mcp-issues "MCP Issues的直接链接")
#### MCP server not connecting[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#mcp-server-not-connecting "MCP server not connecting的直接链接")
...
#### Tools not showing up from MCP server[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#tools-not-showing-up-from-mcp-server "Tools not showing up from MCP server的直接链接")
...
```
# Verify MCP servers are configuredhermes config show |grep-A12 mcp_servers# Restart Hermes or reload MCP after config changeshermes chat
```
...
See also:
  ...
  * [MCP Config Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/reference/mcp-config-reference)


#### MCP timeout errors[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#mcp-timeout-errors "MCP timeout errors的直接链接")
...
## Profiles[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#profiles "Profiles的直接链接")
### How do profiles differ from just setting HERMES_HOME?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#how-do-profiles-differ-from-just-setting-hermes_home "How do profiles differ from just setting HERMES_HOME?的直接链接")
...
### Can two profiles share the same bot token?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-two-profiles-share-the-same-bot-token "Can two profiles share the same bot token?的直接链接")
...
### Do profiles share memory or sessions?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#do-profiles-share-memory-or-sessions "Do profiles share memory or sessions?的直接链接")
...
### What happens when I run `hermes update`?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#what-happens-when-i-run-hermes-update "what-happens-when-i-run-hermes-update的直接链接")
...
### How many profiles can I run?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#how-many-profiles-can-i-run "How many profiles can I run?的直接链接")
...
## Workflows & Patterns[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#workflows--patterns "Workflows & Patterns的直接链接")
### Using different models for different tasks (multi-model workflows)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#using-different-models-for-different-tasks-multi-model-workflows "Using different models for different tasks \(multi-model workflows\)的直接链接")
...
```
delegation:model:"google/gemini-3-flash-preview"# subagents use this modelprovider:"openrouter"# provider for subagents
```
...
See [Subagent Delegation](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/features/delegation) for more on how delegation works.
### Running multiple agents on one WhatsApp number (per-chat binding)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#running-multiple-agents-on-one-whatsapp-number-per-chat-binding "Running multiple agents on one WhatsApp number \(per-chat binding\)的直接链接")
...
See [Profiles](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/profiles) and [WhatsApp setup](https://hermes-agent.nousresearch.com/docs/zh-Hans/user-guide/messaging/whatsapp) for more details.
### Controlling what shows up in Telegram (hiding logs and reasoning)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#controlling-what-shows-up-in-telegram-hiding-logs-and-reasoning "Controlling what shows up in Telegram \(hiding logs and reasoning\)的直接链接")
...
### Managing skills on Telegram (slash command limit)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#managing-skills-on-telegram-slash-command-limit "Managing skills on Telegram \(slash command limit\)的直接链接")
...
```
skills:disabled:[]# globally disabled skillsplatform_disabled:telegram:[skill-a, skill-b]# disabled only on telegram
```
...
### Shared thread sessions (multiple users, one conversation)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#shared-thread-sessions-multiple-users-one-conversation "Shared thread sessions \(multiple users, one conversation\)的直接链接")
...
### Exporting Hermes to another machine[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#exporting-hermes-to-another-machine "Exporting Hermes to another machine的直接链接")
...
### Moving a single profile to another machine[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#moving-a-single-profile-to-another-machine "Moving a single profile to another machine的直接链接")
...
###  `hermes backup` vs `hermes profile export`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#hermes-backup-vs-hermes-profile-export "hermes-backup-vs-hermes-profile-export的直接链接")  
...
### Permission denied when reloading shell after install[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#permission-denied-when-reloading-shell-after-install "Permission denied when reloading shell after install的直接链接")
...
```
# Check permissionsls-la ~/.zshrc# Fix if needed (should be -rw-r--r-- or 644)chmod644 ~/.zshrc# Then reloadsource ~/.zshrc# Or just open a new terminal window — it picks up PATH changes automatically
```
...
### Error 400 on first agent run[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#error-400-on-first-agent-run "Error 400 on first agent run的直接链接")
...
## Still Stuck?[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#still-stuck "Still Stuck?的直接链接")
If your issue isn't covered here:
  ...
  * [Frequently Asked Questions](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#frequently-asked-questions)
    * [What LLM providers work with Hermes?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#what-llm-providers-work-with-hermes)
    * [Does it work on Windows?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#does-it-work-on-windows)
    * [I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#i-run-hermes-in-wsl2-whats-the-best-way-to-control-my-normal-windows-chrome)
    * [Does it work on Android / Termux?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#does-it-work-on-android--termux)
    * [Is my data sent anywhere?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#is-my-data-sent-anywhere)
    * [Can I use it offline / with local models?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-i-use-it-offline--with-local-models)
    * [How much does it cost?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#how-much-does-it-cost)
    * [Can multiple people use one instance?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-multiple-people-use-one-instance)
    * [What's the difference between memory and skills?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#whats-the-difference-between-memory-and-skills)
    * [Can I use it in my own Python project?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-i-use-it-in-my-own-python-project)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#troubleshooting)
    * [Installation Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#installation-issues)
    * [Provider & Model Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#provider--model-issues)
    * [Terminal Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#terminal-issues)
    * [Messaging Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#messaging-issues)
    * [Performance Issues](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#performance-issues)
  * [Profiles](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#profiles)
    * [How do profiles differ from just setting HERMES_HOME?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#how-do-profiles-differ-from-just-setting-hermes_home)
    * [Can two profiles share the same bot token?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#can-two-profiles-share-the-same-bot-token)
    * [Do profiles share memory or sessions?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#do-profiles-share-memory-or-sessions)
    * [What happens when I run `hermes update`?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#what-happens-when-i-run-hermes-update)
    * [How many profiles can I run?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#how-many-profiles-can-i-run)
  * [Workflows & Patterns](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#workflows--patterns)
    * [Using different models for different tasks (multi-model workflows)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#using-different-models-for-different-tasks-multi-model-workflows)
    * [Running multiple agents on one WhatsApp number (per-chat binding)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#running-multiple-agents-on-one-whatsapp-number-per-chat-binding)
    * [Controlling what shows up in Telegram (hiding logs and reasoning)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#controlling-what-shows-up-in-telegram-hiding-logs-and-reasoning)
    * [Managing skills on Telegram (slash command limit)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#managing-skills-on-telegram-slash-command-limit)
    * [Shared thread sessions (multiple users, one conversation)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#shared-thread-sessions-multiple-users-one-conversation)
    * [Exporting Hermes to another machine](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#exporting-hermes-to-another-machine)
    * [Moving a single profile to another machine](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#moving-a-single-profile-to-another-machine)
    * [`hermes backup` vs `hermes profile export`](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#hermes-backup-vs-hermes-profile-export)
    * [Permission denied when reloading shell after install](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#permission-denied-when-reloading-shell-after-install)
    * [Error 400 on first agent run](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#error-400-on-first-agent-run)
  * [Still Stuck?](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/faq#still-stuck)

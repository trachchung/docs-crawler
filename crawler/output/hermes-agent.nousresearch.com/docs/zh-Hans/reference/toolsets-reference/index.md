<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference -->
...
## How Toolsets Work[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#how-toolsets-work "How Toolsets Work的直接链接")
...
## Configuring Toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#configuring-toolsets "Configuring Toolsets的直接链接")
### Per-session (CLI)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#per-session-cli "Per-session \(CLI\)的直接链接")
...
### Per-platform (config.yaml)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#per-platform-configyaml "Per-platform \(config.yaml\)的直接链接")

```
toolsets:- hermes-cli          # default for CLI# - hermes-telegram   # override for Telegram gateway
```

### Interactive management[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#interactive-management "Interactive management的直接链接")
...
## Core Toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#core-toolsets "Core Toolsets的直接链接")  
...
## Platform Toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#platform-toolsets "Platform Toolsets的直接链接")
...
## Dynamic Toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#dynamic-toolsets "Dynamic Toolsets的直接链接")
### MCP server toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#mcp-server-toolsets "MCP server toolsets的直接链接")
...
```
# config.yamlmcp_servers:github:command: npxargs:["-y","@modelcontextprotocol/server-github"]
```

This creates a `mcp-github` toolset you can reference in `--toolsets` or platform configs.
### Plugin toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#plugin-toolsets "Plugin toolsets的直接链接")
...
### Custom toolsets[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#custom-toolsets "Custom toolsets的直接链接")
...
### Wildcards[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#wildcards "Wildcards的直接链接")
  * `all` or `*` — expands to every registered toolset (built-in + dynamic + plugin)


## Relationship to `hermes tools`[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#relationship-to-hermes-tools "relationship-to-hermes-tools的直接链接")
...
See also: [Tools Reference](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference) for the complete list of individual tools and their parameters.
  * [How Toolsets Work](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#how-toolsets-work)
  * [Configuring Toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#configuring-toolsets)
    * [Per-session (CLI)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#per-session-cli)
    * [Per-platform (config.yaml)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#per-platform-configyaml)
    * [Interactive management](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#interactive-management)
  * [Core Toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#core-toolsets)
  * [Platform Toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#platform-toolsets)
  * [Dynamic Toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#dynamic-toolsets)
    * [MCP server toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#mcp-server-toolsets)
    * [Plugin toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#plugin-toolsets)
    * [Custom toolsets](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#custom-toolsets)
  * [Relationship to `hermes tools`](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/toolsets-reference#relationship-to-hermes-tools)

<!-- Source: https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference -->
...
In addition to built-in tools, Hermes can load tools dynamically from MCP servers. MCP tools appear with the prefix `mcp_<server>_` (e.g., `mcp_github_create_issue` for the `github` MCP server). See [MCP Integration](https://hermes-agent.nousresearch.com/docs/zh-Hans/docs/user-guide/features/mcp) for configuration.
##  `browser` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#browser-toolset "browser-toolset的直接链接")  
...
##  `browser` toolset (CDP-gated tools)[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#browser-toolset-cdp-gated-tools "browser-toolset-cdp-gated-tools的直接链接")
...
##  `clarify` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#clarify-toolset "clarify-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `code_execution` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#code_execution-toolset "code_execution-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `cronjob` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#cronjob-toolset "cronjob-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `delegation` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#delegation-toolset "delegation-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `feishu_doc` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#feishu_doc-toolset "feishu_doc-toolset的直接链接")
...
##  `feishu_drive` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#feishu_drive-toolset "feishu_drive-toolset的直接链接")
...
##  `file` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#file-toolset "file-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `homeassistant` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#homeassistant-toolset "homeassistant-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `computer_use` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#computer_use-toolset "computer_use-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `memory` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#memory-toolset "memory-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `messaging` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#messaging-toolset "messaging-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `moa` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#moa-toolset "moa-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `rl` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#rl-toolset "rl-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `session_search` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#session_search-toolset "session_search-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `skills` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#skills-toolset "skills-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `terminal` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#terminal-toolset "terminal-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `todo` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#todo-toolset "todo-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `vision` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#vision-toolset "vision-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `video` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#video-toolset "video-toolset的直接链接")
...
##  `web` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#web-toolset "web-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `tts` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#tts-toolset "tts-toolset的直接链接")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `discord` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#discord-toolset "discord-toolset的直接链接")
...
##  `discord_admin` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#discord_admin-toolset "discord_admin-toolset的直接链接")
...
##  `spotify` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#spotify-toolset "spotify-toolset的直接链接")
...
##  `hermes-yuanbao` toolset[​](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#hermes-yuanbao-toolset "hermes-yuanbao-toolset的直接链接")
...
| `yb_send_sticker`  | Send a built-in sticker to the current Yuanbao chat.  | Yuanbao credentials  |  
  * [`browser` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#browser-toolset)
  * [`browser` toolset (CDP-gated tools)](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#browser-toolset-cdp-gated-tools)
  * [`clarify` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#clarify-toolset)
  * [`code_execution` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#code_execution-toolset)
  * [`cronjob` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#cronjob-toolset)
  * [`delegation` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#delegation-toolset)
  * [`feishu_doc` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#feishu_doc-toolset)
  * [`feishu_drive` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#feishu_drive-toolset)
  * [`file` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#file-toolset)
  * [`homeassistant` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#homeassistant-toolset)
  * [`computer_use` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#computer_use-toolset)
  * [`image_gen` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#image_gen-toolset)
  * [`kanban` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#kanban-toolset)
  * [`memory` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#memory-toolset)
  * [`messaging` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#messaging-toolset)
  * [`moa` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#moa-toolset)
  * [`rl` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#rl-toolset)
  * [`session_search` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#session_search-toolset)
  * [`skills` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#skills-toolset)
  * [`terminal` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#terminal-toolset)
  * [`todo` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#todo-toolset)
  * [`vision` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#vision-toolset)
  * [`video` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#video-toolset)
  * [`web` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#web-toolset)
  * [`tts` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#tts-toolset)
  * [`discord` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#discord-toolset)
  * [`discord_admin` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#discord_admin-toolset)
  * [`spotify` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#spotify-toolset)
  * [`hermes-yuanbao` toolset](https://hermes-agent.nousresearch.com/docs/zh-Hans/reference/tools-reference#hermes-yuanbao-toolset)

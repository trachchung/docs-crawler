...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#__docusaurus_skipToContent_fallback)
On this page
...
## Core Responsibilities[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#core-responsibilities "Direct link to Core Responsibilities")
...
## Two Entry Points[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#two-entry-points "Direct link to Two Entry Points")
...
## API Modes[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#api-modes "Direct link to API Modes")
...
## Turn Lifecycle[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#turn-lifecycle "Direct link to Turn Lifecycle")
...
### Message Format[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#message-format "Direct link to Message Format")
...
### Message Alternation Rules[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#message-alternation-rules "Direct link to Message Alternation Rules")
...
## Interruptible API Calls[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#interruptible-api-calls "Direct link to Interruptible API Calls")
...
## Tool Execution[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#tool-execution "Direct link to Tool Execution")
### Sequential vs Concurrent[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#sequential-vs-concurrent "Direct link to Sequential vs Concurrent")
...
### Execution Flow[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#execution-flow "Direct link to Execution Flow")
...
### Agent-Level Tools[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#agent-level-tools "Direct link to Agent-Level Tools")
...
## Callback Surfaces[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#callback-surfaces "Direct link to Callback Surfaces")
...
## Budget and Fallback Behavior[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#budget-and-fallback-behavior "Direct link to Budget and Fallback Behavior")
### Iteration Budget[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#iteration-budget "Direct link to Iteration Budget")
...
### Fallback Model[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#fallback-model "Direct link to Fallback Model")
...
## Compression and Persistence[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#compression-and-persistence "Direct link to Compression and Persistence")
### When Compression Triggers[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#when-compression-triggers "Direct link to When Compression Triggers")
...
### What Happens During Compression[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#what-happens-during-compression "Direct link to What Happens During Compression")
...
### Session Persistence[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#session-persistence "Direct link to Session Persistence")
After each turn:
...
## Key Source Files[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#key-source-files "Direct link to Key Source Files")  
| File  | Purpose  |  
| --- | --- |  
...
## Related Docs[​](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#related-docs "Direct link to Related Docs")
  ...
  * [Core Responsibilities](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#core-responsibilities)
  * [Two Entry Points](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#two-entry-points)
  * [Turn Lifecycle](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#turn-lifecycle)
    * [Message Format](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#message-format)
    * [Message Alternation Rules](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#message-alternation-rules)
  * [Interruptible API Calls](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#interruptible-api-calls)
  * [Tool Execution](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#tool-execution)
    * [Sequential vs Concurrent](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#sequential-vs-concurrent)
    * [Execution Flow](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#execution-flow)
    * [Agent-Level Tools](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#agent-level-tools)
  * [Callback Surfaces](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#callback-surfaces)
  * [Budget and Fallback Behavior](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#budget-and-fallback-behavior)
    * [Iteration Budget](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#iteration-budget)
    * [Fallback Model](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#fallback-model)
  * [Compression and Persistence](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#compression-and-persistence)
    * [When Compression Triggers](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#when-compression-triggers)
    * [What Happens During Compression](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#what-happens-during-compression)
    * [Session Persistence](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#session-persistence)
  * [Key Source Files](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#key-source-files)
  * [Related Docs](https://hermes-agent.nousresearch.com/docs/developer-guide/agent-loop#related-docs)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#__docusaurus_skipToContent_fallback)
On this page
...
## File Naming Convention[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#file-naming-convention "Direct link to File Naming Convention")
...
## JSONL Entry Format[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#jsonl-entry-format "Direct link to JSONL Entry Format")
Each line in the file is a self-contained JSON object. There are two variants:
### CLI/Interactive Format (from `_save_trajectory`)[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#cliinteractive-format-from-_save_trajectory "Direct link to cliinteractive-format-from-_save_trajectory")

```
"conversations":[ ... ],"timestamp":"2026-03-30T14:22:31.456789","model":"anthropic/claude-sonnet-4.6","completed":true
```

### Batch Runner Format (from `batch_runner.py`)[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#batch-runner-format-from-batch_runnerpy "Direct link to batch-runner-format-from-batch_runnerpy")
...
## Conversations Array (ShareGPT Format)[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#conversations-array-sharegpt-format "Direct link to Conversations Array \(ShareGPT Format\)")
...
| assistant  | `"gpt"`  |  
| tool  | `"tool"`  |  
### Complete Example[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#complete-example "Direct link to Complete Example")
...
## Normalization Rules[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#normalization-rules "Direct link to Normalization Rules")
### Reasoning Content Markup[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#reasoning-content-markup "Direct link to Reasoning Content Markup")
...
### Tool Call Normalization[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#tool-call-normalization "Direct link to Tool Call Normalization")
...
### Tool Response Normalization[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#tool-response-normalization "Direct link to Tool Response Normalization")
...
### System Message[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#system-message "Direct link to System Message")
...
## Loading Trajectories[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#loading-trajectories "Direct link to Loading Trajectories")
...
### Loading for HuggingFace Datasets[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#loading-for-huggingface-datasets "Direct link to Loading for HuggingFace Datasets")
...
## Controlling Trajectory Saving[​](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#controlling-trajectory-saving "Direct link to Controlling Trajectory Saving")
...
Samples with zero reasoning across all turns are automatically discarded by the batch runner to avoid polluting training data with non-reasoning examples.
  * [File Naming Convention](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#file-naming-convention)
  * [JSONL Entry Format](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#jsonl-entry-format)
    * [CLI/Interactive Format (from `_save_trajectory`)](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#cliinteractive-format-from-_save_trajectory)
    * [Batch Runner Format (from `batch_runner.py`)](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#batch-runner-format-from-batch_runnerpy)
  * [Conversations Array (ShareGPT Format)](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#conversations-array-sharegpt-format)
    * [Complete Example](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#complete-example)
  * [Normalization Rules](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#normalization-rules)
    * [Reasoning Content Markup](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#reasoning-content-markup)
    * [Tool Call Normalization](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#tool-call-normalization)
    * [Tool Response Normalization](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#tool-response-normalization)
    * [System Message](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#system-message)
  * [Loading Trajectories](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#loading-trajectories)
    * [Loading for HuggingFace Datasets](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#loading-for-huggingface-datasets)
  * [Controlling Trajectory Saving](https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format#controlling-trajectory-saving)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#__docusaurus_skipToContent_fallback)
On this page
...
## Architecture Overview[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#architecture-overview "Direct link to Architecture Overview")
...
## SQLite Schema[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#sqlite-schema "Direct link to SQLite Schema")
### Sessions Table[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#sessions-table "Direct link to Sessions Table")
...
### Messages Table[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#messages-table "Direct link to Messages Table")
...
### FTS5 Full-Text Search[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#fts5-full-text-search "Direct link to FTS5 Full-Text Search")
...
## Schema Version and Migrations[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#schema-version-and-migrations "Direct link to Schema Version and Migrations")
...
## Write Contention Handling[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#write-contention-handling "Direct link to Write Contention Handling")
...
## Common Operations[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#common-operations "Direct link to Common Operations")
### Initialize[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#initialize "Direct link to Initialize")

```
from hermes_state import SessionDBdb = SessionDB()# Default: ~/.hermes/state.dbdb = SessionDB(db_path=Path("/tmp/test.db"))# Custom path
```

### Create and Manage Sessions[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#create-and-manage-sessions "Direct link to Create and Manage Sessions")
...
### Store Messages[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#store-messages "Direct link to Store Messages")
...
### Retrieve Messages[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#retrieve-messages "Direct link to Retrieve Messages")
...
### Session Titles[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#session-titles "Direct link to Session Titles")
...
## Full-Text Search[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#full-text-search "Direct link to Full-Text Search")
The `search_messages()` method supports FTS5 query syntax with automatic sanitization of user input.
### Basic Search[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#basic-search "Direct link to Basic Search")

```
results = db.search_messages("docker deployment")
```

### FTS5 Query Syntax[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#fts5-query-syntax "Direct link to FTS5 Query Syntax")  
...
### Filtered Search[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#filtered-search "Direct link to Filtered Search")
...
### Search Results Format[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#search-results-format "Direct link to Search Results Format")
...
## Session Lineage[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#session-lineage "Direct link to Session Lineage")
...
### Query: Find Session Lineage[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#query-find-session-lineage "Direct link to Query: Find Session Lineage")
...
### Query: Recent Sessions with Preview[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#query-recent-sessions-with-preview "Direct link to Query: Recent Sessions with Preview")
...
### Query: Token Usage Statistics[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#query-token-usage-statistics "Direct link to Query: Token Usage Statistics")
...
## Export and Cleanup[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#export-and-cleanup "Direct link to Export and Cleanup")
...
## Database Location[​](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#database-location "Direct link to Database Location")
...
The database file, WAL file (`state.db-wal`), and shared-memory file (`state.db-shm`) are all created in the same directory.
  * [Architecture Overview](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#architecture-overview)
  * [SQLite Schema](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#sqlite-schema)
    * [Sessions Table](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#sessions-table)
    * [Messages Table](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#messages-table)
    * [FTS5 Full-Text Search](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#fts5-full-text-search)
  * [Schema Version and Migrations](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#schema-version-and-migrations)
  * [Write Contention Handling](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#write-contention-handling)
  * [Common Operations](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#common-operations)
    * [Create and Manage Sessions](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#create-and-manage-sessions)
    * [Store Messages](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#store-messages)
    * [Retrieve Messages](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#retrieve-messages)
    * [Session Titles](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#session-titles)
  * [Full-Text Search](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#full-text-search)
    * [Basic Search](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#basic-search)
    * [FTS5 Query Syntax](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#fts5-query-syntax)
    * [Filtered Search](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#filtered-search)
    * [Search Results Format](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#search-results-format)
  * [Session Lineage](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#session-lineage)
    * [Query: Find Session Lineage](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#query-find-session-lineage)
    * [Query: Recent Sessions with Preview](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#query-recent-sessions-with-preview)
    * [Query: Token Usage Statistics](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#query-token-usage-statistics)
  * [Export and Cleanup](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#export-and-cleanup)
  * [Database Location](https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage#database-location)

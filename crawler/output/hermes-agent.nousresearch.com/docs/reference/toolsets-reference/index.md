...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#__docusaurus_skipToContent_fallback)
On this page
...
## How Toolsets Work[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#how-toolsets-work "Direct link to How Toolsets Work")
...
## Configuring Toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#configuring-toolsets "Direct link to Configuring Toolsets")
### Per-session (CLI)[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#per-session-cli "Direct link to Per-session \(CLI\)")
...
### Per-platform (config.yaml)[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#per-platform-configyaml "Direct link to Per-platform \(config.yaml\)")

```
toolsets:- hermes-cli          # default for CLI# - hermes-telegram   # override for Telegram gateway
```

### Interactive management[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#interactive-management "Direct link to Interactive management")
...
## Core Toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#core-toolsets "Direct link to Core Toolsets")  
...
## Platform Toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#platform-toolsets "Direct link to Platform Toolsets")
...
## Dynamic Toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#dynamic-toolsets "Direct link to Dynamic Toolsets")
### MCP server toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#mcp-server-toolsets "Direct link to MCP server toolsets")
...
### Plugin toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#plugin-toolsets "Direct link to Plugin toolsets")
...
### Custom toolsets[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#custom-toolsets "Direct link to Custom toolsets")
...
### Wildcards[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#wildcards "Direct link to Wildcards")
  * `all` or `*` — expands to every registered toolset (built-in + dynamic + plugin)


## Relationship to `hermes tools`[​](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#relationship-to-hermes-tools "Direct link to relationship-to-hermes-tools")
...
See also: [Tools Reference](https://hermes-agent.nousresearch.com/docs/reference/tools-reference) for the complete list of individual tools and their parameters.
  * [How Toolsets Work](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#how-toolsets-work)
  * [Configuring Toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#configuring-toolsets)
    * [Per-session (CLI)](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#per-session-cli)
    * [Per-platform (config.yaml)](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#per-platform-configyaml)
    * [Interactive management](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#interactive-management)
  * [Core Toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#core-toolsets)
  * [Platform Toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#platform-toolsets)
  * [Dynamic Toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#dynamic-toolsets)
    * [MCP server toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#mcp-server-toolsets)
    * [Plugin toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#plugin-toolsets)
    * [Custom toolsets](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#custom-toolsets)
  * [Relationship to `hermes tools`](https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference#relationship-to-hermes-tools)

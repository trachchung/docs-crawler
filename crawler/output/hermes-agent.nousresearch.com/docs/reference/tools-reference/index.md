...
##  `rl` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#rl-toolset "Direct link to rl-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
| `yb_send_sticker`  | Send a built-in sticker to the current Yuanbao chat.  | Yuanbao credentials  |  
  ...
  * [`messaging` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#messaging-toolset)
  * [`moa` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#moa-toolset)
  * [`rl` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#rl-toolset)

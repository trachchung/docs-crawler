...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#__docusaurus_skipToContent_fallback)
On this page
...
## See also[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#see-also "Direct link to See also")
  ...
  * [`hermes profile`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile)
  * [`hermes profile list`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-list)
  * [`hermes profile use`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-use)
  * [`hermes profile create`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-create)
  * [`hermes profile delete`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-delete)
  * [`hermes profile show`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-show)
  * [`hermes profile alias`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-alias)
  * [`hermes profile rename`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-rename)
  * [`hermes profile export`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-export)
  * [`hermes profile import`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-import)
  * [Distribution commands](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#distribution-commands)
    * [`hermes profile install`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-install)
    * [`hermes profile update`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-update)
    * [`hermes profile info`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-info)
    * [Private distributions](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#private-distributions)
    * [Distribution manifest (`distribution.yaml`)](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#distribution-manifest-distributionyaml)
    * [Publishing a distribution](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#publishing-a-distribution)
  * [`hermes -p` / `hermes --profile`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes--p--hermes---profile)
  * [`hermes completion`](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-completion)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/reference/faq#__docusaurus_skipToContent_fallback)
On this page
...
### Can two profiles share the same bot token?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#can-two-profiles-share-the-same-bot-token "Direct link to Can two profiles share the same bot token?")
...
### Do profiles share memory or sessions?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#do-profiles-share-memory-or-sessions "Direct link to Do profiles share memory or sessions?")
...
If your issue isn't covered here:
  ...
  * [Frequently Asked Questions](https://hermes-agent.nousresearch.com/docs/reference/faq#frequently-asked-questions)
    * [What LLM providers work with Hermes?](https://hermes-agent.nousresearch.com/docs/reference/faq#what-llm-providers-work-with-hermes)
    * [Does it work on Windows?](https://hermes-agent.nousresearch.com/docs/reference/faq#does-it-work-on-windows)
    * [I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?](https://hermes-agent.nousresearch.com/docs/reference/faq#i-run-hermes-in-wsl2-whats-the-best-way-to-control-my-normal-windows-chrome)
    * [Does it work on Android / Termux?](https://hermes-agent.nousresearch.com/docs/reference/faq#does-it-work-on-android--termux)
    * [Is my data sent anywhere?](https://hermes-agent.nousresearch.com/docs/reference/faq#is-my-data-sent-anywhere)
    * [Can I use it offline / with local models?](https://hermes-agent.nousresearch.com/docs/reference/faq#can-i-use-it-offline--with-local-models)
    * [How much does it cost?](https://hermes-agent.nousresearch.com/docs/reference/faq#how-much-does-it-cost)
    * [Can multiple people use one instance?](https://hermes-agent.nousresearch.com/docs/reference/faq#can-multiple-people-use-one-instance)
    * [What's the difference between memory and skills?](https://hermes-agent.nousresearch.com/docs/reference/faq#whats-the-difference-between-memory-and-skills)
    * [Can I use it in my own Python project?](https://hermes-agent.nousresearch.com/docs/reference/faq#can-i-use-it-in-my-own-python-project)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/reference/faq#troubleshooting)
    * [Installation Issues](https://hermes-agent.nousresearch.com/docs/reference/faq#installation-issues)
    * [Provider & Model Issues](https://hermes-agent.nousresearch.com/docs/reference/faq#provider--model-issues)
    * [Terminal Issues](https://hermes-agent.nousresearch.com/docs/reference/faq#terminal-issues)
    * [Messaging Issues](https://hermes-agent.nousresearch.com/docs/reference/faq#messaging-issues)
    * [Performance Issues](https://hermes-agent.nousresearch.com/docs/reference/faq#performance-issues)
  * [Profiles](https://hermes-agent.nousresearch.com/docs/reference/faq#profiles)
    * [How do profiles differ from just setting HERMES_HOME?](https://hermes-agent.nousresearch.com/docs/reference/faq#how-do-profiles-differ-from-just-setting-hermes_home)
    * [Can two profiles share the same bot token?](https://hermes-agent.nousresearch.com/docs/reference/faq#can-two-profiles-share-the-same-bot-token)
    * [Do profiles share memory or sessions?](https://hermes-agent.nousresearch.com/docs/reference/faq#do-profiles-share-memory-or-sessions)
    * [What happens when I run `hermes update`?](https://hermes-agent.nousresearch.com/docs/reference/faq#what-happens-when-i-run-hermes-update)
    * [How many profiles can I run?](https://hermes-agent.nousresearch.com/docs/reference/faq#how-many-profiles-can-i-run)
  * [Workflows & Patterns](https://hermes-agent.nousresearch.com/docs/reference/faq#workflows--patterns)
    * [Using different models for different tasks (multi-model workflows)](https://hermes-agent.nousresearch.com/docs/reference/faq#using-different-models-for-different-tasks-multi-model-workflows)
    * [Running multiple agents on one WhatsApp number (per-chat binding)](https://hermes-agent.nousresearch.com/docs/reference/faq#running-multiple-agents-on-one-whatsapp-number-per-chat-binding)
    * [Controlling what shows up in Telegram (hiding logs and reasoning)](https://hermes-agent.nousresearch.com/docs/reference/faq#controlling-what-shows-up-in-telegram-hiding-logs-and-reasoning)
    * [Managing skills on Telegram (slash command limit)](https://hermes-agent.nousresearch.com/docs/reference/faq#managing-skills-on-telegram-slash-command-limit)
    * [Shared thread sessions (multiple users, one conversation)](https://hermes-agent.nousresearch.com/docs/reference/faq#shared-thread-sessions-multiple-users-one-conversation)
    * [Exporting Hermes to another machine](https://hermes-agent.nousresearch.com/docs/reference/faq#exporting-hermes-to-another-machine)
    * [Moving a single profile to another machine](https://hermes-agent.nousresearch.com/docs/reference/faq#moving-a-single-profile-to-another-machine)
    * [`hermes backup` vs `hermes profile export`](https://hermes-agent.nousresearch.com/docs/reference/faq#hermes-backup-vs-hermes-profile-export)
    * [Permission denied when reloading shell after install](https://hermes-agent.nousresearch.com/docs/reference/faq#permission-denied-when-reloading-shell-after-install)
    * [Error 400 on first agent run](https://hermes-agent.nousresearch.com/docs/reference/faq#error-400-on-first-agent-run)
  * [Still Stuck?](https://hermes-agent.nousresearch.com/docs/reference/faq#still-stuck)

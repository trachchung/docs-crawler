...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#__docusaurus_skipToContent_fallback)
On this page
Debug Hermes TUI slash commands: Python, gateway, Ink UI.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#skill-metadata "Direct link to Skill metadata")  
...
| Related skills  |  [`python-debugpy`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-python-debugpy), [`node-inspect-debugger`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-node-inspect-debugger), [`systematic-debugging`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#reference-full-skillmd "Direct link to Reference: full SKILL.md")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
# Debugging Hermes TUI Slash Commands
## Overview[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#overview "Direct link to Overview")
...
## When to Use[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#when-to-use "Direct link to When to Use")
...
## Architecture Overview[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#architecture-overview "Direct link to Architecture Overview")

```
Python backend (hermes_cli/commands.py)     <- canonical COMMAND_REGISTRYTUI gateway (tui_gateway/server.py)         <- slash.exec / command.dispatchTUI frontend (ui-tui/src/app/slash/)        <- local handlers + fallthrough
```
...
## Investigation Steps[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#investigation-steps "Direct link to Investigation Steps")
...
```
search_files --pattern"CommandDef"--file_glob"*.py"--path hermes_cli/search_files --pattern"commandname"--path hermes_cli/commands.py --context3
```
...
## Fix: Missing Command Autocomplete[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#fix-missing-command-autocomplete "Direct link to Fix: Missing Command Autocomplete")
If a command exists in the TUI but doesn't show in autocomplete:
  1. Add a `CommandDef` entry to `COMMAND_REGISTRY` in `hermes_cli/commands.py`:

```
CommandDef("commandname","Description of the command","Session",           cli_only=True, aliases=("alias",),           args_hint="[arg1|arg2|arg3]",           subcommands=("arg1","arg2","arg3")),
```
...
```
elif canonical =="commandname":    self._handle_commandname(cmd_original)
```

  5. For gateway-available commands, add a handler in `gateway/run.py`:

```
if canonical =="commandname":returnawait self._handle_commandname(event)
```



## Common Issues[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#common-issues "Direct link to Common Issues")
...
## Debugging Tactics[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#debugging-tactics "Direct link to Debugging Tactics")
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#pitfalls "Direct link to Pitfalls")
...
## Verification[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#verification "Direct link to Verification")
After fixing:
  1. Rebuild the TUI:
...
```
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#reference-full-skillmd)
  * [When to Use](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#when-to-use)
  * [Architecture Overview](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#architecture-overview)
  * [Investigation Steps](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#investigation-steps)
  * [Fix: Missing Command Autocomplete](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#fix-missing-command-autocomplete)
  * [Common Issues](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#common-issues)
  * [Debugging Tactics](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#debugging-tactics)
  * [Verification](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands#verification)

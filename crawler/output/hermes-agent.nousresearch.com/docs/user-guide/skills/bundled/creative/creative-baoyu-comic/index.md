...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#__docusaurus_skipToContent_fallback)
On this page
Knowledge comics (知识漫画): educational, biography, tutorial.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#skill-metadata "Direct link to Skill metadata")  
...
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-full-skillmd "Direct link to Reference: full SKILL.md")
...
## When to Use[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#when-to-use "Direct link to When to Use")
...
## Reference Images[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-images "Direct link to Reference Images")
...
## Options[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#options "Direct link to Options")
### Visual Dimensions[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#visual-dimensions "Direct link to Visual Dimensions")  
...
| Refs  | File paths  | Reference images used for style / palette trait extraction (not passed to the image model). See [Reference Images](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-images) above.  |  
### Partial Workflow Options[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#partial-workflow-options "Direct link to Partial Workflow Options")  
| Option  | Description  |  
| --- | --- |  
...
### Art, Tone & Preset Catalogue[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#art-tone--preset-catalogue "Direct link to Art, Tone & Preset Catalogue")
...
## File Structure[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#file-structure "Direct link to File Structure")
...
## Language Handling[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#language-handling "Direct link to Language Handling")
**Detection Priority** :
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#workflow "Direct link to Workflow")
### Progress Checklist[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#progress-checklist "Direct link to Progress Checklist")
...
### Flow[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#flow "Direct link to Flow")

```
Input → Analyze → [Check Existing?] → [Confirm: Style + Reviews] → Storyboard → [Review?] → Prompts → [Review?] → Images → Complete
```

### Step Summary[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#step-summary "Direct link to Step Summary")  
...
### User Questions[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#user-questions "Direct link to User Questions")
...
### Step 7: Image Generation[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#step-7-image-generation "Direct link to Step 7: Image Generation")
...
## References[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#references "Direct link to References")
**Core Templates** :
...
## Page Modification[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#page-modification "Direct link to Page Modification")  
| Action  | Steps  |  
| --- | --- |  
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#pitfalls "Direct link to Pitfalls")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-full-skillmd)
  * [When to Use](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#when-to-use)
  * [Reference Images](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#reference-images)
  * [Options](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#options)
    * [Visual Dimensions](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#visual-dimensions)
    * [Partial Workflow Options](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#partial-workflow-options)
    * [Art, Tone & Preset Catalogue](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#art-tone--preset-catalogue)
  * [File Structure](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#file-structure)
  * [Language Handling](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#language-handling)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#workflow)
    * [Progress Checklist](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#progress-checklist)
    * [Step Summary](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#step-summary)
    * [User Questions](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#user-questions)
    * [Step 7: Image Generation](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#step-7-image-generation)
  * [Page Modification](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-baoyu-comic#page-modification)

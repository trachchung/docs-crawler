...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#__docusaurus_skipToContent_fallback)
On this page
Control a running TouchDesigner instance via twozero MCP — create operators, set parameters, wire connections, execute Python, build real-time visuals. 36 native tools.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#skill-metadata "Direct link to Skill metadata")  
...
| Related skills  |  [`native-mcp`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mcp/mcp-native-mcp), [`ascii-video`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-manim-video), `hermes-video`  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#reference-full-skillmd "Direct link to Reference: full SKILL.md")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
# TouchDesigner Integration (twozero MCP)
## CRITICAL RULES[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-rules "Direct link to CRITICAL RULES")
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#architecture "Direct link to Architecture")
...
## Setup (Automated)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#setup-automated "Direct link to Setup \(Automated\)")
...
### Manual steps (one-time, cannot be automated)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#manual-steps-one-time-cannot-be-automated "Direct link to Manual steps \(one-time, cannot be automated\)")
...
## Environment Notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#environment-notes "Direct link to Environment Notes")
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#workflow "Direct link to Workflow")
### Step 0: Discover (before building anything)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-0-discover-before-building-anything "Direct link to Step 0: Discover \(before building anything\)")
...
### Step 1: Clean + Build[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-1-clean--build "Direct link to Step 1: Clean + Build")
...
### Step 2: Set Parameters[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-2-set-parameters "Direct link to Step 2: Set Parameters")
...
### Step 3: Wire[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-3-wire "Direct link to Step 3: Wire")
...
### Step 4: Verify[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-4-verify "Direct link to Step 4: Verify")

```
td_get_errors(path="/project1", recursive=true)td_get_perf()td_get_operator_info(path="/project1/out", detail="full")
```

### Step 5: Display / Capture[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-5-display--capture "Direct link to Step 5: Display / Capture")
...
## MCP Tool Quick Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#mcp-tool-quick-reference "Direct link to MCP Tool Quick Reference")
**Core (use these most):**  
| Tool  | What  |  
| --- | --- |  
...
## Key Implementation Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#key-implementation-rules "Direct link to Key Implementation Rules")
...
## Recording / Exporting Video[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#recording--exporting-video "Direct link to Recording / Exporting Video")
...
### Before Recording: Checklist[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#before-recording-checklist "Direct link to Before Recording: Checklist")
...
## Audio-Reactive GLSL (Proven Recipe)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#audio-reactive-glsl-proven-recipe "Direct link to Audio-Reactive GLSL \(Proven Recipe\)")
### Correct signal chain (tested April 2026)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#correct-signal-chain-tested-april-2026 "Direct link to Correct signal chain \(tested April 2026\)")
...
### Critical audio-reactive rules (empirically verified)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-audio-reactive-rules-empirically-verified "Direct link to Critical audio-reactive rules \(empirically verified\)")
...
### GLSL spectrum sampling[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#glsl-spectrum-sampling "Direct link to GLSL spectrum sampling")
...
## Operator Quick Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#operator-quick-reference "Direct link to Operator Quick Reference")  
...
## Security Notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#security-notes "Direct link to Security Notes")
...
## References[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#references "Direct link to References")  
| File  | What  |  
| --- | --- |  
...
> You're not writing code. You're conducting light.
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#reference-full-skillmd)
  * [CRITICAL RULES](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-rules)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#architecture)
  * [Setup (Automated)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#setup-automated)
    * [Manual steps (one-time, cannot be automated)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#manual-steps-one-time-cannot-be-automated)
  * [Environment Notes](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#environment-notes)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#workflow)
    * [Step 0: Discover (before building anything)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-0-discover-before-building-anything)
    * [Step 1: Clean + Build](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-1-clean--build)
    * [Step 2: Set Parameters](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-2-set-parameters)
    * [Step 3: Wire](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-3-wire)
    * [Step 4: Verify](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-4-verify)
    * [Step 5: Display / Capture](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#step-5-display--capture)
  * [MCP Tool Quick Reference](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#mcp-tool-quick-reference)
  * [Key Implementation Rules](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#key-implementation-rules)
  * [Recording / Exporting Video](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#recording--exporting-video)
    * [Before Recording: Checklist](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#before-recording-checklist)
  * [Audio-Reactive GLSL (Proven Recipe)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#audio-reactive-glsl-proven-recipe)
    * [Correct signal chain (tested April 2026)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#correct-signal-chain-tested-april-2026)
    * [Critical audio-reactive rules (empirically verified)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#critical-audio-reactive-rules-empirically-verified)
    * [GLSL spectrum sampling](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#glsl-spectrum-sampling)
  * [Operator Quick Reference](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#operator-quick-reference)
  * [Security Notes](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp#security-notes)

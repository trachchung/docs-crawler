...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#__docusaurus_skipToContent_fallback)
On this page
Songwriting craft and Suno AI music prompts.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#skill-metadata "Direct link to Skill metadata")  
| Source  | Bundled (installed by default)  |  
| --- | --- |  
| Path  | `skills/creative/songwriting-and-ai-music`  |  
| Platforms  | linux, macos, windows  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#reference-full-skillmd "Direct link to Reference: full SKILL.md")
...
## 1. Song Structure (Pick One or Invent Your Own)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#1-song-structure-pick-one-or-invent-your-own "Direct link to 1. Song Structure \(Pick One or Invent Your Own\)")
...
## 2. Rhyme, Meter, and Sound[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#2-rhyme-meter-and-sound "Direct link to 2. Rhyme, Meter, and Sound")
...
## 3. Emotional Arc and Dynamics[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#3-emotional-arc-and-dynamics "Direct link to 3. Emotional Arc and Dynamics")
...
## 4. Writing Lyrics That Work[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#4-writing-lyrics-that-work "Direct link to 4. Writing Lyrics That Work")
...
## 5. Parody and Adaptation[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#5-parody-and-adaptation "Direct link to 5. Parody and Adaptation")
...
## 6. Suno AI Prompt Engineering[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#6-suno-ai-prompt-engineering "Direct link to 6. Suno AI Prompt Engineering")
### Style/Genre Description Field[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#stylegenre-description-field "Direct link to Style/Genre Description Field")
FORMULA (adapt as needed): Genre + Mood + Era + Instruments + Vocal Style + Production + Dynamics

```
BAD:  "sad rock song"GOOD: "Cinematic orchestral spy thriller, 1960s Cold War era, smoky       sultry female vocalist, big band jazz, brass section with       trumpets and french horns, sweeping strings, minor key,       vintage analog warmth"
```
...
### Metatags (place in [brackets] inside lyrics field)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#metatags-place-in-brackets-inside-lyrics-field "Direct link to Metatags \(place in \[brackets\] inside lyrics field\)")
...
### Custom Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#custom-mode "Direct link to Custom Mode")
...
## 7. Phonetic Tricks for AI Singers[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#7-phonetic-tricks-for-ai-singers "Direct link to 7. Phonetic Tricks for AI Singers")
...
## 8. Workflow[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#8-workflow "Direct link to 8. Workflow")
...
## 9. Lessons Learned[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#9-lessons-learned "Direct link to 9. Lessons Learned")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#reference-full-skillmd)
  * [1. Song Structure (Pick One or Invent Your Own)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#1-song-structure-pick-one-or-invent-your-own)
  * [2. Rhyme, Meter, and Sound](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#2-rhyme-meter-and-sound)
  * [3. Emotional Arc and Dynamics](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#3-emotional-arc-and-dynamics)
  * [4. Writing Lyrics That Work](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#4-writing-lyrics-that-work)
  * [5. Parody and Adaptation](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#5-parody-and-adaptation)
  * [6. Suno AI Prompt Engineering](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#6-suno-ai-prompt-engineering)
    * [Style/Genre Description Field](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#stylegenre-description-field)
    * [Metatags (place in [brackets] inside lyrics field)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#metatags-place-in-brackets-inside-lyrics-field)
    * [Custom Mode](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#custom-mode)
  * [7. Phonetic Tricks for AI Singers](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#7-phonetic-tricks-for-ai-singers)
  * [8. Workflow](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#8-workflow)
  * [9. Lessons Learned](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music#9-lessons-learned)

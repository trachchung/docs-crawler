...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#__docusaurus_skipToContent_fallback)
On this page
Design one-off HTML artifacts (landing, deck, prototype).
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#skill-metadata "Direct link to Skill metadata")  
...
| Related skills  |  [`design-md`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-design-md), [`popular-web-designs`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-popular-web-designs), [`excalidraw`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-excalidraw), [`architecture-diagram`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-architecture-diagram)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#reference-full-skillmd "Direct link to Reference: full SKILL.md")
...
## When To Use This Skill vs `popular-web-designs` vs `design-md`[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#when-to-use-this-skill-vs-popular-web-designs-vs-design-md "Direct link to when-to-use-this-skill-vs-popular-web-designs-vs-design-md")
...
## Runtime Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#runtime-mode "Direct link to Runtime Mode")
...
## Core Identity[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#core-identity "Direct link to Core Identity")
...
## When To Use[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#when-to-use "Direct link to When To Use")
Use this skill for:
  * landing pages
  * teaser pages
...
## Design Principle: Start From Context, Not Vibes[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#design-principle-start-from-context-not-vibes "Direct link to Design Principle: Start From Context, Not Vibes")
...
## Asking Questions[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#asking-questions "Direct link to Asking Questions")
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#workflow "Direct link to Workflow")
...
## Artifact Format Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#artifact-format-rules "Direct link to Artifact Format Rules")
...
## HTML / CSS / JS Standards[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#html--css--js-standards "Direct link to HTML / CSS / JS Standards")
Use modern CSS well:
...
## React Guidance for Standalone HTML[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#react-guidance-for-standalone-html "Direct link to React Guidance for Standalone HTML")
...
## Deck Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#deck-rules "Direct link to Deck Rules")
...
## Prototype Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#prototype-rules "Direct link to Prototype Rules")
...
## Variation Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#variation-rules "Direct link to Variation Rules")
...
## Tweakable Designs in CLI/API Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#tweakable-designs-in-cliapi-mode "Direct link to Tweakable Designs in CLI/API Mode")
...
## Content Discipline[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#content-discipline "Direct link to Content Discipline")
...
## Anti-Slop Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#anti-slop-rules "Direct link to Anti-Slop Rules")
...
## Typography[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#typography "Direct link to Typography")
...
## Color[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#color "Direct link to Color")
...
## Layout and Composition[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#layout-and-composition "Direct link to Layout and Composition")
Design with rhythm:
  * scale
  * whitespace
  * density
...
## Motion[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#motion "Direct link to Motion")
...
## Images and Icons[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#images-and-icons "Direct link to Images and Icons")
...
## Source-Code Fidelity[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#source-code-fidelity "Direct link to Source-Code Fidelity")
...
## Reading Documents and Assets[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#reading-documents-and-assets "Direct link to Reading Documents and Assets")
...
## Copyright and Reference Models[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#copyright-and-reference-models "Direct link to Copyright and Reference Models")
...
## Verification[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#verification "Direct link to Verification")
...
## Final Response Format[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#final-response-format "Direct link to Final Response Format")
...
```
Created: /path/to/Prototype.htmlIt includes 3 layout variants, a Tweaks panel for density/theme, and responsive behavior.Verified: file exists and opened cleanly in browser, no console errors.Next: pick the strongest direction and I’ll tighten copy + motion.
```

## Portable Opening Prompt Pattern[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#portable-opening-prompt-pattern "Direct link to Portable Opening Prompt Pattern")
...
## Pitfalls[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#pitfalls "Direct link to Pitfalls")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#reference-full-skillmd)
  * [When To Use This Skill vs `popular-web-designs` vs `design-md`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#when-to-use-this-skill-vs-popular-web-designs-vs-design-md)
  * [Runtime Mode](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#runtime-mode)
  * [Core Identity](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#core-identity)
  * [When To Use](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#when-to-use)
  * [Design Principle: Start From Context, Not Vibes](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#design-principle-start-from-context-not-vibes)
  * [Asking Questions](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#asking-questions)
  * [Artifact Format Rules](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#artifact-format-rules)
  * [HTML / CSS / JS Standards](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#html--css--js-standards)
  * [React Guidance for Standalone HTML](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#react-guidance-for-standalone-html)
  * [Prototype Rules](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#prototype-rules)
  * [Variation Rules](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#variation-rules)
  * [Tweakable Designs in CLI/API Mode](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#tweakable-designs-in-cliapi-mode)
  * [Content Discipline](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#content-discipline)
  * [Anti-Slop Rules](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#anti-slop-rules)
  * [Layout and Composition](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#layout-and-composition)
  * [Images and Icons](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#images-and-icons)
  * [Source-Code Fidelity](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#source-code-fidelity)
  * [Reading Documents and Assets](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#reading-documents-and-assets)
  * [Copyright and Reference Models](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#copyright-and-reference-models)
  * [Verification](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#verification)
  * [Final Response Format](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#final-response-format)
  * [Portable Opening Prompt Pattern](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-claude-design#portable-opening-prompt-pattern)

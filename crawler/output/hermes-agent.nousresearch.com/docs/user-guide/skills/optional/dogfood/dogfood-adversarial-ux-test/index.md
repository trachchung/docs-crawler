...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#__docusaurus_skipToContent_fallback)
On this page
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#skill-metadata "Direct link to Skill metadata")  
...
| Related skills  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#reference-full-skillmd "Direct link to Reference: full SKILL.md")
...
## Why This Works[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#why-this-works "Direct link to Why This Works")
...
## How to Use[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#how-to-use "Direct link to How to Use")
Tell the agent:
...
## Step 1: Define the Persona[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-1-define-the-persona "Direct link to Step 1: Define the Persona")
...
### Good Persona Example[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#good-persona-example "Direct link to Good Persona Example")
...
### Bad Persona Example[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#bad-persona-example "Direct link to Bad Persona Example")
...
## Step 2: Become the Asshole (Browse as the Persona)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-2-become-the-asshole-browse-as-the-persona "Direct link to Step 2: Become the Asshole \(Browse as the Persona\)")
...
## Step 3: The Rant (Write Feedback in Character)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-3-the-rant-write-feedback-in-character "Direct link to Step 3: The Rant \(Write Feedback in Character\)")
...
## Step 4: The Pragmatism Filter (Critical — Do Not Skip)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-4-the-pragmatism-filter-critical--do-not-skip "Direct link to Step 4: The Pragmatism Filter \(Critical — Do Not Skip\)")
...
### Filter Criteria[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#filter-criteria "Direct link to Filter Criteria")
...
## Step 5: Create Tickets[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-5-create-tickets "Direct link to Step 5: Create Tickets")
...
## Step 6: Report[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-6-report "Direct link to Step 6: Report")
Deliver:
...
## Tips[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#tips "Direct link to Tips")
...
## Example Personas by Industry[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#example-personas-by-industry "Direct link to Example Personas by Industry")
...
## Rules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#rules "Direct link to Rules")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#reference-full-skillmd)
  * [Why This Works](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#why-this-works)
  * [Step 1: Define the Persona](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-1-define-the-persona)
    * [Good Persona Example](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#good-persona-example)
    * [Bad Persona Example](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#bad-persona-example)
  * [Step 2: Become the Asshole (Browse as the Persona)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-2-become-the-asshole-browse-as-the-persona)
  * [Step 3: The Rant (Write Feedback in Character)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-3-the-rant-write-feedback-in-character)
  * [Step 4: The Pragmatism Filter (Critical — Do Not Skip)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-4-the-pragmatism-filter-critical--do-not-skip)
    * [Filter Criteria](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#filter-criteria)
  * [Step 5: Create Tickets](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-5-create-tickets)
  * [Step 6: Report](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#step-6-report)
  * [Example Personas by Industry](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test#example-personas-by-industry)

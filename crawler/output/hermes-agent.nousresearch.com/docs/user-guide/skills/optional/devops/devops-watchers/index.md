...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#__docusaurus_skipToContent_fallback)
On this page
Poll RSS, JSON APIs, and GitHub with watermark dedup.
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#skill-metadata "Direct link to Skill metadata")  
...
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#reference-full-skillmd "Direct link to Reference: full SKILL.md")
...
## When to Use[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#when-to-use "Direct link to When to Use")
...
## Mental model[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#mental-model "Direct link to Mental model")
...
## Ready-made scripts[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#ready-made-scripts "Direct link to Ready-made scripts")
...
## Usage[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#usage "Direct link to Usage")
Run a watcher directly from the terminal tool:

```
python $HERMES_HOME/skills/devops/watchers/scripts/watch_rss.py \--name hn --url https://news.ycombinator.com/rss --max5
```
...
## Wiring into cron[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#wiring-into-cron "Direct link to Wiring into cron")
...
## State files[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#state-files "Direct link to State files")
...
## Writing your own[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#writing-your-own "Direct link to Writing your own")
...
## Common Pitfalls[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#common-pitfalls "Direct link to Common Pitfalls")
  ...
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#reference-full-skillmd)
  * [When to Use](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#when-to-use)
  * [Mental model](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#mental-model)
  * [Ready-made scripts](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#ready-made-scripts)
  * [Wiring into cron](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#wiring-into-cron)
  * [State files](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#state-files)
  * [Writing your own](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#writing-your-own)
  * [Common Pitfalls](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-watchers#common-pitfalls)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#__docusaurus_skipToContent_fallback)
On this page
...
## Skill metadata[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#skill-metadata "Direct link to Skill metadata")  
...
| Related skills  |  [`excel-author`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-excel-author), [`pptx-author`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-pptx-author), [`dcf-model`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-dcf-model), [`3-statement-model`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-3-statement-model)  |  
## Reference: full SKILL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#reference-full-skillmd "Direct link to Reference: full SKILL.md")
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
## Environment[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#environment "Direct link to Environment")
...
## TEMPLATE REQUIREMENT[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#template-requirement "Direct link to TEMPLATE REQUIREMENT")
...
## CRITICAL INSTRUCTIONS — READ FIRST[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#critical-instructions--read-first "Direct link to CRITICAL INSTRUCTIONS — READ FIRST")
...
### Core Principles[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#core-principles "Direct link to Core Principles")
...
### Formula Color Conventions[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#formula-color-conventions "Direct link to Formula Color Conventions")
...
### Number Formatting Standards[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#number-formatting-standards "Direct link to Number Formatting Standards")
...
### Clarify Requirements First[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#clarify-requirements-first "Direct link to Clarify Requirements First")
...
## TEMPLATE ANALYSIS PHASE - DO THIS FIRST[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#template-analysis-phase---do-this-first "Direct link to TEMPLATE ANALYSIS PHASE - DO THIS FIRST")
...
## FILLING FORMULAS - GENERAL APPROACH[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#filling-formulas---general-approach "Direct link to FILLING FORMULAS - GENERAL APPROACH")
For each cell that needs a formula, follow this hierarchy:
### Step 1: Check the Template[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#step-1-check-the-template "Direct link to Step 1: Check the Template")
...
### Step 2: Check the User's Instructions[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#step-2-check-the-users-instructions "Direct link to Step 2: Check the User's Instructions")
...
### Step 3: Apply Standard Practice[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#step-3-apply-standard-practice "Direct link to Step 3: Apply Standard Practice")
  * If neither template nor user specifies, use standard LBO modeling conventions
  * Document any assumptions you make
  * If genuinely uncertain, ask the user


## COMMON PROBLEM AREAS[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#common-problem-areas "Direct link to COMMON PROBLEM AREAS")
...
### Balancing Sections[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#balancing-sections "Direct link to Balancing Sections")
...
### Tax Calculations[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#tax-calculations "Direct link to Tax Calculations")
...
### Interest and Circular References[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#interest-and-circular-references "Direct link to Interest and Circular References")
...
### Debt Paydown / Cash Sweeps[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#debt-paydown--cash-sweeps "Direct link to Debt Paydown / Cash Sweeps")
...
### Returns Calculations (IRR/MOIC)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#returns-calculations-irrmoic "Direct link to Returns Calculations \(IRR/MOIC\)")
...
### Sensitivity Tables[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#sensitivity-tables "Direct link to Sensitivity Tables")
...
## VERIFICATION CHECKLIST - RUN AFTER COMPLETION[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#verification-checklist---run-after-completion "Direct link to VERIFICATION CHECKLIST - RUN AFTER COMPLETION")
### Run Formula Validation[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#run-formula-validation "Direct link to Run Formula Validation")
...
### Section Balancing[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#section-balancing "Direct link to Section Balancing")
...
### Income/Operating Projections[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#incomeoperating-projections "Direct link to Income/Operating Projections")
...
### Balance Sheet (if applicable)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#balance-sheet-if-applicable "Direct link to Balance Sheet \(if applicable\)")
...
### Cash Flow (if applicable)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#cash-flow-if-applicable "Direct link to Cash Flow \(if applicable\)")
...
### Supporting Schedules[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#supporting-schedules "Direct link to Supporting Schedules")
...
### Debt/Financing Schedules (if applicable)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#debtfinancing-schedules-if-applicable "Direct link to Debt/Financing Schedules \(if applicable\)")
...
### Returns/Output Analysis[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#returnsoutput-analysis "Direct link to Returns/Output Analysis")
...
### Sensitivity Tables (if applicable)[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#sensitivity-tables-if-applicable "Direct link to Sensitivity Tables \(if applicable\)")
...
### Formatting[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#formatting "Direct link to Formatting")
...
### Logical Sanity Checks[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#logical-sanity-checks "Direct link to Logical Sanity Checks")
...
## COMMON ERRORS TO AVOID[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#common-errors-to-avoid "Direct link to COMMON ERRORS TO AVOID")  
...
## WORKING WITH THE USER — SECTION-BY-SECTION CHECKPOINTS[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#working-with-the-user--section-by-section-checkpoints "Direct link to WORKING WITH THE USER — SECTION-BY-SECTION CHECKPOINTS")
...
## Data sources — MCP first, web fallback[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#data-sources--mcp-first-web-fallback "Direct link to Data sources — MCP first, web fallback")
...
## Attribution[​](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#attribution "Direct link to Attribution")
This skill is adapted from Anthropic's Claude for Financial Services plugin suite (Apache-2.0). The Office-JS / Cowork live-Excel paths have been removed; this version targets headless openpyxl via the `excel-author` skill's conventions. Original: <https://github.com/anthropics/financial-services>
  * [Skill metadata](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#skill-metadata)
  * [Reference: full SKILL.md](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#reference-full-skillmd)
  * [Environment](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#environment)
  * [TEMPLATE REQUIREMENT](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#template-requirement)
  * [CRITICAL INSTRUCTIONS — READ FIRST](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#critical-instructions--read-first)
    * [Core Principles](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#core-principles)
    * [Formula Color Conventions](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#formula-color-conventions)
    * [Fill Color Palette — Professional Blues & Greys (Default unless user/template specifies otherwise)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#fill-color-palette--professional-blues--greys-default-unless-usertemplate-specifies-otherwise)
    * [Number Formatting Standards](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#number-formatting-standards)
    * [Clarify Requirements First](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#clarify-requirements-first)
  * [TEMPLATE ANALYSIS PHASE - DO THIS FIRST](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#template-analysis-phase---do-this-first)
  * [FILLING FORMULAS - GENERAL APPROACH](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#filling-formulas---general-approach)
    * [Step 1: Check the Template](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#step-1-check-the-template)
    * [Step 2: Check the User's Instructions](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#step-2-check-the-users-instructions)
    * [Step 3: Apply Standard Practice](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#step-3-apply-standard-practice)
  * [COMMON PROBLEM AREAS](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#common-problem-areas)
    * [Balancing Sections](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#balancing-sections)
    * [Tax Calculations](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#tax-calculations)
    * [Interest and Circular References](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#interest-and-circular-references)
    * [Debt Paydown / Cash Sweeps](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#debt-paydown--cash-sweeps)
    * [Returns Calculations (IRR/MOIC)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#returns-calculations-irrmoic)
    * [Sensitivity Tables](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#sensitivity-tables)
  * [VERIFICATION CHECKLIST - RUN AFTER COMPLETION](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#verification-checklist---run-after-completion)
    * [Run Formula Validation](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#run-formula-validation)
    * [Section Balancing](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#section-balancing)
    * [Income/Operating Projections](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#incomeoperating-projections)
    * [Balance Sheet (if applicable)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#balance-sheet-if-applicable)
    * [Cash Flow (if applicable)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#cash-flow-if-applicable)
    * [Supporting Schedules](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#supporting-schedules)
    * [Debt/Financing Schedules (if applicable)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#debtfinancing-schedules-if-applicable)
    * [Returns/Output Analysis](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#returnsoutput-analysis)
    * [Sensitivity Tables (if applicable)](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#sensitivity-tables-if-applicable)
    * [Logical Sanity Checks](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#logical-sanity-checks)
  * [COMMON ERRORS TO AVOID](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#common-errors-to-avoid)
  * [WORKING WITH THE USER — SECTION-BY-SECTION CHECKPOINTS](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#working-with-the-user--section-by-section-checkpoints)
  * [Data sources — MCP first, web fallback](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#data-sources--mcp-first-web-fallback)
  * [Attribution](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model#attribution)

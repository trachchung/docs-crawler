...
### Vercel Sandbox Backend[​](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#vercel-sandbox-backend "Direct link to Vercel Sandbox Backend")
...
### Session Search Tuning[​](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#session-search-tuning "Direct link to Session Search Tuning")
...
```
  ...
  * [Terminal Backend Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#terminal-backend-configuration)
    ...
    * [Vercel Sandbox Backend](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#vercel-sandbox-backend)
  ...
  * [Auxiliary Models](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#auxiliary-models)
    ...
    * [Session Search Tuning](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#session-search-tuning)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#__docusaurus_skipToContent_fallback)
On this page
...
## How it works[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#how-it-works "Direct link to How it works")
...
## Enabling[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#enabling "Direct link to Enabling")
...
## Keeping cua-driver up to date[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#keeping-cua-driver-up-to-date "Direct link to Keeping cua-driver up to date")
...
## Quick example[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#quick-example "Direct link to Quick example")
...
## Provider compatibility[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#provider-compatibility "Direct link to Provider compatibility")  
...
## Safety[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#safety "Direct link to Safety")
...
## Token efficiency[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#token-efficiency "Direct link to Token efficiency")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#limitations "Direct link to Limitations")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#configuration "Direct link to Configuration")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#troubleshooting "Direct link to Troubleshooting")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#see-also "Direct link to See also")
  ...
  * [Browser automation](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser) for cross-platform web tasks.


  * [How it works](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#how-it-works)
  * [Keeping cua-driver up to date](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#keeping-cua-driver-up-to-date)
  * [Quick example](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#quick-example)
  * [Provider compatibility](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#provider-compatibility)
  * [Token efficiency](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#token-efficiency)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#limitations)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#configuration)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/features/computer-use#troubleshooting)

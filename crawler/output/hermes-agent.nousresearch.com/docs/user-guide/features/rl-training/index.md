...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#__docusaurus_skipToContent_fallback)
On this page
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#overview "Direct link to Overview")
...
## Requirements[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#requirements "Direct link to Requirements")
...
## Available Tools[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#available-tools "Direct link to Available Tools")  
| Tool  | Description  |  
| --- | --- |  
...
## Workflow[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#workflow "Direct link to Workflow")
### 1. Discover Environments[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#1-discover-environments "Direct link to 1. Discover Environments")
...
### 2. Select and Configure[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#2-select-and-configure "Direct link to 2. Select and Configure")
...
### 3. Start Training[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#3-start-training "Direct link to 3. Start Training")
...
### 4. Monitor Progress[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#4-monitor-progress "Direct link to 4. Monitor Progress")
...
### 5. Stop or Get Results[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#5-stop-or-get-results "Direct link to 5. Stop or Get Results")
...
## Inference Testing[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#inference-testing "Direct link to Inference Testing")
...
## Tinker API Integration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#tinker-api-integration "Direct link to Tinker API Integration")
...
## Architecture Diagram[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#architecture-diagram "Direct link to Architecture Diagram")
...
## Creating Custom Environments[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#creating-custom-environments "Direct link to Creating Custom Environments")
...
## WandB Metrics[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#wandb-metrics "Direct link to WandB Metrics")
...
## Log Files[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#log-files "Direct link to Log Files")
...
These are invaluable for debugging when training fails or produces unexpected results.
  * [Requirements](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#requirements)
  * [Available Tools](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#available-tools)
  * [Workflow](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#workflow)
    * [1. Discover Environments](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#1-discover-environments)
    * [2. Select and Configure](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#2-select-and-configure)
    * [3. Start Training](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#3-start-training)
    * [4. Monitor Progress](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#4-monitor-progress)
    * [5. Stop or Get Results](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#5-stop-or-get-results)
  * [Inference Testing](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#inference-testing)
  * [Tinker API Integration](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#tinker-api-integration)
  * [Architecture Diagram](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#architecture-diagram)
  * [Creating Custom Environments](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#creating-custom-environments)
  * [WandB Metrics](https://hermes-agent.nousresearch.com/docs/user-guide/features/rl-training#wandb-metrics)

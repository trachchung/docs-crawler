...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#__docusaurus_skipToContent_fallback)
On this page
...
### Pinning extra skills to a specific task[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#pinning-extra-skills-to-a-specific-task "Direct link to Pinning extra skills to a specific task")
...
The complete design — architecture, concurrency correctness, comparison with other systems, implementation plan, risks, open questions — lives in `docs/hermes-kanban-v1-spec.pdf`. Read that before filing any behavior-change PR.
  * [Two surfaces: the model talks through tools, you talk through the CLI](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#two-surfaces-the-model-talks-through-tools-you-talk-through-the-cli)
  * [Kanban vs. `delegate_task`](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#kanban-vs-delegate_task)
  * [Core concepts](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#core-concepts)
  * [Boards (multi-project)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#boards-multi-project)
    * [Managing boards from the CLI](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#managing-boards-from-the-cli)
    * [Managing boards from the dashboard](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#managing-boards-from-the-dashboard)
  * [Quick start](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#quick-start)
    * [Gateway-embedded dispatcher (default)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#gateway-embedded-dispatcher-default)
    * [Idempotent create (for automation / webhooks)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#idempotent-create-for-automation--webhooks)
    * [Bulk CLI verbs](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#bulk-cli-verbs)
  * [How workers interact with the board](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#how-workers-interact-with-the-board)
    * [Why tools instead of shelling to `hermes kanban`](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#why-tools-instead-of-shelling-to-hermes-kanban)
    * [Recommended handoff evidence](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#recommended-handoff-evidence)
    * [The worker skill](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#the-worker-skill)
    * [Pinning extra skills to a specific task](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#pinning-extra-skills-to-a-specific-task)
    * [The orchestrator skill](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#the-orchestrator-skill)
  * [Dashboard (GUI)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#dashboard-gui)
    * [What the plugin gives you](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#what-the-plugin-gives-you)
    * [Architecture](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#architecture)
    * [REST surface](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#rest-surface)
    * [Dashboard config](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#dashboard-config)
    * [Security model](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#security-model)
    * [Live updates](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#live-updates)
    * [Extending it](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#extending-it)
    * [Scope boundary](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#scope-boundary)
  * [CLI command reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#cli-command-reference)
  * [`/kanban` slash command](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#kanban-slash-command)
    * [Mid-run usage: `/kanban` bypasses the running-agent guard](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#mid-run-usage-kanban-bypasses-the-running-agent-guard)
    * [Auto-subscribe on `/kanban create` (gateway only)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#auto-subscribe-on-kanban-create-gateway-only)
    * [Output truncation in messaging](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#output-truncation-in-messaging)
    * [Autocomplete](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#autocomplete)
  * [Collaboration patterns](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#collaboration-patterns)
  * [Multi-tenant usage](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#multi-tenant-usage)
  * [Gateway notifications](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#gateway-notifications)
  * [Runs — one row per attempt](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#runs--one-row-per-attempt)
    * [Forward compatibility](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#forward-compatibility)
  * [Event reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#event-reference)
  * [Out of scope](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#out-of-scope)
  * [Design spec](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#design-spec)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#__docusaurus_skipToContent_fallback)
On this page
...
If your configured provider isn't available, Hermes automatically falls back:
  ...
  * [Text-to-Speech](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#text-to-speech)
    * [Platform Delivery](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#platform-delivery)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#configuration)
    * [Input length limits](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#input-length-limits)
    * [Telegram Voice Bubbles & ffmpeg](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#telegram-voice-bubbles--ffmpeg)
    * [xAI Custom Voices (voice cloning)](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#xai-custom-voices-voice-cloning)
    * [Piper (local, 44 languages)](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#piper-local-44-languages)
    * [Custom command providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#custom-command-providers)
  * [Voice Message Transcription (STT)](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#voice-message-transcription-stt)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#configuration-1)
    * [Provider Details](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#provider-details)
    * [Fallback Behavior](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#fallback-behavior)

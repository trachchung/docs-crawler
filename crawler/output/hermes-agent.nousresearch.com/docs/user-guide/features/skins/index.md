...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#__docusaurus_skipToContent_fallback)
On this page
...
## Change skins[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#change-skins "Direct link to Change skins")
...
## Built-in skins[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#built-in-skins "Direct link to Built-in skins")  
...
## Complete list of configurable keys[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#complete-list-of-configurable-keys "Direct link to Complete list of configurable keys")
### Colors (`colors:`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#colors-colors "Direct link to colors-colors")
...
### Spinner (`spinner:`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#spinner-spinner "Direct link to spinner-spinner")
...
### Branding (`branding:`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#branding-branding "Direct link to branding-branding")
...
### Other top-level keys[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#other-top-level-keys "Direct link to Other top-level keys")  
...
## Custom skins[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#custom-skins "Direct link to Custom skins")
...
### Full custom skin YAML template[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#full-custom-skin-yaml-template "Direct link to Full custom skin YAML template")
...
### Minimal custom skin example[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#minimal-custom-skin-example "Direct link to Minimal custom skin example")
...
## Hermes Mod — Visual Skin Editor[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#hermes-mod--visual-skin-editor "Direct link to Hermes Mod — Visual Skin Editor")
...
### Install[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#install "Direct link to Install")
...
### Usage[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#usage "Direct link to Usage")
...
## Operational notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#operational-notes "Direct link to Operational notes")
  ...
  * [Change skins](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#change-skins)
  * [Built-in skins](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#built-in-skins)
  * [Complete list of configurable keys](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#complete-list-of-configurable-keys)
    * [Colors (`colors:`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#colors-colors)
    * [Spinner (`spinner:`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#spinner-spinner)
    * [Branding (`branding:`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#branding-branding)
    * [Other top-level keys](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#other-top-level-keys)
  * [Custom skins](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#custom-skins)
    * [Full custom skin YAML template](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#full-custom-skin-yaml-template)
    * [Minimal custom skin example](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#minimal-custom-skin-example)
  * [Hermes Mod — Visual Skin Editor](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#hermes-mod--visual-skin-editor)
  * [Operational notes](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins#operational-notes)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#__docusaurus_skipToContent_fallback)
On this page
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#limitations "Direct link to Limitations")
  ...
  * [Supported Models](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#supported-models)
  * [Setup](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#setup)
    * [Get a FAL API Key](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#get-a-fal-api-key)
    * [Configure and Pick a Model](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#configure-and-pick-a-model)
    * [GPT-Image Quality](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#gpt-image-quality)
  * [Aspect Ratios](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#aspect-ratios)
  * [Automatic Upscaling](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#automatic-upscaling)
  * [How It Works Internally](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#how-it-works-internally)
  * [Platform Delivery](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#platform-delivery)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/user-guide/features/image-generation#limitations)

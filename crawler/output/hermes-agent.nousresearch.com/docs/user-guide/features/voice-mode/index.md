...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#__docusaurus_skipToContent_fallback)
On this page
...
The hallucination filter catches most cases automatically. If you're still getting phantom transcripts:
  ...
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#prerequisites)
  * [Requirements](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#requirements)
    * [Python Packages](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#python-packages)
    * [System Dependencies](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#system-dependencies)
  * [CLI Voice Mode](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#cli-voice-mode)
    * [Quick Start](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#quick-start)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#how-it-works)
    * [Silence Detection](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#silence-detection)
    * [Streaming TTS](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#streaming-tts)
    * [Hallucination Filter](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#hallucination-filter)
  * [Gateway Voice Reply (Telegram & Discord)](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#gateway-voice-reply-telegram--discord)
    * [Discord: Channels vs DMs](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#discord-channels-vs-dms)
    * [Platform Delivery](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#platform-delivery)
  * [Discord Voice Channels](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#discord-voice-channels)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#start-the-gateway)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#how-it-works-1)
    * [Text Channel Integration](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#text-channel-integration)
    * [Echo Prevention](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#echo-prevention)
    * [Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#access-control)
  * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#configuration-reference)
    * [config.yaml](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#configyaml)
    * [Environment Variables](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#environment-variables)
    * [STT Provider Comparison](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#stt-provider-comparison)
    * [TTS Provider Comparison](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#tts-provider-comparison)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#troubleshooting)
    * ["No audio device found" (CLI)](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#no-audio-device-found-cli)
    * [Bot doesn't respond in Discord server channels](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-doesnt-respond-in-discord-server-channels)
    * [Bot joins VC but doesn't hear me](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-joins-vc-but-doesnt-hear-me)
    * [Bot hears me but doesn't respond](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-hears-me-but-doesnt-respond)
    * [Bot responds in text but not in voice channel](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-responds-in-text-but-not-in-voice-channel)
    * [Whisper returns garbage text](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#whisper-returns-garbage-text)

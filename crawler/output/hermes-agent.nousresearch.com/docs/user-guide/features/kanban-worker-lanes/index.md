...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#__docusaurus_skipToContent_fallback)
On this page
...
## The hierarchy[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#the-hierarchy "Direct link to The hierarchy")
...
## What a lane provides[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#what-a-lane-provides "Direct link to What a lane provides")
To be a kanban worker lane, an integration must provide three things:
### 1. An assignee string[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#1-an-assignee-string "Direct link to 1. An assignee string")
The dispatcher matches `task.assignee` against either a Hermes profile name (the default lane shape) or a registered non-spawnable identifier (the plugin lane shape — see [Adding an external CLI worker lane](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#adding-an-external-cli-worker-lane) below). Tasks whose assignee doesn't resolve are left on `ready` with a `skipped_nonspawnable` event so a board operator can fix them; they are not silently dropped or executed by an arbitrary fallback.
### 2. A spawn mechanism[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#2-a-spawn-mechanism "Direct link to 2. A spawn mechanism")
...
| `HERMES_KANBAN_WORKSPACE`  | absolute path to _this_ task's workspace  |  
...
### 3. A lifecycle terminator[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#3-a-lifecycle-terminator "Direct link to 3. A lifecycle terminator")
...
## Outputs and the review-required convention[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#outputs-and-the-review-required-convention "Direct link to Outputs and the review-required convention")
...
## Logs and audit trail[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#logs-and-audit-trail "Direct link to Logs and audit trail")
...
## Existing lane shapes[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#existing-lane-shapes "Direct link to Existing lane shapes")
### Hermes profile lane (default)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#hermes-profile-lane-default "Direct link to Hermes profile lane \(default\)")
...
### Orchestrator profile lane[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#orchestrator-profile-lane "Direct link to Orchestrator profile lane")
...
## Adding an external CLI worker lane[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#adding-an-external-cli-worker-lane "Direct link to Adding an external CLI worker lane")
...
## Failure modes the dispatcher handles[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#failure-modes-the-dispatcher-handles "Direct link to Failure modes the dispatcher handles")
...
## Related[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#related "Direct link to Related")
  * [Kanban overview](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban) — the user-facing intro.
  * [Kanban tutorial](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial) — walkthrough with the dashboard open.
  ...
  * [The hierarchy](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#the-hierarchy)
  * [What a lane provides](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#what-a-lane-provides)
    * [1. An assignee string](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#1-an-assignee-string)
    * [2. A spawn mechanism](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#2-a-spawn-mechanism)
    * [3. A lifecycle terminator](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#3-a-lifecycle-terminator)
  * [Outputs and the review-required convention](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#outputs-and-the-review-required-convention)
  * [Logs and audit trail](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#logs-and-audit-trail)
  * [Existing lane shapes](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#existing-lane-shapes)
    * [Hermes profile lane (default)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#hermes-profile-lane-default)
    * [Orchestrator profile lane](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#orchestrator-profile-lane)
  * [Adding an external CLI worker lane](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#adding-an-external-cli-worker-lane)
  * [Failure modes the dispatcher handles](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-worker-lanes#failure-modes-the-dispatcher-handles)

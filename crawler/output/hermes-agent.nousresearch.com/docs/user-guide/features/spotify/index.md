...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#__docusaurus_skipToContent_fallback)
On this page
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#prerequisites "Direct link to Prerequisites")
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#setup "Direct link to Setup")
### One-shot: `hermes tools`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#one-shot-hermes-tools "Direct link to one-shot-hermes-tools")
...
### Two-step flow[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#two-step-flow "Direct link to Two-step flow")
#### 1. Enable the toolset[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#1-enable-the-toolset "Direct link to 1. Enable the toolset")
...
#### 2. Run the login wizard[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#2-run-the-login-wizard "Direct link to 2. Run the login wizard")
...
### Creating the Spotify app (what the wizard asks for)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#creating-the-spotify-app-what-the-wizard-asks-for "Direct link to Creating the Spotify app \(what the wizard asks for\)")
...
### Running over SSH / in a headless environment[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#running-over-ssh--in-a-headless-environment "Direct link to Running over SSH / in a headless environment")
...
## Verify[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#verify "Direct link to Verify")
...
## Using it[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#using-it "Direct link to Using it")
...
### Tool reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#tool-reference "Direct link to Tool reference")
...
####  `spotify_playback`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_playback "Direct link to spotify_playback")
...
####  `spotify_devices`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_devices "Direct link to spotify_devices")  
| Action  | Purpose  |  
| --- | --- |  
...
####  `spotify_queue`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_queue "Direct link to spotify_queue")  
| Action  | Purpose  | Premium?  |  
| --- | --- | --- |  
| `get`  | Currently queued tracks  | No  |  
| `add`  | Append `uri` to the queue  | Yes  |  
####  `spotify_search`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_search "Direct link to spotify_search")
...
####  `spotify_playlists`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_playlists "Direct link to spotify_playlists")  
...
####  `spotify_albums`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_albums "Direct link to spotify_albums")  
| Action  | Purpose  | Required args  |  
| --- | --- | --- |  
| `get`  | Album metadata  | `album_id`  |  
| `tracks`  | Album track list  | `album_id`  |  
####  `spotify_library`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#spotify_library "Direct link to spotify_library")
...
### Feature matrix: Free vs Premium[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#feature-matrix-free-vs-premium "Direct link to Feature matrix: Free vs Premium")
...
|  `spotify_albums` (all)  |  
|  `spotify_library` (all)  |  
## Scheduling: Spotify + cron[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#scheduling-spotify--cron "Direct link to Scheduling: Spotify + cron")
...
### Morning wake-up playlist[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#morning-wake-up-playlist "Direct link to Morning wake-up playlist")

```
hermes cronadd\--name"morning-commute"\"0 7 * * 1-5"\"Transfer playback to my kitchen speaker and start my 'Morning Commute' playlist. Volume to 40. Shuffle on."
```
...
### Wind-down at night[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#wind-down-at-night "Direct link to Wind-down at night")

```
hermes cronadd\--name"wind-down"\"30 22 * * *"\"Pause Spotify. Then set volume to 20 so it's quiet when I start it again tomorrow."
```

### Gotchas[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#gotchas "Direct link to Gotchas")
...
## Sign out[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#sign-out "Direct link to Sign out")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#troubleshooting "Direct link to Troubleshooting")
...
## Advanced: custom scopes[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#advanced-custom-scopes "Direct link to Advanced: custom scopes")
...
## Advanced: custom client ID / redirect URI[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#advanced-custom-client-id--redirect-uri "Direct link to Advanced: custom client ID / redirect URI")
...
## Where things live[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#where-things-live "Direct link to Where things live")  
| File  | Contents  |  
| --- | --- |  
...
| Spotify app  | owned by you at [developer.spotify.com/dashboard](https://developer.spotify.com/dashboard); contains the Client ID and the redirect URI allow-list  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#prerequisites)
  * [Setup](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#setup)
    * [One-shot: `hermes tools`](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#one-shot-hermes-tools)
    * [Two-step flow](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#two-step-flow)
    * [Creating the Spotify app (what the wizard asks for)](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#creating-the-spotify-app-what-the-wizard-asks-for)
    * [Running over SSH / in a headless environment](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#running-over-ssh--in-a-headless-environment)
  * [Using it](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#using-it)
    * [Tool reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#tool-reference)
    * [Feature matrix: Free vs Premium](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#feature-matrix-free-vs-premium)
  * [Scheduling: Spotify + cron](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#scheduling-spotify--cron)
    * [Morning wake-up playlist](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#morning-wake-up-playlist)
    * [Wind-down at night](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#wind-down-at-night)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#troubleshooting)
  * [Advanced: custom scopes](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#advanced-custom-scopes)
  * [Advanced: custom client ID / redirect URI](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#advanced-custom-client-id--redirect-uri)
  * [Where things live](https://hermes-agent.nousresearch.com/docs/user-guide/features/spotify#where-things-live)

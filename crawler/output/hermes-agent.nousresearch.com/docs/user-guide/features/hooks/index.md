...
Both Python plugin hooks and shell hooks flow through the same `invoke_hook()` dispatcher. Python plugins are registered first (`discover_and_load()`), shell hooks second (`register_from_config()`), so Python `pre_tool_call` block decisions take precedence in tie cases. The first valid block wins — the aggregator returns as soon as any callback produces `{"action": "block", "message": str}` with a non-empty message.
  * [Gateway Event Hooks](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#gateway-event-hooks)
    * [Creating a Hook](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#creating-a-hook)
    * [Available Events](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#available-events)
    ...
    * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#how-it-works)
  * [Plugin Hooks](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#plugin-hooks)
    * [Quick reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#quick-reference)
    * [`pre_tool_call`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#pre_tool_call)
    * [`post_tool_call`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#post_tool_call)
    * [`pre_llm_call`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#pre_llm_call)
    * [`post_llm_call`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#post_llm_call)
    * [`on_session_start`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#on_session_start)
    * [`on_session_end`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#on_session_end)
    * [`on_session_finalize`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#on_session_finalize)
    * [`on_session_reset`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#on_session_reset)
    * [`subagent_stop`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#subagent_stop)
    * [`pre_gateway_dispatch`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#pre_gateway_dispatch)
    * [`pre_approval_request`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#pre_approval_request)
    ...
    * [`transform_llm_output`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#transform_llm_output)
  * [Shell Hooks](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#shell-hooks)
    ...
    * [JSON wire protocol](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#json-wire-protocol)
    * [Worked examples](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#worked-examples)
    * [Consent model](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#consent-model)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#__docusaurus_skipToContent_fallback)
On this page
...
## Why[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#why "Direct link to Why")
...
## What tools the model actually has[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#what-tools-the-model-actually-has "Direct link to What tools the model actually has")
...
### 1. Codex's built-in toolset (always on)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#1-codexs-built-in-toolset-always-on "Direct link to 1. Codex's built-in toolset \(always on\)")
...
### 2. Native Codex plugins (auto-migrated from your `codex plugin` install)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#2-native-codex-plugins-auto-migrated-from-your-codex-plugin-install "Direct link to 2-native-codex-plugins-auto-migrated-from-your-codex-plugin-install")
...
### 3. Hermes tool callback (MCP server, registered in `~/.codex/config.toml`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#3-hermes-tool-callback-mcp-server-registered-in-codexconfigtoml "Direct link to 3-hermes-tool-callback-mcp-server-registered-in-codexconfigtoml")
...
### What's NOT available on this runtime[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#whats-not-available-on-this-runtime "Direct link to What's NOT available on this runtime")
...
## Workflow features (`/goal`, kanban, cron)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#workflow-features-goal-kanban-cron "Direct link to workflow-features-goal-kanban-cron")
###  `/goal` (the Ralph loop)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#goal-the-ralph-loop "Direct link to goal-the-ralph-loop")
...
### Kanban (multi-agent worktree dispatch)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#kanban-multi-agent-worktree-dispatch "Direct link to Kanban \(multi-agent worktree dispatch\)")
...
### Cron jobs[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#cron-jobs "Direct link to Cron jobs")
...
## Trade-offs[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#trade-offs "Direct link to Trade-offs")  
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#prerequisites "Direct link to Prerequisites")
...
## Enabling[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#enabling "Direct link to Enabling")
In a Hermes session:
...
## Self-improvement loop (memory + skill nudges)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#self-improvement-loop-memory--skill-nudges "Direct link to Self-improvement loop \(memory + skill nudges\)")
...
## How approvals work[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#how-approvals-work "Direct link to How approvals work")
...
## Permission profiles[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#permission-profiles "Direct link to Permission profiles")
...
## Auxiliary tasks and ChatGPT subscription token cost[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#auxiliary-tasks-and-chatgpt-subscription-token-cost "Direct link to Auxiliary tasks and ChatGPT subscription token cost")
...
## Editing `~/.codex/config.toml` safely[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#editing-codexconfigtoml-safely "Direct link to editing-codexconfigtoml-safely")
...
## Multi-profile / multi-tenant setups[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#multi-profile--multi-tenant-setups "Direct link to Multi-profile / multi-tenant setups")
...
## HOME environment variable passthrough[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#home-environment-variable-passthrough "Direct link to HOME environment variable passthrough")
...
## MCP server migration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#mcp-server-migration "Direct link to MCP server migration")
...
## Native Codex plugin migration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#native-codex-plugin-migration "Direct link to Native Codex plugin migration")
...
## Hermes tool callback (the new MCP server)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#hermes-tool-callback-the-new-mcp-server "Direct link to Hermes tool callback \(the new MCP server\)")
...
## Disabling[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#disabling "Direct link to Disabling")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#limitations "Direct link to Limitations")
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#architecture "Direct link to Architecture")
...
For implementation details, see [PR #24182](https://github.com/NousResearch/hermes-agent/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
  * [What tools the model actually has](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#what-tools-the-model-actually-has)
    * [1. Codex's built-in toolset (always on)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#1-codexs-built-in-toolset-always-on)
    * [2. Native Codex plugins (auto-migrated from your `codex plugin` install)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#2-native-codex-plugins-auto-migrated-from-your-codex-plugin-install)
    * [3. Hermes tool callback (MCP server, registered in `~/.codex/config.toml`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#3-hermes-tool-callback-mcp-server-registered-in-codexconfigtoml)
    * [What's NOT available on this runtime](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#whats-not-available-on-this-runtime)
  * [Workflow features (`/goal`, kanban, cron)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#workflow-features-goal-kanban-cron)
    * [`/goal` (the Ralph loop)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#goal-the-ralph-loop)
    * [Kanban (multi-agent worktree dispatch)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#kanban-multi-agent-worktree-dispatch)
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#prerequisites)
  * [Self-improvement loop (memory + skill nudges)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#self-improvement-loop-memory--skill-nudges)
  * [How approvals work](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#how-approvals-work)
  * [Permission profiles](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#permission-profiles)
  * [Auxiliary tasks and ChatGPT subscription token cost](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#auxiliary-tasks-and-chatgpt-subscription-token-cost)
  * [Editing `~/.codex/config.toml` safely](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#editing-codexconfigtoml-safely)
  * [Multi-profile / multi-tenant setups](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#multi-profile--multi-tenant-setups)
  * [HOME environment variable passthrough](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#home-environment-variable-passthrough)
  * [MCP server migration](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#mcp-server-migration)
  * [Native Codex plugin migration](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#native-codex-plugin-migration)
  * [Hermes tool callback (the new MCP server)](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#hermes-tool-callback-the-new-mcp-server)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#limitations)
  * [Architecture](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime#architecture)

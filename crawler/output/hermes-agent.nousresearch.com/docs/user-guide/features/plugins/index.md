...
| An **STT backend** (custom whisper binary, local ASR CLI)  | Config-driven — set `HERMES_LOCAL_STT_COMMAND` env var to a shell template  | [Voice Message Transcription (STT)](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#voice-message-transcription-stt)  |  

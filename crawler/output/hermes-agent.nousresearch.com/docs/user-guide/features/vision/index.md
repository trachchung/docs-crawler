...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#__docusaurus_skipToContent_fallback)
On this page
...
Which auxiliary model handles the text-description path is configurable under `auxiliary.vision` — see [Auxiliary Models](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#auxiliary-models).
  * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#how-it-works)
  * [Paste Methods](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#paste-methods)
    * [`/paste` Command](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#paste-command)
    * [Ctrl+V / Cmd+V](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#ctrlv--cmdv)
    * [`/terminal-setup` for VS Code / Cursor / Windsurf](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#terminal-setup-for-vs-code--cursor--windsurf)
  * [Platform Compatibility](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#platform-compatibility)
  * [Platform-Specific Setup](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#platform-specific-setup)
    * [Linux (X11)](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#linux-x11)
    * [Linux (Wayland)](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#linux-wayland)
  * [SSH & Remote Sessions](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#ssh--remote-sessions)
    * [Workarounds for SSH](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#workarounds-for-ssh)
  * [Why Terminals Can't Paste Images](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#why-terminals-cant-paste-images)
  * [Supported Models](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#supported-models)
  * [Image Routing (Vision-Capable vs Text-Only Models)](https://hermes-agent.nousresearch.com/docs/user-guide/features/vision#image-routing-vision-capable-vs-text-only-models)

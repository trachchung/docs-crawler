...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#__docusaurus_skipToContent_fallback)
On this page
...
`/goal` is Hermes' take on the **Ralph loop** pattern. The user-facing design — keep a goal alive across turns, don't stop until it's achieved, with create/pause/resume/clear controls — was popularised and shipped in [Codex CLI 0.128.0](https://github.com/openai/codex) by Eric Traut on OpenAI's Codex team. Our implementation is independent (central `CommandDef` registry, `SessionDB.state_meta` persistence, auxiliary-client judge, adapter-FIFO continuation on the gateway side) but the idea is theirs. Credit where credit's due.
  * [When to use it](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#when-to-use-it)
  * [Quick start](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#quick-start)
  * [Behavior details](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#behavior-details)
    * [Fail-open semantics](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#fail-open-semantics)
    * [Turn budget](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#turn-budget)
    * [User messages always preempt](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#user-messages-always-preempt)
    * [Mid-run safety (gateway)](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#mid-run-safety-gateway)
    * [Persistence](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#persistence)
    * [Prompt cache](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#prompt-cache)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#configuration)
    * [Choosing the judge model](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#choosing-the-judge-model)
  * [Example walkthrough](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#example-walkthrough)
  * [When the judge gets it wrong](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#when-the-judge-gets-it-wrong)
  * [Attribution](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#attribution)

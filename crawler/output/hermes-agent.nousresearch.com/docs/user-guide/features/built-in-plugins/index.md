...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#__docusaurus_skipToContent_fallback)
On this page
...
Counter-examples — things that should stay as user-installable plugins, not bundled: third-party integrations with API keys, niche workflows, large dependency trees, anything that would meaningfully change agent behaviour by default.
  * [How discovery works](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#how-discovery-works)
  * [Bundled plugins are opt-in](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#bundled-plugins-are-opt-in)
  * [Currently shipped](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#currently-shipped)
    * [disk-cleanup](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#disk-cleanup)
    * [observability/langfuse](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#observabilitylangfuse)
    * [google_meet](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#google_meet)
    * [hermes-achievements](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#hermes-achievements)
  * [Adding a bundled plugin](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#adding-a-bundled-plugin)

...
The agent handles delegation automatically based on the task complexity. You don't need to explicitly ask it to delegate — it will do so when it makes sense.
  * [Single Task](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#single-task)
  * [Parallel Batch](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#parallel-batch)
  ...
  * [Practical Examples](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#practical-examples)
    * [Parallel Research](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#parallel-research)
    * [Code Review + Fix](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#code-review--fix)
  ...
  * [Toolset Selection Tips](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#toolset-selection-tips)
  * [Max Iterations](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#max-iterations)
  * [Child Timeout](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#child-timeout)
  ...
  * [Key Properties](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#key-properties)
  ...
  * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#configuration)

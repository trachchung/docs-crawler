...
If you just want to install, the one-liner on the [landing page](https://hermes-agent.nousresearch.com/docs/) or [Installation page](https://hermes-agent.nousresearch.com/docs/getting-started/installation#windows-native-powershell--early-beta) is all you need. Come back here when something surprises you.
If you prefer a real POSIX environment (for the dashboard's embedded terminal, `fork` semantics, Linux-style file watchers, etc.), see the **[Windows (WSL2) Guide](https://hermes-agent.nousresearch.com/docs/user-guide/windows-wsl-quickstart)**. Both coexist cleanly: native data lives under `%LOCALAPPDATA%\hermes`, WSL data lives under `~/.hermes`.
## Quick install[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#quick-install "Direct link to Quick install")
...
## What the installer actually does[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#what-the-installer-actually-does "Direct link to What the installer actually does")
...
## Feature matrix[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#feature-matrix "Direct link to Feature matrix")
...
## How Hermes runs shell commands on Windows[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#how-hermes-runs-shell-commands-on-windows "Direct link to How Hermes runs shell commands on Windows")
...
## UTF-8 console on Windows[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#utf-8-console-on-windows "Direct link to UTF-8 console on Windows")
...
## The editor (`Ctrl-X Ctrl-E`, `/edit`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#the-editor-ctrl-x-ctrl-e-edit "Direct link to the-editor-ctrl-x-ctrl-e-edit")
...
##  `Ctrl+Enter` for newline in the CLI[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#ctrlenter-for-newline-in-the-cli "Direct link to ctrlenter-for-newline-in-the-cli")
...
## Running the gateway at Windows login[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#running-the-gateway-at-windows-login "Direct link to Running the gateway at Windows login")
`hermes gateway install` on Windows uses **Scheduled Tasks** with a Startup-folder fallback — no admin required.
### Install[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#install "Direct link to Install")
...
### Manage[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#manage "Direct link to Manage")
...
### Why not a Windows Service?[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#why-not-a-windows-service "Direct link to Why not a Windows Service?")
...
## Data layout[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#data-layout "Direct link to Data layout")  
| Path  | Contents  |  
| --- | --- |  
...
## Browser tool[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#browser-tool "Direct link to Browser tool")
...
## Running Hermes on Windows — practical notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#running-hermes-on-windows--practical-notes "Direct link to Running Hermes on Windows — practical notes")
### PATH after install[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#path-after-install "Direct link to PATH after install")
...
### Environment variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#environment-variables "Direct link to Environment variables")
...
### Windows-specific env vars[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#windows-specific-env-vars "Direct link to Windows-specific env vars")
...
## Uninstall[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#uninstall "Direct link to Uninstall")
From PowerShell:
...
## Process management internals[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#process-management-internals "Direct link to Process management internals")
...
## Common pitfalls[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#common-pitfalls "Direct link to Common pitfalls")
...
## Where to go next[​](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#where-to-go-next "Direct link to Where to go next")
  * **[Installation](https://hermes-agent.nousresearch.com/docs/getting-started/installation)** — the full install page, including Linux/macOS/WSL2/Termux.
  * **[Windows (WSL2) Guide](https://hermes-agent.nousresearch.com/docs/user-guide/windows-wsl-quickstart)** — if you want POSIX semantics or the dashboard terminal pane.
  * **[CLI Reference](https://hermes-agent.nousresearch.com/docs/reference/cli-commands)** — every `hermes` subcommand.
  * — common non-Windows-specific questions.
  * **[Messaging Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/)** — running Telegram/Discord/Slack on Windows.


  * [Quick install](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#quick-install)
  * [What the installer actually does](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#what-the-installer-actually-does)
  * [Feature matrix](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#feature-matrix)
  * [How Hermes runs shell commands on Windows](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#how-hermes-runs-shell-commands-on-windows)
  * [UTF-8 console on Windows](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#utf-8-console-on-windows)
  * [The editor (`Ctrl-X Ctrl-E`, `/edit`)](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#the-editor-ctrl-x-ctrl-e-edit)
  * [`Ctrl+Enter` for newline in the CLI](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#ctrlenter-for-newline-in-the-cli)
  * [Running the gateway at Windows login](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#running-the-gateway-at-windows-login)
    * [Why not a Windows Service?](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#why-not-a-windows-service)
  * [Data layout](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#data-layout)
  * [Browser tool](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#browser-tool)
  * [Running Hermes on Windows — practical notes](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#running-hermes-on-windows--practical-notes)
    * [PATH after install](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#path-after-install)
    * [Environment variables](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#environment-variables)
    * [Windows-specific env vars](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#windows-specific-env-vars)
  * [Process management internals](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#process-management-internals)
  * [Common pitfalls](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#common-pitfalls)
  * [Where to go next](https://hermes-agent.nousresearch.com/docs/user-guide/windows-native#where-to-go-next)

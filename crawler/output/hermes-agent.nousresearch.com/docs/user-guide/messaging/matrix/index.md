...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#__docusaurus_skipToContent_fallback)
On this page
...
## Notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#notes "Direct link to Notes")
  ...
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#how-hermes-behaves)
    * [Session Model in Matrix](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#session-model-in-matrix)
    * [Mention and Threading Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#mention-and-threading-configuration)
  * [Step 1: Create a Bot Account](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-1-create-a-bot-account)
    * [Option A: Register on Your Homeserver (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-a-register-on-your-homeserver-recommended)
    * [Option B: Use matrix.org or Another Public Homeserver](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-b-use-matrixorg-or-another-public-homeserver)
    * [Option C: Use Your Own Account](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-c-use-your-own-account)
  * [Step 2: Get an Access Token](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-2-get-an-access-token)
    * [Option A: Access Token (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-a-access-token-recommended)
    * [Option B: Password Login](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-b-password-login)
  * [Step 3: Find Your Matrix User ID](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-3-find-your-matrix-user-id)
  * [Step 4: Configure Hermes Agent](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-4-configure-hermes-agent)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#option-b-manual-configuration)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#start-the-gateway)
  * [End-to-End Encryption (E2EE)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#end-to-end-encryption-e2ee)
    * [Requirements](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#requirements)
    * [Enable E2EE](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#enable-e2ee)
    * [Cross-Signing Verification (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#cross-signing-verification-recommended)
  * [Home Room](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#home-room)
    * [Using the Slash Command](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#using-the-slash-command)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#manual-configuration)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#troubleshooting)
    * [Bot is not responding to messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#bot-is-not-responding-to-messages)
    * ["Failed to authenticate" / "whoami failed" on startup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#failed-to-authenticate--whoami-failed-on-startup)
    * ["mautrix not installed" error](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#mautrix-not-installed-error)
    * [Encryption errors / "could not decrypt event"](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#encryption-errors--could-not-decrypt-event)
    * [Upgrading from a previous version with E2EE](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#upgrading-from-a-previous-version-with-e2ee)
  * [Proxy Mode (E2EE on macOS)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#proxy-mode-e2ee-on-macos)
    * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#how-it-works)
    * [Step 1: Configure the Host (macOS)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-1-configure-the-host-macos)
    * [Step 2: Configure the Docker Container (Linux VM)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-2-configure-the-docker-container-linux-vm)
    * [Step 3: Start Both](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#step-3-start-both)
    * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#configuration-reference)
    * [Works for Any Platform](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#works-for-any-platform)
    * [Sync issues / bot falls behind](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#sync-issues--bot-falls-behind)
    * [Bot is offline](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#bot-is-offline)
    * ["User not allowed" / Bot ignores you](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/matrix#user-not-allowed--bot-ignores-you)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#__docusaurus_skipToContent_fallback)
On this page
...
###  `gh` CLI errors (GitHub comment delivery)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#gh-cli-errors-github-comment-delivery "Direct link to gh-cli-errors-github-comment-delivery")
...
| `WEBHOOK_SECRET`  | Global HMAC secret (used as fallback when routes don't specify their own)  | _(none)_  |  
  * [Video Tutorial](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#video-tutorial)
  * [Quick Start](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#quick-start)
  * [Setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#setup)
    * [Via setup wizard](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#via-setup-wizard)
    * [Via environment variables](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#via-environment-variables)
    * [Verify the server](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#verify-the-server)
  * [Configuring Routes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#configuring-routes)
    * [Route properties](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#route-properties)
    * [Full example](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#full-example)
    * [Prompt Templates](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#prompt-templates)
    * [Forum Topic Delivery](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#forum-topic-delivery)
  * [GitHub PR Review (Step by Step)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#github-pr-review)
    * [1. Create the webhook in GitHub](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#1-create-the-webhook-in-github)
    * [2. Add the route config](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#2-add-the-route-config)
    * [3. Ensure `gh` CLI is authenticated](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#3-ensure-gh-cli-is-authenticated)
  * [GitLab Webhook Setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#gitlab-webhook-setup)
    * [1. Create the webhook in GitLab](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#1-create-the-webhook-in-gitlab)
    * [2. Add the route config](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#2-add-the-route-config-1)
  * [Delivery Options](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#delivery-options)
  * [Direct Delivery Mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#direct-delivery-mode)
    * [When to use direct delivery](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#when-to-use-direct-delivery)
    * [Example: Telegram push from Supabase](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#example-telegram-push-from-supabase)
    * [Example: Dynamic subscription via CLI](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#example-dynamic-subscription-via-cli)
    * [Response codes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#response-codes)
    * [Configuration gotchas](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#configuration-gotchas)
  * [Dynamic Subscriptions (CLI)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#dynamic-subscriptions)
    * [Create a subscription](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#create-a-subscription)
    * [List subscriptions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#list-subscriptions)
    * [Remove a subscription](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#remove-a-subscription)
    * [Test a subscription](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#test-a-subscription)
    * [How dynamic subscriptions work](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#how-dynamic-subscriptions-work)
    * [Agent-driven subscriptions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#agent-driven-subscriptions)
  * [Security](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#security)
    * [HMAC signature validation](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#hmac-signature-validation)
    * [Secret is required](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#secret-is-required)
    * [Rate limiting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#rate-limiting)
    * [Idempotency](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#idempotency)
    * [Body size limits](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#body-size-limits)
    * [Prompt injection risk](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#prompt-injection-risk)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#troubleshooting)
    * [Webhook not arriving](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#webhook-not-arriving)
    * [Signature validation failing](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#signature-validation-failing)
    * [Event being ignored](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#event-being-ignored)
    * [Agent not responding](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#agent-not-responding)
    * [Duplicate responses](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#duplicate-responses)
    * [`gh` CLI errors (GitHub comment delivery)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#gh-cli-errors-github-comment-delivery)
  * [Environment Variables](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#environment-variables)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#__docusaurus_skipToContent_fallback)
On this page
...
## Notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#notes "Direct link to Notes")
  ...
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#how-hermes-behaves)
    * [Session Model in Mattermost](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#session-model-in-mattermost)
  * [Step 1: Enable Bot Accounts](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-1-enable-bot-accounts)
  * [Step 2: Create a Bot Account](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-2-create-a-bot-account)
  * [Step 3: Add the Bot to Channels](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-3-add-the-bot-to-channels)
  * [Step 4: Find Your Mattermost User ID](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-4-find-your-mattermost-user-id)
  * [Step 5: Configure Hermes Agent](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-5-configure-hermes-agent)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#option-b-manual-configuration)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#start-the-gateway)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#home-channel)
    * [Using the Slash Command](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#using-the-slash-command)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#manual-configuration)
  * [Mention Behavior](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#mention-behavior)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#troubleshooting)
    * [Bot is not responding to messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#bot-is-not-responding-to-messages)
    * [403 Forbidden errors](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#403-forbidden-errors)
    * [WebSocket disconnects / reconnection loops](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#websocket-disconnects--reconnection-loops)
    * ["Failed to authenticate" on startup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#failed-to-authenticate-on-startup)
    * [Bot is offline](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#bot-is-offline)
    * ["User not allowed" / Bot ignores you](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#user-not-allowed--bot-ignores-you)
  * [Per-Channel Prompts](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#per-channel-prompts)

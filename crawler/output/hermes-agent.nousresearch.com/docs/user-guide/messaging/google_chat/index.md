...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#__docusaurus_skipToContent_fallback)
On this page
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#overview "Direct link to Overview")  
| Component  | Value  |  
| --- | --- |  
...
## Step 1: Create or pick a GCP project[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-1-create-or-pick-a-gcp-project "Direct link to Step 1: Create or pick a GCP project")
...
## Step 2: Enable two APIs[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-2-enable-two-apis "Direct link to Step 2: Enable two APIs")
...
## Step 3: Create a Service Account[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-3-create-a-service-account "Direct link to Step 3: Create a Service Account")
...
## Step 4: Create the Pub/Sub topic and subscription[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-4-create-the-pubsub-topic-and-subscription "Direct link to Step 4: Create the Pub/Sub topic and subscription")
...
## Step 5: IAM binding on the topic (critical)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-5-iam-binding-on-the-topic-critical "Direct link to Step 5: IAM binding on the topic \(critical\)")
...
## Step 6: IAM binding on the subscription[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-6-iam-binding-on-the-subscription "Direct link to Step 6: IAM binding on the subscription")
...
## Step 7: Configure the Chat app[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-7-configure-the-chat-app "Direct link to Step 7: Configure the Chat app")
...
Save.
## Step 8: Install the bot in a test space[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-8-install-the-bot-in-a-test-space "Direct link to Step 8: Install the bot in a test space")
...
## Step 9: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-9-configure-hermes "Direct link to Step 9: Configure Hermes")
...
## Formatting and capabilities[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#formatting-and-capabilities "Direct link to Formatting and capabilities")
...
## Step 10: Native attachment delivery (optional)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-10-native-attachment-delivery-optional "Direct link to Step 10: Native attachment delivery \(optional\)")
...
### Why a separate flow[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#why-a-separate-flow "Direct link to Why a separate flow")
...
### One-time host setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#one-time-host-setup "Direct link to One-time host setup")
...
### Per-user authorization (in chat)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#per-user-authorization-in-chat "Direct link to Per-user authorization \(in chat\)")
...
### Scope[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#scope "Direct link to Scope")
...
### Multi-user behavior[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#multi-user-behavior "Direct link to Multi-user behavior")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#troubleshooting "Direct link to Troubleshooting")
...
## Security notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#security-notes "Direct link to Security notes")
  ...
  * [Step 1: Create or pick a GCP project](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-1-create-or-pick-a-gcp-project)
  * [Step 2: Enable two APIs](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-2-enable-two-apis)
  * [Step 3: Create a Service Account](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-3-create-a-service-account)
  * [Step 4: Create the Pub/Sub topic and subscription](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-4-create-the-pubsub-topic-and-subscription)
  * [Step 5: IAM binding on the topic (critical)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-5-iam-binding-on-the-topic-critical)
  * [Step 6: IAM binding on the subscription](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-6-iam-binding-on-the-subscription)
  * [Step 7: Configure the Chat app](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-7-configure-the-chat-app)
  * [Step 8: Install the bot in a test space](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-8-install-the-bot-in-a-test-space)
  * [Step 9: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-9-configure-hermes)
  * [Formatting and capabilities](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#formatting-and-capabilities)
  * [Step 10: Native attachment delivery (optional)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#step-10-native-attachment-delivery-optional)
    * [Why a separate flow](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#why-a-separate-flow)
    * [One-time host setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#one-time-host-setup)
    * [Per-user authorization (in chat)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#per-user-authorization-in-chat)
    * [Multi-user behavior](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#multi-user-behavior)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#troubleshooting)
  * [Security notes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/google_chat#security-notes)

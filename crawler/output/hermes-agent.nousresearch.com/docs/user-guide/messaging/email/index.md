...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#__docusaurus_skipToContent_fallback)
On this page
...
### Sending Replies[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#sending-replies "Direct link to Sending Replies")
...
| `EMAIL_ALLOW_ALL_USERS`  | No  | `false`  | Allow all senders (not recommended)  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#prerequisites)
    * [Gmail Setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#gmail-setup)
    * [Outlook / Microsoft 365](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#outlook--microsoft-365)
    * [Other Providers](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#other-providers)
  * [Step 1: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#step-1-configure-hermes)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#manual-configuration)
  * [Step 2: Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#step-2-start-the-gateway)
  * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#how-it-works)
    * [Receiving Messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#receiving-messages)
    * [Sending Replies](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#sending-replies)
    * [File Attachments](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#file-attachments)
    * [Skipping Attachments](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#skipping-attachments)
  * [Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#access-control)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#troubleshooting)
  * [Environment Variables Reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#environment-variables-reference)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#__docusaurus_skipToContent_fallback)
On this page
...
```
  ...
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#prerequisites)
  * [Step 1: Run the Setup Wizard](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#step-1-run-the-setup-wizard)
  * [Step 2: Getting a Second Phone Number (Bot Mode)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#step-2-getting-a-second-phone-number-bot-mode)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#step-3-configure-hermes)
  * [Session Persistence](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#session-persistence)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#voice-messages)
  * [Message Formatting & Delivery](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#message-formatting--delivery)
    * [WhatsApp-Compatible Markdown](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#whatsapp-compatible-markdown)
    * [Tool Progress](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#tool-progress)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#troubleshooting)

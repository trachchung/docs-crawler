...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#__docusaurus_skipToContent_fallback)
On this page
...
## How It Works[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#how-it-works "Direct link to How It Works")
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#prerequisites "Direct link to Prerequisites")
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#setup "Direct link to Setup")
### 1. Create a Self-Built App in WeCom[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#1-create-a-self-built-app-in-wecom "Direct link to 1. Create a Self-Built App in WeCom")
...
### 2. Configure Environment Variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#2-configure-environment-variables "Direct link to 2. Configure Environment Variables")
...
### 3. Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#3-start-the-gateway "Direct link to 3. Start the Gateway")
...
## Configuration Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#configuration-reference "Direct link to Configuration Reference")
...
## Multi-App Routing[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#multi-app-routing "Direct link to Multi-App Routing")
...
## Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#access-control "Direct link to Access Control")
...
## Endpoints[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#endpoints "Direct link to Endpoints")
The adapter exposes:  
| Method  | Path  | Purpose  |  
| --- | --- | --- |  
...
## Encryption[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#encryption "Direct link to Encryption")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#limitations "Direct link to Limitations")
  ...
  * [How It Works](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#how-it-works)
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#prerequisites)
  * [Setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#setup)
    * [1. Create a Self-Built App in WeCom](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#1-create-a-self-built-app-in-wecom)
    * [2. Configure Environment Variables](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#2-configure-environment-variables)
    * [3. Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#3-start-the-gateway)
  * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#configuration-reference)
  * [Multi-App Routing](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#multi-app-routing)
  * [Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#access-control)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/wecom-callback#limitations)

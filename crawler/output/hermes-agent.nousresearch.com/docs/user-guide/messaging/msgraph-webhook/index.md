...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#__docusaurus_skipToContent_fallback)
On this page
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#prerequisites "Direct link to Prerequisites")
  * Microsoft Graph application credentials — [Register a Microsoft Graph Application](https://hermes-agent.nousresearch.com/docs/guides/microsoft-graph-app-registration)
...
## Quick Start[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#quick-start "Direct link to Quick Start")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#configuration "Direct link to Configuration")
...
Each setting also has an equivalent env var (`MSGRAPH_WEBHOOK_*`) that merges into the config at gateway startup — see the [environment variables reference](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#microsoft-graph-teams-meetings).
## Security Hardening[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#security-hardening "Direct link to Security Hardening")
### clientState is the primary auth check[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#clientstate-is-the-primary-auth-check "Direct link to clientState is the primary auth check")
...
### Source-IP allowlisting (production deployments)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#source-ip-allowlisting-production-deployments "Direct link to Source-IP allowlisting \(production deployments\)")
...
### HTTPS termination[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#https-termination "Direct link to HTTPS termination")
...
### Response hygiene[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#response-hygiene "Direct link to Response hygiene")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#troubleshooting "Direct link to Troubleshooting")  
...
## Related Docs[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#related-docs "Direct link to Related Docs")
  * [Register a Microsoft Graph Application](https://hermes-agent.nousresearch.com/docs/guides/microsoft-graph-app-registration) — Azure app registration prereq
  * [Environment Variables → Microsoft Graph](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#microsoft-graph-teams-meetings) — full env var list
  * [Microsoft Teams bot setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/teams) — the different platform that lets users chat with Hermes in Teams


  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#prerequisites)
  * [Quick Start](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#quick-start)
  * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#configuration)
  * [Security Hardening](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#security-hardening)
    * [clientState is the primary auth check](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#clientstate-is-the-primary-auth-check)
    * [Source-IP allowlisting (production deployments)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#source-ip-allowlisting-production-deployments)
    * [HTTPS termination](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#https-termination)
    * [Response hygiene](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#response-hygiene)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#troubleshooting)
  * [Related Docs](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook#related-docs)

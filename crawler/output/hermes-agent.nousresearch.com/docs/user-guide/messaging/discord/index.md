...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#__docusaurus_skipToContent_fallback)
On this page
...
## Sending Media (`send_message` + `MEDIA:` tags)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#sending-media-send_message--media-tags "Direct link to sending-media-send_message--media-tags")
...
For more information on securing your Hermes Agent deployment, see the [Security Guide](https://hermes-agent.nousresearch.com/docs/user-guide/security).
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#how-hermes-behaves)
    * [Discord Gateway Model](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discord-gateway-model)
    * [Session Model in Discord](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#session-model-in-discord)
    * [Interrupts and Concurrency](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#interrupts-and-concurrency)
  * [Step 1: Create a Discord Application](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-1-create-a-discord-application)
  * [Step 2: Create the Bot](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-2-create-the-bot)
  * [Step 3: Enable Privileged Gateway Intents](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-3-enable-privileged-gateway-intents)
  * [Step 4: Get the Bot Token](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-4-get-the-bot-token)
  * [Step 5: Generate the Invite URL](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-5-generate-the-invite-url)
    * [Option A: Using the Installation Tab (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-a-using-the-installation-tab-recommended)
    * [Option B: Manual URL](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-b-manual-url)
    * [Required Permissions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#required-permissions)
    * [Recommended Additional Permissions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#recommended-additional-permissions)
    * [Permission Integers](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#permission-integers)
  * [Step 6: Invite to Your Server](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-6-invite-to-your-server)
  * [Step 7: Find Your Discord User ID](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-7-find-your-discord-user-id)
  * [Step 8: Configure Hermes Agent](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-8-configure-hermes-agent)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-b-manual-configuration)
  * [Configuration Reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#configuration-reference)
    * [Environment Variables (`.env`)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#environment-variables-env)
    * [Config File (`config.yaml`)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#config-file-configyaml)
  * [Slash Command Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#slash-command-access-control)
  * [Interactive Model Picker](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#interactive-model-picker)
  * [Native Slash Commands for Skills](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#native-slash-commands-for-skills)
    * [Disabling Slash Command Registration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#disabling-slash-command-registration)
  * [Sending Media (`send_message` + `MEDIA:` tags)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#sending-media-send_message--media-tags)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#home-channel)
    * [Using the Slash Command](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#using-the-slash-command)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#manual-configuration)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#voice-messages)
  * [Forum Channels](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#forum-channels)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#troubleshooting)
    * [Bot is online but not responding to messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#bot-is-online-but-not-responding-to-messages)
    * ["Disallowed Intents" error on startup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#disallowed-intents-error-on-startup)
    * [Bot can't see messages in a specific channel](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#bot-cant-see-messages-in-a-specific-channel)
    * [403 Forbidden errors](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#403-forbidden-errors)
    * [Bot is offline](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#bot-is-offline)
    * ["User not allowed" / Bot ignores you](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#user-not-allowed--bot-ignores-you)
    * [People in the same channel are sharing context unexpectedly](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#people-in-the-same-channel-are-sharing-context-unexpectedly)
  * [Security](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#security)
    * [Role-Based Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#role-based-access-control)
    * [Mention Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#mention-control)

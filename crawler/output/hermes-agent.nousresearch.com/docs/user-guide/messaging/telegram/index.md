...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#__docusaurus_skipToContent_fallback)
On this page
...
For more details, see the [Security documentation](https://hermes-agent.nousresearch.com/docs/user-guide/security). You can also use [DM pairing](https://hermes-agent.nousresearch.com/docs/user-guide/messaging#dm-pairing-alternative-to-allowlists) for a more dynamic approach to user authorization.
  * [Step 1: Create a Bot via BotFather](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-1-create-a-bot-via-botfather)
  * [Step 2: Customize Your Bot (Optional)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-2-customize-your-bot-optional)
  * [Step 3: Privacy Mode (Critical for Groups)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-3-privacy-mode-critical-for-groups)
    * [How to disable privacy mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-to-disable-privacy-mode)
  * [Step 4: Find Your User ID](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-4-find-your-user-id)
  * [Step 5: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-5-configure-hermes)
    * [Option A: Interactive Setup (Recommended)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#option-a-interactive-setup-recommended)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#option-b-manual-configuration)
    * [Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#start-the-gateway)
  * [Sending Generated Files from Docker-backed Terminals](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#sending-generated-files-from-docker-backed-terminals)
    * [Supported `MEDIA:` file extensions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#supported-media-file-extensions)
  * [Webhook Mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#webhook-mode)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration)
    * [Cloud deployment example (Fly.io)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#cloud-deployment-example-flyio)
  * [Proxy Support](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#proxy-support)
  * [Home Channel](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#home-channel)
  * [Voice Messages](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#voice-messages)
    * [Incoming Voice (Speech-to-Text)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#incoming-voice-speech-to-text)
    * [Outgoing Voice (Text-to-Speech)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#outgoing-voice-text-to-speech)
  * [Group Chat Usage](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#group-chat-usage)
    * [Troubleshooting: works in DMs but not groups](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#troubleshooting-works-in-dms-but-not-groups)
    * [Example group trigger configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#example-group-trigger-configuration)
    * [Notes on `mention_patterns`](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#notes-on-mention_patterns)
  * [Private Chat Topics (Bot API 9.4)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#private-chat-topics-bot-api-94)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-1)
    * [How it works](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-it-works)
    * [Skill binding](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#skill-binding)
  * [Multi-session DM mode (`/topic`)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#multi-session-dm-mode-topic)
    * [`/topic` subcommands](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#topic-subcommands)
    * [DM Topics vs Multi-session DM mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#dm-topics-vs-multi-session-dm-mode)
    * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#prerequisites)
    * [Activation flow](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#activation-flow)
    * [Creating a new topic (end-user flow)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#creating-a-new-topic-end-user-flow)
    * [Auto-renamed topics](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#auto-renamed-topics)
    * [`/new` inside a topic](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#new-inside-a-topic)
    * [Restoring a previous session](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#restoring-a-previous-session)
    * [`/topic` inside a topic (no argument)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#topic-inside-a-topic-no-argument)
    * [Under the hood](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#under-the-hood)
    * [Disabling multi-session mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#disabling-multi-session-mode)
    * [Downgrading Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#downgrading-hermes)
  * [Group Forum Topic Skill Binding](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#group-forum-topic-skill-binding)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-2)
    * [How it works](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-it-works-1)
    * [Differences from DM Topics](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#differences-from-dm-topics)
  * [Recent Bot API Features](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#recent-bot-api-features)
    * [Streaming transport (`gateway.streaming.transport`)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#streaming-transport-gatewaystreamingtransport)
  * [Rendering: Tables and Link Previews](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#rendering-tables-and-link-previews)
  * [Group Allowlisting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#group-allowlisting)
    * [Migration from before PR #17686](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#migration-from-before-pr-17686)
  * [Slash Command Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#slash-command-access-control)
  * [Interactive Model Picker](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#interactive-model-picker)
  * [DNS-over-HTTPS Fallback IPs](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#dns-over-https-fallback-ips)
    * [How it works](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-it-works-2)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-3)
  * [Proxy Support](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#proxy-support-1)
    * [Supported variables](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#supported-variables)
    * [Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-4)
  * [Message Reactions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#message-reactions)
  * [Per-Channel Prompts](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#per-channel-prompts)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#troubleshooting)
  * [Exec Approval](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#exec-approval)
  * [Interactive Prompts (clarify)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#interactive-prompts-clarify)

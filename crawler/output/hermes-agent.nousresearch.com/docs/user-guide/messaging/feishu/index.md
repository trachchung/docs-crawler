...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#__docusaurus_skipToContent_fallback)
On this page
...
## How Hermes Behaves[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#how-hermes-behaves "Direct link to How Hermes Behaves")  
| Context  | Behavior  |  
| --- | --- |  
...
## Step 1: Create a Feishu / Lark App[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-1-create-a-feishu--lark-app "Direct link to Step 1: Create a Feishu / Lark App")
### Recommended: Scan-to-Create (one command)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#recommended-scan-to-create-one-command "Direct link to Recommended: Scan-to-Create \(one command\)")
...
### Alternative: Manual Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#alternative-manual-setup "Direct link to Alternative: Manual Setup")
...
## Step 2: Choose a Connection Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-2-choose-a-connection-mode "Direct link to Step 2: Choose a Connection Mode")
### Recommended: WebSocket mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#recommended-websocket-mode "Direct link to Recommended: WebSocket mode")
...
### Optional: Webhook mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#optional-webhook-mode "Direct link to Optional: Webhook mode")
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-3-configure-hermes "Direct link to Step 3: Configure Hermes")
### Option A: Interactive Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#option-a-interactive-setup "Direct link to Option A: Interactive Setup")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#option-b-manual-configuration "Direct link to Option B: Manual Configuration")
...
## Step 4: Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-4-start-the-gateway "Direct link to Step 4: Start the Gateway")
...
## Home Chat[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#home-chat "Direct link to Home Chat")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#security "Direct link to Security")
### User Allowlist[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#user-allowlist "Direct link to User Allowlist")
...
### Webhook Encryption Key[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#webhook-encryption-key "Direct link to Webhook Encryption Key")
...
### Verification Token[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#verification-token "Direct link to Verification Token")
...
## Group Message Policy[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#group-message-policy "Direct link to Group Message Policy")
...
For per-chat control, set `require_mention` on a `group_rules` entry — see [Per-Group Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#per-group-access-control) below.
### Bot Identity[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#bot-identity "Direct link to Bot Identity")
...
## Bot-to-Bot Messaging[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#bot-to-bot-messaging "Direct link to Bot-to-Bot Messaging")
...
## Interactive Card Actions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#interactive-card-actions "Direct link to Interactive Card Actions")
...
### Required Feishu App Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#required-feishu-app-configuration "Direct link to Required Feishu App Configuration")
...
## Document Comment Intelligent Reply[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#document-comment-intelligent-reply "Direct link to Document Comment Intelligent Reply")
...
### 3-Tier Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#3-tier-access-control "Direct link to 3-Tier Access Control")
...
### Required Feishu App Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#required-feishu-app-configuration-1 "Direct link to Required Feishu App Configuration")
...
## Media Support[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#media-support "Direct link to Media Support")
### Inbound (receiving)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#inbound-receiving "Direct link to Inbound \(receiving\)")
...
### Outbound (sending)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#outbound-sending "Direct link to Outbound \(sending\)")  
...
## Markdown Rendering and Post Fallback[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#markdown-rendering-and-post-fallback "Direct link to Markdown Rendering and Post Fallback")
...
## Processing Status Reactions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#processing-status-reactions "Direct link to Processing Status Reactions")
...
## Burst Protection and Batching[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#burst-protection-and-batching "Direct link to Burst Protection and Batching")
The adapter includes debouncing for rapid message bursts to avoid overwhelming the agent:
### Text Batching[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#text-batching "Direct link to Text Batching")
...
### Media Batching[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#media-batching "Direct link to Media Batching")
...
### Per-Chat Serialization[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#per-chat-serialization "Direct link to Per-Chat Serialization")
...
## Rate Limiting (Webhook Mode)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#rate-limiting-webhook-mode "Direct link to Rate Limiting \(Webhook Mode\)")
...
### Webhook Anomaly Tracking[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#webhook-anomaly-tracking "Direct link to Webhook Anomaly Tracking")
...
## WebSocket Tuning[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#websocket-tuning "Direct link to WebSocket Tuning")
...
## Per-Group Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#per-group-access-control "Direct link to Per-Group Access Control")
...
## Deduplication[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#deduplication "Direct link to Deduplication")
...
## All Environment Variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#all-environment-variables "Direct link to All Environment Variables")  
...
WebSocket and per-group ACL settings are configured via `config.yaml` under `platforms.feishu.extra` (see [WebSocket Tuning](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#websocket-tuning) and [Per-Group Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#per-group-access-control) above).
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#troubleshooting "Direct link to Troubleshooting")  
| Problem  | Fix  |  
| --- | --- |  
...
| Error 200340 when clicking approval buttons  | Enable **Interactive Card** capability and configure **Card Request URL** in the Feishu Developer Console. See [Required Feishu App Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#required-feishu-app-configuration) above.  |  
| `Webhook rate limit exceeded`  | More than 120 requests/minute from the same IP. This is usually a misconfiguration or loop.  |  
## Toolset[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#toolset "Direct link to Toolset")
Feishu / Lark uses the `hermes-feishu` platform preset, which includes the same core tools as Telegram and other gateway-based messaging platforms.
  * [How Hermes Behaves](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#how-hermes-behaves)
  * [Step 1: Create a Feishu / Lark App](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-1-create-a-feishu--lark-app)
    * [Recommended: Scan-to-Create (one command)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#recommended-scan-to-create-one-command)
    * [Alternative: Manual Setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#alternative-manual-setup)
  * [Step 2: Choose a Connection Mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-2-choose-a-connection-mode)
    * [Recommended: WebSocket mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#recommended-websocket-mode)
    * [Optional: Webhook mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#optional-webhook-mode)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-3-configure-hermes)
    * [Option A: Interactive Setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#option-a-interactive-setup)
    * [Option B: Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#option-b-manual-configuration)
  * [Step 4: Start the Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#step-4-start-the-gateway)
  * [Security](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#security)
    * [User Allowlist](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#user-allowlist)
    * [Webhook Encryption Key](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#webhook-encryption-key)
    * [Verification Token](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#verification-token)
  * [Group Message Policy](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#group-message-policy)
    * [Bot Identity](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#bot-identity)
  * [Bot-to-Bot Messaging](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#bot-to-bot-messaging)
  * [Interactive Card Actions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#interactive-card-actions)
    * [Required Feishu App Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#required-feishu-app-configuration)
  * [Document Comment Intelligent Reply](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#document-comment-intelligent-reply)
    * [3-Tier Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#3-tier-access-control)
    * [Required Feishu App Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#required-feishu-app-configuration-1)
  * [Media Support](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#media-support)
    * [Inbound (receiving)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#inbound-receiving)
    * [Outbound (sending)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#outbound-sending)
  * [Markdown Rendering and Post Fallback](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#markdown-rendering-and-post-fallback)
  * [Processing Status Reactions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#processing-status-reactions)
  * [Burst Protection and Batching](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#burst-protection-and-batching)
    * [Text Batching](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#text-batching)
    * [Media Batching](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#media-batching)
    * [Per-Chat Serialization](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#per-chat-serialization)
  * [Rate Limiting (Webhook Mode)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#rate-limiting-webhook-mode)
    * [Webhook Anomaly Tracking](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#webhook-anomaly-tracking)
  * [WebSocket Tuning](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#websocket-tuning)
  * [Per-Group Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#per-group-access-control)
  * [Deduplication](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#deduplication)
  * [All Environment Variables](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#all-environment-variables)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/feishu#troubleshooting)

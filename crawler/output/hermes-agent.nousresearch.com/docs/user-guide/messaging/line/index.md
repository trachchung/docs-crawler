...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#__docusaurus_skipToContent_fallback)
On this page
...
## How the bot responds[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#how-the-bot-responds "Direct link to How the bot responds")  
| Context  | Behavior  |  
| --- | --- |  
...
## Step 1: Create a LINE Messaging API channel[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-1-create-a-line-messaging-api-channel "Direct link to Step 1: Create a LINE Messaging API channel")
...
## Step 2: Expose the webhook port[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-2-expose-the-webhook-port "Direct link to Step 2: Expose the webhook port")
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-3-configure-hermes "Direct link to Step 3: Configure Hermes")
Add to `~/.hermes/.env`:
...
## Step 4: Set the webhook URL[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-4-set-the-webhook-url "Direct link to Step 4: Set the webhook URL")
...
## Step 5: Run the gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-5-run-the-gateway "Direct link to Step 5: Run the gateway")
...
## Slow LLM responses[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#slow-llm-responses "Direct link to Slow LLM responses")
...
## Cron / notification delivery[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#cron--notification-delivery "Direct link to Cron / notification delivery")
...
## Environment variable reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#environment-variable-reference "Direct link to Environment variable reference")  
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#troubleshooting "Direct link to Troubleshooting")
...
## Limitations[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#limitations "Direct link to Limitations")
  ...
  * [How the bot responds](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#how-the-bot-responds)
  * [Step 1: Create a LINE Messaging API channel](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-1-create-a-line-messaging-api-channel)
  * [Step 2: Expose the webhook port](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-2-expose-the-webhook-port)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-3-configure-hermes)
  * [Step 4: Set the webhook URL](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-4-set-the-webhook-url)
  * [Step 5: Run the gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#step-5-run-the-gateway)
  * [Slow LLM responses](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#slow-llm-responses)
  * [Cron / notification delivery](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#cron--notification-delivery)
  * [Environment variable reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#environment-variable-reference)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#troubleshooting)
  * [Limitations](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/line#limitations)

...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#__docusaurus_skipToContent_fallback)
On this page
...
| `SIGNAL_HOME_CHANNEL`  | No  | —  | Default delivery target for cron jobs  |  
  * [Prerequisites](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#prerequisites)
    * [Installing signal-cli](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#installing-signal-cli)
  * [Step 1: Link Your Signal Account](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#step-1-link-your-signal-account)
  * [Step 2: Start the signal-cli Daemon](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#step-2-start-the-signal-cli-daemon)
  * [Step 3: Configure Hermes](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#step-3-configure-hermes)
    * [Manual Configuration](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#manual-configuration)
  * [Access Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#access-control)
    * [Group Access](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#group-access)
  * [Features](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#features)
    * [Attachments](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#attachments)
    * [Native Formatting, Reply Quotes, and Reactions](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#native-formatting-reply-quotes-and-reactions)
    * [Typing Indicators](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#typing-indicators)
    * [Phone Number Redaction](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#phone-number-redaction)
    * [Note to Self (Single-Number Setup)](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#note-to-self-single-number-setup)
    * [Health Monitoring](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#health-monitoring)
  * [Troubleshooting](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#troubleshooting)
  * [Environment Variables Reference](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#environment-variables-reference)

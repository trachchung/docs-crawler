<!-- Source: https://docs.payram.com/ -->

**The complete self-hosted payments stack for global commerce.** Accept payments globally, monetize anything in minutes, with **no middlemen** , **censorship-resistant settlement** , and full custody, data, and control on your own infrastructure.
### 
What is PayRam?
...
Copy paste to terminal for guided quick install
Copy
```
...
**Deployment Guide**
Set up and host PayRam in in under 10 minutes
**Onboarding Guide**
Connect wallets and start accepting payments
**PayRam Features**
See what makes PayRam powerful
### 
...
Need help?
**Community Support**
Drop us a DM or tag us on X (formerly Twitter)
**Contact Support**
Setup faster! Get direct help from our team.
[NextWhat's Newchevron-right](https://docs.payram.com/introduction/whats-new)

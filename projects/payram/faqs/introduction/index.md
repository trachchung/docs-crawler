<!-- Source: https://docs.payram.com/faqs/introduction -->

  * [What is PayRam?](https://docs.payram.com/faqs/introduction#what-is-payram)
  * [How do I get started, and how fast can I go live?](https://docs.payram.com/faqs/introduction#how-do-i-get-started-and-how-fast-can-i-go-live)
  * [What are the minimum server requirements to run PayRam?](https://docs.payram.com/faqs/introduction#what-are-the-minimum-server-requirements-to-run-payram)
  * [Which cryptocurrencies and blockchains does PayRam support?](https://docs.payram.com/faqs/introduction#which-cryptocurrencies-and-blockchains-does-payram-support)
  * [Does PayRam handle fiat currencies (USD, EUR, etc.)?](https://docs.payram.com/faqs/introduction#does-payram-handle-fiat-currencies-usd-eur-etc)
  * [What fees does PayRam charge?](https://docs.payram.com/faqs/introduction#what-fees-does-payram-charge)
  * [Are there any transaction limits?](https://docs.payram.com/faqs/introduction#are-there-any-transaction-limits)
  * [How do I integrate PayRam with my platform?](https://docs.payram.com/faqs/introduction#how-do-i-integrate-payram-with-my-platform)
  * [Is there a sandbox or test mode?](https://docs.payram.com/faqs/introduction#is-there-a-sandbox-or-test-mode)
  * [How secure is PayRam?](https://docs.payram.com/faqs/introduction#how-secure-is-payram)
  * [Does PayRam require KYC/AML?](https://docs.payram.com/faqs/introduction#does-payram-require-kyc-aml)
  * [How are refunds and chargebacks handled?](https://docs.payram.com/faqs/introduction#how-are-refunds-and-chargebacks-handled)
  * [What happens if a customer underpays or overpays?](https://docs.payram.com/faqs/introduction#what-happens-if-a-customer-underpays-or-overpays)
  * [Can I set up recurring subscriptions or billing?](https://docs.payram.com/faqs/introduction#can-i-set-up-recurring-subscriptions-or-billing)
  * [Which industries benefit most from PayRam?](https://docs.payram.com/faqs/introduction#which-industries-benefit-most-from-payram)
  * [How do I migrate from testnet to mainnet?](https://docs.payram.com/faqs/introduction#how-do-i-migrate-from-testnet-to-mainnet)
  * [What support options are available?](https://docs.payram.com/faqs/introduction#what-support-options-are-available)
...
[PreviousCard-to-Crypto Fiat Onrampchevron-left](https://docs.payram.com/features/card-to-crypto-fiat-onramp)[NextGeneral FAQ'schevron-right](https://docs.payram.com/faqs/general-faqs)

...
[Skip to main content](https://docs.meshconnect.com/api-reference/balance/get-aggregated-portfolio-fiat-balances#content-area)
...
YesNo
[ Get account balance Previous ](https://docs.meshconnect.com/api-reference/balance/get-account-balance)[ Verify account identity. Next ](https://docs.meshconnect.com/api-reference/verify/verify)
Ctrl+I
Get aggregated portfolio fiat balances
cURL

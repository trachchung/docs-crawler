...
[Skip to main content](https://docs.meshconnect.com/api-reference/transfers/get-deposit-address#content-area)
...
YesNo
[ Get wallet verifications for user and address. Previous ](https://docs.meshconnect.com/api-reference/verify/wallet)
Ctrl+I
Get deposit address
cURL

...
[Skip to main content](https://docs.meshconnect.com/api-reference/verify/wallet#content-area)
...
YesNo
[ Verify account identity. Previous ](https://docs.meshconnect.com/api-reference/verify/verify)[ Get deposit address Next ](https://docs.meshconnect.com/api-reference/transfers/get-deposit-address)
Ctrl+I
Get wallet verifications for user and address.
cURL

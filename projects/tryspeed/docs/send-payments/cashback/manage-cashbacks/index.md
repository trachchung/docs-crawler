<!-- Source: https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks -->
...
#### [Create a CashbackCopied!](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#create-a-cashback)
...
#### [Retrieve a cashbackCopied!](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#retrieve-a-cashback)
...
#### [Claiming a cashbackCopied!](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#claiming-a-cashback)
...
#### [How does a failed cashback claim work?Copied!](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#how-does-a-failed-cashback-claim-work?)
...
#### [Deactivate a cashbackCopied!](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#deactivate-a-cashback)
...
# Table of contents
[Create a Cashback](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#create-a-cashback)[Retrieve a cashback](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#retrieve-a-cashback)[Claiming a cashback](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#claiming-a-cashback)[How does a failed cashback claim work?](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#how-does-a-failed-cashback-claim-work?)[Deactivate a cashback](https://docs.tryspeed.com/docs/send-payments/cashback/manage-cashbacks#deactivate-a-cashback)
/docs/send-payments/cashback/manage-cashbacks
